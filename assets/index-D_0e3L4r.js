...
}`,CS=[new Y(1,0,0),new Y(-1,0,0),new Y(0,1,0),new Y(0,-1,0),new Y(0,0,1),new Y(0,0,-1)],RS=[new Y(0,-1,0),new Y(0,-1,0),new Y(0,0,1),new Y(0,0,-1),new Y(0,-1,0),new Y(0,-1,0)],qu=new xt,Nr=new Y,Eo=new Y;function PS(n,e,t){let i=new Fh;const r=new ot,s=new ot,a=new _t,o=new Gg,l=new kg,u={},c=t.maxTextureSize,f={[Si]:Wt,[Wt]:Si,[Xn]:Xn},h=new Ln({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new ot},radius:{value:4}},vertexShader:AS,fragmentShader:wS}),p=h.clone();p.defines.HORIZONTAL_PASS=1;const _=new xn;_.setAttribute("position",new ln(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const v=new ni(_,h),g=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=$s;let d=this.type;this.render=function(D,R,z){if(g.enabled===!1||g.autoUpdate===!1&&g.needsUpdate===!1||D.length===0)return;D.type===Dm&&(We("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),D.type=$s);const x=n.getRenderTarget(),E=n.getActiveCubeFace(),U=n.getActiveMipmapLevel(),P=n.state;P.setBlending(Yn),P.buffers.depth.getReversed()===!0?P.buffers.color.setClear(0,0,0,0):P.buffers.color.setClear(1,1,1,1),P.buffers.depth.setTest(!0),P.setScissorTest(!1);const F=d!==this.type;F&&R.traverse(function(j){j.material&&(Array.isArray(j.material)?j.material.forEach(Z=>Z.needsUpdate=!0):j.material.needsUpdate=!0)});for(let j=0,Z=D.length;j<Z;j++){const X=D[j],V=X.shadow;if(V===void 0){We("WebGLShadowMap:",X,"has no shadow.");continue}if(V.autoUpdate===!1&&V.needsUpdate===!1)continue;r.copy(V.mapSize);const Q=V.getFrameExtents();if(r.multiply(Q),s.copy(V.mapSize),(r.x>c||r.y>c)&&(r.x>c&&(s.x=Math.floor(c/Q.x),r.x=s.x*Q.x,V.mapSize.x=s.x),r.y>c&&(s.y=Math.floor(c/Q.y),r.y=s.y*Q.y,V.mapSize.y=s.y)),V.map===null||F===!0){if(V.map!==null&&(V.map.depthTexture!==null&&(V.map.depthTexture.dispose(),V.map.depthTexture=null),V.map.dispose()),this.type===Br){if(X.isPointLight){We("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}V.map=new Pn(r.x,r.y,{format:Sr,type:Qn,minFilter:Pt,magFilter:Pt,generateMipmaps:!1}),V.map.texture.name=X.name+".shadowMap",V.map.depthTexture=new ls(r.x,r.y,Tn),V.map.depthTexture.name=X.name+".shadowMapDepth",V.map.depthTexture.format=ei,V.map.depthTexture.compareFunction=null,V.map.depthTexture.minFilter=Tt,V.map.depthTexture.magFilter=Tt}else{X.isPointLight?(V.map=new Nh(r.x),V.map.depthTexture=new Vg(r.x,Dn)):(V.map=new Pn(r.x,r.y),V.map.depthTexture=new ls(r.x,r.y,Dn)),V.map.depthTexture.name=X.name+".shadowMap",V.map.depthTexture.format=ei;const re=n.state.buffers.depth.getReversed();this.type===$s?(V.map.depthTexture.compareFunction=re?ac:sc,V.map.depthTexture.minFilter=Pt,V.map.depthTexture.magFilter=Pt):(V.map.depthTexture.compareFunction=null,V.map.depthTexture.minFilter=Tt,V.map.depthTexture.magFilter=Tt)}V.camera.updateProjectionMatrix()}const se=V.map.isWebGLCubeRenderTarget?6:1;for(let re=0;re<se;re++){if(V.map.isWebGLCubeRenderTarget)n.setRenderTarget(V.map,re),n.clear();else{re===0&&(n.setRenderTarget(V.map),n.clear());const he=V.getViewport(re);a.set(s.x*he.x,s.y*he.y,s.x*he.z,s.y*he.w),P.viewport(a)}if(X.isPointLight){const he=V.camera,we=V.matrix,le=X.distance||he.far;le!==he.far&&(he.far=le,he.updateProjectionMatrix()),Nr.setFromMatrixPosition(X.matrixWorld),he.position.copy(Nr),Eo.copy(he.position),Eo.add(CS[re]),he.up.copy(RS[re]),he.lookAt(Eo),he.updateMatrixWorld(),we.makeTranslation(-Nr.x,-Nr.y,-Nr.z),qu.multiplyMatrices(he.projectionMatrix,he.matrixWorldInverse),V._frustum.setFromProjectionMatrix(qu,he.coordinateSystem,he.reversedDepth)}else V.updateMatrices(X);i=V.getFrustum(),b(R,z,V.camera,X,this.type)}V.isPointLightShadow!==!0&&this.type===Br&&y(V,z),V.needsUpdate=!1}d=this.type,g.needsUpdate=!1,n.setRenderTarget(x,E,U)};function y(D,R){const z=e.update(v);h.defines.VSM_SAMPLES!==D.blurSamples&&(h.defines.VSM_SAMPLES=D.blurSamples,p.defines.VSM_SAMPLES=D.blurSamples,h.needsUpdate=!0,p.needsUpdate=!0),D.mapPass===null&&(D.mapPass=new Pn(r.x,r.y,{format:Sr,type:Qn})),h.uniforms.shadow_pass.value=D.map.depthTexture,h.uniforms.resolution.value=D.mapSize,h.uniforms.radius.value=D.radius,n.setRenderTarget(D.mapPass),n.clear(),n.renderBufferDirect(R,null,z,h,v,null),p.uniforms.shadow_pass.value=D.mapPass.texture,p.uniforms.resolution.value=D.mapSize,p.uniforms.radius.value=D.radius,n.setRenderTarget(D.map),n.clear(),n.renderBufferDirect(R,null,z,p,v,null)}function w(D,R,z,x){let E=null;const U=z.isPointLight===!0?D.customDistanceMaterial:D.customDepthMaterial;if(U!==void 0)E=U;else if(E=z.isPointLight===!0?l:o,n.localClippingEnabled&&R.clipShadows===!0&&Array.isArray(R.clippingPlanes)&&R.clippingPlanes.length!==0||R.displacementMap&&R.displacementScale!==0||R.alphaMap&&R.alphaTest>0||R.map&&R.alphaTest>0||R.alphaToCoverage===!0){const P=E.uuid,F=R.uuid;let j=u[P];j===void 0&&(j={},u[P]=j);let Z=j[F];Z===void 0&&(Z=E.clone(),j[F]=Z,R.addEventListener("dispose",C)),E=Z}if(E.visible=R.visible,E.wireframe=R.wireframe,x===Br?E.side=R.shadowSide!==null?R.shadowSide:R.side:E.side=R.shadowSide!==null?R.shadowSide:f[R.side],E.alphaMap=R.alphaMap,E.alphaTest=R.alphaToCoverage===!0?.5:R.alphaTest,E.map=R.map,E.clipShadows=R.clipShadows,E.clippingPlanes=R.clippingPlanes,E.clipIntersection=R.clipIntersection,E.displacementMap=R.displacementMap,E.displacementScale=R.displacementScale,E.displacementBias=R.displacementBias,E.wireframeLinewidth=R.wireframeLinewidth,E.linewidth=R.linewidth,z.isPointLight===!0&&E.isMeshDistanceMaterial===!0){const P=n.properties.get(E);P.light=z}return E}function b(D,R,z,x,E){if(D.visible===!1)return;if(D.layers.test(R.layers)&&(D.isMesh||D.isLine||D.isPoints)&&(D.castShadow||D.receiveShadow&&E===Br)&&(!D.frustumCulled||i.intersectsObject(D))){D.modelViewMatrix.multiplyMatrices(z.matrixWorldInverse,D.matrixWorld);const F=e.update(D),j=D.material;if(Array.isArray(j)){const Z=F.groups;for(let X=0,V=Z.length;X<V;X++){const Q=Z[X],se=j[Q.materialIndex];if(se&&se.visible){const re=w(D,se,x,E);D.onBeforeShadow(n,D,R,z,F,re,Q),n.renderBufferDirect(z,null,F,re,D,Q),D.onAfterShadow(n,D,R,z,F,re,Q)}}}else if(j.visible){const Z=w(D,j,x,E);D.onBeforeShadow(n,D,R,z,F,Z,null),n.renderBufferDirect(z,null,F,Z,D,null),D.onAfterShadow(n,D,R,z,F,Z,null)}}const P=D.children;for(let F=0,j=P.length;F<j;F++)b(P[F],R,z,x,E)}function C(D){D.target.removeEventListener("dispose",C);for(const z in u){const x=u[z],E=D.target.uuid;E in x&&(x[E].dispose(),delete x[E])}}}const DS={[zo]:Vo,[Ho]:Wo,[Go]:Xo,[xr]:ko,[Vo]:zo,[Wo]:Ho,[Xo]:Go,[ko]:xr};function LS(n,e){function t(){let N=!1;const Ce=new _t;let _e=null;const De=new _t(0,0,0,0);return{setMask:function(pe){_e!==pe&&!N&&(n.colorMask(pe,pe,pe,pe),_e=pe)},setLocked:function(pe){N=pe},setClear:function(pe,ce,Me,ke,ut){ut===!0&&(pe*=ke,ce*=ke,Me*=ke),Ce.set(pe,ce,Me,ke),De.equals(Ce)===!1&&(n.clearColor(pe,ce,Me,ke),De.copy(Ce))},reset:function(){N=!1,_e=null,De.set(-1,0,0,0)}}}function i(){let N=!1,Ce=!1,_e=null,De=null,pe=null;return{setReversed:function(ce){if(Ce!==ce){const Me=e.get("EXT_clip_control");ce?Me.clipControlEXT(Me.LOWER_LEFT_EXT,Me.ZERO_TO_ONE_EXT):Me.clipControlEXT(Me.LOWER_LEFT_EXT,Me.NEGATIVE_ONE_TO_ONE_EXT),Ce=ce;const ke=pe;pe=null,this.setClear(ke)}},getReversed:function(){return Ce},setTest:function(ce){ce?te(n.DEPTH_TEST):me(n.DEPTH_TEST)},setMask:function(ce){_e!==ce&&!N&&(n.depthMask(ce),_e=ce)},setFunc:function(ce){if(Ce&&(ce=DS[ce]),De!==ce){switch(ce){case zo:n.depthFunc(n.NEVER);break;case Vo:n.depthFunc(n.ALWAYS);break;case Ho:n.depthFunc(n.LESS);break;case xr:n.depthFunc(n.LEQUAL);break;case Go:n.depthFunc(n.EQUAL);break;case ko:n.depthFunc(n.GEQUAL);break;case Wo:n.depthFunc(n.GREATER);break;case Xo:n.depthFunc(n.NOTEQUAL);break;default:n.depthFunc(n.LEQUAL)}De=ce}},setLocked:function(ce){N=ce},setClear:function(ce){pe!==ce&&(Ce&&(ce=1-ce),n.clearDepth(ce),pe=ce)},reset:function(){N=!1,_e=null,De=null,pe=null,Ce=!1}}}function r(){let N=!1,Ce=null,_e=null,De=null,pe=null,ce=null,Me=null,ke=null,ut=null;return{setTest:function(it){N||(it?te(n.STENCIL_TEST):me(n.STENCIL_TEST))},setMask:function(it){Ce!==it&&!N&&(n.stencilMask(it),Ce=it)},setFunc:function(it,vn,In){(_e!==it||De!==vn||pe!==In)&&(n.stencilFunc(it,vn,In),_e=it,De=vn,pe=In)},setOp:function(it,vn,In){(ce!==it||Me!==vn||ke!==In)&&(n.stencilOp(it,vn,In),ce=it,Me=vn,ke=In)},setLocked:function(it){N=it},setClear:function(it){ut!==it&&(n.clearStencil(it),ut=it)},reset:function(){N=!1,Ce=null,_e=null,De=null,pe=null,ce=null,Me=null,ke=null,ut=null}}}const s=new t,a=new i,o=new r,l=new WeakMap,u=new WeakMap;let c={},f={},h=new WeakMap,p=[],_=null,v=!1,g=null,d=null,y=null,w=null,b=null,C=null,D=null,R=new nt(0,0,0),z=0,x=!1,E=null,U=null,P=null,F=null,j=null;const Z=n.getParameter(n.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let X=!1,V=0;const Q=n.getParameter(n.VERSION);Q.indexOf("WebGL")!==-1?(V=parseFloat(/^WebGL (\d)/.exec(Q)[1]),X=V>=1):Q.indexOf("OpenGL ES")!==-1&&(V=parseFloat(/^OpenGL ES (\d)/.exec(Q)[1]),X=V>=2);let se=null,re={};const he=n.getParameter(n.SCISSOR_BOX),we=n.getParameter(n.VIEWPORT),le=new _t().fromArray(he),ge=new _t().fromArray(we);function Ne(N,Ce,_e,De){const pe=new Uint8Array(4),ce=n.createTexture();n.bindTexture(N,ce),n.texParameteri(N,n.TEXTURE_MIN_FILTER,n.NEAREST),n.texParameteri(N,n.TEXTURE_MAG_FILTER,n.NEAREST);for(let Me=0;Me<_e;Me++)N===n.TEXTURE_3D||N===n.TEXTURE_2D_ARRAY?n.texImage3D(Ce,0,n.RGBA,1,1,De,0,n.RGBA,n.UNSIGNED_BYTE,pe):n.texImage2D(Ce+Me,0,n.RGBA,1,1,0,n.RGBA,n.UNSIGNED_BYTE,pe);return ce}const H={};H[n.TEXTURE_2D]=Ne(n.TEXTURE_2D,n.TEXTURE_2D,1),H[n.TEXTURE_CUBE_MAP]=Ne(n.TEXTURE_CUBE_MAP,n.TEXTURE_CUBE_MAP_POSITIVE_X,6),H[n.TEXTURE_2D_ARRAY]=Ne(n.TEXTURE_2D_ARRAY,n.TEXTURE_2D_ARRAY,1,1),H[n.TEXTURE_3D]=Ne(n.TEXTURE_3D,n.TEXTURE_3D,1,1),s.setClear(0,0,0,1),a.setClear(1),o.setClear(0),te(n.DEPTH_TEST),a.setFunc(xr),q(!1),ie(Zc),te(n.CULL_FACE),B(Yn);function te(N){c[N]!==!0&&(n.enable(N),c[N]=!0)}function me(N){c[N]!==!1&&(n.disable(N),c[N]=!1)}function Ie(N,Ce){return f[N]!==Ce?(n.bindFramebuffer(N,Ce),f[N]=Ce,N===n.DRAW_FRAMEBUFFER&&(f[n.FRAMEBUFFER]=Ce),N===n.FRAMEBUFFER&&(f[n.DRAW_FRAMEBUFFER]=Ce),!0):!1}function ve(N,Ce){let _e=p,De=!1;if(N){_e=h.get(Ce),_e===void 0&&(_e=[],h.set(Ce,_e));const pe=N.textures;if(_e.length!==pe.length||_e[0]!==n.COLOR_ATTACHMENT0){for(let ce=0,Me=pe.length;ce<Me;ce++)_e[ce]=n.COLOR_ATTACHMENT0+ce;_e.length=pe.length,De=!0}}else _e[0]!==n.BACK&&(_e[0]=n.BACK,De=!0);De&&n.drawBuffers(_e)}function Ve(N){return _!==N?(n.useProgram(N),_=N,!0):!1}const T={[Oi]:n.FUNC_ADD,[Im]:n.FUNC_SUBTRACT,[Um]:n.FUNC_REVERSE_SUBTRACT};T[Nm]=n.MIN,T[Fm]=n.MAX;const I={[Om]:n.ZERO,[Bm]:n.ONE,[zm]:n.SRC_COLOR,[Oo]:n.SRC_ALPHA,[Xm]:n.SRC_ALPHA_SATURATE,[km]:n.DST_COLOR,[Hm]:n.DST_ALPHA,[Vm]:n.ONE_MINUS_SRC_COLOR,[Bo]:n.ONE_MINUS_SRC_ALPHA,[Wm]:n.ONE_MINUS_DST_COLOR,[Gm]:n.ONE_MINUS_DST_ALPHA,[qm]:n.CONSTANT_COLOR,[Ym]:n.ONE_MINUS_CONSTANT_COLOR,[$m]:n.CONSTANT_ALPHA,[Km]:n.ONE_MINUS_CONSTANT_ALPHA};function B(N,Ce,_e,De,pe,ce,Me,ke,ut,it){if(N===Yn){v===!0&&(me(n.BLEND),v=!1);return}if(v===!1&&(te(n.BLEND),v=!0),N!==Lm){if(N!==g||it!==x){if((d!==Oi||b!==Oi)&&(n.blendEquation(n.FUNC_ADD),d=Oi,b=Oi),it)switch(N){case mr:n.blendFuncSeparate(n.ONE,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case Fo:n.blendFunc(n.ONE,n.ONE);break;case Jc:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case Qc:n.blendFuncSeparate(n.DST_COLOR,n.ONE_MINUS_SRC_ALPHA,n.ZERO,n.ONE);break;default:Qe("WebGLState: Invalid blending: ",N);break}else switch(N){case mr:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case Fo:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE,n.ONE,n.ONE);break;case Jc:Qe("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Qc:Qe("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Qe("WebGLState: Invalid blending: ",N);break}y=null,w=null,C=null,D=null,R.set(0,0,0),z=0,g=N,x=it}return}pe=pe||Ce,ce=ce||_e,Me=Me||De,(Ce!==d||pe!==b)&&(n.blendEquationSeparate(T[Ce],T[pe]),d=Ce,b=pe),(_e!==y||De!==w||ce!==C||Me!==D)&&(n.blendFuncSeparate(I[_e],I[De],I[ce],I[Me]),y=_e,w=De,C=ce,D=Me),(ke.equals(R)===!1||ut!==z)&&(n.blendColor(ke.r,ke.g,ke.b,ut),R.copy(ke),z=ut),g=N,x=!1}function ee(N,Ce){N.side===Xn?me(n.CULL_FACE):te(n.CULL_FACE);let _e=N.side===Wt;Ce&&(_e=!_e),q(_e),N.blending===mr&&N.transparent===!1?B(Yn):B(N.blending,N.blendEquation,N.blendSrc,N.blendDst,N.blendEquationAlpha,N.blendSrcAlpha,N.blendDstAlpha,N.blendColor,N.blendAlpha,N.premultipliedAlpha),a.setFunc(N.depthFunc),a.setTest(N.depthTest),a.setMask(N.depthWrite),s.setMask(N.colorWrite);const De=N.stencilWrite;o.setTest(De),De&&(o.setMask(N.stencilWriteMask),o.setFunc(N.stencilFunc,N.stencilRef,N.stencilFuncMask),o.setOp(N.stencilFail,N.stencilZFail,N.stencilZPass)),ue(N.polygonOffset,N.polygonOffsetFactor,N.polygonOffsetUnits),N.alphaToCoverage===!0?te(n.SAMPLE_ALPHA_TO_COVERAGE):me(n.SAMPLE_ALPHA_TO_COVERAGE)}function q(N){E!==N&&(N?n.frontFace(n.CW):n.frontFace(n.CCW),E=N)}function ie(N){N!==Rm?(te(n.CULL_FACE),N!==U&&(N===Zc?n.cullFace(n.BACK):N===Pm?n.cullFace(n.FRONT):n.cullFace(n.FRONT_AND_BACK))):me(n.CULL_FACE),U=N}function A(N){N!==P&&(X&&n.lineWidth(N),P=N)}function ue(N,Ce,_e){N?(te(n.POLYGON_OFFSET_FILL),(F!==Ce||j!==_e)&&(n.polygonOffset(Ce,_e),F=Ce,j=_e)):me(n.POLYGON_OFFSET_FILL)}function ae(N){N?te(n.SCISSOR_TEST):me(n.SCISSOR_TEST)}function ne(N){N===void 0&&(N=n.TEXTURE0+Z-1),se!==N&&(n.activeTexture(N),se=N)}function oe(N,Ce,_e){_e===void 0&&(se===null?_e=n.TEXTURE0+Z-1:_e=se);let De=re[_e];De===void 0&&(De={type:void 0,texture:void 0},re[_e]=De),(De.type!==N||De.texture!==Ce)&&(se!==_e&&(n.activeTexture(_e),se=_e),n.bindTexture(N,Ce||H[N]),De.type=N,De.texture=Ce)}function S(){const N=re[se];N!==void 0&&N.type!==void 0&&(n.bindTexture(N.type,null),N.type=void 0,N.texture=void 0)}function m(){try{n.compressedTexImage2D(...arguments)}catch(N){Qe("WebGLState:",N)}}function L(){try{n.compressedTexImage3D(...arguments)}catch(N){Qe("WebGLState:",N)}}function W(){try{n.texSubImage2D(...arguments)}catch(N){Qe("WebGLState:",N)}}function J(){try{n.texSubImage3D(...arguments)}catch(N){Qe("WebGLState:",N)}}function k(){try{n.compressedTexSubImage2D(...arguments)}catch(N){Qe("WebGLState:",N)}}function Te(){try{n.compressedTexSubImage3D(...arguments)}catch(N){Qe("WebGLState:",N)}}function de(){try{n.texStorage2D(...arguments)}catch(N){Qe("WebGLState:",N)}}function Re(){try{n.texStorage3D(...arguments)}catch(N){Qe("WebGLState:",N)}}function Fe(){try{n.texImage2D(...arguments)}catch(N){Qe("WebGLState:",N)}}function fe(){try{n.texImage3D(...arguments)}catch(N){Qe("WebGLState:",N)}}function Se(N){le.equals(N)===!1&&(n.scissor(N.x,N.y,N.z,N.w),le.copy(N))}function Ee(N){ge.equals(N)===!1&&(n.viewport(N.x,N.y,N.z,N.w),ge.copy(N))}function Pe(N,Ce){let _e=u.get(Ce);_e===void 0&&(_e=new WeakMap,u.set(Ce,_e));let De=_e.get(N);De===void 0&&(De=n.getUniformBlockIndex(Ce,N.name),_e.set(N,De))}function xe(N,Ce){const De=u.get(Ce).get(N);l.get(Ce)!==De&&(n.uniformBlockBinding(Ce,De,N.__bindingPointIndex),l.set(Ce,De))}function Xe(){n.disable(n.BLEND),n.disable(n.CULL_FACE),n.disable(n.DEPTH_TEST),n.disable(n.POLYGON_OFFSET_FILL),n.disable(n.SCISSOR_TEST),n.disable(n.STENCIL_TEST),n.disable(n.SAMPLE_ALPHA_TO_COVERAGE),n.blendEquation(n.FUNC_ADD),n.blendFunc(n.ONE,n.ZERO),n.blendFuncSeparate(n.ONE,n.ZERO,n.ONE,n.ZERO),n.blendColor(0,0,0,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(n.LESS),a.setReversed(!1),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(n.ALWAYS,0,4294967295),n.stencilOp(n.KEEP,n.KEEP,n.KEEP),n.clearStencil(0),n.cullFace(n.BACK),n.frontFace(n.CCW),n.polygonOffset(0,0),n.activeTexture(n.TEXTURE0),n.bindFramebuffer(n.FRAMEBUFFER,null),n.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),n.bindFramebuffer(n.READ_FRAMEBUFFER,null),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),c={},se=null,re={},f={},h=new WeakMap,p=[],_=null,v=!1,g=null,d=null,y=null,w=null,b=null,C=null,D=null,R=new nt(0,0,0),z=0,x=!1,E=null,U=null,P=null,F=null,j=null,le.set(0,0,n.canvas.width,n.canvas.height),ge.set(0,0,n.canvas.width,n.canvas.height),s.reset(),a.reset(),o.reset()}return{buffers:{color:s,depth:a,stencil:o},enable:te,disable:me,bindFramebuffer:Ie,drawBuffers:ve,useProgram:Ve,setBlending:B,setMaterial:ee,setFlipSided:q,setCullFace:ie,setLineWidth:A,setPolygonOffset:ue,setScissorTest:ae,activeTexture:ne,bindTexture:oe,unbindTexture:S,compressedTexImage2D:m,compressedTexImage3D:L,texImage2D:Fe,texImage3D:fe,updateUBOMapping:Pe,uniformBlockBinding:xe,texStorage2D:de,texStorage3D:Re,texSubImage2D:W,texSubImage3D:J,compressedTexSubImage2D:k,compressedTexSubImage3D:Te,scissor:Se,viewport:Ee,reset:Xe}}function IS(n,e,t,i,r,s,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),u=new ot,c=new WeakMap;let f;const h=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function _(S,m){return p?new OffscreenCanvas(S,m):as("canvas")}function v(S,m,L){let W=1;const J=oe(S);if((J.width>L||J.height>L)&&(W=L/Math.max(J.width,J.height)),W<1)if(typeof HTMLImageElement<"u"&&S instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&S instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&S instanceof ImageBitmap||typeof VideoFrame<"u"&&S instanceof VideoFrame){const k=Math.floor(W*J.width),Te=Math.floor(W*J.height);f===void 0&&(f=_(k,Te));const de=m?_(k,Te):f;return de.width=k,de.height=Te,de.getContext("2d").drawImage(S,0,0,k,Te),We("WebGLRenderer: Texture has been resized from ("+J.width+"x"+J.height+") to ("+k+"x"+Te+")."),de}else return"data"in S&&We("WebGLRenderer: Image in DataTexture is too big ("+J.width+"x"+J.height+")."),S;return S}function g(S){return S.generateMipmaps}function d(S){n.generateMipmap(S)}function y(S){return S.isWebGLCubeRenderTarget?n.TEXTURE_CUBE_MAP:S.isWebGL3DRenderTarget?n.TEXTURE_3D:S.isWebGLArrayRenderTarget||S.isCompressedArrayTexture?n.TEXTURE_2D_ARRAY:n.TEXTURE_2D}function w(S,m,L,W,J=!1){if(S!==null){if(n[S]!==void 0)return n[S];We("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+S+"'")}let k=m;if(m===n.RED&&(L===n.FLOAT&&(k=n.R32F),L===n.HALF_FLOAT&&(k=n.R16F),L===n.UNSIGNED_BYTE&&(k=n.R8)),m===n.RED_INTEGER&&(L===n.UNSIGNED_BYTE&&(k=n.R8UI),L===n.UNSIGNED_SHORT&&(k=n.R16UI),L===n.UNSIGNED_INT&&(k=n.R32UI),L===n.BYTE&&(k=n.R8I),L===n.SHORT&&(k=n.R16I),L===n.INT&&(k=n.R32I)),m===n.RG&&(L===n.FLOAT&&(k=n.RG32F),L===n.HALF_FLOAT&&(k=n.RG16F),L===n.UNSIGNED_BYTE&&(k=n.RG8)),m===n.RG_INTEGER&&(L===n.UNSIGNED_BYTE&&(k=n.RG8UI),L===n.UNSIGNED_SHORT&&(k=n.RG16UI),L===n.UNSIGNED_INT&&(k=n.RG32UI),L===n.BYTE&&(k=n.RG8I),L===n.SHORT&&(k=n.RG16I),L===n.INT&&(k=n.RG32I)),m===n.RGB_INTEGER&&(L===n.UNSIGNED_BYTE&&(k=n.RGB8UI),L===n.UNSIGNED_SHORT&&(k=n.RGB16UI),L===n.UNSIGNED_INT&&(k=n.RGB32UI),L===n.BYTE&&(k=n.RGB8I),L===n.SHORT&&(k=n.RGB16I),L===n.INT&&(k=n.RGB32I)),m===n.RGBA_INTEGER&&(L===n.UNSIGNED_BYTE&&(k=n.RGBA8UI),L===n.UNSIGNED_SHORT&&(k=n.RGBA16UI),L===n.UNSIGNED_INT&&(k=n.RGBA32UI),L===n.BYTE&&(k=n.RGBA8I),L===n.SHORT&&(k=n.RGBA16I),L===n.INT&&(k=n.RGBA32I)),m===n.RGB&&(L===n.UNSIGNED_INT_5_9_9_9_REV&&(k=n.RGB9_E5),L===n.UNSIGNED_INT_10F_11F_11F_REV&&(k=n.R11F_G11F_B10F)),m===n.RGBA){const Te=J?ca:Ze.getTransfer(W);L===n.FLOAT&&(k=n.RGBA32F),L===n.HALF_FLOAT&&(k=n.RGBA16F),L===n.UNSIGNED_BYTE&&(k=Te===st?n.SRGB8_ALPHA8:n.RGBA8),L===n.UNSIGNED_SHORT_4_4_4_4&&(k=n.RGBA4),L===n.UNSIGNED_SHORT_5_5_5_1&&(k=n.RGB5_A1)}return(k===n.R16F||k===n.R32F||k===n.RG16F||k===n.RG32F||k===n.RGBA16F||k===n.RGBA32F)&&e.get("EXT_color_buffer_float"),k}function b(S,m){let L;return S?m===null||m===Dn||m===ss?L=n.DEPTH24_STENCIL8:m===Tn?L=n.DEPTH32F_STENCIL8:m===rs&&(L=n.DEPTH24_STENCIL8,We("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):m===null||m===Dn||m===ss?L=n.DEPTH_COMPONENT24:m===Tn?L=n.DEPTH_COMPONENT32F:m===rs&&(L=n.DEPTH_COMPONENT16),L}function C(S,m){return g(S)===!0||S.isFramebufferTexture&&S.minFilter!==Tt&&S.minFilter!==Pt?Math.log2(Math.max(m.width,m.height))+1:S.mipmaps!==void 0&&S.mipmaps.length>0?S.mipmaps.length:S.isCompressedTexture&&Array.isArray(S.image)?m.mipmaps.length:1}function D(S){const m=S.target;m.removeEventListener("dispose",D),z(m),m.isVideoTexture&&c.delete(m)}function R(S){const m=S.target;m.removeEventListener("dispose",R),E(m)}function z(S){const m=i.get(S);if(m.__webglInit===void 0)return;const L=S.source,W=h.get(L);if(W){const J=W[m.__cacheKey];J.usedTimes--,J.usedTimes===0&&x(S),Object.keys(W).length===0&&h.delete(L)}i.remove(S)}function x(S){const m=i.get(S);n.deleteTexture(m.__webglTexture);const L=S.source,W=h.get(L);delete W[m.__cacheKey],a.memory.textures--}function E(S){const m=i.get(S);if(S.depthTexture&&(S.depthTexture.dispose(),i.remove(S.depthTexture)),S.isWebGLCubeRenderTarget)for(let W=0;W<6;W++){if(Array.isArray(m.__webglFramebuffer[W]))for(let J=0;J<m.__webglFramebuffer[W].length;J++)n.deleteFramebuffer(m.__webglFramebuffer[W][J]);else n.deleteFramebuffer(m.__webglFramebuffer[W]);m.__webglDepthbuffer&&n.deleteRenderbuffer(m.__webglDepthbuffer[W])}else{if(Array.isArray(m.__webglFramebuffer))for(let W=0;W<m.__webglFramebuffer.length;W++)n.deleteFramebuffer(m.__webglFramebuffer[W]);else n.deleteFramebuffer(m.__webglFramebuffer);if(m.__webglDepthbuffer&&n.deleteRenderbuffer(m.__webglDepthbuffer),m.__webglMultisampledFramebuffer&&n.deleteFramebuffer(m.__webglMultisampledFramebuffer),m.__webglColorRenderbuffer)for(let W=0;W<m.__webglColorRenderbuffer.length;W++)m.__webglColorRenderbuffer[W]&&n.deleteRenderbuffer(m.__webglColorRenderbuffer[W]);m.__webglDepthRenderbuffer&&n.deleteRenderbuffer(m.__webglDepthRenderbuffer)}const L=S.textures;for(let W=0,J=L.length;W<J;W++){const k=i.get(L[W]);k.__webglTexture&&(n.deleteTexture(k.__webglTexture),a.memory.textures--),i.remove(L[W])}i.remove(S)}let U=0;function P(){U=0}function F(){const S=U;return S>=r.maxTextures&&We("WebGLTextures: Trying to use "+S+" texture units while this GPU supports only "+r.maxTextures),U+=1,S}function j(S){const m=[];return m.push(S.wrapS),m.push(S.wrapT),m.push(S.wrapR||0),m.push(S.magFilter),m.push(S.minFilter),m.push(S.anisotropy),m.push(S.internalFormat),m.push(S.format),m.push(S.type),m.push(S.generateMipmaps),m.push(S.premultiplyAlpha),m.push(S.flipY),m.push(S.unpackAlignment),m.push(S.colorSpace),m.join()}function Z(S,m){const L=i.get(S);if(S.isVideoTexture&&ae(S),S.isRenderTargetTexture===!1&&S.isExternalTexture!==!0&&S.version>0&&L.__version!==S.version){const W=S.image;if(W===null)We("WebGLRenderer: Texture marked for update but no image data found.");else if(W.complete===!1)We("WebGLRenderer: Texture marked for update but image is incomplete");else{H(L,S,m);return}}else S.isExternalTexture&&(L.__webglTexture=S.sourceTexture?S.sourceTexture:null);t.bindTexture(n.TEXTURE_2D,L.__webglTexture,n.TEXTURE0+m)}function X(S,m){const L=i.get(S);if(S.isRenderTargetTexture===!1&&S.version>0&&L.__version!==S.version){H(L,S,m);return}else S.isExternalTexture&&(L.__webglTexture=S.sourceTexture?S.sourceTexture:null);t.bindTexture(n.TEXTURE_2D_ARRAY,L.__webglTexture,n.TEXTURE0+m)}function V(S,m){const L=i.get(S);if(S.isRenderTargetTexture===!1&&S.version>0&&L.__version!==S.version){H(L,S,m);return}t.bindTexture(n.TEXTURE_3D,L.__webglTexture,n.TEXTURE0+m)}function Q(S,m){const L=i.get(S);if(S.isCubeDepthTexture!==!0&&S.version>0&&L.__version!==S.version){te(L,S,m);return}t.bindTexture(n.TEXTURE_CUBE_MAP,L.__webglTexture,n.TEXTURE0+m)}const se={[$o]:n.REPEAT,[qn]:n.CLAMP_TO_EDGE,[Ko]:n.MIRRORED_REPEAT},re={[Tt]:n.NEAREST,[Jm]:n.NEAREST_MIPMAP_NEAREST,[Es]:n.NEAREST_MIPMAP_LINEAR,[Pt]:n.LINEAR,[Wa]:n.LINEAR_MIPMAP_NEAREST,[zi]:n.LINEAR_MIPMAP_LINEAR},he={[ng]:n.NEVER,[og]:n.ALWAYS,[ig]:n.LESS,[sc]:n.LEQUAL,[rg]:n.EQUAL,[ac]:n.GEQUAL,[sg]:n.GREATER,[ag]:n.NOTEQUAL};function we(S,m){if(m.type===Tn&&e.has("OES_texture_float_linear")===!1&&(m.magFilter===Pt||m.magFilter===Wa||m.magFilter===Es||m.magFilter===zi||m.minFilter===Pt||m.minFilter===Wa||m.minFilter===Es||m.minFilter===zi)&&We("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),n.texParameteri(S,n.TEXTURE_WRAP_S,se[m.wrapS]),n.texParameteri(S,n.TEXTURE_WRAP_T,se[m.wrapT]),(S===n.TEXTURE_3D||S===n.TEXTURE_2D_ARRAY)&&n.texParameteri(S,n.TEXTURE_WRAP_R,se[m.wrapR]),n.texParameteri(S,n.TEXTURE_MAG_FILTER,re[m.magFilter]),n.texParameteri(S,n.TEXTURE_MIN_FILTER,re[m.minFilter]),m.compareFunction&&(n.texParameteri(S,n.TEXTURE_COMPARE_MODE,n.COMPARE_REF_TO_TEXTURE),n.texParameteri(S,n.TEXTURE_COMPARE_FUNC,he[m.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(m.magFilter===Tt||m.minFilter!==Es&&m.minFilter!==zi||m.type===Tn&&e.has("OES_texture_float_linear")===!1)return;if(m.anisotropy>1||i.get(m).__currentAnisotropy){const L=e.get("EXT_texture_filter_anisotropic");n.texParameterf(S,L.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(m.anisotropy,r.getMaxAnisotropy())),i.get(m).__currentAnisotropy=m.anisotropy}}}function le(S,m){let L=!1;S.__webglInit===void 0&&(S.__webglInit=!0,m.addEventListener("dispose",D));const W=m.source;let J=h.get(W);J===void 0&&(J={},h.set(W,J));const k=j(m);if(k!==S.__cacheKey){J[k]===void 0&&(J[k]={texture:n.createTexture(),usedTimes:0},a.memory.textures++,L=!0),J[k].usedTimes++;const Te=J[S.__cacheKey];Te!==void 0&&(J[S.__cacheKey].usedTimes--,Te.usedTimes===0&&x(m)),S.__cacheKey=k,S.__webglTexture=J[k].texture}return L}function ge(S,m,L){return Math.floor(Math.floor(S/L)/m)}function Ne(S,m,L,W){const k=S.updateRanges;if(k.length===0)t.texSubImage2D(n.TEXTURE_2D,0,0,0,m.width,m.height,L,W,m.data);else{k.sort((fe,Se)=>fe.start-Se.start);let Te=0;for(let fe=1;fe<k.length;fe++){const Se=k[Te],Ee=k[fe],Pe=Se.start+Se.count,xe=ge(Ee.start,m.width,4),Xe=ge(Se.start,m.width,4);Ee.start<=Pe+1&&xe===Xe&&ge(Ee.start+Ee.count-1,m.width,4)===xe?Se.count=Math.max(Se.count,Ee.start+Ee.count-Se.start):(++Te,k[Te]=Ee)}k.length=Te+1;const de=n.getParameter(n.UNPACK_ROW_LENGTH),Re=n.getParameter(n.UNPACK_SKIP_PIXELS),Fe=n.getParameter(n.UNPACK_SKIP_ROWS);n.pixelStorei(n.UNPACK_ROW_LENGTH,m.width);for(let fe=0,Se=k.length;fe<Se;fe++){const Ee=k[fe],Pe=Math.floor(Ee.start/4),xe=Math.ceil(Ee.count/4),Xe=Pe%m.width,N=Math.floor(Pe/m.width),Ce=xe,_e=1;n.pixelStorei(n.UNPACK_SKIP_PIXELS,Xe),n.pixelStorei(n.UNPACK_SKIP_ROWS,N),t.texSubImage2D(n.TEXTURE_2D,0,Xe,N,Ce,_e,L,W,m.data)}S.clearUpdateRanges(),n.pixelStorei(n.UNPACK_ROW_LENGTH,de),n.pixelStorei(n.UNPACK_SKIP_PIXELS,Re),n.pixelStorei(n.UNPACK_SKIP_ROWS,Fe)}}function H(S,m,L){let W=n.TEXTURE_2D;(m.isDataArrayTexture||m.isCompressedArrayTexture)&&(W=n.TEXTURE_2D_ARRAY),m.isData3DTexture&&(W=n.TEXTURE_3D);const J=le(S,m),k=m.source;t.bindTexture(W,S.__webglTexture,n.TEXTURE0+L);const Te=i.get(k);if(k.version!==Te.__version||J===!0){t.activeTexture(n.TEXTURE0+L);const de=Ze.getPrimaries(Ze.workingColorSpace),Re=m.colorSpace===pi?null:Ze.getPrimaries(m.colorSpace),Fe=m.colorSpace===pi||de===Re?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,m.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,m.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,m.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,Fe);let fe=v(m.image,!1,r.maxTextureSize);fe=ne(m,fe);const Se=s.convert(m.format,m.colorSpace),Ee=s.convert(m.type);let Pe=w(m.internalFormat,Se,Ee,m.colorSpace,m.isVideoTexture);we(W,m);let xe;const Xe=m.mipmaps,N=m.isVideoTexture!==!0,Ce=Te.__version===void 0||J===!0,_e=k.dataReady,De=C(m,fe);if(m.isDepthTexture)Pe=b(m.format===Vi,m.type),Ce&&(N?t.texStorage2D(n.TEXTURE_2D,1,Pe,fe.width,fe.height):t.texImage2D(n.TEXTURE_2D,0,Pe,fe.width,fe.height,0,Se,Ee,null));else if(m.isDataTexture)if(Xe.length>0){N&&Ce&&t.texStorage2D(n.TEXTURE_2D,De,Pe,Xe[0].width,Xe[0].height);for(let pe=0,ce=Xe.length;pe<ce;pe++)xe=Xe[pe],N?_e&&t.texSubImage2D(n.TEXTURE_2D,pe,0,0,xe.width,xe.height,Se,Ee,xe.data):t.texImage2D(n.TEXTURE_2D,pe,Pe,xe.width,xe.height,0,Se,Ee,xe.data);m.generateMipmaps=!1}else N?(Ce&&t.texStorage2D(n.TEXTURE_2D,De,Pe,fe.width,fe.height),_e&&Ne(m,fe,Se,Ee)):t.texImage2D(n.TEXTURE_2D,0,Pe,fe.width,fe.height,0,Se,Ee,fe.data);else if(m.isCompressedTexture)if(m.isCompressedArrayTexture){N&&Ce&&t.texStorage3D(n.TEXTURE_2D_ARRAY,De,Pe,Xe[0].width,Xe[0].height,fe.depth);for(let pe=0,ce=Xe.length;pe<ce;pe++)if(xe=Xe[pe],m.format!==dn)if(Se!==null)if(N){if(_e)if(m.layerUpdates.size>0){const Me=yu(xe.width,xe.height,m.format,m.type);for(const ke of m.layerUpdates){const ut=xe.data.subarray(ke*Me/xe.data.BYTES_PER_ELEMENT,(ke+1)*Me/xe.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,pe,0,0,ke,xe.width,xe.height,1,Se,ut)}m.clearLayerUpdates()}else t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,pe,0,0,0,xe.width,xe.height,fe.depth,Se,xe.data)}else t.compressedTexImage3D(n.TEXTURE_2D_ARRAY,pe,Pe,xe.width,xe.height,fe.depth,0,xe.data,0,0);else We("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else N?_e&&t.texSubImage3D(n.TEXTURE_2D_ARRAY,pe,0,0,0,xe.width,xe.height,fe.depth,Se,Ee,xe.data):t.texImage3D(n.TEXTURE_2D_ARRAY,pe,Pe,xe.width,xe.height,fe.depth,0,Se,Ee,xe.data)}else{N&&Ce&&t.texStorage2D(n.TEXTURE_2D,De,Pe,Xe[0].width,Xe[0].height);for(let pe=0,ce=Xe.length;pe<ce;pe++)xe=Xe[pe],m.format!==dn?Se!==null?N?_e&&t.compressedTexSubImage2D(n.TEXTURE_2D,pe,0,0,xe.width,xe.height,Se,xe.data):t.compressedTexImage2D(n.TEXTURE_2D,pe,Pe,xe.width,xe.height,0,xe.data):We("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):N?_e&&t.texSubImage2D(n.TEXTURE_2D,pe,0,0,xe.width,xe.height,Se,Ee,xe.data):t.texImage2D(n.TEXTURE_2D,pe,Pe,xe.width,xe.height,0,Se,Ee,xe.data)}else if(m.isDataArrayTexture)if(N){if(Ce&&t.texStorage3D(n.TEXTURE_2D_ARRAY,De,Pe,fe.width,fe.height,fe.depth),_e)if(m.layerUpdates.size>0){const pe=yu(fe.width,fe.height,m.format,m.type);for(const ce of m.layerUpdates){const Me=fe.data.subarray(ce*pe/fe.data.BYTES_PER_ELEMENT,(ce+1)*pe/fe.data.BYTES_PER_ELEMENT);t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,ce,fe.width,fe.height,1,Se,Ee,Me)}m.clearLayerUpdates()}else t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,0,fe.width,fe.height,fe.depth,Se,Ee,fe.data)}else t.texImage3D(n.TEXTURE_2D_ARRAY,0,Pe,fe.width,fe.height,fe.depth,0,Se,Ee,fe.data);else if(m.isData3DTexture)N?(Ce&&t.texStorage3D(n.TEXTURE_3D,De,Pe,fe.width,fe.height,fe.depth),_e&&t.texSubImage3D(n.TEXTURE_3D,0,0,0,0,fe.width,fe.height,fe.depth,Se,Ee,fe.data)):t.texImage3D(n.TEXTURE_3D,0,Pe,fe.width,fe.height,fe.depth,0,Se,Ee,fe.data);else if(m.isFramebufferTexture){if(Ce)if(N)t.texStorage2D(n.TEXTURE_2D,De,Pe,fe.width,fe.height);else{let pe=fe.width,ce=fe.height;for(let Me=0;Me<De;Me++)t.texImage2D(n.TEXTURE_2D,Me,Pe,pe,ce,0,Se,Ee,null),pe>>=1,ce>>=1}}else if(Xe.length>0){if(N&&Ce){const pe=oe(Xe[0]);t.texStorage2D(n.TEXTURE_2D,De,Pe,pe.width,pe.height)}for(let pe=0,ce=Xe.length;pe<ce;pe++)xe=Xe[pe],N?_e&&t.texSubImage2D(n.TEXTURE_2D,pe,0,0,Se,Ee,xe):t.texImage2D(n.TEXTURE_2D,pe,Pe,Se,Ee,xe);m.generateMipmaps=!1}else if(N){if(Ce){const pe=oe(fe);t.texStorage2D(n.TEXTURE_2D,De,Pe,pe.width,pe.height)}_e&&t.texSubImage2D(n.TEXTURE_2D,0,0,0,Se,Ee,fe)}else t.texImage2D(n.TEXTURE_2D,0,Pe,Se,Ee,fe);g(m)&&d(W),Te.__version=k.version,m.onUpdate&&m.onUpdate(m)}S.__version=m.version}function te(S,m,L){if(m.image.length!==6)return;const W=le(S,m),J=m.source;t.bindTexture(n.TEXTURE_CUBE_MAP,S.__webglTexture,n.TEXTURE0+L);const k=i.get(J);if(J.version!==k.__version||W===!0){t.activeTexture(n.TEXTURE0+L);const Te=Ze.getPrimaries(Ze.workingColorSpace),de=m.colorSpace===pi?null:Ze.getPrimaries(m.colorSpace),Re=m.colorSpace===pi||Te===de?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,m.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,m.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,m.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,Re);const Fe=m.isCompressedTexture||m.image[0].isCompressedTexture,fe=m.image[0]&&m.image[0].isDataTexture,Se=[];for(let ce=0;ce<6;ce++)!Fe&&!fe?Se[ce]=v(m.image[ce],!0,r.maxCubemapSize):Se[ce]=fe?m.image[ce].image:m.image[ce],Se[ce]=ne(m,Se[ce]);const Ee=Se[0],Pe=s.convert(m.format,m.colorSpace),xe=s.convert(m.type),Xe=w(m.internalFormat,Pe,xe,m.colorSpace),N=m.isVideoTexture!==!0,Ce=k.__version===void 0||W===!0,_e=J.dataReady;let De=C(m,Ee);we(n.TEXTURE_CUBE_MAP,m);let pe;if(Fe){N&&Ce&&t.texStorage2D(n.TEXTURE_CUBE_MAP,De,Xe,Ee.width,Ee.height);for(let ce=0;ce<6;ce++){pe=Se[ce].mipmaps;for(let Me=0;Me<pe.length;Me++){const ke=pe[Me];m.format!==dn?Pe!==null?N?_e&&t.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ce,Me,0,0,ke.width,ke.height,Pe,ke.data):t.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ce,Me,Xe,ke.width,ke.height,0,ke.data):We("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):N?_e&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ce,Me,0,0,ke.width,ke.height,Pe,xe,ke.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ce,Me,Xe,ke.width,ke.height,0,Pe,xe,ke.data)}}}else{if(pe=m.mipmaps,N&&Ce){pe.length>0&&De++;const ce=oe(Se[0]);t.texStorage2D(n.TEXTURE_CUBE_MAP,De,Xe,ce.width,ce.height)}for(let ce=0;ce<6;ce++)if(fe){N?_e&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ce,0,0,0,Se[ce].width,Se[ce].height,Pe,xe,Se[ce].data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ce,0,Xe,Se[ce].width,Se[ce].height,0,Pe,xe,Se[ce].data);for(let Me=0;Me<pe.length;Me++){const ut=pe[Me].image[ce].image;N?_e&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ce,Me+1,0,0,ut.width,ut.height,Pe,xe,ut.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ce,Me+1,Xe,ut.width,ut.height,0,Pe,xe,ut.data)}}else{N?_e&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ce,0,0,0,Pe,xe,Se[ce]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ce,0,Xe,Pe,xe,Se[ce]);for(let Me=0;Me<pe.length;Me++){const ke=pe[Me];N?_e&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ce,Me+1,0,0,Pe,xe,ke.image[ce]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ce,Me+1,Xe,Pe,xe,ke.image[ce])}}}g(m)&&d(n.TEXTURE_CUBE_MAP),k.__version=J.version,m.onUpdate&&m.onUpdate(m)}S.__version=m.version}function me(S,m,L,W,J,k){const Te=s.convert(L.format,L.colorSpace),de=s.convert(L.type),Re=w(L.internalFormat,Te,de,L.colorSpace),Fe=i.get(m),fe=i.get(L);if(fe.__renderTarget=m,!Fe.__hasExternalTextures){const Se=Math.max(1,m.width>>k),Ee=Math.max(1,m.height>>k);J===n.TEXTURE_3D||J===n.TEXTURE_2D_ARRAY?t.texImage3D(J,k,Re,Se,Ee,m.depth,0,Te,de,null):t.texImage2D(J,k,Re,Se,Ee,0,Te,de,null)}t.bindFramebuffer(n.FRAMEBUFFER,S),ue(m)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,W,J,fe.__webglTexture,0,A(m)):(J===n.TEXTURE_2D||J>=n.TEXTURE_CUBE_MAP_POSITIVE_X&&J<=n.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&n.framebufferTexture2D(n.FRAMEBUFFER,W,J,fe.__webglTexture,k),t.bindFramebuffer(n.FRAMEBUFFER,null)}function Ie(S,m,L){if(n.bindRenderbuffer(n.RENDERBUFFER,S),m.depthBuffer){const W=m.depthTexture,J=W&&W.isDepthTexture?W.type:null,k=b(m.stencilBuffer,J),Te=m.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;ue(m)?o.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,A(m),k,m.width,m.height):L?n.renderbufferStorageMultisample(n.RENDERBUFFER,A(m),k,m.width,m.height):n.renderbufferStorage(n.RENDERBUFFER,k,m.width,m.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,Te,n.RENDERBUFFER,S)}else{const W=m.textures;for(let J=0;J<W.length;J++){const k=W[J],Te=s.convert(k.format,k.colorSpace),de=s.convert(k.type),Re=w(k.internalFormat,Te,de,k.colorSpace);ue(m)?o.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,A(m),Re,m.width,m.height):L?n.renderbufferStorageMultisample(n.RENDERBUFFER,A(m),Re,m.width,m.height):n.renderbufferStorage(n.RENDERBUFFER,Re,m.width,m.height)}}n.bindRenderbuffer(n.RENDERBUFFER,null)}function ve(S,m,L){const W=m.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(n.FRAMEBUFFER,S),!(m.depthTexture&&m.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const J=i.get(m.depthTexture);if(J.__renderTarget=m,(!J.__webglTexture||m.depthTexture.image.width!==m.width||m.depthTexture.image.height!==m.height)&&(m.depthTexture.image.width=m.width,m.depthTexture.image.height=m.height,m.depthTexture.needsUpdate=!0),W){if(J.__webglInit===void 0&&(J.__webglInit=!0,m.depthTexture.addEventListener("dispose",D)),J.__webglTexture===void 0){J.__webglTexture=n.createTexture(),t.bindTexture(n.TEXTURE_CUBE_MAP,J.__webglTexture),we(n.TEXTURE_CUBE_MAP,m.depthTexture);const Fe=s.convert(m.depthTexture.format),fe=s.convert(m.depthTexture.type);let Se;m.depthTexture.format===ei?Se=n.DEPTH_COMPONENT24:m.depthTexture.format===Vi&&(Se=n.DEPTH24_STENCIL8);for(let Ee=0;Ee<6;Ee++)n.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+Ee,0,Se,m.width,m.height,0,Fe,fe,null)}}else Z(m.depthTexture,0);const k=J.__webglTexture,Te=A(m),de=W?n.TEXTURE_CUBE_MAP_POSITIVE_X+L:n.TEXTURE_2D,Re=m.depthTexture.format===Vi?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;if(m.depthTexture.format===ei)ue(m)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,Re,de,k,0,Te):n.framebufferTexture2D(n.FRAMEBUFFER,Re,de,k,0);else if(m.depthTexture.format===Vi)ue(m)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,Re,de,k,0,Te):n.framebufferTexture2D(n.FRAMEBUFFER,Re,de,k,0);else throw new Error("Unknown depthTexture format")}function Ve(S){const m=i.get(S),L=S.isWebGLCubeRenderTarget===!0;if(m.__boundDepthTexture!==S.depthTexture){const W=S.depthTexture;if(m.__depthDisposeCallback&&m.__depthDisposeCallback(),W){const J=()=>{delete m.__boundDepthTexture,delete m.__depthDisposeCallback,W.removeEventListener("dispose",J)};W.addEventListener("dispose",J),m.__depthDisposeCallback=J}m.__boundDepthTexture=W}if(S.depthTexture&&!m.__autoAllocateDepthBuffer)if(L)for(let W=0;W<6;W++)ve(m.__webglFramebuffer[W],S,W);else{const W=S.texture.mipmaps;W&&W.length>0?ve(m.__webglFramebuffer[0],S,0):ve(m.__webglFramebuffer,S,0)}else if(L){m.__webglDepthbuffer=[];for(let W=0;W<6;W++)if(t.bindFramebuffer(n.FRAMEBUFFER,m.__webglFramebuffer[W]),m.__webglDepthbuffer[W]===void 0)m.__webglDepthbuffer[W]=n.createRenderbuffer(),Ie(m.__webglDepthbuffer[W],S,!1);else{const J=S.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,k=m.__webglDepthbuffer[W];n.bindRenderbuffer(n.RENDERBUFFER,k),n.framebufferRenderbuffer(n.FRAMEBUFFER,J,n.RENDERBUFFER,k)}}else{const W=S.texture.mipmaps;if(W&&W.length>0?t.bindFramebuffer(n.FRAMEBUFFER,m.__webglFramebuffer[0]):t.bindFramebuffer(n.FRAMEBUFFER,m.__webglFramebuffer),m.__webglDepthbuffer===void 0)m.__webglDepthbuffer=n.createRenderbuffer(),Ie(m.__webglDepthbuffer,S,!1);else{const J=S.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,k=m.__webglDepthbuffer;n.bindRenderbuffer(n.RENDERBUFFER,k),n.framebufferRenderbuffer(n.FRAMEBUFFER,J,n.RENDERBUFFER,k)}}t.bindFramebuffer(n.FRAMEBUFFER,null)}function T(S,m,L){const W=i.get(S);m!==void 0&&me(W.__webglFramebuffer,S,S.texture,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,0),L!==void 0&&Ve(S)}function I(S){const m=S.texture,L=i.get(S),W=i.get(m);S.addEventListener("dispose",R);const J=S.textures,k=S.isWebGLCubeRenderTarget===!0,Te=J.length>1;if(Te||(W.__webglTexture===void 0&&(W.__webglTexture=n.createTexture()),W.__version=m.version,a.memory.textures++),k){L.__webglFramebuffer=[];for(let de=0;de<6;de++)if(m.mipmaps&&m.mipmaps.length>0){L.__webglFramebuffer[de]=[];for(let Re=0;Re<m.mipmaps.length;Re++)L.__webglFramebuffer[de][Re]=n.createFramebuffer()}else L.__webglFramebuffer[de]=n.createFramebuffer()}else{if(m.mipmaps&&m.mipmaps.length>0){L.__webglFramebuffer=[];for(let de=0;de<m.mipmaps.length;de++)L.__webglFramebuffer[de]=n.createFramebuffer()}else L.__webglFramebuffer=n.createFramebuffer();if(Te)for(let de=0,Re=J.length;de<Re;de++){const Fe=i.get(J[de]);Fe.__webglTexture===void 0&&(Fe.__webglTexture=n.createTexture(),a.memory.textures++)}if(S.samples>0&&ue(S)===!1){L.__webglMultisampledFramebuffer=n.createFramebuffer(),L.__webglColorRenderbuffer=[],t.bindFramebuffer(n.FRAMEBUFFER,L.__webglMultisampledFramebuffer);for(let de=0;de<J.length;de++){const Re=J[de];L.__webglColorRenderbuffer[de]=n.createRenderbuffer(),n.bindRenderbuffer(n.RENDERBUFFER,L.__webglColorRenderbuffer[de]);const Fe=s.convert(Re.format,Re.colorSpace),fe=s.convert(Re.type),Se=w(Re.internalFormat,Fe,fe,Re.colorSpace,S.isXRRenderTarget===!0),Ee=A(S);n.renderbufferStorageMultisample(n.RENDERBUFFER,Ee,Se,S.width,S.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+de,n.RENDERBUFFER,L.__webglColorRenderbuffer[de])}n.bindRenderbuffer(n.RENDERBUFFER,null),S.depthBuffer&&(L.__webglDepthRenderbuffer=n.createRenderbuffer(),Ie(L.__webglDepthRenderbuffer,S,!0)),t.bindFramebuffer(n.FRAMEBUFFER,null)}}if(k){t.bindTexture(n.TEXTURE_CUBE_MAP,W.__webglTexture),we(n.TEXTURE_CUBE_MAP,m);for(let de=0;de<6;de++)if(m.mipmaps&&m.mipmaps.length>0)for(let Re=0;Re<m.mipmaps.length;Re++)me(L.__webglFramebuffer[de][Re],S,m,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+de,Re);else me(L.__webglFramebuffer[de],S,m,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+de,0);g(m)&&d(n.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(Te){for(let de=0,Re=J.length;de<Re;de++){const Fe=J[de],fe=i.get(Fe);let Se=n.TEXTURE_2D;(S.isWebGL3DRenderTarget||S.isWebGLArrayRenderTarget)&&(Se=S.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(Se,fe.__webglTexture),we(Se,Fe),me(L.__webglFramebuffer,S,Fe,n.COLOR_ATTACHMENT0+de,Se,0),g(Fe)&&d(Se)}t.unbindTexture()}else{let de=n.TEXTURE_2D;if((S.isWebGL3DRenderTarget||S.isWebGLArrayRenderTarget)&&(de=S.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(de,W.__webglTexture),we(de,m),m.mipmaps&&m.mipmaps.length>0)for(let Re=0;Re<m.mipmaps.length;Re++)me(L.__webglFramebuffer[Re],S,m,n.COLOR_ATTACHMENT0,de,Re);else me(L.__webglFramebuffer,S,m,n.COLOR_ATTACHMENT0,de,0);g(m)&&d(de),t.unbindTexture()}S.depthBuffer&&Ve(S)}function B(S){const m=S.textures;for(let L=0,W=m.length;L<W;L++){const J=m[L];if(g(J)){const k=y(S),Te=i.get(J).__webglTexture;t.bindTexture(k,Te),d(k),t.unbindTexture()}}}const ee=[],q=[];function ie(S){if(S.samples>0){if(ue(S)===!1){const m=S.textures,L=S.width,W=S.height;let J=n.COLOR_BUFFER_BIT;const k=S.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,Te=i.get(S),de=m.length>1;if(de)for(let Fe=0;Fe<m.length;Fe++)t.bindFramebuffer(n.FRAMEBUFFER,Te.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+Fe,n.RENDERBUFFER,null),t.bindFramebuffer(n.FRAMEBUFFER,Te.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+Fe,n.TEXTURE_2D,null,0);t.bindFramebuffer(n.READ_FRAMEBUFFER,Te.__webglMultisampledFramebuffer);const Re=S.texture.mipmaps;Re&&Re.length>0?t.bindFramebuffer(n.DRAW_FRAMEBUFFER,Te.__webglFramebuffer[0]):t.bindFramebuffer(n.DRAW_FRAMEBUFFER,Te.__webglFramebuffer);for(let Fe=0;Fe<m.length;Fe++){if(S.resolveDepthBuffer&&(S.depthBuffer&&(J|=n.DEPTH_BUFFER_BIT),S.stencilBuffer&&S.resolveStencilBuffer&&(J|=n.STENCIL_BUFFER_BIT)),de){n.framebufferRenderbuffer(n.READ_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.RENDERBUFFER,Te.__webglColorRenderbuffer[Fe]);const fe=i.get(m[Fe]).__webglTexture;n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,fe,0)}n.blitFramebuffer(0,0,L,W,0,0,L,W,J,n.NEAREST),l===!0&&(ee.length=0,q.length=0,ee.push(n.COLOR_ATTACHMENT0+Fe),S.depthBuffer&&S.resolveDepthBuffer===!1&&(ee.push(k),q.push(k),n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,q)),n.invalidateFramebuffer(n.READ_FRAMEBUFFER,ee))}if(t.bindFramebuffer(n.READ_FRAMEBUFFER,null),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),de)for(let Fe=0;Fe<m.length;Fe++){t.bindFramebuffer(n.FRAMEBUFFER,Te.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+Fe,n.RENDERBUFFER,Te.__webglColorRenderbuffer[Fe]);const fe=i.get(m[Fe]).__webglTexture;t.bindFramebuffer(n.FRAMEBUFFER,Te.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+Fe,n.TEXTURE_2D,fe,0)}t.bindFramebuffer(n.DRAW_FRAMEBUFFER,Te.__webglMultisampledFramebuffer)}else if(S.depthBuffer&&S.resolveDepthBuffer===!1&&l){const m=S.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,[m])}}}function A(S){return Math.min(r.maxSamples,S.samples)}function ue(S){const m=i.get(S);return S.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&m.__useRenderToTexture!==!1}function ae(S){const m=a.render.frame;c.get(S)!==m&&(c.set(S,m),S.update())}function ne(S,m){const L=S.colorSpace,W=S.format,J=S.type;return S.isCompressedTexture===!0||S.isVideoTexture===!0||L!==Mr&&L!==pi&&(Ze.getTransfer(L)===st?(W!==dn||J!==an)&&We("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Qe("WebGLTextures: Unsupported texture color space:",L)),m}function oe(S){return typeof HTMLImageElement<"u"&&S instanceof HTMLImageElement?(u.width=S.naturalWidth||S.width,u.height=S.naturalHeight||S.height):typeof VideoFrame<"u"&&S instanceof VideoFrame?(u.width=S.displayWidth,u.height=S.displayHeight):(u.width=S.width,u.height=S.height),u}this.allocateTextureUnit=F,this.resetTextureUnits=P,this.setTexture2D=Z,this.setTexture2DArray=X,this.setTexture3D=V,this.setTextureCube=Q,this.rebindTextures=T,this.setupRenderTarget=I,this.updateRenderTargetMipmap=B,this.updateMultisampleRenderTarget=ie,this.setupDepthRenderbuffer=Ve,this.setupFrameBufferTexture=me,this.useMultisampledRTT=ue,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function US(n,e){function t(i,r=pi){let s;const a=Ze.getTransfer(r);if(i===an)return n.UNSIGNED_BYTE;if(i===ec)return n.UNSIGNED_SHORT_4_4_4_4;if(i===tc)return n.UNSIGNED_SHORT_5_5_5_1;if(i===vh)return n.UNSIGNED_INT_5_9_9_9_REV;if(i===Sh)return n.UNSIGNED_INT_10F_11F_11F_REV;if(i===_h)return n.BYTE;if(i===xh)return n.SHORT;if(i===rs)return n.UNSIGNED_SHORT;if(i===Ql)return n.INT;if(i===Dn)return n.UNSIGNED_INT;if(i===Tn)return n.FLOAT;if(i===Qn)return n.HALF_FLOAT;if(i===Mh)return n.ALPHA;if(i===Eh)return n.RGB;if(i===dn)return n.RGBA;if(i===ei)return n.DEPTH_COMPONENT;if(i===Vi)return n.DEPTH_STENCIL;if(i===yh)return n.RED;if(i===nc)return n.RED_INTEGER;if(i===Sr)return n.RG;if(i===ic)return n.RG_INTEGER;if(i===rc)return n.RGBA_INTEGER;if(i===Ks||i===js||i===Zs||i===Js)if(a===st)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(i===Ks)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===js)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===Zs)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===Js)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(i===Ks)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===js)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===Zs)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===Js)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===jo||i===Zo||i===Jo||i===Qo)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(i===jo)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===Zo)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===Jo)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===Qo)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===el||i===tl||i===nl||i===il||i===rl||i===sl||i===al)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(i===el||i===tl)return a===st?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(i===nl)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC;if(i===il)return s.COMPRESSED_R11_EAC;if(i===rl)return s.COMPRESSED_SIGNED_R11_EAC;if(i===sl)return s.COMPRESSED_RG11_EAC;if(i===al)return s.COMPRESSED_SIGNED_RG11_EAC}else return null;if(i===ol||i===ll||i===cl||i===ul||i===fl||i===hl||i===dl||i===pl||i===ml||i===gl||i===_l||i===xl||i===vl||i===Sl)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(i===ol)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===ll)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===cl)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===ul)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===fl)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===hl)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===dl)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===pl)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===ml)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===gl)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===_l)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===xl)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===vl)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===Sl)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===Ml||i===El||i===yl)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(i===Ml)return a===st?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===El)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===yl)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===bl||i===Tl||i===Al||i===wl)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(i===bl)return s.COMPRESSED_RED_RGTC1_EXT;if(i===Tl)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===Al)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===wl)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===ss?n.UNSIGNED_INT_24_8:n[i]!==void 0?n[i]:null}return{convert:t}}const NS=`
void main() {
...
}`;class OS{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){const i=new Bh(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=i}}getMesh(e){if(this.texture!==null&&this.mesh===null){const t=e.cameras[0].viewport,i=new Ln({vertexShader:NS,fragmentShader:FS,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new ni(new ba(20,20),i)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class BS extends yr{constructor(e,t){super();const i=this;let r=null,s=1,a=null,o="local-floor",l=1,u=null,c=null,f=null,h=null,p=null,_=null;const v=typeof XRWebGLBinding<"u",g=new OS,d={},y=t.getContextAttributes();let w=null,b=null;const C=[],D=[],R=new ot;let z=null;const x=new sn;x.viewport=new _t;const E=new sn;E.viewport=new _t;const U=[x,E],P=new $g;let F=null,j=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(H){let te=C[H];return te===void 0&&(te=new po,C[H]=te),te.getTargetRaySpace()},this.getControllerGrip=function(H){let te=C[H];return te===void 0&&(te=new po,C[H]=te),te.getGripSpace()},this.getHand=function(H){let te=C[H];return te===void 0&&(te=new po,C[H]=te),te.getHandSpace()};function Z(H){const te=D.indexOf(H.inputSource);if(te===-1)return;const me=C[te];me!==void 0&&(me.update(H.inputSource,H.frame,u||a),me.dispatchEvent({type:H.type,data:H.inputSource}))}function X(){r.removeEventListener("select",Z),r.removeEventListener("selectstart",Z),r.removeEventListener("selectend",Z),r.removeEventListener("squeeze",Z),r.removeEventListener("squeezestart",Z),r.removeEventListener("squeezeend",Z),r.removeEventListener("end",X),r.removeEventListener("inputsourceschange",V);for(let H=0;H<C.length;H++){const te=D[H];te!==null&&(D[H]=null,C[H].disconnect(te))}F=null,j=null,g.reset();for(const H in d)delete d[H];e.setRenderTarget(w),p=null,h=null,f=null,r=null,b=null,Ne.stop(),i.isPresenting=!1,e.setPixelRatio(z),e.setSize(R.width,R.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(H){s=H,i.isPresenting===!0&&We("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(H){o=H,i.isPresenting===!0&&We("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return u||a},this.setReferenceSpace=function(H){u=H},this.getBaseLayer=function(){return h!==null?h:p},this.getBinding=function(){return f===null&&v&&(f=new XRWebGLBinding(r,t)),f},this.getFrame=function(){return _},this.getSession=function(){return r},this.setSession=async function(H){if(r=H,r!==null){if(w=e.getRenderTarget(),r.addEventListener("select",Z),r.addEventListener("selectstart",Z),r.addEventListener("selectend",Z),r.addEventListener("squeeze",Z),r.addEventListener("squeezestart",Z),r.addEventListener("squeezeend",Z),r.addEventListener("end",X),r.addEventListener("inputsourceschange",V),y.xrCompatible!==!0&&await t.makeXRCompatible(),z=e.getPixelRatio(),e.getSize(R),v&&"createProjectionLayer"in XRWebGLBinding.prototype){let me=null,Ie=null,ve=null;y.depth&&(ve=y.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,me=y.stencil?Vi:ei,Ie=y.stencil?ss:Dn);const Ve={colorFormat:t.RGBA8,depthFormat:ve,scaleFactor:s};f=this.getBinding(),h=f.createProjectionLayer(Ve),r.updateRenderState({layers:[h]}),e.setPixelRatio(1),e.setSize(h.textureWidth,h.textureHeight,!1),b=new Pn(h.textureWidth,h.textureHeight,{format:dn,type:an,depthTexture:new ls(h.textureWidth,h.textureHeight,Ie,void 0,void 0,void 0,void 0,void 0,void 0,me),stencilBuffer:y.stencil,colorSpace:e.outputColorSpace,samples:y.antialias?4:0,resolveDepthBuffer:h.ignoreDepthValues===!1,resolveStencilBuffer:h.ignoreDepthValues===!1})}else{const me={antialias:y.antialias,alpha:!0,depth:y.depth,stencil:y.stencil,framebufferScaleFactor:s};p=new XRWebGLLayer(r,t,me),r.updateRenderState({baseLayer:p}),e.setPixelRatio(1),e.setSize(p.framebufferWidth,p.framebufferHeight,!1),b=new Pn(p.framebufferWidth,p.framebufferHeight,{format:dn,type:an,colorSpace:e.outputColorSpace,stencilBuffer:y.stencil,resolveDepthBuffer:p.ignoreDepthValues===!1,resolveStencilBuffer:p.ignoreDepthValues===!1})}b.isXRRenderTarget=!0,this.setFoveation(l),u=null,a=await r.requestReferenceSpace(o),Ne.setContext(r),Ne.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return g.getDepthTexture()};function V(H){for(let te=0;te<H.removed.length;te++){const me=H.removed[te],Ie=D.indexOf(me);Ie>=0&&(D[Ie]=null,C[Ie].disconnect(me))}for(let te=0;te<H.added.length;te++){const me=H.added[te];let Ie=D.indexOf(me);if(Ie===-1){for(let Ve=0;Ve<C.length;Ve++)if(Ve>=D.length){D.push(me),Ie=Ve;break}else if(D[Ve]===null){D[Ve]=me,Ie=Ve;break}if(Ie===-1)break}const ve=C[Ie];ve&&ve.connect(me)}}const Q=new Y,se=new Y;function re(H,te,me){Q.setFromMatrixPosition(te.matrixWorld),se.setFromMatrixPosition(me.matrixWorld);const Ie=Q.distanceTo(se),ve=te.projectionMatrix.elements,Ve=me.projectionMatrix.elements,T=ve[14]/(ve[10]-1),I=ve[14]/(ve[10]+1),B=(ve[9]+1)/ve[5],ee=(ve[9]-1)/ve[5],q=(ve[8]-1)/ve[0],ie=(Ve[8]+1)/Ve[0],A=T*q,ue=T*ie,ae=Ie/(-q+ie),ne=ae*-q;if(te.matrixWorld.decompose(H.position,H.quaternion,H.scale),H.translateX(ne),H.translateZ(ae),H.matrixWorld.compose(H.position,H.quaternion,H.scale),H.matrixWorldInverse.copy(H.matrixWorld).invert(),ve[10]===-1)H.projectionMatrix.copy(te.projectionMatrix),H.projectionMatrixInverse.copy(te.projectionMatrixInverse);else{const oe=T+ae,S=I+ae,m=A-ne,L=ue+(Ie-ne),W=B*I/S*oe,J=ee*I/S*oe;H.projectionMatrix.makePerspective(m,L,W,J,oe,S),H.projectionMatrixInverse.copy(H.projectionMatrix).invert()}}function he(H,te){te===null?H.matrixWorld.copy(H.matrix):H.matrixWorld.multiplyMatrices(te.matrixWorld,H.matrix),H.matrixWorldInverse.copy(H.matrixWorld).invert()}this.updateCamera=function(H){if(r===null)return;let te=H.near,me=H.far;g.texture!==null&&(g.depthNear>0&&(te=g.depthNear),g.depthFar>0&&(me=g.depthFar)),P.near=E.near=x.near=te,P.far=E.far=x.far=me,(F!==P.near||j!==P.far)&&(r.updateRenderState({depthNear:P.near,depthFar:P.far}),F=P.near,j=P.far),P.layers.mask=H.layers.mask|6,x.layers.mask=P.layers.mask&3,E.layers.mask=P.layers.mask&5;const Ie=H.parent,ve=P.cameras;he(P,Ie);for(let Ve=0;Ve<ve.length;Ve++)he(ve[Ve],Ie);ve.length===2?re(P,x,E):P.projectionMatrix.copy(x.projectionMatrix),we(H,P,Ie)};function we(H,te,me){me===null?H.matrix.copy(te.matrixWorld):(H.matrix.copy(me.matrixWorld),H.matrix.invert(),H.matrix.multiply(te.matrixWorld)),H.matrix.decompose(H.position,H.quaternion,H.scale),H.updateMatrixWorld(!0),H.projectionMatrix.copy(te.projectionMatrix),H.projectionMatrixInverse.copy(te.projectionMatrixInverse),H.isPerspectiveCamera&&(H.fov=Cl*2*Math.atan(1/H.projectionMatrix.elements[5]),H.zoom=1)}this.getCamera=function(){return P},this.getFoveation=function(){if(!(h===null&&p===null))return l},this.setFoveation=function(H){l=H,h!==null&&(h.fixedFoveation=H),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=H)},this.hasDepthSensing=function(){return g.texture!==null},this.getDepthSensingMesh=function(){return g.getMesh(P)},this.getCameraTexture=function(H){return d[H]};let le=null;function ge(H,te){if(c=te.getViewerPose(u||a),_=te,c!==null){const me=c.views;p!==null&&(e.setRenderTargetFramebuffer(b,p.framebuffer),e.setRenderTarget(b));let Ie=!1;me.length!==P.cameras.length&&(P.cameras.length=0,Ie=!0);for(let I=0;I<me.length;I++){const B=me[I];let ee=null;if(p!==null)ee=p.getViewport(B);else{const ie=f.getViewSubImage(h,B);ee=ie.viewport,I===0&&(e.setRenderTargetTextures(b,ie.colorTexture,ie.depthStencilTexture),e.setRenderTarget(b))}let q=U[I];q===void 0&&(q=new sn,q.layers.enable(I),q.viewport=new _t,U[I]=q),q.matrix.fromArray(B.transform.matrix),q.matrix.decompose(q.position,q.quaternion,q.scale),q.projectionMatrix.fromArray(B.projectionMatrix),q.projectionMatrixInverse.copy(q.projectionMatrix).invert(),q.viewport.set(ee.x,ee.y,ee.width,ee.height),I===0&&(P.matrix.copy(q.matrix),P.matrix.decompose(P.position,P.quaternion,P.scale)),Ie===!0&&P.cameras.push(q)}const ve=r.enabledFeatures;if(ve&&ve.includes("depth-sensing")&&r.depthUsage=="gpu-optimized"&&v){f=i.getBinding();const I=f.getDepthInformation(me[0]);I&&I.isValid&&I.texture&&g.init(I,r.renderState)}if(ve&&ve.includes("camera-access")&&v){e.state.unbindTexture(),f=i.getBinding();for(let I=0;I<me.length;I++){const B=me[I].camera;if(B){let ee=d[B];ee||(ee=new Bh,d[B]=ee);const q=f.getCameraImage(B);ee.sourceTexture=q}}}}for(let me=0;me<C.length;me++){const Ie=D[me],ve=C[me];Ie!==null&&ve!==void 0&&ve.update(Ie,te,u||a)}le&&le(H,te),te.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:te}),_=null}const Ne=new Vh;Ne.setAnimationLoop(ge),this.setAnimationLoop=function(H){le=H},this.dispose=function(){}}}const Ii=new ti,zS=new xt;function VS(n,e){function t(g,d){g.matrixAutoUpdate===!0&&g.updateMatrix(),d.value.copy(g.matrix)}function i(g,d){d.color.getRGB(g.fogColor.value,Lh(n)),d.isFog?(g.fogNear.value=d.near,g.fogFar.value=d.far):d.isFogExp2&&(g.fogDensity.value=d.density)}function r(g,d,y,w,b){d.isMeshBasicMaterial||d.isMeshLambertMaterial?s(g,d):d.isMeshToonMaterial?(s(g,d),f(g,d)):d.isMeshPhongMaterial?(s(g,d),c(g,d)):d.isMeshStandardMaterial?(s(g,d),h(g,d),d.isMeshPhysicalMaterial&&p(g,d,b)):d.isMeshMatcapMaterial?(s(g,d),_(g,d)):d.isMeshDepthMaterial?s(g,d):d.isMeshDistanceMaterial?(s(g,d),v(g,d)):d.isMeshNormalMaterial?s(g,d):d.isLineBasicMaterial?(a(g,d),d.isLineDashedMaterial&&o(g,d)):d.isPointsMaterial?l(g,d,y,w):d.isSpriteMaterial?u(g,d):d.isShadowMaterial?(g.color.value.copy(d.color),g.opacity.value=d.opacity):d.isShaderMaterial&&(d.uniformsNeedUpdate=!1)}function s(g,d){g.opacity.value=d.opacity,d.color&&g.diffuse.value.copy(d.color),d.emissive&&g.emissive.value.copy(d.emissive).multiplyScalar(d.emissiveIntensity),d.map&&(g.map.value=d.map,t(d.map,g.mapTransform)),d.alphaMap&&(g.alphaMap.value=d.alphaMap,t(d.alphaMap,g.alphaMapTransform)),d.bumpMap&&(g.bumpMap.value=d.bumpMap,t(d.bumpMap,g.bumpMapTransform),g.bumpScale.value=d.bumpScale,d.side===Wt&&(g.bumpScale.value*=-1)),d.normalMap&&(g.normalMap.value=d.normalMap,t(d.normalMap,g.normalMapTransform),g.normalScale.value.copy(d.normalScale),d.side===Wt&&g.normalScale.value.negate()),d.displacementMap&&(g.displacementMap.value=d.displacementMap,t(d.displacementMap,g.displacementMapTransform),g.displacementScale.value=d.displacementScale,g.displacementBias.value=d.displacementBias),d.emissiveMap&&(g.emissiveMap.value=d.emissiveMap,t(d.emissiveMap,g.emissiveMapTransform)),d.specularMap&&(g.specularMap.value=d.specularMap,t(d.specularMap,g.specularMapTransform)),d.alphaTest>0&&(g.alphaTest.value=d.alphaTest);const y=e.get(d),w=y.envMap,b=y.envMapRotation;w&&(g.envMap.value=w,Ii.copy(b),Ii.x*=-1,Ii.y*=-1,Ii.z*=-1,w.isCubeTexture&&w.isRenderTargetTexture===!1&&(Ii.y*=-1,Ii.z*=-1),g.envMapRotation.value.setFromMatrix4(zS.makeRotationFromEuler(Ii)),g.flipEnvMap.value=w.isCubeTexture&&w.isRenderTargetTexture===!1?-1:1,g.reflectivity.value=d.reflectivity,g.ior.value=d.ior,g.refractionRatio.value=d.refractionRatio),d.lightMap&&(g.lightMap.value=d.lightMap,g.lightMapIntensity.value=d.lightMapIntensity,t(d.lightMap,g.lightMapTransform)),d.aoMap&&(g.aoMap.value=d.aoMap,g.aoMapIntensity.value=d.aoMapIntensity,t(d.aoMap,g.aoMapTransform))}function a(g,d){g.diffuse.value.copy(d.color),g.opacity.value=d.opacity,d.map&&(g.map.value=d.map,t(d.map,g.mapTransform))}function o(g,d){g.dashSize.value=d.dashSize,g.totalSize.value=d.dashSize+d.gapSize,g.scale.value=d.scale}function l(g,d,y,w){g.diffuse.value.copy(d.color),g.opacity.value=d.opacity,g.size.value=d.size*y,g.scale.value=w*.5,d.map&&(g.map.value=d.map,t(d.map,g.uvTransform)),d.alphaMap&&(g.alphaMap.value=d.alphaMap,t(d.alphaMap,g.alphaMapTransform)),d.alphaTest>0&&(g.alphaTest.value=d.alphaTest)}function u(g,d){g.diffuse.value.copy(d.color),g.opacity.value=d.opacity,g.rotation.value=d.rotation,d.map&&(g.map.value=d.map,t(d.map,g.mapTransform)),d.alphaMap&&(g.alphaMap.value=d.alphaMap,t(d.alphaMap,g.alphaMapTransform)),d.alphaTest>0&&(g.alphaTest.value=d.alphaTest)}function c(g,d){g.specular.value.copy(d.specular),g.shininess.value=Math.max(d.shininess,1e-4)}function f(g,d){d.gradientMap&&(g.gradientMap.value=d.gradientMap)}function h(g,d){g.metalness.value=d.metalness,d.metalnessMap&&(g.metalnessMap.value=d.metalnessMap,t(d.metalnessMap,g.metalnessMapTransform)),g.roughness.value=d.roughness,d.roughnessMap&&(g.roughnessMap.value=d.roughnessMap,t(d.roughnessMap,g.roughnessMapTransform)),d.envMap&&(g.envMapIntensity.value=d.envMapIntensity)}function p(g,d,y){g.ior.value=d.ior,d.sheen>0&&(g.sheenColor.value.copy(d.sheenColor).multiplyScalar(d.sheen),g.sheenRoughness.value=d.sheenRoughness,d.sheenColorMap&&(g.sheenColorMap.value=d.sheenColorMap,t(d.sheenColorMap,g.sheenColorMapTransform)),d.sheenRoughnessMap&&(g.sheenRoughnessMap.value=d.sheenRoughnessMap,t(d.sheenRoughnessMap,g.sheenRoughnessMapTransform))),d.clearcoat>0&&(g.clearcoat.value=d.clearcoat,g.clearcoatRoughness.value=d.clearcoatRoughness,d.clearcoatMap&&(g.clearcoatMap.value=d.clearcoatMap,t(d.clearcoatMap,g.clearcoatMapTransform)),d.clearcoatRoughnessMap&&(g.clearcoatRoughnessMap.value=d.clearcoatRoughnessMap,t(d.clearcoatRoughnessMap,g.clearcoatRoughnessMapTransform)),d.clearcoatNormalMap&&(g.clearcoatNormalMap.value=d.clearcoatNormalMap,t(d.clearcoatNormalMap,g.clearcoatNormalMapTransform),g.clearcoatNormalScale.value.copy(d.clearcoatNormalScale),d.side===Wt&&g.clearcoatNormalScale.value.negate())),d.dispersion>0&&(g.dispersion.value=d.dispersion),d.iridescence>0&&(g.iridescence.value=d.iridescence,g.iridescenceIOR.value=d.iridescenceIOR,g.iridescenceThicknessMinimum.value=d.iridescenceThicknessRange[0],g.iridescenceThicknessMaximum.value=d.iridescenceThicknessRange[1],d.iridescenceMap&&(g.iridescenceMap.value=d.iridescenceMap,t(d.iridescenceMap,g.iridescenceMapTransform)),d.iridescenceThicknessMap&&(g.iridescenceThicknessMap.value=d.iridescenceThicknessMap,t(d.iridescenceThicknessMap,g.iridescenceThicknessMapTransform))),d.transmission>0&&(g.transmission.value=d.transmission,g.transmissionSamplerMap.value=y.texture,g.transmissionSamplerSize.value.set(y.width,y.height),d.transmissionMap&&(g.transmissionMap.value=d.transmissionMap,t(d.transmissionMap,g.transmissionMapTransform)),g.thickness.value=d.thickness,d.thicknessMap&&(g.thicknessMap.value=d.thicknessMap,t(d.thicknessMap,g.thicknessMapTransform)),g.attenuationDistance.value=d.attenuationDistance,g.attenuationColor.value.copy(d.attenuationColor)),d.anisotropy>0&&(g.anisotropyVector.value.set(d.anisotropy*Math.cos(d.anisotropyRotation),d.anisotropy*Math.sin(d.anisotropyRotation)),d.anisotropyMap&&(g.anisotropyMap.value=d.anisotropyMap,t(d.anisotropyMap,g.anisotropyMapTransform))),g.specularIntensity.value=d.specularIntensity,g.specularColor.value.copy(d.specularColor),d.specularColorMap&&(g.specularColorMap.value=d.specularColorMap,t(d.specularColorMap,g.specularColorMapTransform)),d.specularIntensityMap&&(g.specularIntensityMap.value=d.specularIntensityMap,t(d.specularIntensityMap,g.specularIntensityMapTransform))}function _(g,d){d.matcap&&(g.matcap.value=d.matcap)}function v(g,d){const y=e.get(d).light;g.referencePosition.value.setFromMatrixPosition(y.matrixWorld),g.nearDistance.value=y.shadow.camera.near,g.farDistance.value=y.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:r}}function HS(n,e,t,i){let r={},s={},a=[];const o=n.getParameter(n.MAX_UNIFORM_BUFFER_BINDINGS);function l(y,w){const b=w.program;i.uniformBlockBinding(y,b)}function u(y,w){let b=r[y.id];b===void 0&&(_(y),b=c(y),r[y.id]=b,y.addEventListener("dispose",g));const C=w.program;i.updateUBOMapping(y,C);const D=e.render.frame;s[y.id]!==D&&(h(y),s[y.id]=D)}function c(y){const w=f();y.__bindingPointIndex=w;const b=n.createBuffer(),C=y.__size,D=y.usage;return n.bindBuffer(n.UNIFORM_BUFFER,b),n.bufferData(n.UNIFORM_BUFFER,C,D),n.bindBuffer(n.UNIFORM_BUFFER,null),n.bindBufferBase(n.UNIFORM_BUFFER,w,b),b}function f(){for(let y=0;y<o;y++)if(a.indexOf(y)===-1)return a.push(y),y;return Qe("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function h(y){const w=r[y.id],b=y.uniforms,C=y.__cache;n.bindBuffer(n.UNIFORM_BUFFER,w);for(let D=0,R=b.length;D<R;D++){const z=Array.isArray(b[D])?b[D]:[b[D]];for(let x=0,E=z.length;x<E;x++){const U=z[x];if(p(U,D,x,C)===!0){const P=U.__offset,F=Array.isArray(U.value)?U.value:[U.value];let j=0;for(let Z=0;Z<F.length;Z++){const X=F[Z],V=v(X);typeof X=="number"||typeof X=="boolean"?(U.__data[0]=X,n.bufferSubData(n.UNIFORM_BUFFER,P+j,U.__data)):X.isMatrix3?(U.__data[0]=X.elements[0],U.__data[1]=X.elements[1],U.__data[2]=X.elements[2],U.__data[3]=0,U.__data[4]=X.elements[3],U.__data[5]=X.elements[4],U.__data[6]=X.elements[5],U.__data[7]=0,U.__data[8]=X.elements[6],U.__data[9]=X.elements[7],U.__data[10]=X.elements[8],U.__data[11]=0):(X.toArray(U.__data,j),j+=V.storage/Float32Array.BYTES_PER_ELEMENT)}n.bufferSubData(n.UNIFORM_BUFFER,P,U.__data)}}}n.bindBuffer(n.UNIFORM_BUFFER,null)}function p(y,w,b,C){const D=y.value,R=w+"_"+b;if(C[R]===void 0)return typeof D=="number"||typeof D=="boolean"?C[R]=D:C[R]=D.clone(),!0;{const z=C[R];if(typeof D=="number"||typeof D=="boolean"){if(z!==D)return C[R]=D,!0}else if(z.equals(D)===!1)return z.copy(D),!0}return!1}function _(y){const w=y.uniforms;let b=0;const C=16;for(let R=0,z=w.length;R<z;R++){const x=Array.isArray(w[R])?w[R]:[w[R]];for(let E=0,U=x.length;E<U;E++){const P=x[E],F=Array.isArray(P.value)?P.value:[P.value];for(let j=0,Z=F.length;j<Z;j++){const X=F[j],V=v(X),Q=b%C,se=Q%V.boundary,re=Q+se;b+=se,re!==0&&C-re<V.storage&&(b+=C-re),P.__data=new Float32Array(V.storage/Float32Array.BYTES_PER_ELEMENT),P.__offset=b,b+=V.storage}}}const D=b%C;return D>0&&(b+=C-D),y.__size=b,y.__cache={},this}function v(y){const w={boundary:0,storage:0};return typeof y=="number"||typeof y=="boolean"?(w.boundary=4,w.storage=4):y.isVector2?(w.boundary=8,w.storage=8):y.isVector3||y.isColor?(w.boundary=16,w.storage=12):y.isVector4?(w.boundary=16,w.storage=16):y.isMatrix3?(w.boundary=48,w.storage=48):y.isMatrix4?(w.boundary=64,w.storage=64):y.isTexture?We("WebGLRenderer: Texture samplers can not be part of an uniforms group."):We("WebGLRenderer: Unsupported uniform value type.",y),w}function g(y){const w=y.target;w.removeEventListener("dispose",g);const b=a.indexOf(w.__bindingPointIndex);a.splice(b,1),n.deleteBuffer(r[w.id]),delete r[w.id],delete s[w.id]}function d(){for(const y in r)n.deleteBuffer(r[y]);a=[],r={},s={}}return{bind:l,update:u,dispose:d}}const GS=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]);let Mn=null;function kS(){return Mn===null&&(Mn=new Ng(GS,16,16,Sr,Qn),Mn.name="DFG_LUT",Mn.minFilter=Pt,Mn.magFilter=Pt,Mn.wrapS=qn,Mn.wrapT=qn,Mn.generateMipmaps=!1,Mn.needsUpdate=!0),Mn}class WS{constructor(e={}){const{canvas:t=lg(),context:i=null,depth:r=!0,stencil:s=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:u=!1,powerPreference:c="default",failIfMajorPerformanceCaveat:f=!1,reversedDepthBuffer:h=!1,outputBufferType:p=an}=e;this.isWebGLRenderer=!0;let _;if(i!==null){if(typeof WebGLRenderingContext<"u"&&i instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");_=i.getContextAttributes().alpha}else _=a;const v=p,g=new Set([rc,ic,nc]),d=new Set([an,Dn,rs,ss,ec,tc]),y=new Uint32Array(4),w=new Int32Array(4);let b=null,C=null;const D=[],R=[];let z=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=Rn,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const x=this;let E=!1;this._outputColorSpace=nn;let U=0,P=0,F=null,j=-1,Z=null;const X=new _t,V=new _t;let Q=null;const se=new nt(0);let re=0,he=t.width,we=t.height,le=1,ge=null,Ne=null;const H=new _t(0,0,he,we),te=new _t(0,0,he,we);let me=!1;const Ie=new Fh;let ve=!1,Ve=!1;const T=new xt,I=new Y,B=new _t,ee={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let q=!1;function ie(){return F===null?le:1}let A=i;function ue(M,O){return t.getContext(M,O)}try{const M={alpha:!0,depth:r,stencil:s,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:u,powerPreference:c,failIfMajorPerformanceCaveat:f};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${Jl}`),t.addEventListener("webglcontextlost",ke,!1),t.addEventListener("webglcontextrestored",ut,!1),t.addEventListener("webglcontextcreationerror",it,!1),A===null){const O="webgl2";if(A=ue(O,M),A===null)throw ue(O)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(M){throw Qe("WebGLRenderer: "+M.message),M}let ae,ne,oe,S,m,L,W,J,k,Te,de,Re,Fe,fe,Se,Ee,Pe,xe,Xe,N,Ce,_e,De,pe;function ce(){ae=new kx(A),ae.init(),_e=new US(A,ae),ne=new Ux(A,ae,e,_e),oe=new LS(A,ae),ne.reversedDepthBuffer&&h&&oe.buffers.depth.setReversed(!0),S=new qx(A),m=new _S,L=new IS(A,ae,oe,m,ne,_e,S),W=new Fx(x),J=new Gx(x),k=new jg(A),De=new Lx(A,k),Te=new Wx(A,k,S,De),de=new $x(A,Te,k,S),Xe=new Yx(A,ne,L),Ee=new Nx(m),Re=new gS(x,W,J,ae,ne,De,Ee),Fe=new VS(x,m),fe=new vS,Se=new TS(ae),xe=new Dx(x,W,J,oe,de,_,l),Pe=new PS(x,de,ne),pe=new HS(A,S,ne,oe),N=new Ix(A,ae,S),Ce=new Xx(A,ae,S),S.programs=Re.programs,x.capabilities=ne,x.extensions=ae,x.properties=m,x.renderLists=fe,x.shadowMap=Pe,x.state=oe,x.info=S}ce(),v!==an&&(z=new jx(v,t.width,t.height,r,s));const Me=new BS(x,A);this.xr=Me,this.getContext=function(){return A},this.getContextAttributes=function(){return A.getContextAttributes()},this.forceContextLoss=function(){const M=ae.get("WEBGL_lose_context");M&&M.loseContext()},this.forceContextRestore=function(){const M=ae.get("WEBGL_lose_context");M&&M.restoreContext()},this.getPixelRatio=function(){return le},this.setPixelRatio=function(M){M!==void 0&&(le=M,this.setSize(he,we,!1))},this.getSize=function(M){return M.set(he,we)},this.setSize=function(M,O,K=!0){if(Me.isPresenting){We("WebGLRenderer: Can't change size while VR device is presenting.");return}he=M,we=O,t.width=Math.floor(M*le),t.height=Math.floor(O*le),K===!0&&(t.style.width=M+"px",t.style.height=O+"px"),z!==null&&z.setSize(t.width,t.height),this.setViewport(0,0,M,O)},this.getDrawingBufferSize=function(M){return M.set(he*le,we*le).floor()},this.setDrawingBufferSize=function(M,O,K){he=M,we=O,le=K,t.width=Math.floor(M*K),t.height=Math.floor(O*K),this.setViewport(0,0,M,O)},this.setEffects=function(M){if(v===an){console.error("THREE.WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(M){for(let O=0;O<M.length;O++)if(M[O].isOutputPass===!0){console.warn("THREE.WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}z.setEffects(M||[])},this.getCurrentViewport=function(M){return M.copy(X)},this.getViewport=function(M){return M.copy(H)},this.setViewport=function(M,O,K,$){M.isVector4?H.set(M.x,M.y,M.z,M.w):H.set(M,O,K,$),oe.viewport(X.copy(H).multiplyScalar(le).round())},this.getScissor=function(M){return M.copy(te)},this.setScissor=function(M,O,K,$){M.isVector4?te.set(M.x,M.y,M.z,M.w):te.set(M,O,K,$),oe.scissor(V.copy(te).multiplyScalar(le).round())},this.getScissorTest=function(){return me},this.setScissorTest=function(M){oe.setScissorTest(me=M)},this.setOpaqueSort=function(M){ge=M},this.setTransparentSort=function(M){Ne=M},this.getClearColor=function(M){return M.copy(xe.getClearColor())},this.setClearColor=function(){xe.setClearColor(...arguments)},this.getClearAlpha=function(){return xe.getClearAlpha()},this.setClearAlpha=function(){xe.setClearAlpha(...arguments)},this.clear=function(M=!0,O=!0,K=!0){let $=0;if(M){let G=!1;if(F!==null){const ye=F.texture.format;G=g.has(ye)}if(G){const ye=F.texture.type,Le=d.has(ye),Ae=xe.getClearColor(),Ue=xe.getClearAlpha(),Oe=Ae.r,He=Ae.g,Be=Ae.b;Le?(y[0]=Oe,y[1]=He,y[2]=Be,y[3]=Ue,A.clearBufferuiv(A.COLOR,0,y)):(w[0]=Oe,w[1]=He,w[2]=Be,w[3]=Ue,A.clearBufferiv(A.COLOR,0,w))}else $|=A.COLOR_BUFFER_BIT}O&&($|=A.DEPTH_BUFFER_BIT),K&&($|=A.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),A.clear($)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener("webglcontextlost",ke,!1),t.removeEventListener("webglcontextrestored",ut,!1),t.removeEventListener("webglcontextcreationerror",it,!1),xe.dispose(),fe.dispose(),Se.dispose(),m.dispose(),W.dispose(),J.dispose(),de.dispose(),De.dispose(),pe.dispose(),Re.dispose(),Me.dispose(),Me.removeEventListener("sessionstart",fc),Me.removeEventListener("sessionend",hc),Ei.stop()};function ke(M){M.preventDefault(),ru("WebGLRenderer: Context Lost."),E=!0}function ut(){ru("WebGLRenderer: Context Restored."),E=!1;const M=S.autoReset,O=Pe.enabled,K=Pe.autoUpdate,$=Pe.needsUpdate,G=Pe.type;ce(),S.autoReset=M,Pe.enabled=O,Pe.autoUpdate=K,Pe.needsUpdate=$,Pe.type=G}function it(M){Qe("WebGLRenderer: A WebGL context could not be created. Reason: ",M.statusMessage)}function vn(M){const O=M.target;O.removeEventListener("dispose",vn),In(O)}function In(M){Xh(M),m.remove(M)}function Xh(M){const O=m.get(M).programs;O!==void 0&&(O.forEach(function(K){Re.releaseProgram(K)}),M.isShaderMaterial&&Re.releaseShaderCache(M))}this.renderBufferDirect=function(M,O,K,$,G,ye){O===null&&(O=ee);const Le=G.isMesh&&G.matrixWorld.determinant()<0,Ae=Yh(M,O,K,$,G);oe.setMaterial($,Le);let Ue=K.index,Oe=1;if($.wireframe===!0){if(Ue=Te.getWireframeAttribute(K),Ue===void 0)return;Oe=2}const He=K.drawRange,Be=K.attributes.position;let Ke=He.start*Oe,at=(He.start+He.count)*Oe;ye!==null&&(Ke=Math.max(Ke,ye.start*Oe),at=Math.min(at,(ye.start+ye.count)*Oe)),Ue!==null?(Ke=Math.max(Ke,0),at=Math.min(at,Ue.count)):Be!=null&&(Ke=Math.max(Ke,0),at=Math.min(at,Be.count));const mt=at-Ke;if(mt<0||mt===1/0)return;De.setup(G,$,Ae,K,Ue);let gt,lt=N;if(Ue!==null&&(gt=k.get(Ue),lt=Ce,lt.setIndex(gt)),G.isMesh)$.wireframe===!0?(oe.setLineWidth($.wireframeLinewidth*ie()),lt.setMode(A.LINES)):lt.setMode(A.TRIANGLES);else if(G.isLine){let ze=$.linewidth;ze===void 0&&(ze=1),oe.setLineWidth(ze*ie()),G.isLineSegments?lt.setMode(A.LINES):G.isLineLoop?lt.setMode(A.LINE_LOOP):lt.setMode(A.LINE_STRIP)}else G.isPoints?lt.setMode(A.POINTS):G.isSprite&&lt.setMode(A.TRIANGLES);if(G.isBatchedMesh)if(G._multiDrawInstances!==null)os("WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),lt.renderMultiDrawInstances(G._multiDrawStarts,G._multiDrawCounts,G._multiDrawCount,G._multiDrawInstances);else if(ae.get("WEBGL_multi_draw"))lt.renderMultiDraw(G._multiDrawStarts,G._multiDrawCounts,G._multiDrawCount);else{const ze=G._multiDrawStarts,rt=G._multiDrawCounts,Je=G._multiDrawCount,qt=Ue?k.get(Ue).bytesPerElement:1,Wi=m.get($).currentProgram.getUniforms();for(let Yt=0;Yt<Je;Yt++)Wi.setValue(A,"_gl_DrawID",Yt),lt.render(ze[Yt]/qt,rt[Yt])}else if(G.isInstancedMesh)lt.renderInstances(Ke,mt,G.count);else if(K.isInstancedBufferGeometry){const ze=K._maxInstanceCount!==void 0?K._maxInstanceCount:1/0,rt=Math.min(K.instanceCount,ze);lt.renderInstances(Ke,mt,rt)}else lt.render(Ke,mt)};function uc(M,O,K){M.transparent===!0&&M.side===Xn&&M.forceSinglePass===!1?(M.side=Wt,M.needsUpdate=!0,_s(M,O,K),M.side=Si,M.needsUpdate=!0,_s(M,O,K),M.side=Xn):_s(M,O,K)}this.compile=function(M,O,K=null){K===null&&(K=M),C=Se.get(K),C.init(O),R.push(C),K.traverseVisible(function(G){G.isLight&&G.layers.test(O.layers)&&(C.pushLight(G),G.castShadow&&C.pushShadow(G))}),M!==K&&M.traverseVisible(function(G){G.isLight&&G.layers.test(O.layers)&&(C.pushLight(G),G.castShadow&&C.pushShadow(G))}),C.setupLights();const $=new Set;return M.traverse(function(G){if(!(G.isMesh||G.isPoints||G.isLine||G.isSprite))return;const ye=G.material;if(ye)if(Array.isArray(ye))for(let Le=0;Le<ye.length;Le++){const Ae=ye[Le];uc(Ae,K,G),$.add(Ae)}else uc(ye,K,G),$.add(ye)}),C=R.pop(),$},this.compileAsync=function(M,O,K=null){const $=this.compile(M,O,K);return new Promise(G=>{function ye(){if($.forEach(function(Le){m.get(Le).currentProgram.isReady()&&$.delete(Le)}),$.size===0){G(M);return}setTimeout(ye,10)}ae.get("KHR_parallel_shader_compile")!==null?ye():setTimeout(ye,10)})};let Ca=null;function qh(M){Ca&&Ca(M)}function fc(){Ei.stop()}function hc(){Ei.start()}const Ei=new Vh;Ei.setAnimationLoop(qh),typeof self<"u"&&Ei.setContext(self),this.setAnimationLoop=function(M){Ca=M,Me.setAnimationLoop(M),M===null?Ei.stop():Ei.start()},Me.addEventListener("sessionstart",fc),Me.addEventListener("sessionend",hc),this.render=function(M,O){if(O!==void 0&&O.isCamera!==!0){Qe("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(E===!0)return;const K=Me.enabled===!0&&Me.isPresenting===!0,$=z!==null&&(F===null||K)&&z.begin(x,F);if(M.matrixWorldAutoUpdate===!0&&M.updateMatrixWorld(),O.parent===null&&O.matrixWorldAutoUpdate===!0&&O.updateMatrixWorld(),Me.enabled===!0&&Me.isPresenting===!0&&(z===null||z.isCompositing()===!1)&&(Me.cameraAutoUpdate===!0&&Me.updateCamera(O),O=Me.getCamera()),M.isScene===!0&&M.onBeforeRender(x,M,O,F),C=Se.get(M,R.length),C.init(O),R.push(C),T.multiplyMatrices(O.projectionMatrix,O.matrixWorldInverse),Ie.setFromProjectionMatrix(T,An,O.reversedDepth),Ve=this.localClippingEnabled,ve=Ee.init(this.clippingPlanes,Ve),b=fe.get(M,D.length),b.init(),D.push(b),Me.enabled===!0&&Me.isPresenting===!0){const Le=x.xr.getDepthSensingMesh();Le!==null&&Ra(Le,O,-1/0,x.sortObjects)}Ra(M,O,0,x.sortObjects),b.finish(),x.sortObjects===!0&&b.sort(ge,Ne),q=Me.enabled===!1||Me.isPresenting===!1||Me.hasDepthSensing()===!1,q&&xe.addToRenderList(b,M),this.info.render.frame++,ve===!0&&Ee.beginShadows();const G=C.state.shadowsArray;if(Pe.render(G,M,O),ve===!0&&Ee.endShadows(),this.info.autoReset===!0&&this.info.reset(),($&&z.hasRenderPass())===!1){const Le=b.opaque,Ae=b.transmissive;if(C.setupLights(),O.isArrayCamera){const Ue=O.cameras;if(Ae.length>0)for(let Oe=0,He=Ue.length;Oe<He;Oe++){const Be=Ue[Oe];pc(Le,Ae,M,Be)}q&&xe.render(M);for(let Oe=0,He=Ue.length;Oe<He;Oe++){const Be=Ue[Oe];dc(b,M,Be,Be.viewport)}}else Ae.length>0&&pc(Le,Ae,M,O),q&&xe.render(M),dc(b,M,O)}F!==null&&P===0&&(L.updateMultisampleRenderTarget(F),L.updateRenderTargetMipmap(F)),$&&z.end(x),M.isScene===!0&&M.onAfterRender(x,M,O),De.resetDefaultState(),j=-1,Z=null,R.pop(),R.length>0?(C=R[R.length-1],ve===!0&&Ee.setGlobalState(x.clippingPlanes,C.state.camera)):C=null,D.pop(),D.length>0?b=D[D.length-1]:b=null};function Ra(M,O,K,$){if(M.visible===!1)return;if(M.layers.test(O.layers)){if(M.isGroup)K=M.renderOrder;else if(M.isLOD)M.autoUpdate===!0&&M.update(O);else if(M.isLight)C.pushLight(M),M.castShadow&&C.pushShadow(M);else if(M.isSprite){if(!M.frustumCulled||Ie.intersectsSprite(M)){$&&B.setFromMatrixPosition(M.matrixWorld).applyMatrix4(T);const Le=de.update(M),Ae=M.material;Ae.visible&&b.push(M,Le,Ae,K,B.z,null)}}else if((M.isMesh||M.isLine||M.isPoints)&&(!M.frustumCulled||Ie.intersectsObject(M))){const Le=de.update(M),Ae=M.material;if($&&(M.boundingSphere!==void 0?(M.boundingSphere===null&&M.computeBoundingSphere(),B.copy(M.boundingSphere.center)):(Le.boundingSphere===null&&Le.computeBoundingSphere(),B.copy(Le.boundingSphere.center)),B.applyMatrix4(M.matrixWorld).applyMatrix4(T)),Array.isArray(Ae)){const Ue=Le.groups;for(let Oe=0,He=Ue.length;Oe<He;Oe++){const Be=Ue[Oe],Ke=Ae[Be.materialIndex];Ke&&Ke.visible&&b.push(M,Le,Ke,K,B.z,Be)}}else Ae.visible&&b.push(M,Le,Ae,K,B.z,null)}}const ye=M.children;for(let Le=0,Ae=ye.length;Le<Ae;Le++)Ra(ye[Le],O,K,$)}function dc(M,O,K,$){const{opaque:G,transmissive:ye,transparent:Le}=M;C.setupLightsView(K),ve===!0&&Ee.setGlobalState(x.clippingPlanes,K),$&&oe.viewport(X.copy($)),G.length>0&&gs(G,O,K),ye.length>0&&gs(ye,O,K),Le.length>0&&gs(Le,O,K),oe.buffers.depth.setTest(!0),oe.buffers.depth.setMask(!0),oe.buffers.color.setMask(!0),oe.setPolygonOffset(!1)}function pc(M,O,K,$){if((K.isScene===!0?K.overrideMaterial:null)!==null)return;if(C.state.transmissionRenderTarget[$.id]===void 0){const Ke=ae.has("EXT_color_buffer_half_float")||ae.has("EXT_color_buffer_float");C.state.transmissionRenderTarget[$.id]=new Pn(1,1,{generateMipmaps:!0,type:Ke?Qn:an,minFilter:zi,samples:ne.samples,stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Ze.workingColorSpace})}const ye=C.state.transmissionRenderTarget[$.id],Le=$.viewport||X;ye.setSize(Le.z*x.transmissionResolutionScale,Le.w*x.transmissionResolutionScale);const Ae=x.getRenderTarget(),Ue=x.getActiveCubeFace(),Oe=x.getActiveMipmapLevel();x.setRenderTarget(ye),x.getClearColor(se),re=x.getClearAlpha(),re<1&&x.setClearColor(16777215,.5),x.clear(),q&&xe.render(K);const He=x.toneMapping;x.toneMapping=Rn;const Be=$.viewport;if($.viewport!==void 0&&($.viewport=void 0),C.setupLightsView($),ve===!0&&Ee.setGlobalState(x.clippingPlanes,$),gs(M,K,$),L.updateMultisampleRenderTarget(ye),L.updateRenderTargetMipmap(ye),ae.has("WEBGL_multisampled_render_to_texture")===!1){let Ke=!1;for(let at=0,mt=O.length;at<mt;at++){const gt=O[at],{object:lt,geometry:ze,material:rt,group:Je}=gt;if(rt.side===Xn&&lt.layers.test($.layers)){const qt=rt.side;rt.side=Wt,rt.needsUpdate=!0,mc(lt,K,$,ze,rt,Je),rt.side=qt,rt.needsUpdate=!0,Ke=!0}}Ke===!0&&(L.updateMultisampleRenderTarget(ye),L.updateRenderTargetMipmap(ye))}x.setRenderTarget(Ae,Ue,Oe),x.setClearColor(se,re),Be!==void 0&&($.viewport=Be),x.toneMapping=He}function gs(M,O,K){const $=O.isScene===!0?O.overrideMaterial:null;for(let G=0,ye=M.length;G<ye;G++){const Le=M[G],{object:Ae,geometry:Ue,group:Oe}=Le;let He=Le.material;He.allowOverride===!0&&$!==null&&(He=$),Ae.layers.test(K.layers)&&mc(Ae,O,K,Ue,He,Oe)}}function mc(M,O,K,$,G,ye){M.onBeforeRender(x,O,K,$,G,ye),M.modelViewMatrix.multiplyMatrices(K.matrixWorldInverse,M.matrixWorld),M.normalMatrix.getNormalMatrix(M.modelViewMatrix),G.onBeforeRender(x,O,K,$,M,ye),G.transparent===!0&&G.side===Xn&&G.forceSinglePass===!1?(G.side=Wt,G.needsUpdate=!0,x.renderBufferDirect(K,O,$,G,M,ye),G.side=Si,G.needsUpdate=!0,x.renderBufferDirect(K,O,$,G,M,ye),G.side=Xn):x.renderBufferDirect(K,O,$,G,M,ye),M.onAfterRender(x,O,K,$,G,ye)}function _s(M,O,K){O.isScene!==!0&&(O=ee);const $=m.get(M),G=C.state.lights,ye=C.state.shadowsArray,Le=G.state.version,Ae=Re.getParameters(M,G.state,ye,O,K),Ue=Re.getProgramCacheKey(Ae);let Oe=$.programs;$.environment=M.isMeshStandardMaterial?O.environment:null,$.fog=O.fog,$.envMap=(M.isMeshStandardMaterial?J:W).get(M.envMap||$.environment),$.envMapRotation=$.environment!==null&&M.envMap===null?O.environmentRotation:M.envMapRotation,Oe===void 0&&(M.addEventListener("dispose",vn),Oe=new Map,$.programs=Oe);let He=Oe.get(Ue);if(He!==void 0){if($.currentProgram===He&&$.lightsStateVersion===Le)return _c(M,Ae),He}else Ae.uniforms=Re.getUniforms(M),M.onBeforeCompile(Ae,x),He=Re.acquireProgram(Ae,Ue),Oe.set(Ue,He),$.uniforms=Ae.uniforms;const Be=$.uniforms;return(!M.isShaderMaterial&&!M.isRawShaderMaterial||M.clipping===!0)&&(Be.clippingPlanes=Ee.uniform),_c(M,Ae),$.needsLights=Kh(M),$.lightsStateVersion=Le,$.needsLights&&(Be.ambientLightColor.value=G.state.ambient,Be.lightProbe.value=G.state.probe,Be.directionalLights.value=G.state.directional,Be.directionalLightShadows.value=G.state.directionalShadow,Be.spotLights.value=G.state.spot,Be.spotLightShadows.value=G.state.spotShadow,Be.rectAreaLights.value=G.state.rectArea,Be.ltc_1.value=G.state.rectAreaLTC1,Be.ltc_2.value=G.state.rectAreaLTC2,Be.pointLights.value=G.state.point,Be.pointLightShadows.value=G.state.pointShadow,Be.hemisphereLights.value=G.state.hemi,Be.directionalShadowMap.value=G.state.directionalShadowMap,Be.directionalShadowMatrix.value=G.state.directionalShadowMatrix,Be.spotShadowMap.value=G.state.spotShadowMap,Be.spotLightMatrix.value=G.state.spotLightMatrix,Be.spotLightMap.value=G.state.spotLightMap,Be.pointShadowMap.value=G.state.pointShadowMap,Be.pointShadowMatrix.value=G.state.pointShadowMatrix),$.currentProgram=He,$.uniformsList=null,He}function gc(M){if(M.uniformsList===null){const O=M.currentProgram.getUniforms();M.uniformsList=Qs.seqWithValue(O.seq,M.uniforms)}return M.uniformsList}function _c(M,O){const K=m.get(M);K.outputColorSpace=O.outputColorSpace,K.batching=O.batching,K.batchingColor=O.batchingColor,K.instancing=O.instancing,K.instancingColor=O.instancingColor,K.instancingMorph=O.instancingMorph,K.skinning=O.skinning,K.morphTargets=O.morphTargets,K.morphNormals=O.morphNormals,K.morphColors=O.morphColors,K.morphTargetsCount=O.morphTargetsCount,K.numClippingPlanes=O.numClippingPlanes,K.numIntersection=O.numClipIntersection,K.vertexAlphas=O.vertexAlphas,K.vertexTangents=O.vertexTangents,K.toneMapping=O.toneMapping}function Yh(M,O,K,$,G){O.isScene!==!0&&(O=ee),L.resetTextureUnits();const ye=O.fog,Le=$.isMeshStandardMaterial?O.environment:null,Ae=F===null?x.outputColorSpace:F.isXRRenderTarget===!0?F.texture.colorSpace:Mr,Ue=($.isMeshStandardMaterial?J:W).get($.envMap||Le),Oe=$.vertexColors===!0&&!!K.attributes.color&&K.attributes.color.itemSize===4,He=!!K.attributes.tangent&&(!!$.normalMap||$.anisotropy>0),Be=!!K.morphAttributes.position,Ke=!!K.morphAttributes.normal,at=!!K.morphAttributes.color;let mt=Rn;$.toneMapped&&(F===null||F.isXRRenderTarget===!0)&&(mt=x.toneMapping);const gt=K.morphAttributes.position||K.morphAttributes.normal||K.morphAttributes.color,lt=gt!==void 0?gt.length:0,ze=m.get($),rt=C.state.lights;if(ve===!0&&(Ve===!0||M!==Z)){const It=M===Z&&$.id===j;Ee.setState($,M,It)}let Je=!1;$.version===ze.__version?(ze.needsLights&&ze.lightsStateVersion!==rt.state.version||ze.outputColorSpace!==Ae||G.isBatchedMesh&&ze.batching===!1||!G.isBatchedMesh&&ze.batching===!0||G.isBatchedMesh&&ze.batchingColor===!0&&G.colorTexture===null||G.isBatchedMesh&&ze.batchingColor===!1&&G.colorTexture!==null||G.isInstancedMesh&&ze.instancing===!1||!G.isInstancedMesh&&ze.instancing===!0||G.isSkinnedMesh&&ze.skinning===!1||!G.isSkinnedMesh&&ze.skinning===!0||G.isInstancedMesh&&ze.instancingColor===!0&&G.instanceColor===null||G.isInstancedMesh&&ze.instancingColor===!1&&G.instanceColor!==null||G.isInstancedMesh&&ze.instancingMorph===!0&&G.morphTexture===null||G.isInstancedMesh&&ze.instancingMorph===!1&&G.morphTexture!==null||ze.envMap!==Ue||$.fog===!0&&ze.fog!==ye||ze.numClippingPlanes!==void 0&&(ze.numClippingPlanes!==Ee.numPlanes||ze.numIntersection!==Ee.numIntersection)||ze.vertexAlphas!==Oe||ze.vertexTangents!==He||ze.morphTargets!==Be||ze.morphNormals!==Ke||ze.morphColors!==at||ze.toneMapping!==mt||ze.morphTargetsCount!==lt)&&(Je=!0):(Je=!0,ze.__version=$.version);let qt=ze.currentProgram;Je===!0&&(qt=_s($,O,G));let Wi=!1,Yt=!1,Tr=!1;const ft=qt.getUniforms(),Vt=ze.uniforms;if(oe.useProgram(qt.program)&&(Wi=!0,Yt=!0,Tr=!0),$.id!==j&&(j=$.id,Yt=!0),Wi||Z!==M){oe.buffers.depth.getReversed()&&M.reversedDepth!==!0&&(M._reversedDepth=!0,M.updateProjectionMatrix()),ft.setValue(A,"projectionMatrix",M.projectionMatrix),ft.setValue(A,"viewMatrix",M.matrixWorldInverse);const Ht=ft.map.cameraPosition;Ht!==void 0&&Ht.setValue(A,I.setFromMatrixPosition(M.matrixWorld)),ne.logarithmicDepthBuffer&&ft.setValue(A,"logDepthBufFC",2/(Math.log(M.far+1)/Math.LN2)),($.isMeshPhongMaterial||$.isMeshToonMaterial||$.isMeshLambertMaterial||$.isMeshBasicMaterial||$.isMeshStandardMaterial||$.isShaderMaterial)&&ft.setValue(A,"isOrthographic",M.isOrthographicCamera===!0),Z!==M&&(Z=M,Yt=!0,Tr=!0)}if(ze.needsLights&&(rt.state.directionalShadowMap.length>0&&ft.setValue(A,"directionalShadowMap",rt.state.directionalShadowMap,L),rt.state.spotShadowMap.length>0&&ft.setValue(A,"spotShadowMap",rt.state.spotShadowMap,L),rt.state.pointShadowMap.length>0&&ft.setValue(A,"pointShadowMap",rt.state.pointShadowMap,L)),G.isSkinnedMesh){ft.setOptional(A,G,"bindMatrix"),ft.setOptional(A,G,"bindMatrixInverse");const It=G.skeleton;It&&(It.boneTexture===null&&It.computeBoneTexture(),ft.setValue(A,"boneTexture",It.boneTexture,L))}G.isBatchedMesh&&(ft.setOptional(A,G,"batchingTexture"),ft.setValue(A,"batchingTexture",G._matricesTexture,L),ft.setOptional(A,G,"batchingIdTexture"),ft.setValue(A,"batchingIdTexture",G._indirectTexture,L),ft.setOptional(A,G,"batchingColorTexture"),G._colorsTexture!==null&&ft.setValue(A,"batchingColorTexture",G._colorsTexture,L));const Jt=K.morphAttributes;if((Jt.position!==void 0||Jt.normal!==void 0||Jt.color!==void 0)&&Xe.update(G,K,qt),(Yt||ze.receiveShadow!==G.receiveShadow)&&(ze.receiveShadow=G.receiveShadow,ft.setValue(A,"receiveShadow",G.receiveShadow)),$.isMeshGouraudMaterial&&$.envMap!==null&&(Vt.envMap.value=Ue,Vt.flipEnvMap.value=Ue.isCubeTexture&&Ue.isRenderTargetTexture===!1?-1:1),$.isMeshStandardMaterial&&$.envMap===null&&O.environment!==null&&(Vt.envMapIntensity.value=O.environmentIntensity),Vt.dfgLUT!==void 0&&(Vt.dfgLUT.value=kS()),Yt&&(ft.setValue(A,"toneMappingExposure",x.toneMappingExposure),ze.needsLights&&$h(Vt,Tr),ye&&$.fog===!0&&Fe.refreshFogUniforms(Vt,ye),Fe.refreshMaterialUniforms(Vt,$,le,we,C.state.transmissionRenderTarget[M.id]),Qs.upload(A,gc(ze),Vt,L)),$.isShaderMaterial&&$.uniformsNeedUpdate===!0&&(Qs.upload(A,gc(ze),Vt,L),$.uniformsNeedUpdate=!1),$.isSpriteMaterial&&ft.setValue(A,"center",G.center),ft.setValue(A,"modelViewMatrix",G.modelViewMatrix),ft.setValue(A,"normalMatrix",G.normalMatrix),ft.setValue(A,"modelMatrix",G.matrixWorld),$.isShaderMaterial||$.isRawShaderMaterial){const It=$.uniformsGroups;for(let Ht=0,Pa=It.length;Ht<Pa;Ht++){const yi=It[Ht];pe.update(yi,qt),pe.bind(yi,qt)}}return qt}function $h(M,O){M.ambientLightColor.needsUpdate=O,M.lightProbe.needsUpdate=O,M.directionalLights.needsUpdate=O,M.directionalLightShadows.needsUpdate=O,M.pointLights.needsUpdate=O,M.pointLightShadows.needsUpdate=O,M.spotLights.needsUpdate=O,M.spotLightShadows.needsUpdate=O,M.rectAreaLights.needsUpdate=O,M.hemisphereLights.needsUpdate=O}function Kh(M){return M.isMeshLambertMaterial||M.isMeshToonMaterial||M.isMeshPhongMaterial||M.isMeshStandardMaterial||M.isShadowMaterial||M.isShaderMaterial&&M.lights===!0}this.getActiveCubeFace=function(){return U},this.getActiveMipmapLevel=function(){return P},this.getRenderTarget=function(){return F},this.setRenderTargetTextures=function(M,O,K){const $=m.get(M);$.__autoAllocateDepthBuffer=M.resolveDepthBuffer===!1,$.__autoAllocateDepthBuffer===!1&&($.__useRenderToTexture=!1),m.get(M.texture).__webglTexture=O,m.get(M.depthTexture).__webglTexture=$.__autoAllocateDepthBuffer?void 0:K,$.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(M,O){const K=m.get(M);K.__webglFramebuffer=O,K.__useDefaultFramebuffer=O===void 0};const jh=A.createFramebuffer();this.setRenderTarget=function(M,O=0,K=0){F=M,U=O,P=K;let $=null,G=!1,ye=!1;if(M){const Ae=m.get(M);if(Ae.__useDefaultFramebuffer!==void 0){oe.bindFramebuffer(A.FRAMEBUFFER,Ae.__webglFramebuffer),X.copy(M.viewport),V.copy(M.scissor),Q=M.scissorTest,oe.viewport(X),oe.scissor(V),oe.setScissorTest(Q),j=-1;return}else if(Ae.__webglFramebuffer===void 0)L.setupRenderTarget(M);else if(Ae.__hasExternalTextures)L.rebindTextures(M,m.get(M.texture).__webglTexture,m.get(M.depthTexture).__webglTexture);else if(M.depthBuffer){const He=M.depthTexture;if(Ae.__boundDepthTexture!==He){if(He!==null&&m.has(He)&&(M.width!==He.image.width||M.height!==He.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");L.setupDepthRenderbuffer(M)}}const Ue=M.texture;(Ue.isData3DTexture||Ue.isDataArrayTexture||Ue.isCompressedArrayTexture)&&(ye=!0);const Oe=m.get(M).__webglFramebuffer;M.isWebGLCubeRenderTarget?(Array.isArray(Oe[O])?$=Oe[O][K]:$=Oe[O],G=!0):M.samples>0&&L.useMultisampledRTT(M)===!1?$=m.get(M).__webglMultisampledFramebuffer:Array.isArray(Oe)?$=Oe[K]:$=Oe,X.copy(M.viewport),V.copy(M.scissor),Q=M.scissorTest}else X.copy(H).multiplyScalar(le).floor(),V.copy(te).multiplyScalar(le).floor(),Q=me;if(K!==0&&($=jh),oe.bindFramebuffer(A.FRAMEBUFFER,$)&&oe.drawBuffers(M,$),oe.viewport(X),oe.scissor(V),oe.setScissorTest(Q),G){const Ae=m.get(M.texture);A.framebufferTexture2D(A.FRAMEBUFFER,A.COLOR_ATTACHMENT0,A.TEXTURE_CUBE_MAP_POSITIVE_X+O,Ae.__webglTexture,K)}else if(ye){const Ae=O;for(let Ue=0;Ue<M.textures.length;Ue++){const Oe=m.get(M.textures[Ue]);A.framebufferTextureLayer(A.FRAMEBUFFER,A.COLOR_ATTACHMENT0+Ue,Oe.__webglTexture,K,Ae)}}else if(M!==null&&K!==0){const Ae=m.get(M.texture);A.framebufferTexture2D(A.FRAMEBUFFER,A.COLOR_ATTACHMENT0,A.TEXTURE_2D,Ae.__webglTexture,K)}j=-1},this.readRenderTargetPixels=function(M,O,K,$,G,ye,Le,Ae=0){if(!(M&&M.isWebGLRenderTarget)){Qe("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Ue=m.get(M).__webglFramebuffer;if(M.isWebGLCubeRenderTarget&&Le!==void 0&&(Ue=Ue[Le]),Ue){oe.bindFramebuffer(A.FRAMEBUFFER,Ue);try{const Oe=M.textures[Ae],He=Oe.format,Be=Oe.type;if(!ne.textureFormatReadable(He)){Qe("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!ne.textureTypeReadable(Be)){Qe("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}O>=0&&O<=M.width-$&&K>=0&&K<=M.height-G&&(M.textures.length>1&&A.readBuffer(A.COLOR_ATTACHMENT0+Ae),A.readPixels(O,K,$,G,_e.convert(He),_e.convert(Be),ye))}finally{const Oe=F!==null?m.get(F).__webglFramebuffer:null;oe.bindFramebuffer(A.FRAMEBUFFER,Oe)}}},this.readRenderTargetPixelsAsync=async function(M,O,K,$,G,ye,Le,Ae=0){if(!(M&&M.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Ue=m.get(M).__webglFramebuffer;if(M.isWebGLCubeRenderTarget&&Le!==void 0&&(Ue=Ue[Le]),Ue)if(O>=0&&O<=M.width-$&&K>=0&&K<=M.height-G){oe.bindFramebuffer(A.FRAMEBUFFER,Ue);const Oe=M.textures[Ae],He=Oe.format,Be=Oe.type;if(!ne.textureFormatReadable(He))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!ne.textureTypeReadable(Be))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const Ke=A.createBuffer();A.bindBuffer(A.PIXEL_PACK_BUFFER,Ke),A.bufferData(A.PIXEL_PACK_BUFFER,ye.byteLength,A.STREAM_READ),M.textures.length>1&&A.readBuffer(A.COLOR_ATTACHMENT0+Ae),A.readPixels(O,K,$,G,_e.convert(He),_e.convert(Be),0);const at=F!==null?m.get(F).__webglFramebuffer:null;oe.bindFramebuffer(A.FRAMEBUFFER,at);const mt=A.fenceSync(A.SYNC_GPU_COMMANDS_COMPLETE,0);return A.flush(),await cg(A,mt,4),A.bindBuffer(A.PIXEL_PACK_BUFFER,Ke),A.getBufferSubData(A.PIXEL_PACK_BUFFER,0,ye),A.deleteBuffer(Ke),A.deleteSync(mt),ye}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(M,O=null,K=0){const $=Math.pow(2,-K),G=Math.floor(M.image.width*$),ye=Math.floor(M.image.height*$),Le=O!==null?O.x:0,Ae=O!==null?O.y:0;L.setTexture2D(M,0),A.copyTexSubImage2D(A.TEXTURE_2D,K,0,0,Le,Ae,G,ye),oe.unbindTexture()};const Zh=A.createFramebuffer(),Jh=A.createFramebuffer();this.copyTextureToTexture=function(M,O,K=null,$=null,G=0,ye=null){ye===null&&(G!==0?(os("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),ye=G,G=0):ye=0);let Le,Ae,Ue,Oe,He,Be,Ke,at,mt;const gt=M.isCompressedTexture?M.mipmaps[ye]:M.image;if(K!==null)Le=K.max.x-K.min.x,Ae=K.max.y-K.min.y,Ue=K.isBox3?K.max.z-K.min.z:1,Oe=K.min.x,He=K.min.y,Be=K.isBox3?K.min.z:0;else{const Jt=Math.pow(2,-G);Le=Math.floor(gt.width*Jt),Ae=Math.floor(gt.height*Jt),M.isDataArrayTexture?Ue=gt.depth:M.isData3DTexture?Ue=Math.floor(gt.depth*Jt):Ue=1,Oe=0,He=0,Be=0}$!==null?(Ke=$.x,at=$.y,mt=$.z):(Ke=0,at=0,mt=0);const lt=_e.convert(O.format),ze=_e.convert(O.type);let rt;O.isData3DTexture?(L.setTexture3D(O,0),rt=A.TEXTURE_3D):O.isDataArrayTexture||O.isCompressedArrayTexture?(L.setTexture2DArray(O,0),rt=A.TEXTURE_2D_ARRAY):(L.setTexture2D(O,0),rt=A.TEXTURE_2D),A.pixelStorei(A.UNPACK_FLIP_Y_WEBGL,O.flipY),A.pixelStorei(A.UNPACK_PREMULTIPLY_ALPHA_WEBGL,O.premultiplyAlpha),A.pixelStorei(A.UNPACK_ALIGNMENT,O.unpackAlignment);const Je=A.getParameter(A.UNPACK_ROW_LENGTH),qt=A.getParameter(A.UNPACK_IMAGE_HEIGHT),Wi=A.getParameter(A.UNPACK_SKIP_PIXELS),Yt=A.getParameter(A.UNPACK_SKIP_ROWS),Tr=A.getParameter(A.UNPACK_SKIP_IMAGES);A.pixelStorei(A.UNPACK_ROW_LENGTH,gt.width),A.pixelStorei(A.UNPACK_IMAGE_HEIGHT,gt.height),A.pixelStorei(A.UNPACK_SKIP_PIXELS,Oe),A.pixelStorei(A.UNPACK_SKIP_ROWS,He),A.pixelStorei(A.UNPACK_SKIP_IMAGES,Be);const ft=M.isDataArrayTexture||M.isData3DTexture,Vt=O.isDataArrayTexture||O.isData3DTexture;if(M.isDepthTexture){const Jt=m.get(M),It=m.get(O),Ht=m.get(Jt.__renderTarget),Pa=m.get(It.__renderTarget);oe.bindFramebuffer(A.READ_FRAMEBUFFER,Ht.__webglFramebuffer),oe.bindFramebuffer(A.DRAW_FRAMEBUFFER,Pa.__webglFramebuffer);for(let yi=0;yi<Ue;yi++)ft&&(A.framebufferTextureLayer(A.READ_FRAMEBUFFER,A.COLOR_ATTACHMENT0,m.get(M).__webglTexture,G,Be+yi),A.framebufferTextureLayer(A.DRAW_FRAMEBUFFER,A.COLOR_ATTACHMENT0,m.get(O).__webglTexture,ye,mt+yi)),A.blitFramebuffer(Oe,He,Le,Ae,Ke,at,Le,Ae,A.DEPTH_BUFFER_BIT,A.NEAREST);oe.bindFramebuffer(A.READ_FRAMEBUFFER,null),oe.bindFramebuffer(A.DRAW_FRAMEBUFFER,null)}else if(G!==0||M.isRenderTargetTexture||m.has(M)){const Jt=m.get(M),It=m.get(O);oe.bindFramebuffer(A.READ_FRAMEBUFFER,Zh),oe.bindFramebuffer(A.DRAW_FRAMEBUFFER,Jh);for(let Ht=0;Ht<Ue;Ht++)ft?A.framebufferTextureLayer(A.READ_FRAMEBUFFER,A.COLOR_ATTACHMENT0,Jt.__webglTexture,G,Be+Ht):A.framebufferTexture2D(A.READ_FRAMEBUFFER,A.COLOR_ATTACHMENT0,A.TEXTURE_2D,Jt.__webglTexture,G),Vt?A.framebufferTextureLayer(A.DRAW_FRAMEBUFFER,A.COLOR_ATTACHMENT0,It.__webglTexture,ye,mt+Ht):A.framebufferTexture2D(A.DRAW_FRAMEBUFFER,A.COLOR_ATTACHMENT0,A.TEXTURE_2D,It.__webglTexture,ye),G!==0?A.blitFramebuffer(Oe,He,Le,Ae,Ke,at,Le,Ae,A.COLOR_BUFFER_BIT,A.NEAREST):Vt?A.copyTexSubImage3D(rt,ye,Ke,at,mt+Ht,Oe,He,Le,Ae):A.copyTexSubImage2D(rt,ye,Ke,at,Oe,He,Le,Ae);oe.bindFramebuffer(A.READ_FRAMEBUFFER,null),oe.bindFramebuffer(A.DRAW_FRAMEBUFFER,null)}else Vt?M.isDataTexture||M.isData3DTexture?A.texSubImage3D(rt,ye,Ke,at,mt,Le,Ae,Ue,lt,ze,gt.data):O.isCompressedArrayTexture?A.compressedTexSubImage3D(rt,ye,Ke,at,mt,Le,Ae,Ue,lt,gt.data):A.texSubImage3D(rt,ye,Ke,at,mt,Le,Ae,Ue,lt,ze,gt):M.isDataTexture?A.texSubImage2D(A.TEXTURE_2D,ye,Ke,at,Le,Ae,lt,ze,gt.data):M.isCompressedTexture?A.compressedTexSubImage2D(A.TEXTURE_2D,ye,Ke,at,gt.width,gt.height,lt,gt.data):A.texSubImage2D(A.TEXTURE_2D,ye,Ke,at,Le,Ae,lt,ze,gt);A.pixelStorei(A.UNPACK_ROW_LENGTH,Je),A.pixelStorei(A.UNPACK_IMAGE_HEIGHT,qt),A.pixelStorei(A.UNPACK_SKIP_PIXELS,Wi),A.pixelStorei(A.UNPACK_SKIP_ROWS,Yt),A.pixelStorei(A.UNPACK_SKIP_IMAGES,Tr),ye===0&&O.generateMipmaps&&A.generateMipmap(rt),oe.unbindTexture()},this.initRenderTarget=function(M){m.get(M).__webglFramebuffer===void 0&&L.setupRenderTarget(M)},this.initTexture=function(M){M.isCubeTexture?L.setTextureCube(M,0):M.isData3DTexture?L.setTexture3D(M,0):M.isDataArrayTexture||M.isCompressedArrayTexture?L.setTexture2DArray(M,0):L.setTexture2D(M,0),oe.unbindTexture()},this.resetState=function(){U=0,P=0,F=null,oe.reset(),De.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return An}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=Ze._getDrawingBufferColorSpace(e),t.unpackColorSpace=Ze._getUnpackColorSpace()}}const Yr=window.innerWidth<768,Ft={particleCount:Yr?18e3:35e3,particleSize:Yr?1.6:1.2,textScale:Yr?.14:.22,canvasFont:'900 100px "Microsoft YaHei", sans-serif'},XS=["快乐","悲伤","喜悦","愤怒","平静","恐惧","爱","焦虑","感恩","羞愧","希望","嫉妒","自豪","孤独","兴奋","内疚","幽默","厌恶"];function $r(n,e=null){const t=e!==null?e:Ft.textScale,i=document.createElement("canvas"),r=i.getContext("2d");i.width=1024,i.height=256,r.fillStyle="black",r.fillRect(0,0,i.width,i.height),r.fillStyle="white",r.font=Ft.canvasFont,r.textAlign="center",r.textBaseline="middle",r.fillText(n,i.width/2,i.height/2);const s=r.getImageData(0,0,i.width,i.height),a=[],o=Yr?4:2;for(let l=0;l<i.height;l+=o)for(let u=0;u<i.width;u+=o)s.data[(l*i.width+u)*4]>100&&a.push({x:(u-i.width/2)*t,y:-(l-i.height/2)*t,z:0});return a}function qS(){return XS.map(n=>$r(n))}function YS(n){const e=[],t=Math.floor(n*.6),i=Math.floor(n*.3),r=n-t-i,s=140,a=35,o=40,l=-60,u=l+a/2;for(let p=0;p<t;p++)e.push({x:(Math.random()-.5)*s,y:l+(Math.random()-.5)*a,z:(Math.random()-.5)*o,type:"box",noise:Math.random()});const c=5,f=8,h=20;for(let p=0;p<i;p++){const v=(Math.floor(Math.random()*c)-(c-1)/2)*25,g=Math.random()*Math.PI*2,d=Math.sqrt(Math.random())*f,y=Math.random()*h;e.push({x:v+Math.cos(g)*d,y:u+y,z:Math.sin(g)*d,type:"tube",noise:Math.random()})}for(let p=0;p<r;p++){const v=(Math.floor(Math.random()*c)-(c-1)/2)*25,g=u+h,d=Math.random()*Math.PI*2,y=Math.sqrt(Math.random())*(f*.8);e.push({x:v+Math.cos(d)*y,y:g,z:Math.sin(d)*y,type:"spark",noise:Math.random()})}return e}function $S(n){const e=[];for(let t=0;t<n;t++){const i=(Math.random()-.5)*220;let r=Math.sqrt(Math.pow(i,2))*.5+3;Math.abs(i)>100&&(r=60*Math.random());const s=Math.random()*Math.PI*2;Math.random()>.85&&(r*=Math.random()),e.push({x:r*Math.cos(s),y:i,z:r*Math.sin(s)})}return e}function Yu(n,e){return $r(n,Yr?.08:.12).map(r=>({x:r.x,y:r.y+e,z:r.z}))}function KS(n){const e=[];for(let t=0;t<n;t++){const i=t<n/2,r=i?-50:50;let s="glass",a=(Math.random()-.5)*110,o=28,l=Math.random()*Math.PI*2;Math.random()>.35&&a<35&&a>-50&&(s="liquid",o=Math.random()*26,a>30&&(s="foam"));let u=o*Math.cos(l),c=o*Math.sin(l),f=a;s==="glass"&&a>-15&&a<35&&Math.abs(l-(i?Math.PI:0))<.6&&(u+=i?-18:18,s="handle"),e.push({x:u+r,y:f,z:c,type:s,isLeft:i,baseX:u+r})}return e}function jS(n){const e=[];for(let t=0;t<n;t++){const i=(Math.random()-.5)*200;let r=0;i>60?r=20*(100-i)/40:i>-80?r=20:r=20+(-80-i)*1.5;const s=Math.random()*Math.PI*2;i<60&&i>-80&&Math.random()>.4&&(r*=Math.random()),e.push({x:r*Math.cos(s),y:i,z:r*Math.sin(s)})}return e}function ZS(n){const e=[],i=n-1600,r=[{r:1,g:0,b:0},{r:1,g:.5,b:0},{r:1,g:1,b:0},{r:0,g:1,b:0},{r:0,g:1,b:1},{r:0,g:0,b:1},{r:.5,g:0,b:1}];for(let s=0;s<i;s++){const o=(Math.random()-.5)*800,l=-6e-4*o*o+40,u=(Math.random()-.5)*80,c=(Math.random()-.5)*15,f=l+c;let h="bridge-body",p=o<0?"left":"right";const _=Math.floor((u+40)/80*7),v=Math.max(0,Math.min(6,_)),g=r[v];e.push({x:o,y:f,z:u,type:h,side:p,color:g,baseY:f,baseX:o})}for(let s=0;s<1600;s++){const a=s<800?0:1,o=Math.random();let l=0,u=0,c=0;if(o>.85){const f=Math.random()*6.28,h=Math.random()*5;l=Math.cos(f)*h,u=28+Math.sin(f)*h}else o>.45?(l=(Math.random()-.5)*8,u=10+Math.random()*18,c=(Math.random()-.5)*6):(l=(Math.random()-.5)*10,u=Math.random()*12);e.push({x:0,y:0,z:0,type:"man",manIndex:a,relX:l,relY:u,relZ:c})}return e}const wa=(n,e)=>{const t=n.__vccOpts||n;for(const[i,r]of e)t[i]=r;return t},Fr=3e3,JS={__name:"ParticleScene",props:{currentShape:String,triggerState:Number,currentTheme:String},emits:["firework-tick"],setup(n,{emit:e}){const t=n,i=e,r=tn(null);let s,a,o,l,u,c=[],f,h=0,p=[],_=[],v=[],g=[],d=0,y=[],w=[],b=0,C=[],D=[],R=[],z=[],x=[],E=[],U=0,P=!1;const F=async()=>{s=new Ug,s.fog=new lc(0,.002),a=new sn(75,window.innerWidth/window.innerHeight,.1,1e3),a.position.z=140,o=new WS({antialias:!0,alpha:!0}),o.setSize(window.innerWidth,window.innerHeight),o.setPixelRatio(Math.min(window.devicePixelRatio,2)),r.value&&r.value.appendChild(o.domElement),j(),V()},j=()=>{u=new xn;const se=Ft.particleCount,re=new Float32Array(se*3),he=new Float32Array(se*3);c=new Float32Array(se*3);for(let ge=0;ge<se;ge++)re[ge*3]=(Math.random()-.5)*800,re[ge*3+1]=(Math.random()-.5)*800,re[ge*3+2]=(Math.random()-.5)*800,he[ge*3]=1,he[ge*3+1]=1,he[ge*3+2]=1;u.setAttribute("position",new ln(re,3)),u.setAttribute("color",new ln(he,3));const we=new Yg().load("https://threejs.org/examples/textures/sprites/spark1.png"),le=new Oh({size:Ft.particleSize,map:we,transparent:!0,opacity:.9,vertexColors:!0,blending:Fo,depthWrite:!1});l=new zg(u,le),s.add(l),Z()},Z=()=>{h=0,b=0,d=0;let se=[];const re=Ft.particleCount;if(t.currentShape==="fireworks")x.length===0&&(x=YS(Fr)),E.length===0&&(E=qS()),P=!1,U=0,i("firework-tick",{idx:0,total:18,time:0}),se=x;else if(t.currentShape==="hourglass"){if(p.length===0){p=$S(re*.6),_=Yu("2025",60),v=Yu("今年辛苦啦",-60);const we=re-p.length;g=new Float32Array(we);for(let le=0;le<we;le++)g[le]=Math.random()*6}se=p}else t.currentShape==="beer"?(y.length===0&&(y=KS(re*.9),w=$r("2025 有你相伴")),se=y):t.currentShape==="rocket"?(C.length===0&&(C=jS(re),D=$r("2026新年快乐")),se=C):t.currentShape==="bridge"&&(R.length===0&&(R=ZS(re*.9),z=$r("2026 与你同行")),se=R);const he=u.attributes.position.array;for(let we=0;we<re;we++){const le=we*3;we<se.length?(c[le]=se[we].x,c[le+1]=se[we].y,c[le+2]=se[we].z,t.currentShape==="fireworks"&&(he[le]=se[we].x,he[le+1]=se[we].y,he[le+2]=se[we].z)):t.currentShape==="fireworks"?(c[le]=0,c[le+1]=-3e3,c[le+2]=0,he[le]=0,he[le+1]=-3e3,he[le+2]=0):(c[le]=(Math.random()-.5)*1e3,c[le+1]=(Math.random()-.5)*1e3,c[le+2]=-500)}u.attributes.position.needsUpdate=!0,X()},X=()=>{if(!u)return;const se=u.attributes.color;for(let re=0;re<Ft.particleCount;re++){let he=1,we=1,le=1;t.currentTheme==="warm"?(he=1,we=.8,le=.4):(he=.2,we=.8,le=1),t.currentShape==="beer"&&re<y.length&&y[re].type==="liquid"&&(he=1,we=.6,le=0),se.setXYZ(re,he,we,le)}se.needsUpdate=!0};dr(()=>t.triggerState,se=>{t.currentShape==="hourglass"&&se===0&&(d=0)});const V=()=>{f=requestAnimationFrame(V);const se=u.attributes.position.array,re=u.attributes.color.array;if(h+=.01,t.currentShape==="fireworks"){for(let le=0;le<Fr;le++){const ge=le*3;if(le<x.length){const Ne=x[le];let H=Ne.x,te=Ne.y,me=Ne.z,Ie=1,ve=1,Ve=1;if(Ne.type==="box")H+=(Math.random()-.5)*.5,te+=(Math.random()-.5)*.5,Ie=.6,ve=.4,Ve=.2;else if(Ne.type==="tube")H+=(Math.random()-.5)*.5,Ie=.8,ve=.6,Ve=.1;else if(Ne.type==="spark"){const T=h*8+Ne.noise*50,I=Math.sin(T);if(I>.85){const B=(I-.85)/.15;te+=B*20,Ie=1,ve=1,Ve=.8}else Ie=1,ve=.3,Ve=0;H+=(Math.random()-.5)*1.5}c[ge]=H,c[ge+1]=te,c[ge+2]=me,re[ge]=Ie,re[ge+1]=ve,re[ge+2]=Ve}}if(t.triggerState>=1){P||(P=!0,U=Date.now());const ge=(Date.now()-U)/1e3,Ne=5,H=18,te=Math.floor(ge/Ne),me=ge%Ne;if(te<H){i("firework-tick",{idx:te+1,total:H,time:(Ne-me).toFixed(1)});const Ie=E[te%18],ve=te<9;for(let Ve=Fr;Ve<Ft.particleCount;Ve++){const T=Ve*3,I=Ve-Fr;if(me<1.5){const B=me/1.5,ee=B*20+I*.05,q=5*Math.sin(B*Math.PI),ie=-80+B*250;c[T]=Math.cos(ee)*q,c[T+1]=ie-I%50*.5,c[T+2]=Math.sin(ee)*q,re[T]=1,re[T+1]=.9,re[T+2]=.6}else if(me<2){if(me<1.6){const B=Math.acos(-1+2*Math.random()),ee=Math.sqrt(Ft.particleCount*Math.PI)*B,q=100+Math.random()*50;c[T]=q*Math.sin(B)*Math.cos(ee),c[T+1]=100+q*Math.sin(B)*Math.sin(ee),c[T+2]=q*Math.cos(B),re[T]=Math.random(),re[T+1]=Math.random(),re[T+2]=1}}else if(me<2.5)c[T+1]-=2,c[T]*=.98,c[T+2]*=.98;else if(me<4.5)if(I<Ie.length){const B=Ie[I];c[T]+=(B.x-c[T])*.1,c[T+1]+=(B.y+50-c[T+1])*.1,c[T+2]+=(B.z-c[T+2])*.1,ve?(re[T]=1,re[T+1]=.4,re[T+2]=.2):(re[T]=.2,re[T+1]=.2,re[T+2]=.9)}else c[T+1]-=5,re[T]*=.9;else c[T]*=1.05,c[T+1]+=2,re[T]*=.8}u.attributes.color.needsUpdate=!0}else i("firework-tick",{idx:18,total:18,time:0})}else{P=!1;for(let le=Fr;le<Ft.particleCount;le++){const ge=le*3;c[ge]=0,c[ge+1]=-3e3,c[ge+2]=0,se[ge]=0,se[ge+1]=-3e3,se[ge+2]=0}}}else if(t.currentShape==="hourglass"){t.triggerState===1?d+=.01:d=0;const ge=d;for(let Ne=0;Ne<Ft.particleCount;Ne++){const H=Ne*3;if(Ne<p.length){const te=c[H],me=c[H+2],Ie=Math.atan2(me,te)+.003,ve=Math.sqrt(te*te+me*me);c[H]=ve*Math.cos(Ie),c[H+2]=ve*Math.sin(Ie)}else{const te=Ne-p.length,me=_[te%_.length],Ie=v[te%v.length],ve=g[te%g.length];if(t.triggerState===0||ge<ve)me&&(c[H]=me.x,c[H+1]=me.y,c[H+2]=me.z);else{const Ve=(ge-ve)/1.5;if(Ve<1){if(Ve<.5){const T=Ve*2;c[H]=me.x*(1-T),c[H+1]=me.y*(1-T),c[H+2]=me.z*(1-T)}else{const T=(Ve-.5)*2;c[H]=Ie.x*T,c[H+1]=Ie.y*T,c[H+2]=Ie.z*T}c[H]+=(Math.random()-.5)*2,c[H+2]+=(Math.random()-.5)*2}else Ie&&(c[H]=Ie.x,c[H+1]=Ie.y,c[H+2]=Ie.z)}}}}else if(t.currentShape==="beer"){t.triggerState>=1&&b++;for(let le=0;le<Ft.particleCount;le++){const ge=le*3;if(le<y.length){const Ne=y[le];let H=Ne.x;if(t.triggerState>=1){const te=Math.min(25,b*.5);H+=Ne.isLeft?te:-te}c[ge]=H,c[ge+1]=Ne.y}else if(b>60&&w.length>0){const Ne=le-y.length,H=w[Ne%w.length];c[ge]+=(H.x-c[ge])*.05,c[ge+1]+=(H.y-60-c[ge+1])*.05,c[ge+2]+=(H.z-c[ge+2])*.05}else c[ge]=0,c[ge+1]=-800}}else if(t.currentShape==="rocket"){if(t.triggerState===1)for(let le=0;le<Ft.particleCount;le++)c[le*3+1]+=8;else if(t.triggerState===2)for(let le=0;le<Ft.particleCount;le++){const ge=le*3;if(le<D.length){const Ne=D[le];c[ge]=Ne.x,c[ge+1]=Ne.y,c[ge+2]=Ne.z}else c[ge]*=1.1}}else if(t.currentShape==="bridge"&&t.triggerState>=1)for(let le=0;le<Ft.particleCount;le++){const ge=le*3;if(le<R.length){const Ne=R[le];if(Ne.isBrokenPart&&(c[ge+1]+=(Ne.targetY-c[ge+1])*.04),Ne.type==="man"){let H,te=h*120%220;Ne.manIndex===0?H=-220+te:H=220-te,c[ge]=H,c[ge+1]=-5e-4*H*H+30}}else{const Ne=le-R.length;if(z.length>0){const H=z[Ne%z.length];c[ge]=H.x,c[ge+1]=H.y-40,c[ge+2]=H.z}}}const he=.15,we=0;for(let le=we;le<Ft.particleCount;le++){const ge=le*3;se[ge]+=(c[ge]-se[ge])*he,se[ge+1]+=(c[ge+1]-se[ge+1])*he,se[ge+2]+=(c[ge+2]-se[ge+2])*he}u.attributes.position.needsUpdate=!0,o.render(s,a)};dr(()=>t.currentShape,Z),dr(()=>t.currentTheme,X),Yl(()=>{F(),window.addEventListener("resize",Q)}),xa(()=>{cancelAnimationFrame(f),window.removeEventListener("resize",Q)});const Q=()=>{a&&o&&(a.aspect=window.innerWidth/window.innerHeight,a.updateProjectionMatrix(),o.setSize(window.innerWidth,window.innerHeight))};return(se,re)=>(gn(),Cn("div",{ref_key:"canvasContainer",ref:r,class:"canvas-wrapper"},null,512))}},QS=wa(JS,[["__scopeId","data-v-ce2f8b12"]]),eM={id:"ui-container"},tM={class:"panel-card"},nM={class:"year-group"},iM={class:"year-item"},rM={key:0,class:"hint-wrap"},sM={class:"sub-hint"},aM={class:"year-item"},oM={key:0,class:"hint-wrap"},lM={class:"sub-hint"},cM={__name:"ControlPanel",props:{currentYear:String,sceneIndex:Number},emits:["select-year"],setup(n){const e=n,t=Zl(()=>{if(e.currentYear==="2025"){if(e.sceneIndex===0)return"✊握拳: 重置流沙";if(e.sceneIndex===1)return"✌️剪刀手: 18连发烟花";if(e.sceneIndex===2)return"✊握拳: 干杯碰撞"}else{if(e.sceneIndex===0)return"🖐️上滑: 发射火箭";if(e.sceneIndex===1)return"✊握拳: 断桥重连"}return"互动就绪"});return(i,r)=>(gn(),Cn("div",eM,[pt("div",tM,[pt("div",nM,[pt("div",iM,[pt("button",{class:_r(["year-btn y25",{active:n.currentYear==="2025"}]),onClick:r[0]||(r[0]=s=>i.$emit("select-year","2025"))}," 2025 ",2),n.currentYear==="2025"?(gn(),Cn("div",rM,[r[2]||(r[2]=pt("div",{class:"main-hint"},"👋 左 → 右 切页",-1)),pt("div",sM,ur(t.value),1)])):ts("",!0)]),r[4]||(r[4]=pt("div",{class:"divider"},null,-1)),pt("div",aM,[pt("button",{class:_r(["year-btn y26",{active:n.currentYear==="2026"}]),onClick:r[1]||(r[1]=s=>i.$emit("select-year","2026"))}," 2026 ",2),n.currentYear==="2026"?(gn(),Cn("div",oM,[r[3]||(r[3]=pt("div",{class:"main-hint"},"👋 右 ← 左 切页",-1)),pt("div",lM,ur(t.value),1)])):ts("",!0)])])])]))}},uM=wa(cM,[["__scopeId","data-v-a36f4ce9"]]);function $u(n){return new Promise((e,t)=>{if(document.querySelector(`script[src="${n}"]`)){e();return}const i=document.createElement("script");i.src=n,i.async=!0,i.crossOrigin="anonymous",i.onload=()=>e(),i.onerror=()=>t(new Error(`Script load error: ${n}`)),document.head.appendChild(i)})}const fM={class:"camera-wrapper"},hM=3,dM={__name:"CameraInput",props:{isActive:Boolean},emits:["status-change","camera-error","gesture","hand-x","hand-y","lock-swipe"],setup(n,{expose:e,emit:t}){const i=n,r=t,s=tn(null),a=tn(null);let o=null,l=null,u=-1,c="NONE",f=0;const h=async()=>{try{r("status-change","启动视觉引擎..."),await Promise.all([$u("https://cdn.jsdelivr.net/npm/@mediapipe/hands/hands.js"),$u("https://cdn.jsdelivr.net/npm/@mediapipe/drawing_utils/drawing_utils.js")]);const d=window.Hands;o=new d({locateFile:w=>`https://cdn.jsdelivr.net/npm/@mediapipe/hands/${w}`}),o.setOptions({maxNumHands:1,modelComplexity:0,minDetectionConfidence:.5,minTrackingConfidence:.5}),o.onResults(g);let y;try{y=await navigator.mediaDevices.getUserMedia({video:{facingMode:"user",width:{ideal:640},height:{ideal:480}}})}catch(w){console.warn("方案A失败，尝试方案B...",w);try{y=await navigator.mediaDevices.getUserMedia({video:{facingMode:"user"}})}catch(b){console.warn("方案B失败，尝试方案C...",b);try{y=await navigator.mediaDevices.getUserMedia({video:!0})}catch(C){throw C}}}p(y)}catch(d){console.error("Camera Init Error:",d);let y="无法开启摄像头";d.name==="NotAllowedError"&&(y="请允许访问摄像头"),r("camera-error",y)}},p=d=>{s.value&&(s.value.srcObject=d,s.value.onloadedmetadata=()=>{s.value.play().catch(y=>console.error("Auto-play failed:",y)),a.value.width=s.value.videoWidth,a.value.height=s.value.videoHeight,r("status-change","Ready"),_()})},_=async()=>{i.isActive&&(s.value&&s.value.readyState>=2&&s.value.currentTime!==u&&(u=s.value.currentTime,o&&await o.send({image:s.value})),l=requestAnimationFrame(_))},v=(d,y)=>Math.sqrt(Math.pow(d.x-y.x,2)+Math.pow(d.y-y.y,2)),g=d=>{if(!a.value)return;const y=a.value.getContext("2d"),w=a.value.width,b=a.value.height;y.save(),y.clearRect(0,0,w,b),y.translate(w,0),y.scale(-1,1),y.drawImage(d.image,0,0,w,b);let C="NONE",D=-1;if(d.multiHandLandmarks&&d.multiHandLandmarks.length>0){const R=d.multiHandLandmarks[0];window.drawConnectors&&(window.drawConnectors(y,R,window.HAND_CONNECTIONS,{color:"#00d2ff",lineWidth:2}),window.drawLandmarks(y,R,{color:"#ff0000",lineWidth:1,radius:2})),D=R[0].x,r("hand-x",D),r("hand-y",R[0].y);const z=R[0],x=(Z,X)=>v(z,R[Z])>v(z,R[X])*1.1,E=(Z,X)=>v(z,R[Z])<v(z,R[X]),U=x(8,6),P=x(12,10),F=E(16,14),j=E(20,18);U&&P&&F&&j?C="VICTORY":!U&&!P&&F&&j?C="FIST":U&&P&&!F&&!j&&(C="PALM")}C===c?(f++,f>hM&&(r("gesture",C),r("lock-swipe",C==="VICTORY"||C==="FIST"))):(f=0,c=C,(C==="NONE"||C==="PALM")&&r("lock-swipe",!1)),y.restore()};return e({startCamera:h}),xa(()=>{s.value?.srcObject&&s.value.srcObject.getTracks().forEach(d=>d.stop()),cancelAnimationFrame(l),o&&o.close()}),(d,y)=>(gn(),Cn("div",fM,[pt("video",{ref_key:"inputVideo",ref:s,playsinline:"","webkit-playsinline":"",muted:"",style:{display:"none"}},null,512),Xd(pt("canvas",{ref_key:"previewCanvas",ref:a,class:"video-preview"},null,512),[[cm,n.isActive]])]))}},pM=wa(dM,[["__scopeId","data-v-2133c7e0"]]),mM={key:0,id:"overlay"},gM={__name:"IntroOverlay",props:{visible:Boolean,showGuide:Boolean},emits:["select-mode"],setup(n){return(e,t)=>(gn(),Cn(rn,null,[n.visible?(gn(),Cn("div",mM,[t[2]||(t[2]=pt("h2",{class:"title"},"Lynx",-1)),t[3]||(t[3]=pt("div",{class:"msg-box"},"请选择交互方式",-1)),pt("button",{id:"btn-cam",class:"action-btn",onClick:t[0]||(t[0]=i=>e.$emit("select-mode","camera"))},"开启摄像头"),pt("button",{id:"btn-touch",class:"action-btn",onClick:t[1]||(t[1]=i=>e.$emit("select-mode","touch"))},"触屏 / 鼠标模式")])):ts("",!0),pt("div",{id:"touch-guide",class:_r({show:n.showGuide})},"⟵ 滑动屏幕控制扩散 ⟶",2)],64))}},_M=wa(gM,[["__scopeId","data-v-da6579d6"]]),xM={class:"app-container"},vM={key:0,class:"firework-hud"},SM={class:"hud-row"},MM={class:"hud-row"},EM={key:0,class:"status-tip"},yM={__name:"App",setup(n){const e=tn("2025"),t=tn(0),i=tn("warm"),r=tn(1),s=tn(""),a=tn(!0),o=tn(null),l=tn(!1);let u=null;const c=tn({idx:0,total:18,time:0}),f={2025:["hourglass","fireworks","beer"],2026:["rocket","bridge"]},h=Zl(()=>f[e.value][t.value]);let p=-1,_=-1,v=!1;const g=P=>{a.value=!1,P==="camera"&&o.value.startCamera()},d=()=>{u&&(clearTimeout(u),u=null),r.value=0,v=!1,l.value=!1,s.value="",c.value={idx:0,total:18,time:0}},y=P=>{e.value!==P&&(d(),e.value=P,t.value=0,i.value=P==="2025"?"warm":"cyber",P==="2025"&&(r.value=1))},w=P=>{h.value==="fireworks"&&r.value===1&&(c.value=P)},b=P=>{const F=h.value==="fireworks"&&r.value===1;if(v&&!F||l.value){p=P;return}if(p===-1){p=P;return}const j=P-p;p=P;const Z=.04;(e.value==="2025"&&j>Z||e.value==="2026"&&j<-Z)&&C()},C=()=>{d();const P=f[e.value].length;t.value=(t.value+1)%P,h.value==="hourglass"&&(r.value=1),s.value="切换场景...",v=!0,setTimeout(()=>{v=!1,s.value=""},1e3)},D=P=>{if(v||r.value!==0)return;if(_===-1){_=P;return}const F=P-_;_=P,F<-.05&&h.value==="rocket"&&E(2e3)};let R=0;const z=P=>{if(!(v&&h.value!=="hourglass"))if(h.value==="hourglass"&&P==="FIST")R++,R>3&&(R=0,x());else if(h.value==="fireworks"&&P==="VICTORY"&&r.value===0)R++,R>3&&(R=0,E(0));else if((h.value==="beer"||h.value==="bridge")&&P==="FIST"&&r.value===0){if(R++,R>6){R=0;const F=h.value==="beer"?5e3:2e3;E(F)}}else R>0&&R--},x=()=>{s.value!=="时光倒流..."&&(v=!0,r.value=0,s.value="时光倒流...",u&&clearTimeout(u),u=setTimeout(()=>{r.value=1,s.value="沙漏启动",v=!1,setTimeout(()=>{s.value==="沙漏启动"&&(s.value="")},1e3)},1500))},E=P=>{v=!0,r.value=1,s.value="特效触发!",u&&clearTimeout(u),h.value==="fireworks"?u=setTimeout(()=>{r.value===1&&(v=!1,r.value=0,s.value="演示结束",setTimeout(()=>{s.value==="演示结束"&&(s.value="")},2e3))},92e3):h.value==="bridge"?u=setTimeout(()=>{r.value===1&&(r.value=2,setTimeout(()=>{r.value===2&&(r.value=0,v=!1,s.value="")},2e3))},15e3):P>0&&(u=setTimeout(()=>{r.value===1&&(r.value=2,setTimeout(()=>{r.value===2&&(r.value=0,v=!1,s.value="")},3e3))},P))},U=P=>{s.value=P};return(P,F)=>(gn(),Cn("div",xM,[bt(QS,{currentShape:h.value,currentTheme:i.value,triggerState:r.value,onFireworkTick:w},null,8,["currentShape","currentTheme","triggerState"]),bt(im,{name:"fade"},{default:Af(()=>[e.value==="2025"&&t.value===1&&r.value>=1?(gn(),Cn("div",vM,[pt("div",SM,[F[2]||(F[2]=pt("span",{class:"label"},"发射进度:",-1)),Io(" "+ur(c.value.idx)+" / 18",1)]),pt("div",MM,[F[3]||(F[3]=pt("span",{class:"label"},"下轮倒计时:",-1)),Io(" "+ur(c.value.time)+"s",1)])])):ts("",!0)]),_:1}),bt(pM,{ref_key:"cameraInputRef",ref:o,isActive:"",onStatusChange:F[0]||(F[0]=j=>s.value=j),onCameraError:U,onHandX:b,onHandY:D,onGesture:z,onLockSwipe:F[1]||(F[1]=j=>l.value=j)},null,512),bt(uM,{currentYear:e.value,sceneIndex:t.value,onSelectYear:y},null,8,["currentYear","sceneIndex"]),bt(_M,{visible:a.value,onSelectMode:g},null,8,["visible"]),s.value?(gn(),Cn("div",EM,ur(s.value),1)):ts("",!0)]))}};Am(yM).mount("#app");
