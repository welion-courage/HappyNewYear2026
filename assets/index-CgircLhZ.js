...
`)}const cv={[Lf]:"Linear",[If]:"Reinhard",[Uf]:"Cineon",[Nf]:"ACESFilmic",[Of]:"AgX",[Bf]:"Neutral",[Ff]:"Custom"};function uv(n,e){const t=cv[e];return t===void 0?(Ve("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+n+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+n+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Ds=new X;function fv(){je.getLuminanceCoefficients(Ds);const n=Ds.x.toFixed(4),e=Ds.y.toFixed(4),t=Ds.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${n}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
`)+`
`+d);const A=T+g+a,y=T+d+o,w=hu(r,r.VERTEX_SHADER,A),R=hu(r,r.FRAGMENT_SHADER,y);r.attachShader(x,w),r.attachShader(x,R),t.index0AttributeName!==void 0?r.bindAttribLocation(x,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(x,0,"position"),r.linkProgram(x);function D(N){if(n.debug.checkShaderErrors){const Z=r.getProgramInfoLog(x)||"",W=r.getShaderInfoLog(w)||"",K=r.getShaderInfoLog(R)||"",Y=Z.trim(),U=W.trim(),L=K.trim();let O=!0,te=!0;if(r.getProgramParameter(x,r.LINK_STATUS)===!1)if(O=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(r,x,w,R);else{const he=pu(r,w,"vertex"),pe=pu(r,R,"fragment");Je("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(x,r.VALIDATE_STATUS)+`
...
}`,Xv=[new X(1,0,0),new X(-1,0,0),new X(0,1,0),new X(0,-1,0),new X(0,0,1),new X(0,0,-1)],qv=[new X(0,-1,0),new X(0,-1,0),new X(0,0,1),new X(0,0,-1),new X(0,-1,0),new X(0,-1,0)],Eu=new _t,Rr=new X,ro=new X;function Yv(n,e,t){let i=new sh;const r=new ot,s=new ot,a=new gt,o=new sg,l=new ag,c={},u=t.maxTextureSize,f={[mi]:Gt,[Gt]:mi,[Vn]:Vn},h=new Cn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new ot},radius:{value:4}},vertexShader:kv,fragmentShader:Wv}),p=h.clone();p.defines.HORIZONTAL_PASS=1;const _=new dn;_.setAttribute("position",new rn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const x=new Jn(_,h),g=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Ns;let d=this.type;this.render=function(R,D,z){if(g.enabled===!1||g.autoUpdate===!1&&g.needsUpdate===!1||R.length===0)return;R.type===$p&&(Ve("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),R.type=Ns);const M=n.getRenderTarget(),E=n.getActiveCubeFace(),N=n.getActiveMipmapLevel(),Z=n.state;Z.setBlending(kn),Z.buffers.depth.getReversed()===!0?Z.buffers.color.setClear(0,0,0,0):Z.buffers.color.setClear(1,1,1,1),Z.buffers.depth.setTest(!0),Z.setScissorTest(!1);const W=d!==this.type;W&&D.traverse(function(K){K.material&&(Array.isArray(K.material)?K.material.forEach(Y=>Y.needsUpdate=!0):K.material.needsUpdate=!0)});for(let K=0,Y=R.length;K<Y;K++){const U=R[K],L=U.shadow;if(L===void 0){Ve("WebGLShadowMap:",U,"has no shadow.");continue}if(L.autoUpdate===!1&&L.needsUpdate===!1)continue;r.copy(L.mapSize);const O=L.getFrameExtents();if(r.multiply(O),s.copy(L.mapSize),(r.x>u||r.y>u)&&(r.x>u&&(s.x=Math.floor(u/O.x),r.x=s.x*O.x,L.mapSize.x=s.x),r.y>u&&(s.y=Math.floor(u/O.y),r.y=s.y*O.y,L.mapSize.y=s.y)),L.map===null||W===!0){if(L.map!==null&&(L.map.depthTexture!==null&&(L.map.depthTexture.dispose(),L.map.depthTexture=null),L.map.dispose()),this.type===Pr){if(U.isPointLight){Ve("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}L.map=new An(r.x,r.y,{format:dr,type:Kn,minFilter:Rt,magFilter:Rt,generateMipmaps:!1}),L.map.texture.name=U.name+".shadowMap",L.map.depthTexture=new jr(r.x,r.y,Mn),L.map.depthTexture.name=U.name+".shadowMapDepth",L.map.depthTexture.format=jn,L.map.depthTexture.compareFunction=null,L.map.depthTexture.minFilter=bt,L.map.depthTexture.magFilter=bt}else{U.isPointLight?(L.map=new rh(r.x),L.map.depthTexture=new ig(r.x,Rn)):(L.map=new An(r.x,r.y),L.map.depthTexture=new jr(r.x,r.y,Rn)),L.map.depthTexture.name=U.name+".shadowMap",L.map.depthTexture.format=jn;const he=n.state.buffers.depth.getReversed();this.type===Ns?(L.map.depthTexture.compareFunction=he?Gl:Hl,L.map.depthTexture.minFilter=Rt,L.map.depthTexture.magFilter=Rt):(L.map.depthTexture.compareFunction=null,L.map.depthTexture.minFilter=bt,L.map.depthTexture.magFilter=bt)}L.camera.updateProjectionMatrix()}const te=L.map.isWebGLCubeRenderTarget?6:1;for(let he=0;he<te;he++){if(L.map.isWebGLCubeRenderTarget)n.setRenderTarget(L.map,he),n.clear();else{he===0&&(n.setRenderTarget(L.map),n.clear());const pe=L.getViewport(he);a.set(s.x*pe.x,s.y*pe.y,s.x*pe.z,s.y*pe.w),Z.viewport(a)}if(U.isPointLight){const pe=L.camera,De=L.matrix,Le=U.distance||pe.far;Le!==pe.far&&(pe.far=Le,pe.updateProjectionMatrix()),Rr.setFromMatrixPosition(U.matrixWorld),pe.position.copy(Rr),ro.copy(pe.position),ro.add(Xv[he]),pe.up.copy(qv[he]),pe.lookAt(ro),pe.updateMatrixWorld(),De.makeTranslation(-Rr.x,-Rr.y,-Rr.z),Eu.multiplyMatrices(pe.projectionMatrix,pe.matrixWorldInverse),L._frustum.setFromProjectionMatrix(Eu,pe.coordinateSystem,pe.reversedDepth)}else L.updateMatrices(U);i=L.getFrustum(),y(D,z,L.camera,U,this.type)}L.isPointLightShadow!==!0&&this.type===Pr&&T(L,z),L.needsUpdate=!1}d=this.type,g.needsUpdate=!1,n.setRenderTarget(M,E,N)};function T(R,D){const z=e.update(x);h.defines.VSM_SAMPLES!==R.blurSamples&&(h.defines.VSM_SAMPLES=R.blurSamples,p.defines.VSM_SAMPLES=R.blurSamples,h.needsUpdate=!0,p.needsUpdate=!0),R.mapPass===null&&(R.mapPass=new An(r.x,r.y,{format:dr,type:Kn})),h.uniforms.shadow_pass.value=R.map.depthTexture,h.uniforms.resolution.value=R.mapSize,h.uniforms.radius.value=R.radius,n.setRenderTarget(R.mapPass),n.clear(),n.renderBufferDirect(D,null,z,h,x,null),p.uniforms.shadow_pass.value=R.mapPass.texture,p.uniforms.resolution.value=R.mapSize,p.uniforms.radius.value=R.radius,n.setRenderTarget(R.map),n.clear(),n.renderBufferDirect(D,null,z,p,x,null)}function A(R,D,z,M){let E=null;const N=z.isPointLight===!0?R.customDistanceMaterial:R.customDepthMaterial;if(N!==void 0)E=N;else if(E=z.isPointLight===!0?l:o,n.localClippingEnabled&&D.clipShadows===!0&&Array.isArray(D.clippingPlanes)&&D.clippingPlanes.length!==0||D.displacementMap&&D.displacementScale!==0||D.alphaMap&&D.alphaTest>0||D.map&&D.alphaTest>0||D.alphaToCoverage===!0){const Z=E.uuid,W=D.uuid;let K=c[Z];K===void 0&&(K={},c[Z]=K);let Y=K[W];Y===void 0&&(Y=E.clone(),K[W]=Y,D.addEventListener("dispose",w)),E=Y}if(E.visible=D.visible,E.wireframe=D.wireframe,M===Pr?E.side=D.shadowSide!==null?D.shadowSide:D.side:E.side=D.shadowSide!==null?D.shadowSide:f[D.side],E.alphaMap=D.alphaMap,E.alphaTest=D.alphaToCoverage===!0?.5:D.alphaTest,E.map=D.map,E.clipShadows=D.clipShadows,E.clippingPlanes=D.clippingPlanes,E.clipIntersection=D.clipIntersection,E.displacementMap=D.displacementMap,E.displacementScale=D.displacementScale,E.displacementBias=D.displacementBias,E.wireframeLinewidth=D.wireframeLinewidth,E.linewidth=D.linewidth,z.isPointLight===!0&&E.isMeshDistanceMaterial===!0){const Z=n.properties.get(E);Z.light=z}return E}function y(R,D,z,M,E){if(R.visible===!1)return;if(R.layers.test(D.layers)&&(R.isMesh||R.isLine||R.isPoints)&&(R.castShadow||R.receiveShadow&&E===Pr)&&(!R.frustumCulled||i.intersectsObject(R))){R.modelViewMatrix.multiplyMatrices(z.matrixWorldInverse,R.matrixWorld);const W=e.update(R),K=R.material;if(Array.isArray(K)){const Y=W.groups;for(let U=0,L=Y.length;U<L;U++){const O=Y[U],te=K[O.materialIndex];if(te&&te.visible){const he=A(R,te,M,E);R.onBeforeShadow(n,R,D,z,W,he,O),n.renderBufferDirect(z,null,W,he,R,O),R.onAfterShadow(n,R,D,z,W,he,O)}}}else if(K.visible){const Y=A(R,K,M,E);R.onBeforeShadow(n,R,D,z,W,Y,null),n.renderBufferDirect(z,null,W,Y,R,null),R.onAfterShadow(n,R,D,z,W,Y,null)}}const Z=R.children;for(let W=0,K=Z.length;W<K;W++)y(Z[W],D,z,M,E)}function w(R){R.target.removeEventListener("dispose",w);for(const z in c){const M=c[z],E=R.target.uuid;E in M&&(M[E].dispose(),delete M[E])}}}const $v={[So]:Mo,[Eo]:To,[yo]:Ao,[fr]:bo,[Mo]:So,[To]:Eo,[Ao]:yo,[bo]:fr};function Kv(n,e){function t(){let F=!1;const ye=new gt;let de=null;const Ae=new gt(0,0,0,0);return{setMask:function(fe){de!==fe&&!F&&(n.colorMask(fe,fe,fe,fe),de=fe)},setLocked:function(fe){F=fe},setClear:function(fe,ae,_e,ze,ut){ut===!0&&(fe*=ze,ae*=ze,_e*=ze),ye.set(fe,ae,_e,ze),Ae.equals(ye)===!1&&(n.clearColor(fe,ae,_e,ze),Ae.copy(ye))},reset:function(){F=!1,de=null,Ae.set(-1,0,0,0)}}}function i(){let F=!1,ye=!1,de=null,Ae=null,fe=null;return{setReversed:function(ae){if(ye!==ae){const _e=e.get("EXT_clip_control");ae?_e.clipControlEXT(_e.LOWER_LEFT_EXT,_e.ZERO_TO_ONE_EXT):_e.clipControlEXT(_e.LOWER_LEFT_EXT,_e.NEGATIVE_ONE_TO_ONE_EXT),ye=ae;const ze=fe;fe=null,this.setClear(ze)}},getReversed:function(){return ye},setTest:function(ae){ae?oe(n.DEPTH_TEST):we(n.DEPTH_TEST)},setMask:function(ae){de!==ae&&!F&&(n.depthMask(ae),de=ae)},setFunc:function(ae){if(ye&&(ae=$v[ae]),Ae!==ae){switch(ae){case So:n.depthFunc(n.NEVER);break;case Mo:n.depthFunc(n.ALWAYS);break;case Eo:n.depthFunc(n.LESS);break;case fr:n.depthFunc(n.LEQUAL);break;case yo:n.depthFunc(n.EQUAL);break;case bo:n.depthFunc(n.GEQUAL);break;case To:n.depthFunc(n.GREATER);break;case Ao:n.depthFunc(n.NOTEQUAL);break;default:n.depthFunc(n.LEQUAL)}Ae=ae}},setLocked:function(ae){F=ae},setClear:function(ae){fe!==ae&&(ye&&(ae=1-ae),n.clearDepth(ae),fe=ae)},reset:function(){F=!1,de=null,Ae=null,fe=null,ye=!1}}}function r(){let F=!1,ye=null,de=null,Ae=null,fe=null,ae=null,_e=null,ze=null,ut=null;return{setTest:function(it){F||(it?oe(n.STENCIL_TEST):we(n.STENCIL_TEST))},setMask:function(it){ye!==it&&!F&&(n.stencilMask(it),ye=it)},setFunc:function(it,pn,Pn){(de!==it||Ae!==pn||fe!==Pn)&&(n.stencilFunc(it,pn,Pn),de=it,Ae=pn,fe=Pn)},setOp:function(it,pn,Pn){(ae!==it||_e!==pn||ze!==Pn)&&(n.stencilOp(it,pn,Pn),ae=it,_e=pn,ze=Pn)},setLocked:function(it){F=it},setClear:function(it){ut!==it&&(n.clearStencil(it),ut=it)},reset:function(){F=!1,ye=null,de=null,Ae=null,fe=null,ae=null,_e=null,ze=null,ut=null}}}const s=new t,a=new i,o=new r,l=new WeakMap,c=new WeakMap;let u={},f={},h=new WeakMap,p=[],_=null,x=!1,g=null,d=null,T=null,A=null,y=null,w=null,R=null,D=new tt(0,0,0),z=0,M=!1,E=null,N=null,Z=null,W=null,K=null;const Y=n.getParameter(n.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let U=!1,L=0;const O=n.getParameter(n.VERSION);O.indexOf("WebGL")!==-1?(L=parseFloat(/^WebGL (\d)/.exec(O)[1]),U=L>=1):O.indexOf("OpenGL ES")!==-1&&(L=parseFloat(/^OpenGL ES (\d)/.exec(O)[1]),U=L>=2);let te=null,he={};const pe=n.getParameter(n.SCISSOR_BOX),De=n.getParameter(n.VIEWPORT),Le=new gt().fromArray(pe),qe=new gt().fromArray(De);function nt(F,ye,de,Ae){const fe=new Uint8Array(4),ae=n.createTexture();n.bindTexture(F,ae),n.texParameteri(F,n.TEXTURE_MIN_FILTER,n.NEAREST),n.texParameteri(F,n.TEXTURE_MAG_FILTER,n.NEAREST);for(let _e=0;_e<de;_e++)F===n.TEXTURE_3D||F===n.TEXTURE_2D_ARRAY?n.texImage3D(ye,0,n.RGBA,1,1,Ae,0,n.RGBA,n.UNSIGNED_BYTE,fe):n.texImage2D(ye+_e,0,n.RGBA,1,1,0,n.RGBA,n.UNSIGNED_BYTE,fe);return ae}const ne={};ne[n.TEXTURE_2D]=nt(n.TEXTURE_2D,n.TEXTURE_2D,1),ne[n.TEXTURE_CUBE_MAP]=nt(n.TEXTURE_CUBE_MAP,n.TEXTURE_CUBE_MAP_POSITIVE_X,6),ne[n.TEXTURE_2D_ARRAY]=nt(n.TEXTURE_2D_ARRAY,n.TEXTURE_2D_ARRAY,1,1),ne[n.TEXTURE_3D]=nt(n.TEXTURE_3D,n.TEXTURE_3D,1,1),s.setClear(0,0,0,1),a.setClear(1),o.setClear(0),oe(n.DEPTH_TEST),a.setFunc(fr),j(!1),ie(wc),oe(n.CULL_FACE),G(kn);function oe(F){u[F]!==!0&&(n.enable(F),u[F]=!0)}function we(F){u[F]!==!1&&(n.disable(F),u[F]=!1)}function Be(F,ye){return f[F]!==ye?(n.bindFramebuffer(F,ye),f[F]=ye,F===n.DRAW_FRAMEBUFFER&&(f[n.FRAMEBUFFER]=ye),F===n.FRAMEBUFFER&&(f[n.DRAW_FRAMEBUFFER]=ye),!0):!1}function Re(F,ye){let de=p,Ae=!1;if(F){de=h.get(ye),de===void 0&&(de=[],h.set(ye,de));const fe=F.textures;if(de.length!==fe.length||de[0]!==n.COLOR_ATTACHMENT0){for(let ae=0,_e=fe.length;ae<_e;ae++)de[ae]=n.COLOR_ATTACHMENT0+ae;de.length=fe.length,Ae=!0}}else de[0]!==n.BACK&&(de[0]=n.BACK,Ae=!0);Ae&&n.drawBuffers(de)}function Ke(F){return _!==F?(n.useProgram(F),_=F,!0):!1}const C={[Ci]:n.FUNC_ADD,[jp]:n.FUNC_SUBTRACT,[Zp]:n.FUNC_REVERSE_SUBTRACT};C[Jp]=n.MIN,C[Qp]=n.MAX;const I={[em]:n.ZERO,[tm]:n.ONE,[nm]:n.SRC_COLOR,[xo]:n.SRC_ALPHA,[lm]:n.SRC_ALPHA_SATURATE,[am]:n.DST_COLOR,[rm]:n.DST_ALPHA,[im]:n.ONE_MINUS_SRC_COLOR,[vo]:n.ONE_MINUS_SRC_ALPHA,[om]:n.ONE_MINUS_DST_COLOR,[sm]:n.ONE_MINUS_DST_ALPHA,[cm]:n.CONSTANT_COLOR,[um]:n.ONE_MINUS_CONSTANT_COLOR,[fm]:n.CONSTANT_ALPHA,[hm]:n.ONE_MINUS_CONSTANT_ALPHA};function G(F,ye,de,Ae,fe,ae,_e,ze,ut,it){if(F===kn){x===!0&&(we(n.BLEND),x=!1);return}if(x===!1&&(oe(n.BLEND),x=!0),F!==Kp){if(F!==g||it!==M){if((d!==Ci||y!==Ci)&&(n.blendEquation(n.FUNC_ADD),d=Ci,y=Ci),it)switch(F){case or:n.blendFuncSeparate(n.ONE,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case _o:n.blendFunc(n.ONE,n.ONE);break;case Rc:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case Cc:n.blendFuncSeparate(n.DST_COLOR,n.ONE_MINUS_SRC_ALPHA,n.ZERO,n.ONE);break;default:Je("WebGLState: Invalid blending: ",F);break}else switch(F){case or:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case _o:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE,n.ONE,n.ONE);break;case Rc:Je("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Cc:Je("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Je("WebGLState: Invalid blending: ",F);break}T=null,A=null,w=null,R=null,D.set(0,0,0),z=0,g=F,M=it}return}fe=fe||ye,ae=ae||de,_e=_e||Ae,(ye!==d||fe!==y)&&(n.blendEquationSeparate(C[ye],C[fe]),d=ye,y=fe),(de!==T||Ae!==A||ae!==w||_e!==R)&&(n.blendFuncSeparate(I[de],I[Ae],I[ae],I[_e]),T=de,A=Ae,w=ae,R=_e),(ze.equals(D)===!1||ut!==z)&&(n.blendColor(ze.r,ze.g,ze.b,ut),D.copy(ze),z=ut),g=F,M=!1}function ee(F,ye){F.side===Vn?we(n.CULL_FACE):oe(n.CULL_FACE);let de=F.side===Gt;ye&&(de=!de),j(de),F.blending===or&&F.transparent===!1?G(kn):G(F.blending,F.blendEquation,F.blendSrc,F.blendDst,F.blendEquationAlpha,F.blendSrcAlpha,F.blendDstAlpha,F.blendColor,F.blendAlpha,F.premultipliedAlpha),a.setFunc(F.depthFunc),a.setTest(F.depthTest),a.setMask(F.depthWrite),s.setMask(F.colorWrite);const Ae=F.stencilWrite;o.setTest(Ae),Ae&&(o.setMask(F.stencilWriteMask),o.setFunc(F.stencilFunc,F.stencilRef,F.stencilFuncMask),o.setOp(F.stencilFail,F.stencilZFail,F.stencilZPass)),le(F.polygonOffset,F.polygonOffsetFactor,F.polygonOffsetUnits),F.alphaToCoverage===!0?oe(n.SAMPLE_ALPHA_TO_COVERAGE):we(n.SAMPLE_ALPHA_TO_COVERAGE)}function j(F){E!==F&&(F?n.frontFace(n.CW):n.frontFace(n.CCW),E=F)}function ie(F){F!==qp?(oe(n.CULL_FACE),F!==N&&(F===wc?n.cullFace(n.BACK):F===Yp?n.cullFace(n.FRONT):n.cullFace(n.FRONT_AND_BACK))):we(n.CULL_FACE),N=F}function b(F){F!==Z&&(U&&n.lineWidth(F),Z=F)}function le(F,ye,de){F?(oe(n.POLYGON_OFFSET_FILL),(W!==ye||K!==de)&&(n.polygonOffset(ye,de),W=ye,K=de)):we(n.POLYGON_OFFSET_FILL)}function re(F){F?oe(n.SCISSOR_TEST):we(n.SCISSOR_TEST)}function Q(F){F===void 0&&(F=n.TEXTURE0+Y-1),te!==F&&(n.activeTexture(F),te=F)}function se(F,ye,de){de===void 0&&(te===null?de=n.TEXTURE0+Y-1:de=te);let Ae=he[de];Ae===void 0&&(Ae={type:void 0,texture:void 0},he[de]=Ae),(Ae.type!==F||Ae.texture!==ye)&&(te!==de&&(n.activeTexture(de),te=de),n.bindTexture(F,ye||ne[F]),Ae.type=F,Ae.texture=ye)}function v(){const F=he[te];F!==void 0&&F.type!==void 0&&(n.bindTexture(F.type,null),F.type=void 0,F.texture=void 0)}function m(){try{n.compressedTexImage2D(...arguments)}catch(F){Je("WebGLState:",F)}}function P(){try{n.compressedTexImage3D(...arguments)}catch(F){Je("WebGLState:",F)}}function k(){try{n.texSubImage2D(...arguments)}catch(F){Je("WebGLState:",F)}}function J(){try{n.texSubImage3D(...arguments)}catch(F){Je("WebGLState:",F)}}function H(){try{n.compressedTexSubImage2D(...arguments)}catch(F){Je("WebGLState:",F)}}function Me(){try{n.compressedTexSubImage3D(...arguments)}catch(F){Je("WebGLState:",F)}}function ue(){try{n.texStorage2D(...arguments)}catch(F){Je("WebGLState:",F)}}function be(){try{n.texStorage3D(...arguments)}catch(F){Je("WebGLState:",F)}}function Ie(){try{n.texImage2D(...arguments)}catch(F){Je("WebGLState:",F)}}function ce(){try{n.texImage3D(...arguments)}catch(F){Je("WebGLState:",F)}}function ge(F){Le.equals(F)===!1&&(n.scissor(F.x,F.y,F.z,F.w),Le.copy(F))}function xe(F){qe.equals(F)===!1&&(n.viewport(F.x,F.y,F.z,F.w),qe.copy(F))}function Te(F,ye){let de=c.get(ye);de===void 0&&(de=new WeakMap,c.set(ye,de));let Ae=de.get(F);Ae===void 0&&(Ae=n.getUniformBlockIndex(ye,F.name),de.set(F,Ae))}function me(F,ye){const Ae=c.get(ye).get(F);l.get(ye)!==Ae&&(n.uniformBlockBinding(ye,Ae,F.__bindingPointIndex),l.set(ye,Ae))}function He(){n.disable(n.BLEND),n.disable(n.CULL_FACE),n.disable(n.DEPTH_TEST),n.disable(n.POLYGON_OFFSET_FILL),n.disable(n.SCISSOR_TEST),n.disable(n.STENCIL_TEST),n.disable(n.SAMPLE_ALPHA_TO_COVERAGE),n.blendEquation(n.FUNC_ADD),n.blendFunc(n.ONE,n.ZERO),n.blendFuncSeparate(n.ONE,n.ZERO,n.ONE,n.ZERO),n.blendColor(0,0,0,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(n.LESS),a.setReversed(!1),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(n.ALWAYS,0,4294967295),n.stencilOp(n.KEEP,n.KEEP,n.KEEP),n.clearStencil(0),n.cullFace(n.BACK),n.frontFace(n.CCW),n.polygonOffset(0,0),n.activeTexture(n.TEXTURE0),n.bindFramebuffer(n.FRAMEBUFFER,null),n.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),n.bindFramebuffer(n.READ_FRAMEBUFFER,null),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),u={},te=null,he={},f={},h=new WeakMap,p=[],_=null,x=!1,g=null,d=null,T=null,A=null,y=null,w=null,R=null,D=new tt(0,0,0),z=0,M=!1,E=null,N=null,Z=null,W=null,K=null,Le.set(0,0,n.canvas.width,n.canvas.height),qe.set(0,0,n.canvas.width,n.canvas.height),s.reset(),a.reset(),o.reset()}return{buffers:{color:s,depth:a,stencil:o},enable:oe,disable:we,bindFramebuffer:Be,drawBuffers:Re,useProgram:Ke,setBlending:G,setMaterial:ee,setFlipSided:j,setCullFace:ie,setLineWidth:b,setPolygonOffset:le,setScissorTest:re,activeTexture:Q,bindTexture:se,unbindTexture:v,compressedTexImage2D:m,compressedTexImage3D:P,texImage2D:Ie,texImage3D:ce,updateUBOMapping:Te,uniformBlockBinding:me,texStorage2D:ue,texStorage3D:be,texSubImage2D:k,texSubImage3D:J,compressedTexSubImage2D:H,compressedTexSubImage3D:Me,scissor:ge,viewport:xe,reset:He}}function jv(n,e,t,i,r,s,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new ot,u=new WeakMap;let f;const h=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function _(v,m){return p?new OffscreenCanvas(v,m):$r("canvas")}function x(v,m,P){let k=1;const J=se(v);if((J.width>P||J.height>P)&&(k=P/Math.max(J.width,J.height)),k<1)if(typeof HTMLImageElement<"u"&&v instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&v instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&v instanceof ImageBitmap||typeof VideoFrame<"u"&&v instanceof VideoFrame){const H=Math.floor(k*J.width),Me=Math.floor(k*J.height);f===void 0&&(f=_(H,Me));const ue=m?_(H,Me):f;return ue.width=H,ue.height=Me,ue.getContext("2d").drawImage(v,0,0,H,Me),Ve("WebGLRenderer: Texture has been resized from ("+J.width+"x"+J.height+") to ("+H+"x"+Me+")."),ue}else return"data"in v&&Ve("WebGLRenderer: Image in DataTexture is too big ("+J.width+"x"+J.height+")."),v;return v}function g(v){return v.generateMipmaps}function d(v){n.generateMipmap(v)}function T(v){return v.isWebGLCubeRenderTarget?n.TEXTURE_CUBE_MAP:v.isWebGL3DRenderTarget?n.TEXTURE_3D:v.isWebGLArrayRenderTarget||v.isCompressedArrayTexture?n.TEXTURE_2D_ARRAY:n.TEXTURE_2D}function A(v,m,P,k,J=!1){if(v!==null){if(n[v]!==void 0)return n[v];Ve("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+v+"'")}let H=m;if(m===n.RED&&(P===n.FLOAT&&(H=n.R32F),P===n.HALF_FLOAT&&(H=n.R16F),P===n.UNSIGNED_BYTE&&(H=n.R8)),m===n.RED_INTEGER&&(P===n.UNSIGNED_BYTE&&(H=n.R8UI),P===n.UNSIGNED_SHORT&&(H=n.R16UI),P===n.UNSIGNED_INT&&(H=n.R32UI),P===n.BYTE&&(H=n.R8I),P===n.SHORT&&(H=n.R16I),P===n.INT&&(H=n.R32I)),m===n.RG&&(P===n.FLOAT&&(H=n.RG32F),P===n.HALF_FLOAT&&(H=n.RG16F),P===n.UNSIGNED_BYTE&&(H=n.RG8)),m===n.RG_INTEGER&&(P===n.UNSIGNED_BYTE&&(H=n.RG8UI),P===n.UNSIGNED_SHORT&&(H=n.RG16UI),P===n.UNSIGNED_INT&&(H=n.RG32UI),P===n.BYTE&&(H=n.RG8I),P===n.SHORT&&(H=n.RG16I),P===n.INT&&(H=n.RG32I)),m===n.RGB_INTEGER&&(P===n.UNSIGNED_BYTE&&(H=n.RGB8UI),P===n.UNSIGNED_SHORT&&(H=n.RGB16UI),P===n.UNSIGNED_INT&&(H=n.RGB32UI),P===n.BYTE&&(H=n.RGB8I),P===n.SHORT&&(H=n.RGB16I),P===n.INT&&(H=n.RGB32I)),m===n.RGBA_INTEGER&&(P===n.UNSIGNED_BYTE&&(H=n.RGBA8UI),P===n.UNSIGNED_SHORT&&(H=n.RGBA16UI),P===n.UNSIGNED_INT&&(H=n.RGBA32UI),P===n.BYTE&&(H=n.RGBA8I),P===n.SHORT&&(H=n.RGBA16I),P===n.INT&&(H=n.RGBA32I)),m===n.RGB&&(P===n.UNSIGNED_INT_5_9_9_9_REV&&(H=n.RGB9_E5),P===n.UNSIGNED_INT_10F_11F_11F_REV&&(H=n.R11F_G11F_B10F)),m===n.RGBA){const Me=J?js:je.getTransfer(k);P===n.FLOAT&&(H=n.RGBA32F),P===n.HALF_FLOAT&&(H=n.RGBA16F),P===n.UNSIGNED_BYTE&&(H=Me===st?n.SRGB8_ALPHA8:n.RGBA8),P===n.UNSIGNED_SHORT_4_4_4_4&&(H=n.RGBA4),P===n.UNSIGNED_SHORT_5_5_5_1&&(H=n.RGB5_A1)}return(H===n.R16F||H===n.R32F||H===n.RG16F||H===n.RG32F||H===n.RGBA16F||H===n.RGBA32F)&&e.get("EXT_color_buffer_float"),H}function y(v,m){let P;return v?m===null||m===Rn||m===Yr?P=n.DEPTH24_STENCIL8:m===Mn?P=n.DEPTH32F_STENCIL8:m===qr&&(P=n.DEPTH24_STENCIL8,Ve("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):m===null||m===Rn||m===Yr?P=n.DEPTH_COMPONENT24:m===Mn?P=n.DEPTH_COMPONENT32F:m===qr&&(P=n.DEPTH_COMPONENT16),P}function w(v,m){return g(v)===!0||v.isFramebufferTexture&&v.minFilter!==bt&&v.minFilter!==Rt?Math.log2(Math.max(m.width,m.height))+1:v.mipmaps!==void 0&&v.mipmaps.length>0?v.mipmaps.length:v.isCompressedTexture&&Array.isArray(v.image)?m.mipmaps.length:1}function R(v){const m=v.target;m.removeEventListener("dispose",R),z(m),m.isVideoTexture&&u.delete(m)}function D(v){const m=v.target;m.removeEventListener("dispose",D),E(m)}function z(v){const m=i.get(v);if(m.__webglInit===void 0)return;const P=v.source,k=h.get(P);if(k){const J=k[m.__cacheKey];J.usedTimes--,J.usedTimes===0&&M(v),Object.keys(k).length===0&&h.delete(P)}i.remove(v)}function M(v){const m=i.get(v);n.deleteTexture(m.__webglTexture);const P=v.source,k=h.get(P);delete k[m.__cacheKey],a.memory.textures--}function E(v){const m=i.get(v);if(v.depthTexture&&(v.depthTexture.dispose(),i.remove(v.depthTexture)),v.isWebGLCubeRenderTarget)for(let k=0;k<6;k++){if(Array.isArray(m.__webglFramebuffer[k]))for(let J=0;J<m.__webglFramebuffer[k].length;J++)n.deleteFramebuffer(m.__webglFramebuffer[k][J]);else n.deleteFramebuffer(m.__webglFramebuffer[k]);m.__webglDepthbuffer&&n.deleteRenderbuffer(m.__webglDepthbuffer[k])}else{if(Array.isArray(m.__webglFramebuffer))for(let k=0;k<m.__webglFramebuffer.length;k++)n.deleteFramebuffer(m.__webglFramebuffer[k]);else n.deleteFramebuffer(m.__webglFramebuffer);if(m.__webglDepthbuffer&&n.deleteRenderbuffer(m.__webglDepthbuffer),m.__webglMultisampledFramebuffer&&n.deleteFramebuffer(m.__webglMultisampledFramebuffer),m.__webglColorRenderbuffer)for(let k=0;k<m.__webglColorRenderbuffer.length;k++)m.__webglColorRenderbuffer[k]&&n.deleteRenderbuffer(m.__webglColorRenderbuffer[k]);m.__webglDepthRenderbuffer&&n.deleteRenderbuffer(m.__webglDepthRenderbuffer)}const P=v.textures;for(let k=0,J=P.length;k<J;k++){const H=i.get(P[k]);H.__webglTexture&&(n.deleteTexture(H.__webglTexture),a.memory.textures--),i.remove(P[k])}i.remove(v)}let N=0;function Z(){N=0}function W(){const v=N;return v>=r.maxTextures&&Ve("WebGLTextures: Trying to use "+v+" texture units while this GPU supports only "+r.maxTextures),N+=1,v}function K(v){const m=[];return m.push(v.wrapS),m.push(v.wrapT),m.push(v.wrapR||0),m.push(v.magFilter),m.push(v.minFilter),m.push(v.anisotropy),m.push(v.internalFormat),m.push(v.format),m.push(v.type),m.push(v.generateMipmaps),m.push(v.premultiplyAlpha),m.push(v.flipY),m.push(v.unpackAlignment),m.push(v.colorSpace),m.join()}function Y(v,m){const P=i.get(v);if(v.isVideoTexture&&re(v),v.isRenderTargetTexture===!1&&v.isExternalTexture!==!0&&v.version>0&&P.__version!==v.version){const k=v.image;if(k===null)Ve("WebGLRenderer: Texture marked for update but no image data found.");else if(k.complete===!1)Ve("WebGLRenderer: Texture marked for update but image is incomplete");else{ne(P,v,m);return}}else v.isExternalTexture&&(P.__webglTexture=v.sourceTexture?v.sourceTexture:null);t.bindTexture(n.TEXTURE_2D,P.__webglTexture,n.TEXTURE0+m)}function U(v,m){const P=i.get(v);if(v.isRenderTargetTexture===!1&&v.version>0&&P.__version!==v.version){ne(P,v,m);return}else v.isExternalTexture&&(P.__webglTexture=v.sourceTexture?v.sourceTexture:null);t.bindTexture(n.TEXTURE_2D_ARRAY,P.__webglTexture,n.TEXTURE0+m)}function L(v,m){const P=i.get(v);if(v.isRenderTargetTexture===!1&&v.version>0&&P.__version!==v.version){ne(P,v,m);return}t.bindTexture(n.TEXTURE_3D,P.__webglTexture,n.TEXTURE0+m)}function O(v,m){const P=i.get(v);if(v.isCubeDepthTexture!==!0&&v.version>0&&P.__version!==v.version){oe(P,v,m);return}t.bindTexture(n.TEXTURE_CUBE_MAP,P.__webglTexture,n.TEXTURE0+m)}const te={[Co]:n.REPEAT,[Hn]:n.CLAMP_TO_EDGE,[Po]:n.MIRRORED_REPEAT},he={[bt]:n.NEAREST,[mm]:n.NEAREST_MIPMAP_NEAREST,[cs]:n.NEAREST_MIPMAP_LINEAR,[Rt]:n.LINEAR,[wa]:n.LINEAR_MIPMAP_NEAREST,[Di]:n.LINEAR_MIPMAP_LINEAR},pe={[vm]:n.NEVER,[bm]:n.ALWAYS,[Sm]:n.LESS,[Hl]:n.LEQUAL,[Mm]:n.EQUAL,[Gl]:n.GEQUAL,[Em]:n.GREATER,[ym]:n.NOTEQUAL};function De(v,m){if(m.type===Mn&&e.has("OES_texture_float_linear")===!1&&(m.magFilter===Rt||m.magFilter===wa||m.magFilter===cs||m.magFilter===Di||m.minFilter===Rt||m.minFilter===wa||m.minFilter===cs||m.minFilter===Di)&&Ve("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),n.texParameteri(v,n.TEXTURE_WRAP_S,te[m.wrapS]),n.texParameteri(v,n.TEXTURE_WRAP_T,te[m.wrapT]),(v===n.TEXTURE_3D||v===n.TEXTURE_2D_ARRAY)&&n.texParameteri(v,n.TEXTURE_WRAP_R,te[m.wrapR]),n.texParameteri(v,n.TEXTURE_MAG_FILTER,he[m.magFilter]),n.texParameteri(v,n.TEXTURE_MIN_FILTER,he[m.minFilter]),m.compareFunction&&(n.texParameteri(v,n.TEXTURE_COMPARE_MODE,n.COMPARE_REF_TO_TEXTURE),n.texParameteri(v,n.TEXTURE_COMPARE_FUNC,pe[m.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(m.magFilter===bt||m.minFilter!==cs&&m.minFilter!==Di||m.type===Mn&&e.has("OES_texture_float_linear")===!1)return;if(m.anisotropy>1||i.get(m).__currentAnisotropy){const P=e.get("EXT_texture_filter_anisotropic");n.texParameterf(v,P.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(m.anisotropy,r.getMaxAnisotropy())),i.get(m).__currentAnisotropy=m.anisotropy}}}function Le(v,m){let P=!1;v.__webglInit===void 0&&(v.__webglInit=!0,m.addEventListener("dispose",R));const k=m.source;let J=h.get(k);J===void 0&&(J={},h.set(k,J));const H=K(m);if(H!==v.__cacheKey){J[H]===void 0&&(J[H]={texture:n.createTexture(),usedTimes:0},a.memory.textures++,P=!0),J[H].usedTimes++;const Me=J[v.__cacheKey];Me!==void 0&&(J[v.__cacheKey].usedTimes--,Me.usedTimes===0&&M(m)),v.__cacheKey=H,v.__webglTexture=J[H].texture}return P}function qe(v,m,P){return Math.floor(Math.floor(v/P)/m)}function nt(v,m,P,k){const H=v.updateRanges;if(H.length===0)t.texSubImage2D(n.TEXTURE_2D,0,0,0,m.width,m.height,P,k,m.data);else{H.sort((ce,ge)=>ce.start-ge.start);let Me=0;for(let ce=1;ce<H.length;ce++){const ge=H[Me],xe=H[ce],Te=ge.start+ge.count,me=qe(xe.start,m.width,4),He=qe(ge.start,m.width,4);xe.start<=Te+1&&me===He&&qe(xe.start+xe.count-1,m.width,4)===me?ge.count=Math.max(ge.count,xe.start+xe.count-ge.start):(++Me,H[Me]=xe)}H.length=Me+1;const ue=n.getParameter(n.UNPACK_ROW_LENGTH),be=n.getParameter(n.UNPACK_SKIP_PIXELS),Ie=n.getParameter(n.UNPACK_SKIP_ROWS);n.pixelStorei(n.UNPACK_ROW_LENGTH,m.width);for(let ce=0,ge=H.length;ce<ge;ce++){const xe=H[ce],Te=Math.floor(xe.start/4),me=Math.ceil(xe.count/4),He=Te%m.width,F=Math.floor(Te/m.width),ye=me,de=1;n.pixelStorei(n.UNPACK_SKIP_PIXELS,He),n.pixelStorei(n.UNPACK_SKIP_ROWS,F),t.texSubImage2D(n.TEXTURE_2D,0,He,F,ye,de,P,k,m.data)}v.clearUpdateRanges(),n.pixelStorei(n.UNPACK_ROW_LENGTH,ue),n.pixelStorei(n.UNPACK_SKIP_PIXELS,be),n.pixelStorei(n.UNPACK_SKIP_ROWS,Ie)}}function ne(v,m,P){let k=n.TEXTURE_2D;(m.isDataArrayTexture||m.isCompressedArrayTexture)&&(k=n.TEXTURE_2D_ARRAY),m.isData3DTexture&&(k=n.TEXTURE_3D);const J=Le(v,m),H=m.source;t.bindTexture(k,v.__webglTexture,n.TEXTURE0+P);const Me=i.get(H);if(H.version!==Me.__version||J===!0){t.activeTexture(n.TEXTURE0+P);const ue=je.getPrimaries(je.workingColorSpace),be=m.colorSpace===ci?null:je.getPrimaries(m.colorSpace),Ie=m.colorSpace===ci||ue===be?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,m.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,m.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,m.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ie);let ce=x(m.image,!1,r.maxTextureSize);ce=Q(m,ce);const ge=s.convert(m.format,m.colorSpace),xe=s.convert(m.type);let Te=A(m.internalFormat,ge,xe,m.colorSpace,m.isVideoTexture);De(k,m);let me;const He=m.mipmaps,F=m.isVideoTexture!==!0,ye=Me.__version===void 0||J===!0,de=H.dataReady,Ae=w(m,ce);if(m.isDepthTexture)Te=y(m.format===Li,m.type),ye&&(F?t.texStorage2D(n.TEXTURE_2D,1,Te,ce.width,ce.height):t.texImage2D(n.TEXTURE_2D,0,Te,ce.width,ce.height,0,ge,xe,null));else if(m.isDataTexture)if(He.length>0){F&&ye&&t.texStorage2D(n.TEXTURE_2D,Ae,Te,He[0].width,He[0].height);for(let fe=0,ae=He.length;fe<ae;fe++)me=He[fe],F?de&&t.texSubImage2D(n.TEXTURE_2D,fe,0,0,me.width,me.height,ge,xe,me.data):t.texImage2D(n.TEXTURE_2D,fe,Te,me.width,me.height,0,ge,xe,me.data);m.generateMipmaps=!1}else F?(ye&&t.texStorage2D(n.TEXTURE_2D,Ae,Te,ce.width,ce.height),de&&nt(m,ce,ge,xe)):t.texImage2D(n.TEXTURE_2D,0,Te,ce.width,ce.height,0,ge,xe,ce.data);else if(m.isCompressedTexture)if(m.isCompressedArrayTexture){F&&ye&&t.texStorage3D(n.TEXTURE_2D_ARRAY,Ae,Te,He[0].width,He[0].height,ce.depth);for(let fe=0,ae=He.length;fe<ae;fe++)if(me=He[fe],m.format!==un)if(ge!==null)if(F){if(de)if(m.layerUpdates.size>0){const _e=Qc(me.width,me.height,m.format,m.type);for(const ze of m.layerUpdates){const ut=me.data.subarray(ze*_e/me.data.BYTES_PER_ELEMENT,(ze+1)*_e/me.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,fe,0,0,ze,me.width,me.height,1,ge,ut)}m.clearLayerUpdates()}else t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,fe,0,0,0,me.width,me.height,ce.depth,ge,me.data)}else t.compressedTexImage3D(n.TEXTURE_2D_ARRAY,fe,Te,me.width,me.height,ce.depth,0,me.data,0,0);else Ve("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else F?de&&t.texSubImage3D(n.TEXTURE_2D_ARRAY,fe,0,0,0,me.width,me.height,ce.depth,ge,xe,me.data):t.texImage3D(n.TEXTURE_2D_ARRAY,fe,Te,me.width,me.height,ce.depth,0,ge,xe,me.data)}else{F&&ye&&t.texStorage2D(n.TEXTURE_2D,Ae,Te,He[0].width,He[0].height);for(let fe=0,ae=He.length;fe<ae;fe++)me=He[fe],m.format!==un?ge!==null?F?de&&t.compressedTexSubImage2D(n.TEXTURE_2D,fe,0,0,me.width,me.height,ge,me.data):t.compressedTexImage2D(n.TEXTURE_2D,fe,Te,me.width,me.height,0,me.data):Ve("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):F?de&&t.texSubImage2D(n.TEXTURE_2D,fe,0,0,me.width,me.height,ge,xe,me.data):t.texImage2D(n.TEXTURE_2D,fe,Te,me.width,me.height,0,ge,xe,me.data)}else if(m.isDataArrayTexture)if(F){if(ye&&t.texStorage3D(n.TEXTURE_2D_ARRAY,Ae,Te,ce.width,ce.height,ce.depth),de)if(m.layerUpdates.size>0){const fe=Qc(ce.width,ce.height,m.format,m.type);for(const ae of m.layerUpdates){const _e=ce.data.subarray(ae*fe/ce.data.BYTES_PER_ELEMENT,(ae+1)*fe/ce.data.BYTES_PER_ELEMENT);t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,ae,ce.width,ce.height,1,ge,xe,_e)}m.clearLayerUpdates()}else t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,0,ce.width,ce.height,ce.depth,ge,xe,ce.data)}else t.texImage3D(n.TEXTURE_2D_ARRAY,0,Te,ce.width,ce.height,ce.depth,0,ge,xe,ce.data);else if(m.isData3DTexture)F?(ye&&t.texStorage3D(n.TEXTURE_3D,Ae,Te,ce.width,ce.height,ce.depth),de&&t.texSubImage3D(n.TEXTURE_3D,0,0,0,0,ce.width,ce.height,ce.depth,ge,xe,ce.data)):t.texImage3D(n.TEXTURE_3D,0,Te,ce.width,ce.height,ce.depth,0,ge,xe,ce.data);else if(m.isFramebufferTexture){if(ye)if(F)t.texStorage2D(n.TEXTURE_2D,Ae,Te,ce.width,ce.height);else{let fe=ce.width,ae=ce.height;for(let _e=0;_e<Ae;_e++)t.texImage2D(n.TEXTURE_2D,_e,Te,fe,ae,0,ge,xe,null),fe>>=1,ae>>=1}}else if(He.length>0){if(F&&ye){const fe=se(He[0]);t.texStorage2D(n.TEXTURE_2D,Ae,Te,fe.width,fe.height)}for(let fe=0,ae=He.length;fe<ae;fe++)me=He[fe],F?de&&t.texSubImage2D(n.TEXTURE_2D,fe,0,0,ge,xe,me):t.texImage2D(n.TEXTURE_2D,fe,Te,ge,xe,me);m.generateMipmaps=!1}else if(F){if(ye){const fe=se(ce);t.texStorage2D(n.TEXTURE_2D,Ae,Te,fe.width,fe.height)}de&&t.texSubImage2D(n.TEXTURE_2D,0,0,0,ge,xe,ce)}else t.texImage2D(n.TEXTURE_2D,0,Te,ge,xe,ce);g(m)&&d(k),Me.__version=H.version,m.onUpdate&&m.onUpdate(m)}v.__version=m.version}function oe(v,m,P){if(m.image.length!==6)return;const k=Le(v,m),J=m.source;t.bindTexture(n.TEXTURE_CUBE_MAP,v.__webglTexture,n.TEXTURE0+P);const H=i.get(J);if(J.version!==H.__version||k===!0){t.activeTexture(n.TEXTURE0+P);const Me=je.getPrimaries(je.workingColorSpace),ue=m.colorSpace===ci?null:je.getPrimaries(m.colorSpace),be=m.colorSpace===ci||Me===ue?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,m.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,m.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,m.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,be);const Ie=m.isCompressedTexture||m.image[0].isCompressedTexture,ce=m.image[0]&&m.image[0].isDataTexture,ge=[];for(let ae=0;ae<6;ae++)!Ie&&!ce?ge[ae]=x(m.image[ae],!0,r.maxCubemapSize):ge[ae]=ce?m.image[ae].image:m.image[ae],ge[ae]=Q(m,ge[ae]);const xe=ge[0],Te=s.convert(m.format,m.colorSpace),me=s.convert(m.type),He=A(m.internalFormat,Te,me,m.colorSpace),F=m.isVideoTexture!==!0,ye=H.__version===void 0||k===!0,de=J.dataReady;let Ae=w(m,xe);De(n.TEXTURE_CUBE_MAP,m);let fe;if(Ie){F&&ye&&t.texStorage2D(n.TEXTURE_CUBE_MAP,Ae,He,xe.width,xe.height);for(let ae=0;ae<6;ae++){fe=ge[ae].mipmaps;for(let _e=0;_e<fe.length;_e++){const ze=fe[_e];m.format!==un?Te!==null?F?de&&t.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ae,_e,0,0,ze.width,ze.height,Te,ze.data):t.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ae,_e,He,ze.width,ze.height,0,ze.data):Ve("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):F?de&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ae,_e,0,0,ze.width,ze.height,Te,me,ze.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ae,_e,He,ze.width,ze.height,0,Te,me,ze.data)}}}else{if(fe=m.mipmaps,F&&ye){fe.length>0&&Ae++;const ae=se(ge[0]);t.texStorage2D(n.TEXTURE_CUBE_MAP,Ae,He,ae.width,ae.height)}for(let ae=0;ae<6;ae++)if(ce){F?de&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ae,0,0,0,ge[ae].width,ge[ae].height,Te,me,ge[ae].data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ae,0,He,ge[ae].width,ge[ae].height,0,Te,me,ge[ae].data);for(let _e=0;_e<fe.length;_e++){const ut=fe[_e].image[ae].image;F?de&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ae,_e+1,0,0,ut.width,ut.height,Te,me,ut.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ae,_e+1,He,ut.width,ut.height,0,Te,me,ut.data)}}else{F?de&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ae,0,0,0,Te,me,ge[ae]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ae,0,He,Te,me,ge[ae]);for(let _e=0;_e<fe.length;_e++){const ze=fe[_e];F?de&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ae,_e+1,0,0,Te,me,ze.image[ae]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ae,_e+1,He,Te,me,ze.image[ae])}}}g(m)&&d(n.TEXTURE_CUBE_MAP),H.__version=J.version,m.onUpdate&&m.onUpdate(m)}v.__version=m.version}function we(v,m,P,k,J,H){const Me=s.convert(P.format,P.colorSpace),ue=s.convert(P.type),be=A(P.internalFormat,Me,ue,P.colorSpace),Ie=i.get(m),ce=i.get(P);if(ce.__renderTarget=m,!Ie.__hasExternalTextures){const ge=Math.max(1,m.width>>H),xe=Math.max(1,m.height>>H);J===n.TEXTURE_3D||J===n.TEXTURE_2D_ARRAY?t.texImage3D(J,H,be,ge,xe,m.depth,0,Me,ue,null):t.texImage2D(J,H,be,ge,xe,0,Me,ue,null)}t.bindFramebuffer(n.FRAMEBUFFER,v),le(m)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,k,J,ce.__webglTexture,0,b(m)):(J===n.TEXTURE_2D||J>=n.TEXTURE_CUBE_MAP_POSITIVE_X&&J<=n.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&n.framebufferTexture2D(n.FRAMEBUFFER,k,J,ce.__webglTexture,H),t.bindFramebuffer(n.FRAMEBUFFER,null)}function Be(v,m,P){if(n.bindRenderbuffer(n.RENDERBUFFER,v),m.depthBuffer){const k=m.depthTexture,J=k&&k.isDepthTexture?k.type:null,H=y(m.stencilBuffer,J),Me=m.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;le(m)?o.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,b(m),H,m.width,m.height):P?n.renderbufferStorageMultisample(n.RENDERBUFFER,b(m),H,m.width,m.height):n.renderbufferStorage(n.RENDERBUFFER,H,m.width,m.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,Me,n.RENDERBUFFER,v)}else{const k=m.textures;for(let J=0;J<k.length;J++){const H=k[J],Me=s.convert(H.format,H.colorSpace),ue=s.convert(H.type),be=A(H.internalFormat,Me,ue,H.colorSpace);le(m)?o.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,b(m),be,m.width,m.height):P?n.renderbufferStorageMultisample(n.RENDERBUFFER,b(m),be,m.width,m.height):n.renderbufferStorage(n.RENDERBUFFER,be,m.width,m.height)}}n.bindRenderbuffer(n.RENDERBUFFER,null)}function Re(v,m,P){const k=m.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(n.FRAMEBUFFER,v),!(m.depthTexture&&m.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const J=i.get(m.depthTexture);if(J.__renderTarget=m,(!J.__webglTexture||m.depthTexture.image.width!==m.width||m.depthTexture.image.height!==m.height)&&(m.depthTexture.image.width=m.width,m.depthTexture.image.height=m.height,m.depthTexture.needsUpdate=!0),k){if(J.__webglInit===void 0&&(J.__webglInit=!0,m.depthTexture.addEventListener("dispose",R)),J.__webglTexture===void 0){J.__webglTexture=n.createTexture(),t.bindTexture(n.TEXTURE_CUBE_MAP,J.__webglTexture),De(n.TEXTURE_CUBE_MAP,m.depthTexture);const Ie=s.convert(m.depthTexture.format),ce=s.convert(m.depthTexture.type);let ge;m.depthTexture.format===jn?ge=n.DEPTH_COMPONENT24:m.depthTexture.format===Li&&(ge=n.DEPTH24_STENCIL8);for(let xe=0;xe<6;xe++)n.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+xe,0,ge,m.width,m.height,0,Ie,ce,null)}}else Y(m.depthTexture,0);const H=J.__webglTexture,Me=b(m),ue=k?n.TEXTURE_CUBE_MAP_POSITIVE_X+P:n.TEXTURE_2D,be=m.depthTexture.format===Li?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;if(m.depthTexture.format===jn)le(m)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,be,ue,H,0,Me):n.framebufferTexture2D(n.FRAMEBUFFER,be,ue,H,0);else if(m.depthTexture.format===Li)le(m)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,be,ue,H,0,Me):n.framebufferTexture2D(n.FRAMEBUFFER,be,ue,H,0);else throw new Error("Unknown depthTexture format")}function Ke(v){const m=i.get(v),P=v.isWebGLCubeRenderTarget===!0;if(m.__boundDepthTexture!==v.depthTexture){const k=v.depthTexture;if(m.__depthDisposeCallback&&m.__depthDisposeCallback(),k){const J=()=>{delete m.__boundDepthTexture,delete m.__depthDisposeCallback,k.removeEventListener("dispose",J)};k.addEventListener("dispose",J),m.__depthDisposeCallback=J}m.__boundDepthTexture=k}if(v.depthTexture&&!m.__autoAllocateDepthBuffer)if(P)for(let k=0;k<6;k++)Re(m.__webglFramebuffer[k],v,k);else{const k=v.texture.mipmaps;k&&k.length>0?Re(m.__webglFramebuffer[0],v,0):Re(m.__webglFramebuffer,v,0)}else if(P){m.__webglDepthbuffer=[];for(let k=0;k<6;k++)if(t.bindFramebuffer(n.FRAMEBUFFER,m.__webglFramebuffer[k]),m.__webglDepthbuffer[k]===void 0)m.__webglDepthbuffer[k]=n.createRenderbuffer(),Be(m.__webglDepthbuffer[k],v,!1);else{const J=v.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,H=m.__webglDepthbuffer[k];n.bindRenderbuffer(n.RENDERBUFFER,H),n.framebufferRenderbuffer(n.FRAMEBUFFER,J,n.RENDERBUFFER,H)}}else{const k=v.texture.mipmaps;if(k&&k.length>0?t.bindFramebuffer(n.FRAMEBUFFER,m.__webglFramebuffer[0]):t.bindFramebuffer(n.FRAMEBUFFER,m.__webglFramebuffer),m.__webglDepthbuffer===void 0)m.__webglDepthbuffer=n.createRenderbuffer(),Be(m.__webglDepthbuffer,v,!1);else{const J=v.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,H=m.__webglDepthbuffer;n.bindRenderbuffer(n.RENDERBUFFER,H),n.framebufferRenderbuffer(n.FRAMEBUFFER,J,n.RENDERBUFFER,H)}}t.bindFramebuffer(n.FRAMEBUFFER,null)}function C(v,m,P){const k=i.get(v);m!==void 0&&we(k.__webglFramebuffer,v,v.texture,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,0),P!==void 0&&Ke(v)}function I(v){const m=v.texture,P=i.get(v),k=i.get(m);v.addEventListener("dispose",D);const J=v.textures,H=v.isWebGLCubeRenderTarget===!0,Me=J.length>1;if(Me||(k.__webglTexture===void 0&&(k.__webglTexture=n.createTexture()),k.__version=m.version,a.memory.textures++),H){P.__webglFramebuffer=[];for(let ue=0;ue<6;ue++)if(m.mipmaps&&m.mipmaps.length>0){P.__webglFramebuffer[ue]=[];for(let be=0;be<m.mipmaps.length;be++)P.__webglFramebuffer[ue][be]=n.createFramebuffer()}else P.__webglFramebuffer[ue]=n.createFramebuffer()}else{if(m.mipmaps&&m.mipmaps.length>0){P.__webglFramebuffer=[];for(let ue=0;ue<m.mipmaps.length;ue++)P.__webglFramebuffer[ue]=n.createFramebuffer()}else P.__webglFramebuffer=n.createFramebuffer();if(Me)for(let ue=0,be=J.length;ue<be;ue++){const Ie=i.get(J[ue]);Ie.__webglTexture===void 0&&(Ie.__webglTexture=n.createTexture(),a.memory.textures++)}if(v.samples>0&&le(v)===!1){P.__webglMultisampledFramebuffer=n.createFramebuffer(),P.__webglColorRenderbuffer=[],t.bindFramebuffer(n.FRAMEBUFFER,P.__webglMultisampledFramebuffer);for(let ue=0;ue<J.length;ue++){const be=J[ue];P.__webglColorRenderbuffer[ue]=n.createRenderbuffer(),n.bindRenderbuffer(n.RENDERBUFFER,P.__webglColorRenderbuffer[ue]);const Ie=s.convert(be.format,be.colorSpace),ce=s.convert(be.type),ge=A(be.internalFormat,Ie,ce,be.colorSpace,v.isXRRenderTarget===!0),xe=b(v);n.renderbufferStorageMultisample(n.RENDERBUFFER,xe,ge,v.width,v.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+ue,n.RENDERBUFFER,P.__webglColorRenderbuffer[ue])}n.bindRenderbuffer(n.RENDERBUFFER,null),v.depthBuffer&&(P.__webglDepthRenderbuffer=n.createRenderbuffer(),Be(P.__webglDepthRenderbuffer,v,!0)),t.bindFramebuffer(n.FRAMEBUFFER,null)}}if(H){t.bindTexture(n.TEXTURE_CUBE_MAP,k.__webglTexture),De(n.TEXTURE_CUBE_MAP,m);for(let ue=0;ue<6;ue++)if(m.mipmaps&&m.mipmaps.length>0)for(let be=0;be<m.mipmaps.length;be++)we(P.__webglFramebuffer[ue][be],v,m,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+ue,be);else we(P.__webglFramebuffer[ue],v,m,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+ue,0);g(m)&&d(n.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(Me){for(let ue=0,be=J.length;ue<be;ue++){const Ie=J[ue],ce=i.get(Ie);let ge=n.TEXTURE_2D;(v.isWebGL3DRenderTarget||v.isWebGLArrayRenderTarget)&&(ge=v.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(ge,ce.__webglTexture),De(ge,Ie),we(P.__webglFramebuffer,v,Ie,n.COLOR_ATTACHMENT0+ue,ge,0),g(Ie)&&d(ge)}t.unbindTexture()}else{let ue=n.TEXTURE_2D;if((v.isWebGL3DRenderTarget||v.isWebGLArrayRenderTarget)&&(ue=v.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(ue,k.__webglTexture),De(ue,m),m.mipmaps&&m.mipmaps.length>0)for(let be=0;be<m.mipmaps.length;be++)we(P.__webglFramebuffer[be],v,m,n.COLOR_ATTACHMENT0,ue,be);else we(P.__webglFramebuffer,v,m,n.COLOR_ATTACHMENT0,ue,0);g(m)&&d(ue),t.unbindTexture()}v.depthBuffer&&Ke(v)}function G(v){const m=v.textures;for(let P=0,k=m.length;P<k;P++){const J=m[P];if(g(J)){const H=T(v),Me=i.get(J).__webglTexture;t.bindTexture(H,Me),d(H),t.unbindTexture()}}}const ee=[],j=[];function ie(v){if(v.samples>0){if(le(v)===!1){const m=v.textures,P=v.width,k=v.height;let J=n.COLOR_BUFFER_BIT;const H=v.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,Me=i.get(v),ue=m.length>1;if(ue)for(let Ie=0;Ie<m.length;Ie++)t.bindFramebuffer(n.FRAMEBUFFER,Me.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+Ie,n.RENDERBUFFER,null),t.bindFramebuffer(n.FRAMEBUFFER,Me.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+Ie,n.TEXTURE_2D,null,0);t.bindFramebuffer(n.READ_FRAMEBUFFER,Me.__webglMultisampledFramebuffer);const be=v.texture.mipmaps;be&&be.length>0?t.bindFramebuffer(n.DRAW_FRAMEBUFFER,Me.__webglFramebuffer[0]):t.bindFramebuffer(n.DRAW_FRAMEBUFFER,Me.__webglFramebuffer);for(let Ie=0;Ie<m.length;Ie++){if(v.resolveDepthBuffer&&(v.depthBuffer&&(J|=n.DEPTH_BUFFER_BIT),v.stencilBuffer&&v.resolveStencilBuffer&&(J|=n.STENCIL_BUFFER_BIT)),ue){n.framebufferRenderbuffer(n.READ_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.RENDERBUFFER,Me.__webglColorRenderbuffer[Ie]);const ce=i.get(m[Ie]).__webglTexture;n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,ce,0)}n.blitFramebuffer(0,0,P,k,0,0,P,k,J,n.NEAREST),l===!0&&(ee.length=0,j.length=0,ee.push(n.COLOR_ATTACHMENT0+Ie),v.depthBuffer&&v.resolveDepthBuffer===!1&&(ee.push(H),j.push(H),n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,j)),n.invalidateFramebuffer(n.READ_FRAMEBUFFER,ee))}if(t.bindFramebuffer(n.READ_FRAMEBUFFER,null),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),ue)for(let Ie=0;Ie<m.length;Ie++){t.bindFramebuffer(n.FRAMEBUFFER,Me.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+Ie,n.RENDERBUFFER,Me.__webglColorRenderbuffer[Ie]);const ce=i.get(m[Ie]).__webglTexture;t.bindFramebuffer(n.FRAMEBUFFER,Me.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+Ie,n.TEXTURE_2D,ce,0)}t.bindFramebuffer(n.DRAW_FRAMEBUFFER,Me.__webglMultisampledFramebuffer)}else if(v.depthBuffer&&v.resolveDepthBuffer===!1&&l){const m=v.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,[m])}}}function b(v){return Math.min(r.maxSamples,v.samples)}function le(v){const m=i.get(v);return v.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&m.__useRenderToTexture!==!1}function re(v){const m=a.render.frame;u.get(v)!==m&&(u.set(v,m),v.update())}function Q(v,m){const P=v.colorSpace,k=v.format,J=v.type;return v.isCompressedTexture===!0||v.isVideoTexture===!0||P!==pr&&P!==ci&&(je.getTransfer(P)===st?(k!==un||J!==tn)&&Ve("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Je("WebGLTextures: Unsupported texture color space:",P)),m}function se(v){return typeof HTMLImageElement<"u"&&v instanceof HTMLImageElement?(c.width=v.naturalWidth||v.width,c.height=v.naturalHeight||v.height):typeof VideoFrame<"u"&&v instanceof VideoFrame?(c.width=v.displayWidth,c.height=v.displayHeight):(c.width=v.width,c.height=v.height),c}this.allocateTextureUnit=W,this.resetTextureUnits=Z,this.setTexture2D=Y,this.setTexture2DArray=U,this.setTexture3D=L,this.setTextureCube=O,this.rebindTextures=C,this.setupRenderTarget=I,this.updateRenderTargetMipmap=G,this.updateMultisampleRenderTarget=ie,this.setupDepthRenderbuffer=Ke,this.setupFrameBufferTexture=we,this.useMultisampledRTT=le,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function Zv(n,e){function t(i,r=ci){let s;const a=je.getTransfer(r);if(i===tn)return n.UNSIGNED_BYTE;if(i===Fl)return n.UNSIGNED_SHORT_4_4_4_4;if(i===Ol)return n.UNSIGNED_SHORT_5_5_5_1;if(i===Gf)return n.UNSIGNED_INT_5_9_9_9_REV;if(i===kf)return n.UNSIGNED_INT_10F_11F_11F_REV;if(i===Vf)return n.BYTE;if(i===Hf)return n.SHORT;if(i===qr)return n.UNSIGNED_SHORT;if(i===Nl)return n.INT;if(i===Rn)return n.UNSIGNED_INT;if(i===Mn)return n.FLOAT;if(i===Kn)return n.HALF_FLOAT;if(i===Wf)return n.ALPHA;if(i===Xf)return n.RGB;if(i===un)return n.RGBA;if(i===jn)return n.DEPTH_COMPONENT;if(i===Li)return n.DEPTH_STENCIL;if(i===qf)return n.RED;if(i===Bl)return n.RED_INTEGER;if(i===dr)return n.RG;if(i===zl)return n.RG_INTEGER;if(i===Vl)return n.RGBA_INTEGER;if(i===Fs||i===Os||i===Bs||i===zs)if(a===st)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(i===Fs)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===Os)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===Bs)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===zs)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(i===Fs)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===Os)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===Bs)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===zs)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===Do||i===Lo||i===Io||i===Uo)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(i===Do)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===Lo)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===Io)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===Uo)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===No||i===Fo||i===Oo||i===Bo||i===zo||i===Vo||i===Ho)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(i===No||i===Fo)return a===st?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(i===Oo)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC;if(i===Bo)return s.COMPRESSED_R11_EAC;if(i===zo)return s.COMPRESSED_SIGNED_R11_EAC;if(i===Vo)return s.COMPRESSED_RG11_EAC;if(i===Ho)return s.COMPRESSED_SIGNED_RG11_EAC}else return null;if(i===Go||i===ko||i===Wo||i===Xo||i===qo||i===Yo||i===$o||i===Ko||i===jo||i===Zo||i===Jo||i===Qo||i===el||i===tl)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(i===Go)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===ko)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===Wo)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===Xo)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===qo)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===Yo)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===$o)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===Ko)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===jo)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===Zo)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===Jo)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===Qo)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===el)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===tl)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===nl||i===il||i===rl)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(i===nl)return a===st?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===il)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===rl)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===sl||i===al||i===ol||i===ll)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(i===sl)return s.COMPRESSED_RED_RGTC1_EXT;if(i===al)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===ol)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===ll)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===Yr?n.UNSIGNED_INT_24_8:n[i]!==void 0?n[i]:null}return{convert:t}}const Jv=`
void main() {
...
}`;class eS{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){const i=new oh(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=i}}getMesh(e){if(this.texture!==null&&this.mesh===null){const t=e.cameras[0].viewport,i=new Cn({vertexShader:Jv,fragmentShader:Qv,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new Jn(new ca(20,20),i)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class tS extends gr{constructor(e,t){super();const i=this;let r=null,s=1,a=null,o="local-floor",l=1,c=null,u=null,f=null,h=null,p=null,_=null;const x=typeof XRWebGLBinding<"u",g=new eS,d={},T=t.getContextAttributes();let A=null,y=null;const w=[],R=[],D=new ot;let z=null;const M=new en;M.viewport=new gt;const E=new en;E.viewport=new gt;const N=[M,E],Z=new fg;let W=null,K=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(ne){let oe=w[ne];return oe===void 0&&(oe=new ja,w[ne]=oe),oe.getTargetRaySpace()},this.getControllerGrip=function(ne){let oe=w[ne];return oe===void 0&&(oe=new ja,w[ne]=oe),oe.getGripSpace()},this.getHand=function(ne){let oe=w[ne];return oe===void 0&&(oe=new ja,w[ne]=oe),oe.getHandSpace()};function Y(ne){const oe=R.indexOf(ne.inputSource);if(oe===-1)return;const we=w[oe];we!==void 0&&(we.update(ne.inputSource,ne.frame,c||a),we.dispatchEvent({type:ne.type,data:ne.inputSource}))}function U(){r.removeEventListener("select",Y),r.removeEventListener("selectstart",Y),r.removeEventListener("selectend",Y),r.removeEventListener("squeeze",Y),r.removeEventListener("squeezestart",Y),r.removeEventListener("squeezeend",Y),r.removeEventListener("end",U),r.removeEventListener("inputsourceschange",L);for(let ne=0;ne<w.length;ne++){const oe=R[ne];oe!==null&&(R[ne]=null,w[ne].disconnect(oe))}W=null,K=null,g.reset();for(const ne in d)delete d[ne];e.setRenderTarget(A),p=null,h=null,f=null,r=null,y=null,nt.stop(),i.isPresenting=!1,e.setPixelRatio(z),e.setSize(D.width,D.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(ne){s=ne,i.isPresenting===!0&&Ve("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(ne){o=ne,i.isPresenting===!0&&Ve("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(ne){c=ne},this.getBaseLayer=function(){return h!==null?h:p},this.getBinding=function(){return f===null&&x&&(f=new XRWebGLBinding(r,t)),f},this.getFrame=function(){return _},this.getSession=function(){return r},this.setSession=async function(ne){if(r=ne,r!==null){if(A=e.getRenderTarget(),r.addEventListener("select",Y),r.addEventListener("selectstart",Y),r.addEventListener("selectend",Y),r.addEventListener("squeeze",Y),r.addEventListener("squeezestart",Y),r.addEventListener("squeezeend",Y),r.addEventListener("end",U),r.addEventListener("inputsourceschange",L),T.xrCompatible!==!0&&await t.makeXRCompatible(),z=e.getPixelRatio(),e.getSize(D),x&&"createProjectionLayer"in XRWebGLBinding.prototype){let we=null,Be=null,Re=null;T.depth&&(Re=T.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,we=T.stencil?Li:jn,Be=T.stencil?Yr:Rn);const Ke={colorFormat:t.RGBA8,depthFormat:Re,scaleFactor:s};f=this.getBinding(),h=f.createProjectionLayer(Ke),r.updateRenderState({layers:[h]}),e.setPixelRatio(1),e.setSize(h.textureWidth,h.textureHeight,!1),y=new An(h.textureWidth,h.textureHeight,{format:un,type:tn,depthTexture:new jr(h.textureWidth,h.textureHeight,Be,void 0,void 0,void 0,void 0,void 0,void 0,we),stencilBuffer:T.stencil,colorSpace:e.outputColorSpace,samples:T.antialias?4:0,resolveDepthBuffer:h.ignoreDepthValues===!1,resolveStencilBuffer:h.ignoreDepthValues===!1})}else{const we={antialias:T.antialias,alpha:!0,depth:T.depth,stencil:T.stencil,framebufferScaleFactor:s};p=new XRWebGLLayer(r,t,we),r.updateRenderState({baseLayer:p}),e.setPixelRatio(1),e.setSize(p.framebufferWidth,p.framebufferHeight,!1),y=new An(p.framebufferWidth,p.framebufferHeight,{format:un,type:tn,colorSpace:e.outputColorSpace,stencilBuffer:T.stencil,resolveDepthBuffer:p.ignoreDepthValues===!1,resolveStencilBuffer:p.ignoreDepthValues===!1})}y.isXRRenderTarget=!0,this.setFoveation(l),c=null,a=await r.requestReferenceSpace(o),nt.setContext(r),nt.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return g.getDepthTexture()};function L(ne){for(let oe=0;oe<ne.removed.length;oe++){const we=ne.removed[oe],Be=R.indexOf(we);Be>=0&&(R[Be]=null,w[Be].disconnect(we))}for(let oe=0;oe<ne.added.length;oe++){const we=ne.added[oe];let Be=R.indexOf(we);if(Be===-1){for(let Ke=0;Ke<w.length;Ke++)if(Ke>=R.length){R.push(we),Be=Ke;break}else if(R[Ke]===null){R[Ke]=we,Be=Ke;break}if(Be===-1)break}const Re=w[Be];Re&&Re.connect(we)}}const O=new X,te=new X;function he(ne,oe,we){O.setFromMatrixPosition(oe.matrixWorld),te.setFromMatrixPosition(we.matrixWorld);const Be=O.distanceTo(te),Re=oe.projectionMatrix.elements,Ke=we.projectionMatrix.elements,C=Re[14]/(Re[10]-1),I=Re[14]/(Re[10]+1),G=(Re[9]+1)/Re[5],ee=(Re[9]-1)/Re[5],j=(Re[8]-1)/Re[0],ie=(Ke[8]+1)/Ke[0],b=C*j,le=C*ie,re=Be/(-j+ie),Q=re*-j;if(oe.matrixWorld.decompose(ne.position,ne.quaternion,ne.scale),ne.translateX(Q),ne.translateZ(re),ne.matrixWorld.compose(ne.position,ne.quaternion,ne.scale),ne.matrixWorldInverse.copy(ne.matrixWorld).invert(),Re[10]===-1)ne.projectionMatrix.copy(oe.projectionMatrix),ne.projectionMatrixInverse.copy(oe.projectionMatrixInverse);else{const se=C+re,v=I+re,m=b-Q,P=le+(Be-Q),k=G*I/v*se,J=ee*I/v*se;ne.projectionMatrix.makePerspective(m,P,k,J,se,v),ne.projectionMatrixInverse.copy(ne.projectionMatrix).invert()}}function pe(ne,oe){oe===null?ne.matrixWorld.copy(ne.matrix):ne.matrixWorld.multiplyMatrices(oe.matrixWorld,ne.matrix),ne.matrixWorldInverse.copy(ne.matrixWorld).invert()}this.updateCamera=function(ne){if(r===null)return;let oe=ne.near,we=ne.far;g.texture!==null&&(g.depthNear>0&&(oe=g.depthNear),g.depthFar>0&&(we=g.depthFar)),Z.near=E.near=M.near=oe,Z.far=E.far=M.far=we,(W!==Z.near||K!==Z.far)&&(r.updateRenderState({depthNear:Z.near,depthFar:Z.far}),W=Z.near,K=Z.far),Z.layers.mask=ne.layers.mask|6,M.layers.mask=Z.layers.mask&3,E.layers.mask=Z.layers.mask&5;const Be=ne.parent,Re=Z.cameras;pe(Z,Be);for(let Ke=0;Ke<Re.length;Ke++)pe(Re[Ke],Be);Re.length===2?he(Z,M,E):Z.projectionMatrix.copy(M.projectionMatrix),De(ne,Z,Be)};function De(ne,oe,we){we===null?ne.matrix.copy(oe.matrixWorld):(ne.matrix.copy(we.matrixWorld),ne.matrix.invert(),ne.matrix.multiply(oe.matrixWorld)),ne.matrix.decompose(ne.position,ne.quaternion,ne.scale),ne.updateMatrixWorld(!0),ne.projectionMatrix.copy(oe.projectionMatrix),ne.projectionMatrixInverse.copy(oe.projectionMatrixInverse),ne.isPerspectiveCamera&&(ne.fov=cl*2*Math.atan(1/ne.projectionMatrix.elements[5]),ne.zoom=1)}this.getCamera=function(){return Z},this.getFoveation=function(){if(!(h===null&&p===null))return l},this.setFoveation=function(ne){l=ne,h!==null&&(h.fixedFoveation=ne),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=ne)},this.hasDepthSensing=function(){return g.texture!==null},this.getDepthSensingMesh=function(){return g.getMesh(Z)},this.getCameraTexture=function(ne){return d[ne]};let Le=null;function qe(ne,oe){if(u=oe.getViewerPose(c||a),_=oe,u!==null){const we=u.views;p!==null&&(e.setRenderTargetFramebuffer(y,p.framebuffer),e.setRenderTarget(y));let Be=!1;we.length!==Z.cameras.length&&(Z.cameras.length=0,Be=!0);for(let I=0;I<we.length;I++){const G=we[I];let ee=null;if(p!==null)ee=p.getViewport(G);else{const ie=f.getViewSubImage(h,G);ee=ie.viewport,I===0&&(e.setRenderTargetTextures(y,ie.colorTexture,ie.depthStencilTexture),e.setRenderTarget(y))}let j=N[I];j===void 0&&(j=new en,j.layers.enable(I),j.viewport=new gt,N[I]=j),j.matrix.fromArray(G.transform.matrix),j.matrix.decompose(j.position,j.quaternion,j.scale),j.projectionMatrix.fromArray(G.projectionMatrix),j.projectionMatrixInverse.copy(j.projectionMatrix).invert(),j.viewport.set(ee.x,ee.y,ee.width,ee.height),I===0&&(Z.matrix.copy(j.matrix),Z.matrix.decompose(Z.position,Z.quaternion,Z.scale)),Be===!0&&Z.cameras.push(j)}const Re=r.enabledFeatures;if(Re&&Re.includes("depth-sensing")&&r.depthUsage=="gpu-optimized"&&x){f=i.getBinding();const I=f.getDepthInformation(we[0]);I&&I.isValid&&I.texture&&g.init(I,r.renderState)}if(Re&&Re.includes("camera-access")&&x){e.state.unbindTexture(),f=i.getBinding();for(let I=0;I<we.length;I++){const G=we[I].camera;if(G){let ee=d[G];ee||(ee=new oh,d[G]=ee);const j=f.getCameraImage(G);ee.sourceTexture=j}}}}for(let we=0;we<w.length;we++){const Be=R[we],Re=w[we];Be!==null&&Re!==void 0&&Re.update(Be,oe,c||a)}Le&&Le(ne,oe),oe.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:oe}),_=null}const nt=new ch;nt.setAnimationLoop(qe),this.setAnimationLoop=function(ne){Le=ne},this.dispose=function(){}}}const Ai=new Zn,nS=new _t;function iS(n,e){function t(g,d){g.matrixAutoUpdate===!0&&g.updateMatrix(),d.value.copy(g.matrix)}function i(g,d){d.color.getRGB(g.fogColor.value,th(n)),d.isFog?(g.fogNear.value=d.near,g.fogFar.value=d.far):d.isFogExp2&&(g.fogDensity.value=d.density)}function r(g,d,T,A,y){d.isMeshBasicMaterial||d.isMeshLambertMaterial?s(g,d):d.isMeshToonMaterial?(s(g,d),f(g,d)):d.isMeshPhongMaterial?(s(g,d),u(g,d)):d.isMeshStandardMaterial?(s(g,d),h(g,d),d.isMeshPhysicalMaterial&&p(g,d,y)):d.isMeshMatcapMaterial?(s(g,d),_(g,d)):d.isMeshDepthMaterial?s(g,d):d.isMeshDistanceMaterial?(s(g,d),x(g,d)):d.isMeshNormalMaterial?s(g,d):d.isLineBasicMaterial?(a(g,d),d.isLineDashedMaterial&&o(g,d)):d.isPointsMaterial?l(g,d,T,A):d.isSpriteMaterial?c(g,d):d.isShadowMaterial?(g.color.value.copy(d.color),g.opacity.value=d.opacity):d.isShaderMaterial&&(d.uniformsNeedUpdate=!1)}function s(g,d){g.opacity.value=d.opacity,d.color&&g.diffuse.value.copy(d.color),d.emissive&&g.emissive.value.copy(d.emissive).multiplyScalar(d.emissiveIntensity),d.map&&(g.map.value=d.map,t(d.map,g.mapTransform)),d.alphaMap&&(g.alphaMap.value=d.alphaMap,t(d.alphaMap,g.alphaMapTransform)),d.bumpMap&&(g.bumpMap.value=d.bumpMap,t(d.bumpMap,g.bumpMapTransform),g.bumpScale.value=d.bumpScale,d.side===Gt&&(g.bumpScale.value*=-1)),d.normalMap&&(g.normalMap.value=d.normalMap,t(d.normalMap,g.normalMapTransform),g.normalScale.value.copy(d.normalScale),d.side===Gt&&g.normalScale.value.negate()),d.displacementMap&&(g.displacementMap.value=d.displacementMap,t(d.displacementMap,g.displacementMapTransform),g.displacementScale.value=d.displacementScale,g.displacementBias.value=d.displacementBias),d.emissiveMap&&(g.emissiveMap.value=d.emissiveMap,t(d.emissiveMap,g.emissiveMapTransform)),d.specularMap&&(g.specularMap.value=d.specularMap,t(d.specularMap,g.specularMapTransform)),d.alphaTest>0&&(g.alphaTest.value=d.alphaTest);const T=e.get(d),A=T.envMap,y=T.envMapRotation;A&&(g.envMap.value=A,Ai.copy(y),Ai.x*=-1,Ai.y*=-1,Ai.z*=-1,A.isCubeTexture&&A.isRenderTargetTexture===!1&&(Ai.y*=-1,Ai.z*=-1),g.envMapRotation.value.setFromMatrix4(nS.makeRotationFromEuler(Ai)),g.flipEnvMap.value=A.isCubeTexture&&A.isRenderTargetTexture===!1?-1:1,g.reflectivity.value=d.reflectivity,g.ior.value=d.ior,g.refractionRatio.value=d.refractionRatio),d.lightMap&&(g.lightMap.value=d.lightMap,g.lightMapIntensity.value=d.lightMapIntensity,t(d.lightMap,g.lightMapTransform)),d.aoMap&&(g.aoMap.value=d.aoMap,g.aoMapIntensity.value=d.aoMapIntensity,t(d.aoMap,g.aoMapTransform))}function a(g,d){g.diffuse.value.copy(d.color),g.opacity.value=d.opacity,d.map&&(g.map.value=d.map,t(d.map,g.mapTransform))}function o(g,d){g.dashSize.value=d.dashSize,g.totalSize.value=d.dashSize+d.gapSize,g.scale.value=d.scale}function l(g,d,T,A){g.diffuse.value.copy(d.color),g.opacity.value=d.opacity,g.size.value=d.size*T,g.scale.value=A*.5,d.map&&(g.map.value=d.map,t(d.map,g.uvTransform)),d.alphaMap&&(g.alphaMap.value=d.alphaMap,t(d.alphaMap,g.alphaMapTransform)),d.alphaTest>0&&(g.alphaTest.value=d.alphaTest)}function c(g,d){g.diffuse.value.copy(d.color),g.opacity.value=d.opacity,g.rotation.value=d.rotation,d.map&&(g.map.value=d.map,t(d.map,g.mapTransform)),d.alphaMap&&(g.alphaMap.value=d.alphaMap,t(d.alphaMap,g.alphaMapTransform)),d.alphaTest>0&&(g.alphaTest.value=d.alphaTest)}function u(g,d){g.specular.value.copy(d.specular),g.shininess.value=Math.max(d.shininess,1e-4)}function f(g,d){d.gradientMap&&(g.gradientMap.value=d.gradientMap)}function h(g,d){g.metalness.value=d.metalness,d.metalnessMap&&(g.metalnessMap.value=d.metalnessMap,t(d.metalnessMap,g.metalnessMapTransform)),g.roughness.value=d.roughness,d.roughnessMap&&(g.roughnessMap.value=d.roughnessMap,t(d.roughnessMap,g.roughnessMapTransform)),d.envMap&&(g.envMapIntensity.value=d.envMapIntensity)}function p(g,d,T){g.ior.value=d.ior,d.sheen>0&&(g.sheenColor.value.copy(d.sheenColor).multiplyScalar(d.sheen),g.sheenRoughness.value=d.sheenRoughness,d.sheenColorMap&&(g.sheenColorMap.value=d.sheenColorMap,t(d.sheenColorMap,g.sheenColorMapTransform)),d.sheenRoughnessMap&&(g.sheenRoughnessMap.value=d.sheenRoughnessMap,t(d.sheenRoughnessMap,g.sheenRoughnessMapTransform))),d.clearcoat>0&&(g.clearcoat.value=d.clearcoat,g.clearcoatRoughness.value=d.clearcoatRoughness,d.clearcoatMap&&(g.clearcoatMap.value=d.clearcoatMap,t(d.clearcoatMap,g.clearcoatMapTransform)),d.clearcoatRoughnessMap&&(g.clearcoatRoughnessMap.value=d.clearcoatRoughnessMap,t(d.clearcoatRoughnessMap,g.clearcoatRoughnessMapTransform)),d.clearcoatNormalMap&&(g.clearcoatNormalMap.value=d.clearcoatNormalMap,t(d.clearcoatNormalMap,g.clearcoatNormalMapTransform),g.clearcoatNormalScale.value.copy(d.clearcoatNormalScale),d.side===Gt&&g.clearcoatNormalScale.value.negate())),d.dispersion>0&&(g.dispersion.value=d.dispersion),d.iridescence>0&&(g.iridescence.value=d.iridescence,g.iridescenceIOR.value=d.iridescenceIOR,g.iridescenceThicknessMinimum.value=d.iridescenceThicknessRange[0],g.iridescenceThicknessMaximum.value=d.iridescenceThicknessRange[1],d.iridescenceMap&&(g.iridescenceMap.value=d.iridescenceMap,t(d.iridescenceMap,g.iridescenceMapTransform)),d.iridescenceThicknessMap&&(g.iridescenceThicknessMap.value=d.iridescenceThicknessMap,t(d.iridescenceThicknessMap,g.iridescenceThicknessMapTransform))),d.transmission>0&&(g.transmission.value=d.transmission,g.transmissionSamplerMap.value=T.texture,g.transmissionSamplerSize.value.set(T.width,T.height),d.transmissionMap&&(g.transmissionMap.value=d.transmissionMap,t(d.transmissionMap,g.transmissionMapTransform)),g.thickness.value=d.thickness,d.thicknessMap&&(g.thicknessMap.value=d.thicknessMap,t(d.thicknessMap,g.thicknessMapTransform)),g.attenuationDistance.value=d.attenuationDistance,g.attenuationColor.value.copy(d.attenuationColor)),d.anisotropy>0&&(g.anisotropyVector.value.set(d.anisotropy*Math.cos(d.anisotropyRotation),d.anisotropy*Math.sin(d.anisotropyRotation)),d.anisotropyMap&&(g.anisotropyMap.value=d.anisotropyMap,t(d.anisotropyMap,g.anisotropyMapTransform))),g.specularIntensity.value=d.specularIntensity,g.specularColor.value.copy(d.specularColor),d.specularColorMap&&(g.specularColorMap.value=d.specularColorMap,t(d.specularColorMap,g.specularColorMapTransform)),d.specularIntensityMap&&(g.specularIntensityMap.value=d.specularIntensityMap,t(d.specularIntensityMap,g.specularIntensityMapTransform))}function _(g,d){d.matcap&&(g.matcap.value=d.matcap)}function x(g,d){const T=e.get(d).light;g.referencePosition.value.setFromMatrixPosition(T.matrixWorld),g.nearDistance.value=T.shadow.camera.near,g.farDistance.value=T.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:r}}function rS(n,e,t,i){let r={},s={},a=[];const o=n.getParameter(n.MAX_UNIFORM_BUFFER_BINDINGS);function l(T,A){const y=A.program;i.uniformBlockBinding(T,y)}function c(T,A){let y=r[T.id];y===void 0&&(_(T),y=u(T),r[T.id]=y,T.addEventListener("dispose",g));const w=A.program;i.updateUBOMapping(T,w);const R=e.render.frame;s[T.id]!==R&&(h(T),s[T.id]=R)}function u(T){const A=f();T.__bindingPointIndex=A;const y=n.createBuffer(),w=T.__size,R=T.usage;return n.bindBuffer(n.UNIFORM_BUFFER,y),n.bufferData(n.UNIFORM_BUFFER,w,R),n.bindBuffer(n.UNIFORM_BUFFER,null),n.bindBufferBase(n.UNIFORM_BUFFER,A,y),y}function f(){for(let T=0;T<o;T++)if(a.indexOf(T)===-1)return a.push(T),T;return Je("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function h(T){const A=r[T.id],y=T.uniforms,w=T.__cache;n.bindBuffer(n.UNIFORM_BUFFER,A);for(let R=0,D=y.length;R<D;R++){const z=Array.isArray(y[R])?y[R]:[y[R]];for(let M=0,E=z.length;M<E;M++){const N=z[M];if(p(N,R,M,w)===!0){const Z=N.__offset,W=Array.isArray(N.value)?N.value:[N.value];let K=0;for(let Y=0;Y<W.length;Y++){const U=W[Y],L=x(U);typeof U=="number"||typeof U=="boolean"?(N.__data[0]=U,n.bufferSubData(n.UNIFORM_BUFFER,Z+K,N.__data)):U.isMatrix3?(N.__data[0]=U.elements[0],N.__data[1]=U.elements[1],N.__data[2]=U.elements[2],N.__data[3]=0,N.__data[4]=U.elements[3],N.__data[5]=U.elements[4],N.__data[6]=U.elements[5],N.__data[7]=0,N.__data[8]=U.elements[6],N.__data[9]=U.elements[7],N.__data[10]=U.elements[8],N.__data[11]=0):(U.toArray(N.__data,K),K+=L.storage/Float32Array.BYTES_PER_ELEMENT)}n.bufferSubData(n.UNIFORM_BUFFER,Z,N.__data)}}}n.bindBuffer(n.UNIFORM_BUFFER,null)}function p(T,A,y,w){const R=T.value,D=A+"_"+y;if(w[D]===void 0)return typeof R=="number"||typeof R=="boolean"?w[D]=R:w[D]=R.clone(),!0;{const z=w[D];if(typeof R=="number"||typeof R=="boolean"){if(z!==R)return w[D]=R,!0}else if(z.equals(R)===!1)return z.copy(R),!0}return!1}function _(T){const A=T.uniforms;let y=0;const w=16;for(let D=0,z=A.length;D<z;D++){const M=Array.isArray(A[D])?A[D]:[A[D]];for(let E=0,N=M.length;E<N;E++){const Z=M[E],W=Array.isArray(Z.value)?Z.value:[Z.value];for(let K=0,Y=W.length;K<Y;K++){const U=W[K],L=x(U),O=y%w,te=O%L.boundary,he=O+te;y+=te,he!==0&&w-he<L.storage&&(y+=w-he),Z.__data=new Float32Array(L.storage/Float32Array.BYTES_PER_ELEMENT),Z.__offset=y,y+=L.storage}}}const R=y%w;return R>0&&(y+=w-R),T.__size=y,T.__cache={},this}function x(T){const A={boundary:0,storage:0};return typeof T=="number"||typeof T=="boolean"?(A.boundary=4,A.storage=4):T.isVector2?(A.boundary=8,A.storage=8):T.isVector3||T.isColor?(A.boundary=16,A.storage=12):T.isVector4?(A.boundary=16,A.storage=16):T.isMatrix3?(A.boundary=48,A.storage=48):T.isMatrix4?(A.boundary=64,A.storage=64):T.isTexture?Ve("WebGLRenderer: Texture samplers can not be part of an uniforms group."):Ve("WebGLRenderer: Unsupported uniform value type.",T),A}function g(T){const A=T.target;A.removeEventListener("dispose",g);const y=a.indexOf(A.__bindingPointIndex);a.splice(y,1),n.deleteBuffer(r[A.id]),delete r[A.id],delete s[A.id]}function d(){for(const T in r)n.deleteBuffer(r[T]);a=[],r={},s={}}return{bind:l,update:c,dispose:d}}const sS=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]);let gn=null;function aS(){return gn===null&&(gn=new Jm(sS,16,16,dr,Kn),gn.name="DFG_LUT",gn.minFilter=Rt,gn.magFilter=Rt,gn.wrapS=Hn,gn.wrapT=Hn,gn.generateMipmaps=!1,gn.needsUpdate=!0),gn}class oS{constructor(e={}){const{canvas:t=Tm(),context:i=null,depth:r=!0,stencil:s=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:u="default",failIfMajorPerformanceCaveat:f=!1,reversedDepthBuffer:h=!1,outputBufferType:p=tn}=e;this.isWebGLRenderer=!0;let _;if(i!==null){if(typeof WebGLRenderingContext<"u"&&i instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");_=i.getContextAttributes().alpha}else _=a;const x=p,g=new Set([Vl,zl,Bl]),d=new Set([tn,Rn,qr,Yr,Fl,Ol]),T=new Uint32Array(4),A=new Int32Array(4);let y=null,w=null;const R=[],D=[];let z=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=Tn,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const M=this;let E=!1;this._outputColorSpace=Qt;let N=0,Z=0,W=null,K=-1,Y=null;const U=new gt,L=new gt;let O=null;const te=new tt(0);let he=0,pe=t.width,De=t.height,Le=1,qe=null,nt=null;const ne=new gt(0,0,pe,De),oe=new gt(0,0,pe,De);let we=!1;const Be=new sh;let Re=!1,Ke=!1;const C=new _t,I=new X,G=new gt,ee={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let j=!1;function ie(){return W===null?Le:1}let b=i;function le(S,B){return t.getContext(S,B)}try{const S={alpha:!0,depth:r,stencil:s,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:u,failIfMajorPerformanceCaveat:f};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${Ul}`),t.addEventListener("webglcontextlost",ze,!1),t.addEventListener("webglcontextrestored",ut,!1),t.addEventListener("webglcontextcreationerror",it,!1),b===null){const B="webgl2";if(b=le(B,S),b===null)throw le(B)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(S){throw Je("WebGLRenderer: "+S.message),S}let re,Q,se,v,m,P,k,J,H,Me,ue,be,Ie,ce,ge,xe,Te,me,He,F,ye,de,Ae,fe;function ae(){re=new ax(b),re.init(),de=new Zv(b,re),Q=new Z0(b,re,e,de),se=new Kv(b,re),Q.reversedDepthBuffer&&h&&se.buffers.depth.setReversed(!0),v=new cx(b),m=new Uv,P=new jv(b,re,se,m,Q,de,v),k=new Q0(M),J=new sx(M),H=new dg(b),Ae=new K0(b,H),Me=new ox(b,H,v,Ae),ue=new fx(b,Me,H,v),He=new ux(b,Q,P),xe=new J0(m),be=new Iv(M,k,J,re,Q,Ae,xe),Ie=new iS(M,m),ce=new Fv,ge=new Gv(re),me=new $0(M,k,J,se,ue,_,l),Te=new Yv(M,ue,Q),fe=new rS(b,v,Q,se),F=new j0(b,re,v),ye=new lx(b,re,v),v.programs=be.programs,M.capabilities=Q,M.extensions=re,M.properties=m,M.renderLists=ce,M.shadowMap=Te,M.state=se,M.info=v}ae(),x!==tn&&(z=new dx(x,t.width,t.height,r,s));const _e=new tS(M,b);this.xr=_e,this.getContext=function(){return b},this.getContextAttributes=function(){return b.getContextAttributes()},this.forceContextLoss=function(){const S=re.get("WEBGL_lose_context");S&&S.loseContext()},this.forceContextRestore=function(){const S=re.get("WEBGL_lose_context");S&&S.restoreContext()},this.getPixelRatio=function(){return Le},this.setPixelRatio=function(S){S!==void 0&&(Le=S,this.setSize(pe,De,!1))},this.getSize=function(S){return S.set(pe,De)},this.setSize=function(S,B,$=!0){if(_e.isPresenting){Ve("WebGLRenderer: Can't change size while VR device is presenting.");return}pe=S,De=B,t.width=Math.floor(S*Le),t.height=Math.floor(B*Le),$===!0&&(t.style.width=S+"px",t.style.height=B+"px"),z!==null&&z.setSize(t.width,t.height),this.setViewport(0,0,S,B)},this.getDrawingBufferSize=function(S){return S.set(pe*Le,De*Le).floor()},this.setDrawingBufferSize=function(S,B,$){pe=S,De=B,Le=$,t.width=Math.floor(S*$),t.height=Math.floor(B*$),this.setViewport(0,0,S,B)},this.setEffects=function(S){if(x===tn){console.error("THREE.WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(S){for(let B=0;B<S.length;B++)if(S[B].isOutputPass===!0){console.warn("THREE.WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}z.setEffects(S||[])},this.getCurrentViewport=function(S){return S.copy(U)},this.getViewport=function(S){return S.copy(ne)},this.setViewport=function(S,B,$,q){S.isVector4?ne.set(S.x,S.y,S.z,S.w):ne.set(S,B,$,q),se.viewport(U.copy(ne).multiplyScalar(Le).round())},this.getScissor=function(S){return S.copy(oe)},this.setScissor=function(S,B,$,q){S.isVector4?oe.set(S.x,S.y,S.z,S.w):oe.set(S,B,$,q),se.scissor(L.copy(oe).multiplyScalar(Le).round())},this.getScissorTest=function(){return we},this.setScissorTest=function(S){se.setScissorTest(we=S)},this.setOpaqueSort=function(S){qe=S},this.setTransparentSort=function(S){nt=S},this.getClearColor=function(S){return S.copy(me.getClearColor())},this.setClearColor=function(){me.setClearColor(...arguments)},this.getClearAlpha=function(){return me.getClearAlpha()},this.setClearAlpha=function(){me.setClearAlpha(...arguments)},this.clear=function(S=!0,B=!0,$=!0){let q=0;if(S){let V=!1;if(W!==null){const ve=W.texture.format;V=g.has(ve)}if(V){const ve=W.texture.type,Ce=d.has(ve),Ee=me.getClearColor(),Pe=me.getClearAlpha(),Ue=Ee.r,Oe=Ee.g,Ne=Ee.b;Ce?(T[0]=Ue,T[1]=Oe,T[2]=Ne,T[3]=Pe,b.clearBufferuiv(b.COLOR,0,T)):(A[0]=Ue,A[1]=Oe,A[2]=Ne,A[3]=Pe,b.clearBufferiv(b.COLOR,0,A))}else q|=b.COLOR_BUFFER_BIT}B&&(q|=b.DEPTH_BUFFER_BIT),$&&(q|=b.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),b.clear(q)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener("webglcontextlost",ze,!1),t.removeEventListener("webglcontextrestored",ut,!1),t.removeEventListener("webglcontextcreationerror",it,!1),me.dispose(),ce.dispose(),ge.dispose(),m.dispose(),k.dispose(),J.dispose(),ue.dispose(),Ae.dispose(),fe.dispose(),be.dispose(),_e.dispose(),_e.removeEventListener("sessionstart",Yl),_e.removeEventListener("sessionend",$l),_i.stop()};function ze(S){S.preventDefault(),Uc("WebGLRenderer: Context Lost."),E=!0}function ut(){Uc("WebGLRenderer: Context Restored."),E=!1;const S=v.autoReset,B=Te.enabled,$=Te.autoUpdate,q=Te.needsUpdate,V=Te.type;ae(),v.autoReset=S,Te.enabled=B,Te.autoUpdate=$,Te.needsUpdate=q,Te.type=V}function it(S){Je("WebGLRenderer: A WebGL context could not be created. Reason: ",S.statusMessage)}function pn(S){const B=S.target;B.removeEventListener("dispose",pn),Pn(B)}function Pn(S){ph(S),m.remove(S)}function ph(S){const B=m.get(S).programs;B!==void 0&&(B.forEach(function($){be.releaseProgram($)}),S.isShaderMaterial&&be.releaseShaderCache(S))}this.renderBufferDirect=function(S,B,$,q,V,ve){B===null&&(B=ee);const Ce=V.isMesh&&V.matrixWorld.determinant()<0,Ee=gh(S,B,$,q,V);se.setMaterial(q,Ce);let Pe=$.index,Ue=1;if(q.wireframe===!0){if(Pe=Me.getWireframeAttribute($),Pe===void 0)return;Ue=2}const Oe=$.drawRange,Ne=$.attributes.position;let Ye=Oe.start*Ue,at=(Oe.start+Oe.count)*Ue;ve!==null&&(Ye=Math.max(Ye,ve.start*Ue),at=Math.min(at,(ve.start+ve.count)*Ue)),Pe!==null?(Ye=Math.max(Ye,0),at=Math.min(at,Pe.count)):Ne!=null&&(Ye=Math.max(Ye,0),at=Math.min(at,Ne.count));const pt=at-Ye;if(pt<0||pt===1/0)return;Ae.setup(V,q,Ee,$,Pe);let mt,lt=F;if(Pe!==null&&(mt=H.get(Pe),lt=ye,lt.setIndex(mt)),V.isMesh)q.wireframe===!0?(se.setLineWidth(q.wireframeLinewidth*ie()),lt.setMode(b.LINES)):lt.setMode(b.TRIANGLES);else if(V.isLine){let Fe=q.linewidth;Fe===void 0&&(Fe=1),se.setLineWidth(Fe*ie()),V.isLineSegments?lt.setMode(b.LINES):V.isLineLoop?lt.setMode(b.LINE_LOOP):lt.setMode(b.LINE_STRIP)}else V.isPoints?lt.setMode(b.POINTS):V.isSprite&&lt.setMode(b.TRIANGLES);if(V.isBatchedMesh)if(V._multiDrawInstances!==null)Kr("WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),lt.renderMultiDrawInstances(V._multiDrawStarts,V._multiDrawCounts,V._multiDrawCount,V._multiDrawInstances);else if(re.get("WEBGL_multi_draw"))lt.renderMultiDraw(V._multiDrawStarts,V._multiDrawCounts,V._multiDrawCount);else{const Fe=V._multiDrawStarts,rt=V._multiDrawCounts,Ze=V._multiDrawCount,Wt=Pe?H.get(Pe).bytesPerElement:1,Fi=m.get(q).currentProgram.getUniforms();for(let Xt=0;Xt<Ze;Xt++)Fi.setValue(b,"_gl_DrawID",Xt),lt.render(Fe[Xt]/Wt,rt[Xt])}else if(V.isInstancedMesh)lt.renderInstances(Ye,pt,V.count);else if($.isInstancedBufferGeometry){const Fe=$._maxInstanceCount!==void 0?$._maxInstanceCount:1/0,rt=Math.min($.instanceCount,Fe);lt.renderInstances(Ye,pt,rt)}else lt.render(Ye,pt)};function ql(S,B,$){S.transparent===!0&&S.side===Vn&&S.forceSinglePass===!1?(S.side=Gt,S.needsUpdate=!0,ss(S,B,$),S.side=mi,S.needsUpdate=!0,ss(S,B,$),S.side=Vn):ss(S,B,$)}this.compile=function(S,B,$=null){$===null&&($=S),w=ge.get($),w.init(B),D.push(w),$.traverseVisible(function(V){V.isLight&&V.layers.test(B.layers)&&(w.pushLight(V),V.castShadow&&w.pushShadow(V))}),S!==$&&S.traverseVisible(function(V){V.isLight&&V.layers.test(B.layers)&&(w.pushLight(V),V.castShadow&&w.pushShadow(V))}),w.setupLights();const q=new Set;return S.traverse(function(V){if(!(V.isMesh||V.isPoints||V.isLine||V.isSprite))return;const ve=V.material;if(ve)if(Array.isArray(ve))for(let Ce=0;Ce<ve.length;Ce++){const Ee=ve[Ce];ql(Ee,$,V),q.add(Ee)}else ql(ve,$,V),q.add(ve)}),w=D.pop(),q},this.compileAsync=function(S,B,$=null){const q=this.compile(S,B,$);return new Promise(V=>{function ve(){if(q.forEach(function(Ce){m.get(Ce).currentProgram.isReady()&&q.delete(Ce)}),q.size===0){V(S);return}setTimeout(ve,10)}re.get("KHR_parallel_shader_compile")!==null?ve():setTimeout(ve,10)})};let da=null;function mh(S){da&&da(S)}function Yl(){_i.stop()}function $l(){_i.start()}const _i=new ch;_i.setAnimationLoop(mh),typeof self<"u"&&_i.setContext(self),this.setAnimationLoop=function(S){da=S,_e.setAnimationLoop(S),S===null?_i.stop():_i.start()},_e.addEventListener("sessionstart",Yl),_e.addEventListener("sessionend",$l),this.render=function(S,B){if(B!==void 0&&B.isCamera!==!0){Je("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(E===!0)return;const $=_e.enabled===!0&&_e.isPresenting===!0,q=z!==null&&(W===null||$)&&z.begin(M,W);if(S.matrixWorldAutoUpdate===!0&&S.updateMatrixWorld(),B.parent===null&&B.matrixWorldAutoUpdate===!0&&B.updateMatrixWorld(),_e.enabled===!0&&_e.isPresenting===!0&&(z===null||z.isCompositing()===!1)&&(_e.cameraAutoUpdate===!0&&_e.updateCamera(B),B=_e.getCamera()),S.isScene===!0&&S.onBeforeRender(M,S,B,W),w=ge.get(S,D.length),w.init(B),D.push(w),C.multiplyMatrices(B.projectionMatrix,B.matrixWorldInverse),Be.setFromProjectionMatrix(C,En,B.reversedDepth),Ke=this.localClippingEnabled,Re=xe.init(this.clippingPlanes,Ke),y=ce.get(S,R.length),y.init(),R.push(y),_e.enabled===!0&&_e.isPresenting===!0){const Ce=M.xr.getDepthSensingMesh();Ce!==null&&pa(Ce,B,-1/0,M.sortObjects)}pa(S,B,0,M.sortObjects),y.finish(),M.sortObjects===!0&&y.sort(qe,nt),j=_e.enabled===!1||_e.isPresenting===!1||_e.hasDepthSensing()===!1,j&&me.addToRenderList(y,S),this.info.render.frame++,Re===!0&&xe.beginShadows();const V=w.state.shadowsArray;if(Te.render(V,S,B),Re===!0&&xe.endShadows(),this.info.autoReset===!0&&this.info.reset(),(q&&z.hasRenderPass())===!1){const Ce=y.opaque,Ee=y.transmissive;if(w.setupLights(),B.isArrayCamera){const Pe=B.cameras;if(Ee.length>0)for(let Ue=0,Oe=Pe.length;Ue<Oe;Ue++){const Ne=Pe[Ue];jl(Ce,Ee,S,Ne)}j&&me.render(S);for(let Ue=0,Oe=Pe.length;Ue<Oe;Ue++){const Ne=Pe[Ue];Kl(y,S,Ne,Ne.viewport)}}else Ee.length>0&&jl(Ce,Ee,S,B),j&&me.render(S),Kl(y,S,B)}W!==null&&Z===0&&(P.updateMultisampleRenderTarget(W),P.updateRenderTargetMipmap(W)),q&&z.end(M),S.isScene===!0&&S.onAfterRender(M,S,B),Ae.resetDefaultState(),K=-1,Y=null,D.pop(),D.length>0?(w=D[D.length-1],Re===!0&&xe.setGlobalState(M.clippingPlanes,w.state.camera)):w=null,R.pop(),R.length>0?y=R[R.length-1]:y=null};function pa(S,B,$,q){if(S.visible===!1)return;if(S.layers.test(B.layers)){if(S.isGroup)$=S.renderOrder;else if(S.isLOD)S.autoUpdate===!0&&S.update(B);else if(S.isLight)w.pushLight(S),S.castShadow&&w.pushShadow(S);else if(S.isSprite){if(!S.frustumCulled||Be.intersectsSprite(S)){q&&G.setFromMatrixPosition(S.matrixWorld).applyMatrix4(C);const Ce=ue.update(S),Ee=S.material;Ee.visible&&y.push(S,Ce,Ee,$,G.z,null)}}else if((S.isMesh||S.isLine||S.isPoints)&&(!S.frustumCulled||Be.intersectsObject(S))){const Ce=ue.update(S),Ee=S.material;if(q&&(S.boundingSphere!==void 0?(S.boundingSphere===null&&S.computeBoundingSphere(),G.copy(S.boundingSphere.center)):(Ce.boundingSphere===null&&Ce.computeBoundingSphere(),G.copy(Ce.boundingSphere.center)),G.applyMatrix4(S.matrixWorld).applyMatrix4(C)),Array.isArray(Ee)){const Pe=Ce.groups;for(let Ue=0,Oe=Pe.length;Ue<Oe;Ue++){const Ne=Pe[Ue],Ye=Ee[Ne.materialIndex];Ye&&Ye.visible&&y.push(S,Ce,Ye,$,G.z,Ne)}}else Ee.visible&&y.push(S,Ce,Ee,$,G.z,null)}}const ve=S.children;for(let Ce=0,Ee=ve.length;Ce<Ee;Ce++)pa(ve[Ce],B,$,q)}function Kl(S,B,$,q){const{opaque:V,transmissive:ve,transparent:Ce}=S;w.setupLightsView($),Re===!0&&xe.setGlobalState(M.clippingPlanes,$),q&&se.viewport(U.copy(q)),V.length>0&&rs(V,B,$),ve.length>0&&rs(ve,B,$),Ce.length>0&&rs(Ce,B,$),se.buffers.depth.setTest(!0),se.buffers.depth.setMask(!0),se.buffers.color.setMask(!0),se.setPolygonOffset(!1)}function jl(S,B,$,q){if(($.isScene===!0?$.overrideMaterial:null)!==null)return;if(w.state.transmissionRenderTarget[q.id]===void 0){const Ye=re.has("EXT_color_buffer_half_float")||re.has("EXT_color_buffer_float");w.state.transmissionRenderTarget[q.id]=new An(1,1,{generateMipmaps:!0,type:Ye?Kn:tn,minFilter:Di,samples:Q.samples,stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:je.workingColorSpace})}const ve=w.state.transmissionRenderTarget[q.id],Ce=q.viewport||U;ve.setSize(Ce.z*M.transmissionResolutionScale,Ce.w*M.transmissionResolutionScale);const Ee=M.getRenderTarget(),Pe=M.getActiveCubeFace(),Ue=M.getActiveMipmapLevel();M.setRenderTarget(ve),M.getClearColor(te),he=M.getClearAlpha(),he<1&&M.setClearColor(16777215,.5),M.clear(),j&&me.render($);const Oe=M.toneMapping;M.toneMapping=Tn;const Ne=q.viewport;if(q.viewport!==void 0&&(q.viewport=void 0),w.setupLightsView(q),Re===!0&&xe.setGlobalState(M.clippingPlanes,q),rs(S,$,q),P.updateMultisampleRenderTarget(ve),P.updateRenderTargetMipmap(ve),re.has("WEBGL_multisampled_render_to_texture")===!1){let Ye=!1;for(let at=0,pt=B.length;at<pt;at++){const mt=B[at],{object:lt,geometry:Fe,material:rt,group:Ze}=mt;if(rt.side===Vn&&lt.layers.test(q.layers)){const Wt=rt.side;rt.side=Gt,rt.needsUpdate=!0,Zl(lt,$,q,Fe,rt,Ze),rt.side=Wt,rt.needsUpdate=!0,Ye=!0}}Ye===!0&&(P.updateMultisampleRenderTarget(ve),P.updateRenderTargetMipmap(ve))}M.setRenderTarget(Ee,Pe,Ue),M.setClearColor(te,he),Ne!==void 0&&(q.viewport=Ne),M.toneMapping=Oe}function rs(S,B,$){const q=B.isScene===!0?B.overrideMaterial:null;for(let V=0,ve=S.length;V<ve;V++){const Ce=S[V],{object:Ee,geometry:Pe,group:Ue}=Ce;let Oe=Ce.material;Oe.allowOverride===!0&&q!==null&&(Oe=q),Ee.layers.test($.layers)&&Zl(Ee,B,$,Pe,Oe,Ue)}}function Zl(S,B,$,q,V,ve){S.onBeforeRender(M,B,$,q,V,ve),S.modelViewMatrix.multiplyMatrices($.matrixWorldInverse,S.matrixWorld),S.normalMatrix.getNormalMatrix(S.modelViewMatrix),V.onBeforeRender(M,B,$,q,S,ve),V.transparent===!0&&V.side===Vn&&V.forceSinglePass===!1?(V.side=Gt,V.needsUpdate=!0,M.renderBufferDirect($,B,q,V,S,ve),V.side=mi,V.needsUpdate=!0,M.renderBufferDirect($,B,q,V,S,ve),V.side=Vn):M.renderBufferDirect($,B,q,V,S,ve),S.onAfterRender(M,B,$,q,V,ve)}function ss(S,B,$){B.isScene!==!0&&(B=ee);const q=m.get(S),V=w.state.lights,ve=w.state.shadowsArray,Ce=V.state.version,Ee=be.getParameters(S,V.state,ve,B,$),Pe=be.getProgramCacheKey(Ee);let Ue=q.programs;q.environment=S.isMeshStandardMaterial?B.environment:null,q.fog=B.fog,q.envMap=(S.isMeshStandardMaterial?J:k).get(S.envMap||q.environment),q.envMapRotation=q.environment!==null&&S.envMap===null?B.environmentRotation:S.envMapRotation,Ue===void 0&&(S.addEventListener("dispose",pn),Ue=new Map,q.programs=Ue);let Oe=Ue.get(Pe);if(Oe!==void 0){if(q.currentProgram===Oe&&q.lightsStateVersion===Ce)return Ql(S,Ee),Oe}else Ee.uniforms=be.getUniforms(S),S.onBeforeCompile(Ee,M),Oe=be.acquireProgram(Ee,Pe),Ue.set(Pe,Oe),q.uniforms=Ee.uniforms;const Ne=q.uniforms;return(!S.isShaderMaterial&&!S.isRawShaderMaterial||S.clipping===!0)&&(Ne.clippingPlanes=xe.uniform),Ql(S,Ee),q.needsLights=xh(S),q.lightsStateVersion=Ce,q.needsLights&&(Ne.ambientLightColor.value=V.state.ambient,Ne.lightProbe.value=V.state.probe,Ne.directionalLights.value=V.state.directional,Ne.directionalLightShadows.value=V.state.directionalShadow,Ne.spotLights.value=V.state.spot,Ne.spotLightShadows.value=V.state.spotShadow,Ne.rectAreaLights.value=V.state.rectArea,Ne.ltc_1.value=V.state.rectAreaLTC1,Ne.ltc_2.value=V.state.rectAreaLTC2,Ne.pointLights.value=V.state.point,Ne.pointLightShadows.value=V.state.pointShadow,Ne.hemisphereLights.value=V.state.hemi,Ne.directionalShadowMap.value=V.state.directionalShadowMap,Ne.directionalShadowMatrix.value=V.state.directionalShadowMatrix,Ne.spotShadowMap.value=V.state.spotShadowMap,Ne.spotLightMatrix.value=V.state.spotLightMatrix,Ne.spotLightMap.value=V.state.spotLightMap,Ne.pointShadowMap.value=V.state.pointShadowMap,Ne.pointShadowMatrix.value=V.state.pointShadowMatrix),q.currentProgram=Oe,q.uniformsList=null,Oe}function Jl(S){if(S.uniformsList===null){const B=S.currentProgram.getUniforms();S.uniformsList=Vs.seqWithValue(B.seq,S.uniforms)}return S.uniformsList}function Ql(S,B){const $=m.get(S);$.outputColorSpace=B.outputColorSpace,$.batching=B.batching,$.batchingColor=B.batchingColor,$.instancing=B.instancing,$.instancingColor=B.instancingColor,$.instancingMorph=B.instancingMorph,$.skinning=B.skinning,$.morphTargets=B.morphTargets,$.morphNormals=B.morphNormals,$.morphColors=B.morphColors,$.morphTargetsCount=B.morphTargetsCount,$.numClippingPlanes=B.numClippingPlanes,$.numIntersection=B.numClipIntersection,$.vertexAlphas=B.vertexAlphas,$.vertexTangents=B.vertexTangents,$.toneMapping=B.toneMapping}function gh(S,B,$,q,V){B.isScene!==!0&&(B=ee),P.resetTextureUnits();const ve=B.fog,Ce=q.isMeshStandardMaterial?B.environment:null,Ee=W===null?M.outputColorSpace:W.isXRRenderTarget===!0?W.texture.colorSpace:pr,Pe=(q.isMeshStandardMaterial?J:k).get(q.envMap||Ce),Ue=q.vertexColors===!0&&!!$.attributes.color&&$.attributes.color.itemSize===4,Oe=!!$.attributes.tangent&&(!!q.normalMap||q.anisotropy>0),Ne=!!$.morphAttributes.position,Ye=!!$.morphAttributes.normal,at=!!$.morphAttributes.color;let pt=Tn;q.toneMapped&&(W===null||W.isXRRenderTarget===!0)&&(pt=M.toneMapping);const mt=$.morphAttributes.position||$.morphAttributes.normal||$.morphAttributes.color,lt=mt!==void 0?mt.length:0,Fe=m.get(q),rt=w.state.lights;if(Re===!0&&(Ke===!0||S!==Y)){const Dt=S===Y&&q.id===K;xe.setState(q,S,Dt)}let Ze=!1;q.version===Fe.__version?(Fe.needsLights&&Fe.lightsStateVersion!==rt.state.version||Fe.outputColorSpace!==Ee||V.isBatchedMesh&&Fe.batching===!1||!V.isBatchedMesh&&Fe.batching===!0||V.isBatchedMesh&&Fe.batchingColor===!0&&V.colorTexture===null||V.isBatchedMesh&&Fe.batchingColor===!1&&V.colorTexture!==null||V.isInstancedMesh&&Fe.instancing===!1||!V.isInstancedMesh&&Fe.instancing===!0||V.isSkinnedMesh&&Fe.skinning===!1||!V.isSkinnedMesh&&Fe.skinning===!0||V.isInstancedMesh&&Fe.instancingColor===!0&&V.instanceColor===null||V.isInstancedMesh&&Fe.instancingColor===!1&&V.instanceColor!==null||V.isInstancedMesh&&Fe.instancingMorph===!0&&V.morphTexture===null||V.isInstancedMesh&&Fe.instancingMorph===!1&&V.morphTexture!==null||Fe.envMap!==Pe||q.fog===!0&&Fe.fog!==ve||Fe.numClippingPlanes!==void 0&&(Fe.numClippingPlanes!==xe.numPlanes||Fe.numIntersection!==xe.numIntersection)||Fe.vertexAlphas!==Ue||Fe.vertexTangents!==Oe||Fe.morphTargets!==Ne||Fe.morphNormals!==Ye||Fe.morphColors!==at||Fe.toneMapping!==pt||Fe.morphTargetsCount!==lt)&&(Ze=!0):(Ze=!0,Fe.__version=q.version);let Wt=Fe.currentProgram;Ze===!0&&(Wt=ss(q,B,V));let Fi=!1,Xt=!1,xr=!1;const ft=Wt.getUniforms(),Ot=Fe.uniforms;if(se.useProgram(Wt.program)&&(Fi=!0,Xt=!0,xr=!0),q.id!==K&&(K=q.id,Xt=!0),Fi||Y!==S){se.buffers.depth.getReversed()&&S.reversedDepth!==!0&&(S._reversedDepth=!0,S.updateProjectionMatrix()),ft.setValue(b,"projectionMatrix",S.projectionMatrix),ft.setValue(b,"viewMatrix",S.matrixWorldInverse);const Bt=ft.map.cameraPosition;Bt!==void 0&&Bt.setValue(b,I.setFromMatrixPosition(S.matrixWorld)),Q.logarithmicDepthBuffer&&ft.setValue(b,"logDepthBufFC",2/(Math.log(S.far+1)/Math.LN2)),(q.isMeshPhongMaterial||q.isMeshToonMaterial||q.isMeshLambertMaterial||q.isMeshBasicMaterial||q.isMeshStandardMaterial||q.isShaderMaterial)&&ft.setValue(b,"isOrthographic",S.isOrthographicCamera===!0),Y!==S&&(Y=S,Xt=!0,xr=!0)}if(Fe.needsLights&&(rt.state.directionalShadowMap.length>0&&ft.setValue(b,"directionalShadowMap",rt.state.directionalShadowMap,P),rt.state.spotShadowMap.length>0&&ft.setValue(b,"spotShadowMap",rt.state.spotShadowMap,P),rt.state.pointShadowMap.length>0&&ft.setValue(b,"pointShadowMap",rt.state.pointShadowMap,P)),V.isSkinnedMesh){ft.setOptional(b,V,"bindMatrix"),ft.setOptional(b,V,"bindMatrixInverse");const Dt=V.skeleton;Dt&&(Dt.boneTexture===null&&Dt.computeBoneTexture(),ft.setValue(b,"boneTexture",Dt.boneTexture,P))}V.isBatchedMesh&&(ft.setOptional(b,V,"batchingTexture"),ft.setValue(b,"batchingTexture",V._matricesTexture,P),ft.setOptional(b,V,"batchingIdTexture"),ft.setValue(b,"batchingIdTexture",V._indirectTexture,P),ft.setOptional(b,V,"batchingColorTexture"),V._colorsTexture!==null&&ft.setValue(b,"batchingColorTexture",V._colorsTexture,P));const Zt=$.morphAttributes;if((Zt.position!==void 0||Zt.normal!==void 0||Zt.color!==void 0)&&He.update(V,$,Wt),(Xt||Fe.receiveShadow!==V.receiveShadow)&&(Fe.receiveShadow=V.receiveShadow,ft.setValue(b,"receiveShadow",V.receiveShadow)),q.isMeshGouraudMaterial&&q.envMap!==null&&(Ot.envMap.value=Pe,Ot.flipEnvMap.value=Pe.isCubeTexture&&Pe.isRenderTargetTexture===!1?-1:1),q.isMeshStandardMaterial&&q.envMap===null&&B.environment!==null&&(Ot.envMapIntensity.value=B.environmentIntensity),Ot.dfgLUT!==void 0&&(Ot.dfgLUT.value=aS()),Xt&&(ft.setValue(b,"toneMappingExposure",M.toneMappingExposure),Fe.needsLights&&_h(Ot,xr),ve&&q.fog===!0&&Ie.refreshFogUniforms(Ot,ve),Ie.refreshMaterialUniforms(Ot,q,Le,De,w.state.transmissionRenderTarget[S.id]),Vs.upload(b,Jl(Fe),Ot,P)),q.isShaderMaterial&&q.uniformsNeedUpdate===!0&&(Vs.upload(b,Jl(Fe),Ot,P),q.uniformsNeedUpdate=!1),q.isSpriteMaterial&&ft.setValue(b,"center",V.center),ft.setValue(b,"modelViewMatrix",V.modelViewMatrix),ft.setValue(b,"normalMatrix",V.normalMatrix),ft.setValue(b,"modelMatrix",V.matrixWorld),q.isShaderMaterial||q.isRawShaderMaterial){const Dt=q.uniformsGroups;for(let Bt=0,ma=Dt.length;Bt<ma;Bt++){const xi=Dt[Bt];fe.update(xi,Wt),fe.bind(xi,Wt)}}return Wt}function _h(S,B){S.ambientLightColor.needsUpdate=B,S.lightProbe.needsUpdate=B,S.directionalLights.needsUpdate=B,S.directionalLightShadows.needsUpdate=B,S.pointLights.needsUpdate=B,S.pointLightShadows.needsUpdate=B,S.spotLights.needsUpdate=B,S.spotLightShadows.needsUpdate=B,S.rectAreaLights.needsUpdate=B,S.hemisphereLights.needsUpdate=B}function xh(S){return S.isMeshLambertMaterial||S.isMeshToonMaterial||S.isMeshPhongMaterial||S.isMeshStandardMaterial||S.isShadowMaterial||S.isShaderMaterial&&S.lights===!0}this.getActiveCubeFace=function(){return N},this.getActiveMipmapLevel=function(){return Z},this.getRenderTarget=function(){return W},this.setRenderTargetTextures=function(S,B,$){const q=m.get(S);q.__autoAllocateDepthBuffer=S.resolveDepthBuffer===!1,q.__autoAllocateDepthBuffer===!1&&(q.__useRenderToTexture=!1),m.get(S.texture).__webglTexture=B,m.get(S.depthTexture).__webglTexture=q.__autoAllocateDepthBuffer?void 0:$,q.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(S,B){const $=m.get(S);$.__webglFramebuffer=B,$.__useDefaultFramebuffer=B===void 0};const vh=b.createFramebuffer();this.setRenderTarget=function(S,B=0,$=0){W=S,N=B,Z=$;let q=null,V=!1,ve=!1;if(S){const Ee=m.get(S);if(Ee.__useDefaultFramebuffer!==void 0){se.bindFramebuffer(b.FRAMEBUFFER,Ee.__webglFramebuffer),U.copy(S.viewport),L.copy(S.scissor),O=S.scissorTest,se.viewport(U),se.scissor(L),se.setScissorTest(O),K=-1;return}else if(Ee.__webglFramebuffer===void 0)P.setupRenderTarget(S);else if(Ee.__hasExternalTextures)P.rebindTextures(S,m.get(S.texture).__webglTexture,m.get(S.depthTexture).__webglTexture);else if(S.depthBuffer){const Oe=S.depthTexture;if(Ee.__boundDepthTexture!==Oe){if(Oe!==null&&m.has(Oe)&&(S.width!==Oe.image.width||S.height!==Oe.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");P.setupDepthRenderbuffer(S)}}const Pe=S.texture;(Pe.isData3DTexture||Pe.isDataArrayTexture||Pe.isCompressedArrayTexture)&&(ve=!0);const Ue=m.get(S).__webglFramebuffer;S.isWebGLCubeRenderTarget?(Array.isArray(Ue[B])?q=Ue[B][$]:q=Ue[B],V=!0):S.samples>0&&P.useMultisampledRTT(S)===!1?q=m.get(S).__webglMultisampledFramebuffer:Array.isArray(Ue)?q=Ue[$]:q=Ue,U.copy(S.viewport),L.copy(S.scissor),O=S.scissorTest}else U.copy(ne).multiplyScalar(Le).floor(),L.copy(oe).multiplyScalar(Le).floor(),O=we;if($!==0&&(q=vh),se.bindFramebuffer(b.FRAMEBUFFER,q)&&se.drawBuffers(S,q),se.viewport(U),se.scissor(L),se.setScissorTest(O),V){const Ee=m.get(S.texture);b.framebufferTexture2D(b.FRAMEBUFFER,b.COLOR_ATTACHMENT0,b.TEXTURE_CUBE_MAP_POSITIVE_X+B,Ee.__webglTexture,$)}else if(ve){const Ee=B;for(let Pe=0;Pe<S.textures.length;Pe++){const Ue=m.get(S.textures[Pe]);b.framebufferTextureLayer(b.FRAMEBUFFER,b.COLOR_ATTACHMENT0+Pe,Ue.__webglTexture,$,Ee)}}else if(S!==null&&$!==0){const Ee=m.get(S.texture);b.framebufferTexture2D(b.FRAMEBUFFER,b.COLOR_ATTACHMENT0,b.TEXTURE_2D,Ee.__webglTexture,$)}K=-1},this.readRenderTargetPixels=function(S,B,$,q,V,ve,Ce,Ee=0){if(!(S&&S.isWebGLRenderTarget)){Je("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Pe=m.get(S).__webglFramebuffer;if(S.isWebGLCubeRenderTarget&&Ce!==void 0&&(Pe=Pe[Ce]),Pe){se.bindFramebuffer(b.FRAMEBUFFER,Pe);try{const Ue=S.textures[Ee],Oe=Ue.format,Ne=Ue.type;if(!Q.textureFormatReadable(Oe)){Je("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!Q.textureTypeReadable(Ne)){Je("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}B>=0&&B<=S.width-q&&$>=0&&$<=S.height-V&&(S.textures.length>1&&b.readBuffer(b.COLOR_ATTACHMENT0+Ee),b.readPixels(B,$,q,V,de.convert(Oe),de.convert(Ne),ve))}finally{const Ue=W!==null?m.get(W).__webglFramebuffer:null;se.bindFramebuffer(b.FRAMEBUFFER,Ue)}}},this.readRenderTargetPixelsAsync=async function(S,B,$,q,V,ve,Ce,Ee=0){if(!(S&&S.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Pe=m.get(S).__webglFramebuffer;if(S.isWebGLCubeRenderTarget&&Ce!==void 0&&(Pe=Pe[Ce]),Pe)if(B>=0&&B<=S.width-q&&$>=0&&$<=S.height-V){se.bindFramebuffer(b.FRAMEBUFFER,Pe);const Ue=S.textures[Ee],Oe=Ue.format,Ne=Ue.type;if(!Q.textureFormatReadable(Oe))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!Q.textureTypeReadable(Ne))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const Ye=b.createBuffer();b.bindBuffer(b.PIXEL_PACK_BUFFER,Ye),b.bufferData(b.PIXEL_PACK_BUFFER,ve.byteLength,b.STREAM_READ),S.textures.length>1&&b.readBuffer(b.COLOR_ATTACHMENT0+Ee),b.readPixels(B,$,q,V,de.convert(Oe),de.convert(Ne),0);const at=W!==null?m.get(W).__webglFramebuffer:null;se.bindFramebuffer(b.FRAMEBUFFER,at);const pt=b.fenceSync(b.SYNC_GPU_COMMANDS_COMPLETE,0);return b.flush(),await Am(b,pt,4),b.bindBuffer(b.PIXEL_PACK_BUFFER,Ye),b.getBufferSubData(b.PIXEL_PACK_BUFFER,0,ve),b.deleteBuffer(Ye),b.deleteSync(pt),ve}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(S,B=null,$=0){const q=Math.pow(2,-$),V=Math.floor(S.image.width*q),ve=Math.floor(S.image.height*q),Ce=B!==null?B.x:0,Ee=B!==null?B.y:0;P.setTexture2D(S,0),b.copyTexSubImage2D(b.TEXTURE_2D,$,0,0,Ce,Ee,V,ve),se.unbindTexture()};const Sh=b.createFramebuffer(),Mh=b.createFramebuffer();this.copyTextureToTexture=function(S,B,$=null,q=null,V=0,ve=null){ve===null&&(V!==0?(Kr("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),ve=V,V=0):ve=0);let Ce,Ee,Pe,Ue,Oe,Ne,Ye,at,pt;const mt=S.isCompressedTexture?S.mipmaps[ve]:S.image;if($!==null)Ce=$.max.x-$.min.x,Ee=$.max.y-$.min.y,Pe=$.isBox3?$.max.z-$.min.z:1,Ue=$.min.x,Oe=$.min.y,Ne=$.isBox3?$.min.z:0;else{const Zt=Math.pow(2,-V);Ce=Math.floor(mt.width*Zt),Ee=Math.floor(mt.height*Zt),S.isDataArrayTexture?Pe=mt.depth:S.isData3DTexture?Pe=Math.floor(mt.depth*Zt):Pe=1,Ue=0,Oe=0,Ne=0}q!==null?(Ye=q.x,at=q.y,pt=q.z):(Ye=0,at=0,pt=0);const lt=de.convert(B.format),Fe=de.convert(B.type);let rt;B.isData3DTexture?(P.setTexture3D(B,0),rt=b.TEXTURE_3D):B.isDataArrayTexture||B.isCompressedArrayTexture?(P.setTexture2DArray(B,0),rt=b.TEXTURE_2D_ARRAY):(P.setTexture2D(B,0),rt=b.TEXTURE_2D),b.pixelStorei(b.UNPACK_FLIP_Y_WEBGL,B.flipY),b.pixelStorei(b.UNPACK_PREMULTIPLY_ALPHA_WEBGL,B.premultiplyAlpha),b.pixelStorei(b.UNPACK_ALIGNMENT,B.unpackAlignment);const Ze=b.getParameter(b.UNPACK_ROW_LENGTH),Wt=b.getParameter(b.UNPACK_IMAGE_HEIGHT),Fi=b.getParameter(b.UNPACK_SKIP_PIXELS),Xt=b.getParameter(b.UNPACK_SKIP_ROWS),xr=b.getParameter(b.UNPACK_SKIP_IMAGES);b.pixelStorei(b.UNPACK_ROW_LENGTH,mt.width),b.pixelStorei(b.UNPACK_IMAGE_HEIGHT,mt.height),b.pixelStorei(b.UNPACK_SKIP_PIXELS,Ue),b.pixelStorei(b.UNPACK_SKIP_ROWS,Oe),b.pixelStorei(b.UNPACK_SKIP_IMAGES,Ne);const ft=S.isDataArrayTexture||S.isData3DTexture,Ot=B.isDataArrayTexture||B.isData3DTexture;if(S.isDepthTexture){const Zt=m.get(S),Dt=m.get(B),Bt=m.get(Zt.__renderTarget),ma=m.get(Dt.__renderTarget);se.bindFramebuffer(b.READ_FRAMEBUFFER,Bt.__webglFramebuffer),se.bindFramebuffer(b.DRAW_FRAMEBUFFER,ma.__webglFramebuffer);for(let xi=0;xi<Pe;xi++)ft&&(b.framebufferTextureLayer(b.READ_FRAMEBUFFER,b.COLOR_ATTACHMENT0,m.get(S).__webglTexture,V,Ne+xi),b.framebufferTextureLayer(b.DRAW_FRAMEBUFFER,b.COLOR_ATTACHMENT0,m.get(B).__webglTexture,ve,pt+xi)),b.blitFramebuffer(Ue,Oe,Ce,Ee,Ye,at,Ce,Ee,b.DEPTH_BUFFER_BIT,b.NEAREST);se.bindFramebuffer(b.READ_FRAMEBUFFER,null),se.bindFramebuffer(b.DRAW_FRAMEBUFFER,null)}else if(V!==0||S.isRenderTargetTexture||m.has(S)){const Zt=m.get(S),Dt=m.get(B);se.bindFramebuffer(b.READ_FRAMEBUFFER,Sh),se.bindFramebuffer(b.DRAW_FRAMEBUFFER,Mh);for(let Bt=0;Bt<Pe;Bt++)ft?b.framebufferTextureLayer(b.READ_FRAMEBUFFER,b.COLOR_ATTACHMENT0,Zt.__webglTexture,V,Ne+Bt):b.framebufferTexture2D(b.READ_FRAMEBUFFER,b.COLOR_ATTACHMENT0,b.TEXTURE_2D,Zt.__webglTexture,V),Ot?b.framebufferTextureLayer(b.DRAW_FRAMEBUFFER,b.COLOR_ATTACHMENT0,Dt.__webglTexture,ve,pt+Bt):b.framebufferTexture2D(b.DRAW_FRAMEBUFFER,b.COLOR_ATTACHMENT0,b.TEXTURE_2D,Dt.__webglTexture,ve),V!==0?b.blitFramebuffer(Ue,Oe,Ce,Ee,Ye,at,Ce,Ee,b.COLOR_BUFFER_BIT,b.NEAREST):Ot?b.copyTexSubImage3D(rt,ve,Ye,at,pt+Bt,Ue,Oe,Ce,Ee):b.copyTexSubImage2D(rt,ve,Ye,at,Ue,Oe,Ce,Ee);se.bindFramebuffer(b.READ_FRAMEBUFFER,null),se.bindFramebuffer(b.DRAW_FRAMEBUFFER,null)}else Ot?S.isDataTexture||S.isData3DTexture?b.texSubImage3D(rt,ve,Ye,at,pt,Ce,Ee,Pe,lt,Fe,mt.data):B.isCompressedArrayTexture?b.compressedTexSubImage3D(rt,ve,Ye,at,pt,Ce,Ee,Pe,lt,mt.data):b.texSubImage3D(rt,ve,Ye,at,pt,Ce,Ee,Pe,lt,Fe,mt):S.isDataTexture?b.texSubImage2D(b.TEXTURE_2D,ve,Ye,at,Ce,Ee,lt,Fe,mt.data):S.isCompressedTexture?b.compressedTexSubImage2D(b.TEXTURE_2D,ve,Ye,at,mt.width,mt.height,lt,mt.data):b.texSubImage2D(b.TEXTURE_2D,ve,Ye,at,Ce,Ee,lt,Fe,mt);b.pixelStorei(b.UNPACK_ROW_LENGTH,Ze),b.pixelStorei(b.UNPACK_IMAGE_HEIGHT,Wt),b.pixelStorei(b.UNPACK_SKIP_PIXELS,Fi),b.pixelStorei(b.UNPACK_SKIP_ROWS,Xt),b.pixelStorei(b.UNPACK_SKIP_IMAGES,xr),ve===0&&B.generateMipmaps&&b.generateMipmap(rt),se.unbindTexture()},this.initRenderTarget=function(S){m.get(S).__webglFramebuffer===void 0&&P.setupRenderTarget(S)},this.initTexture=function(S){S.isCubeTexture?P.setTextureCube(S,0):S.isData3DTexture?P.setTexture3D(S,0):S.isDataArrayTexture||S.isCompressedArrayTexture?P.setTexture2DArray(S,0):P.setTexture2D(S,0),se.unbindTexture()},this.resetState=function(){N=0,Z=0,W=null,se.reset(),Ae.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return En}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=je._getDrawingBufferColorSpace(e),t.unpackColorSpace=je._getUnpackColorSpace()}}const tr=window.innerWidth<768,Vt={particleCount:tr?5e3:9e3,particleSize:tr?1.5:1,textScale:tr?.12:.16,canvasFont:tr?'900 80px "Microsoft YaHei", sans-serif':'900 120px "Microsoft YaHei", sans-serif'},lS=["快乐","喜悦","平静","爱","感恩","希望","自豪","兴奋","幽默","悲伤","愤怒","恐惧","焦虑","羞愧","嫉妒","孤独","内疚","厌恶"];function Qi(n){const e=document.createElement("canvas"),t=e.getContext("2d");e.width=tr?512:1024,e.height=256,t.fillStyle="black",t.fillRect(0,0,e.width,e.height),t.fillStyle="white",t.font=Vt.canvasFont,t.textAlign="center",t.textBaseline="middle",t.fillText(n,e.width/2,e.height/2);const i=t.getImageData(0,0,e.width,e.height),r=[],s=tr?3:2;for(let a=0;a<e.height;a+=s)for(let o=0;o<e.width;o+=s)i.data[(a*e.width+o)*4]>100&&r.push({x:(o-e.width/2)*Vt.textScale,y:-(a-e.height/2)*Vt.textScale,z:0});return r}function cS(n){const e=[];for(let t=0;t<n;t++){const i=(Math.random()-.5)*160;let r=Math.abs(i)*.6+4;const s=Math.random()*Math.PI*2;Math.abs(i)>75&&(r=Math.random()*r),e.push({x:r*Math.cos(s),y:i,z:r*Math.sin(s)})}return e}function uS(n){const e=[];for(let s=0;s<n;s++)e.push({x:(Math.random()-.5)*80,y:(Math.random()-.5)*40-100,z:(Math.random()-.5)*40});return e}function fS(n){const e=[];for(let t=0;t<n;t++){const i=t<n/2,r=i?-40:40;let s="glass",a=(Math.random()-.5)*80,o=20,l=Math.random()*Math.PI*2;Math.random()>.6&&a<20&&a>-35&&(s="liquid",o=Math.random()*18);let c=o*Math.cos(l),u=o*Math.sin(l),f=a;s==="glass"&&a>-10&&a<25&&Math.abs(l-(i?Math.PI:0))<.5&&(c+=i?-10:10,s="handle"),e.push({x:c+r,y:f,z:u,type:s,isLeft:i,baseX:c+r})}return e}function hS(n){const e=[];for(let t=0;t<n;t++){const i=(Math.random()-.5)*140;let r=0;i>40?r=12*(80-i)/40:i>-50?r=12:r=12+(-50-i);const s=Math.random()*Math.PI*2;e.push({x:r*Math.cos(s),y:i,z:r*Math.sin(s)})}return e}function dS(n){const e=[],i=n-150;for(let r=0;r<i;r++){const s=Math.random();let a,o,l;a=(s-.5)*300,o=-.001*a*a+10,l=(Math.random()-.5)*40,Math.random()>.5&&(o-=Math.random()*8);let u=s>.4&&s<.6,f=o;u&&(f=-150-Math.random()*50),e.push({x:a,y:f,z:l,targetY:o,type:"bridge",isBrokenPart:u})}for(let r=0;r<150;r++)e.push({x:-160,y:0,z:0,type:"man"});return e}const ha=(n,e)=>{const t=n.__vccOpts||n;for(const[i,r]of e)t[i]=r;return t},pS={__name:"ParticleScene",props:{currentShape:String,triggerState:Number,currentTheme:String},setup(n){const e=n,t=xn(null);let i,r,s,a,o,l=[],c,u=0,f=[],h=[],p=[],_=[],x=[],g=[],d=[],T=[],A=[],y=[],w=[],R=[],D=[];const z=async()=>{i=new Zm,i.fog=new Wl(0,.002),r=new en(75,window.innerWidth/window.innerHeight,.1,1e3),r.position.z=130,s=new oS({antialias:!0,alpha:!0}),s.setSize(window.innerWidth,window.innerHeight),s.setPixelRatio(Math.min(window.devicePixelRatio,2)),t.value&&t.value.appendChild(s.domElement),M(),Z()},M=()=>{o=new dn;const K=Vt.particleCount,Y=new Float32Array(K*3),U=new Float32Array(K*3);l=new Float32Array(K*3);for(let te=0;te<K;te++)Y[te*3]=(Math.random()-.5)*600,Y[te*3+1]=(Math.random()-.5)*600,Y[te*3+2]=(Math.random()-.5)*600,U[te*3]=1,U[te*3+1]=1,U[te*3+2]=1;o.setAttribute("position",new rn(Y,3)),o.setAttribute("color",new rn(U,3));const L=new ug().load("https://threejs.org/examples/textures/sprites/spark1.png"),O=new ah({size:Vt.particleSize,map:L,transparent:!0,opacity:.9,vertexColors:!0,blending:_o,depthWrite:!1});a=new ng(o,O),i.add(a),E()},E=()=>{u=0;let K=[];const Y=Vt.particleCount;if(e.currentShape==="hourglass")f.length===0&&(f=cS(Y*.6),h=Qi("2025"),p=Qi("今年辛苦啦")),K=[...f];else if(e.currentShape==="fireworks"){if(_.length===0&&(_=uS(Y)),x.length===0){x=lS.map(U=>Qi(U));for(let U=0;U<18;U++)g[U]=0,d[U]=0}K=_}else e.currentShape==="beer"?(T.length===0&&(T=fS(Y*.8),A=Qi("2025 有你相伴")),K=T):e.currentShape==="rocket"?(y.length===0&&(y=hS(Y),w=Qi("2026新年快乐")),K=y):e.currentShape==="bridge"&&(R.length===0&&(R=dS(Y*.8),D=Qi("2026 与你同行")),K=R);for(let U=0;U<Y;U++){const L=U*3;U<K.length?(l[L]=K[U].x,l[L+1]=K[U].y,l[L+2]=K[U].z):(l[L]=(Math.random()-.5)*400,l[L+1]=(Math.random()-.5)*400,l[L+2]=(Math.random()-.5)*200-100)}N()},N=()=>{if(!o)return;const K=o.attributes.color;for(let Y=0;Y<Vt.particleCount;Y++){let U,L,O;const te=Math.random();e.currentTheme==="warm"?te>.6?(U=1,L=.8,O=.2):te>.3?(U=1,L=.4,O=.1):(U=1,L=1,O=.9):te>.6?(U=0,L=1,O=.9):te>.3?(U=.6,L=0,O=1):(U=1,L=1,O=1),e.currentShape==="beer"&&Y<T.length&&T[Y].type==="liquid"&&(U=1,L=.7,O=0),K.setXYZ(Y,U,L,O)}K.needsUpdate=!0},Z=()=>{c=requestAnimationFrame(Z);const K=o.attributes.position.array;if(u+=.01,e.currentShape==="hourglass")for(let L=0;L<Vt.particleCount;L++){const O=L*3;if(L<f.length){const te=l[O],he=l[O+2],pe=Math.atan2(he,te)+.003,De=Math.sqrt(te*te+he*he);l[O]=De*Math.cos(pe),l[O+2]=De*Math.sin(pe)}else{const te=L-f.length,he=h.length,pe=p.length,De=te%1e3*.005,Le=u-De;if(Le<0){const qe=h[te%he];l[O]=qe.x,l[O+1]=qe.y+40,l[O+2]=qe.z}else if(Le<2.5){const qe=Le/2.5;l[O]=(Math.random()-.5)*2,l[O+1]=40-qe*80,l[O+2]=(Math.random()-.5)*2}else{const qe=p[te%pe];l[O]=qe.x,l[O+1]=qe.y-40,l[O+2]=qe.z}}}else if(e.currentShape==="fireworks"){if(e.triggerState>=1){const L=Math.floor(u*100);for(let O=0;O<18;O++)if(L>O*20&&g[O]===0&&(g[O]=1),g[O]>0){d[O]++;const te=_.length+O*250,he=te+250,pe=x[O];for(let De=te;De<he&&!(De>=Vt.particleCount);De++){const Le=De*3;if(g[O]===1)l[Le]=(Math.random()-.5)*10,l[Le+1]+=3,l[Le+2]=(Math.random()-.5)*10,d[O]>40&&(g[O]=2);else if(g[O]===2){const qe=pe[De%pe.length],nt=qe.x,ne=qe.y+20,oe=qe.z;l[Le]+=(nt-l[Le])*.15,l[Le+1]+=(ne-l[Le+1])*.15,l[Le+2]+=(oe-l[Le+2])*.15,d[O]>100&&(g[O]=3)}else g[O]===3&&(l[Le]*=1.05,l[Le+1]*=1.05,l[Le+2]*=1.05)}}}for(let U=0;U<_.length;U++)Math.random()>.995?l[U*3+1]+=30:l[U*3+1]+=(_[U].y-l[U*3+1])*.2}else if(e.currentShape==="beer")for(let U=0;U<Vt.particleCount;U++){const L=U*3;if(U<T.length){const O=T[U];let te=O.x,he=O.y;if(e.triggerState>=1&&(O.isLeft?te+=20:te-=20,e.triggerState===2&&O.type==="liquid"&&Math.random()>.98)){l[L+1]+=2,l[L]+=(Math.random()-.5)*2;continue}O.type==="liquid"&&(he+=Math.sin(u*3+te*.1)*1.5),l[L]=te,l[L+1]=he}else if(e.triggerState===2){const O=U-T.length,te=A[O%A.length];l[L]=te.x,l[L+1]=te.y-50,l[L+2]=te.z}}else if(e.currentShape==="rocket"){if(e.triggerState===1)for(let U=0;U<Vt.particleCount;U++)l[U*3+1]+=6,Math.random()>.6&&(l[U*3+1]-=15);else if(e.triggerState===2)for(let U=0;U<Vt.particleCount;U++){const L=U*3;if(U<w.length){const O=w[U];l[L]=O.x,l[L+1]=O.y,l[L+2]=O.z}else l[L]*=1.1}}else if(e.currentShape==="bridge"&&e.triggerState>=1)for(let U=0;U<Vt.particleCount;U++){const L=U*3;if(U<R.length){const O=R[U];if(O.isBrokenPart&&(l[L+1]+=(O.targetY-l[L+1])*.05),O.type==="man"){const te=u*60%350-175;l[L]=te,l[L+1]=-.001*te*te+10+Math.abs(Math.sin(te*.2))*3,l[L+2]=0}}else{const O=U-R.length,te=D[O%D.length];l[L]=te.x,l[L+1]=te.y-50,l[L+2]=te.z}}const Y=.1;for(let U=0;U<Vt.particleCount;U++){const L=U*3;K[L]+=(l[L]-K[L])*Y,K[L+1]+=(l[L+1]-K[L+1])*Y,K[L+2]+=(l[L+2]-K[L+2])*Y}o.attributes.position.needsUpdate=!0,s.render(i,r)};Nr(()=>e.currentShape,E),Nr(()=>e.currentTheme,N),af(()=>{z(),window.addEventListener("resize",W)}),Cl(()=>{cancelAnimationFrame(c),window.removeEventListener("resize",W)});const W=()=>{!r||!s||(r.aspect=window.innerWidth/window.innerHeight,r.updateProjectionMatrix(),s.setSize(window.innerWidth,window.innerHeight),E())};return(K,Y)=>(bn(),Gn("div",{ref_key:"canvasContainer",ref:t,class:"canvas-wrapper"},null,512))}},mS=ha(pS,[["__scopeId","data-v-ef6fdff0"]]),gS={id:"ui-container"},_S={class:"panel-card"},xS={class:"year-group"},vS={class:"year-item"},SS={key:0,class:"hint-box"},MS={class:"action-hint"},ES={class:"year-item"},yS={key:0,class:"hint-box"},bS={class:"action-hint"},TS={__name:"ControlPanel",props:{currentYear:String,sceneIndex:Number},emits:["select-year"],setup(n){const e=n,t=Il(()=>{if(e.currentYear==="2025"){if(e.sceneIndex===0)return"自动流动中...";if(e.sceneIndex===1)return"✌️ 剪刀手：触发情绪烟花";if(e.sceneIndex===2)return"✊ 握拳：干杯"}else{if(e.sceneIndex===0)return"🖐️ 上滑：发射火箭";if(e.sceneIndex===1)return"✊ 握拳：连接桥梁"}return""});return(i,r)=>(bn(),Gn("div",gS,[vt("div",_S,[vt("div",xS,[vt("div",vS,[vt("button",{class:cr(["year-btn y25",{active:n.currentYear==="2025"}]),onClick:r[0]||(r[0]=s=>i.$emit("select-year","2025"))}," 2025 ",2),n.currentYear==="2025"?(bn(),Gn("div",SS,[r[2]||(r[2]=vt("span",{class:"gesture-icon"},"👋 左 → 右 切页",-1)),vt("span",MS,Hs(t.value),1)])):Ys("",!0)]),r[4]||(r[4]=vt("div",{class:"divider"},null,-1)),vt("div",ES,[vt("button",{class:cr(["year-btn y26",{active:n.currentYear==="2026"}]),onClick:r[1]||(r[1]=s=>i.$emit("select-year","2026"))}," 2026 ",2),n.currentYear==="2026"?(bn(),Gn("div",yS,[r[3]||(r[3]=vt("span",{class:"gesture-icon"},"👋 右 ← 左 切页",-1)),vt("span",bS,Hs(t.value),1)])):Ys("",!0)])])])]))}},AS=ha(TS,[["__scopeId","data-v-800c17ae"]]);function yu(n){return new Promise((e,t)=>{if(document.querySelector(`script[src="${n}"]`)){e();return}const i=document.createElement("script");i.src=n,i.async=!0,i.crossOrigin="anonymous",i.onload=()=>e(),i.onerror=()=>t(new Error(`Script load error: ${n}`)),document.head.appendChild(i)})}const wS={class:"camera-wrapper"},RS={__name:"CameraInput",props:{isActive:Boolean},emits:["status-change","camera-error","gesture","hand-x","hand-y"],setup(n,{expose:e,emit:t}){const i=n,r=t,s=xn(null),a=xn(null);let o=null,l=null,c=-1;const u=(_,x)=>Math.sqrt(Math.pow(_.x-x.x,2)+Math.pow(_.y-x.y,2)),f=async()=>{try{r("status-change","引擎启动中..."),await Promise.all([yu("https://cdn.jsdelivr.net/npm/@mediapipe/hands/hands.js"),yu("https://cdn.jsdelivr.net/npm/@mediapipe/drawing_utils/drawing_utils.js")]);const _=window.Hands;o=new _({locateFile:g=>`https://cdn.jsdelivr.net/npm/@mediapipe/hands/${g}`}),o.setOptions({maxNumHands:1,modelComplexity:0,minDetectionConfidence:.4,minTrackingConfidence:.4}),o.onResults(p);const x=await navigator.mediaDevices.getUserMedia({video:{facingMode:"user",width:{ideal:320},height:{ideal:240}}});s.value.srcObject=x,s.value.onloadedmetadata=()=>{s.value.play(),a.value.width=s.value.videoWidth,a.value.height=s.value.videoHeight,r("status-change","视觉引擎就绪"),h()}}catch(_){console.error(_),r("camera-error",_.name==="NotAllowedError"?"NO_PERMISSION":"NO_HARDWARE")}},h=async()=>{i.isActive&&(s.value&&s.value.readyState>=2&&s.value.currentTime!==c&&(c=s.value.currentTime,o&&await o.send({image:s.value})),l=requestAnimationFrame(h))},p=_=>{if(!a.value)return;const x=a.value.getContext("2d"),g=a.value.width,d=a.value.height;if(x.save(),x.clearRect(0,0,g,d),x.translate(g,0),x.scale(-1,1),x.drawImage(_.image,0,0,g,d),_.multiHandLandmarks&&_.multiHandLandmarks.length>0){const T=_.multiHandLandmarks[0];window.drawConnectors&&window.drawConnectors(x,T,window.HAND_CONNECTIONS,{color:"#00d2ff",lineWidth:2}),r("hand-x",T[0].x),r("hand-y",T[0].y);const A=(M,E)=>u(T[0],T[M])>u(T[0],T[E])*1.1,y=A(8,6),w=A(12,10),R=A(16,14),D=A(20,18);let z="NONE";y&&w&&!R&&!D?z="VICTORY":!y&&!w&&!R&&!D?z="FIST":(y&&w&&R||w&&R&&D)&&(z="PALM"),r("gesture",z)}x.restore()};return e({startCamera:f}),Cl(()=>{s.value?.srcObject&&s.value.srcObject.getTracks().forEach(_=>_.stop()),cancelAnimationFrame(l),o&&o.close()}),(_,x)=>(bn(),Gn("div",wS,[vt("video",{ref_key:"inputVideo",ref:s,playsinline:"","webkit-playsinline":"",style:{display:"none"}},null,512),pd(vt("canvas",{ref_key:"previewCanvas",ref:a,class:"video-preview"},null,512),[[Ap,n.isActive]])]))}},CS=ha(RS,[["__scopeId","data-v-44c007ca"]]),PS={key:0,id:"overlay"},DS={__name:"IntroOverlay",props:{visible:Boolean,showGuide:Boolean},emits:["select-mode"],setup(n){return(e,t)=>(bn(),Gn(ln,null,[n.visible?(bn(),Gn("div",PS,[t[2]||(t[2]=vt("h2",{class:"title"},"Lynx",-1)),t[3]||(t[3]=vt("div",{class:"msg-box"},"请选择交互方式",-1)),vt("button",{id:"btn-cam",class:"action-btn",onClick:t[0]||(t[0]=i=>e.$emit("select-mode","camera"))},"开启摄像头"),vt("button",{id:"btn-touch",class:"action-btn",onClick:t[1]||(t[1]=i=>e.$emit("select-mode","touch"))},"触屏 / 鼠标模式")])):Ys("",!0),vt("div",{id:"touch-guide",class:cr({show:n.showGuide})},"⟵ 滑动屏幕控制扩散 ⟶",2)],64))}},LS=ha(DS,[["__scopeId","data-v-da6579d6"]]),IS={class:"app-container"},US={key:0,class:"status-tip"},NS={__name:"App",setup(n){const e=xn("2025"),t=xn(0),i=xn("warm"),r=xn(0),s=xn(""),a=xn(!0),o=xn(null),l={2025:["hourglass","fireworks","beer"],2026:["rocket","bridge"]},c=Il(()=>l[e.value][t.value]);let u=-1,f=-1,h=!1;const p=R=>{a.value=!1,R==="camera"&&o.value.startCamera()},_=R=>{e.value=R,t.value=0,r.value=0,i.value=R==="2025"?"warm":"cyber"},x=R=>{if(h)return;if(u===-1){u=R;return}const D=R-u;u=R;const z=.04;(e.value==="2025"&&D>z||e.value==="2026"&&D<-z)&&g()},g=()=>{h=!0,r.value=0;const R=l[e.value].length;t.value=(t.value+1)%R,s.value="切换场景...",setTimeout(()=>h=!1,1500)},d=R=>{if(h||r.value!==0)return;if(f===-1){f=R;return}const D=R-f;f=R,D<-.05&&c.value==="rocket"&&y(2e3)};let T=0;const A=R=>{h||r.value!==0||(c.value==="fireworks"&&R==="VICTORY"?(T++,T>3&&y(0)):(c.value==="beer"||c.value==="bridge")&&R==="FIST"?(T++,T>5&&y(2e3)):T=0)},y=R=>{h=!0,r.value=1,s.value="特效触发!",R>0?setTimeout(()=>{r.value=2,setTimeout(()=>{h=!1},3e3)},R):setTimeout(()=>{h=!1},2e3)},w=R=>{s.value="摄像头错误: "+R};return(R,D)=>(bn(),Gn("div",IS,[jt(mS,{currentShape:c.value,currentTheme:i.value,triggerState:r.value},null,8,["currentShape","currentTheme","triggerState"]),jt(CS,{ref_key:"cameraInputRef",ref:o,isActive:"",onStatusChange:D[0]||(D[0]=z=>s.value=z),onCameraError:w,onHandX:x,onHandY:d,onGesture:A},null,512),jt(AS,{currentYear:e.value,sceneIndex:t.value,onSelectYear:_},null,8,["currentYear","sceneIndex"]),jt(LS,{visible:a.value,onSelectMode:p},null,8,["visible"]),s.value?(bn(),Gn("div",US,Hs(s.value),1)):Ys("",!0)]))}};kp(NS).mount("#app");
