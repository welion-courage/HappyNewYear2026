...
`)+`
`+d);const w=b+g+a,T=b+d+o,C=Fu(r,r.VERTEX_SHADER,w),D=Fu(r,r.FRAGMENT_SHADER,T);r.attachShader(v,C),r.attachShader(v,D),t.index0AttributeName!==void 0?r.bindAttribLocation(v,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(v,0,"position"),r.linkProgram(v);function R(I){if(n.debug.checkShaderErrors){const U=r.getProgramInfoLog(v)||"",N=r.getShaderInfoLog(C)||"",Y=r.getShaderInfoLog(D)||"",j=U.trim(),X=N.trim(),V=Y.trim();let ee=!0,se=!0;if(r.getProgramParameter(v,r.LINK_STATUS)===!1)if(ee=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(r,v,C,D);else{const re=Bu(r,C,"vertex"),fe=Bu(r,D,"fragment");Qe("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(v,r.VALIDATE_STATUS)+`
