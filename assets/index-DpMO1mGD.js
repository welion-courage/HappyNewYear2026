...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Yn,depthTest:!1,depthWrite:!1})}function Hx(n,e,t){const i=new Float32Array(Bi),r=new j(0,1,0);return new Ln({name:"SphericalGaussianBlur",defines:{n:Bi,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${n}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:i},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:r}},vertexShader:Ta(),fragmentShader:`
...
`)}const qv={[ch]:"Linear",[uh]:"Reinhard",[fh]:"Cineon",[hh]:"ACESFilmic",[ph]:"AgX",[mh]:"Neutral",[dh]:"Custom"};function Yv(n,e){const t=qv[e];return t===void 0?(We("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+n+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+n+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Ws=new j;function $v(){Ze.getLuminanceCoefficients(Ws);const n=Ws.x.toFixed(4),e=Ws.y.toFixed(4),t=Ws.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${n}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
`)+`
`+d);const A=b+g+a,y=b+d+o,w=Fu(r,r.VERTEX_SHADER,A),D=Fu(r,r.FRAGMENT_SHADER,y);r.attachShader(v,w),r.attachShader(v,D),t.index0AttributeName!==void 0?r.bindAttribLocation(v,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(v,0,"position"),r.linkProgram(v);function P(I){if(n.debug.checkShaderErrors){const U=r.getProgramInfoLog(v)||"",B=r.getShaderInfoLog(w)||"",V=r.getShaderInfoLog(D)||"",$=U.trim(),X=B.trim(),z=V.trim();let W=!0,re=!0;if(r.getProgramParameter(v,r.LINK_STATUS)===!1)if(W=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(r,v,w,D);else{const oe=Bu(r,w,"vertex"),fe=Bu(r,D,"fragment");Qe("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(v,r.VALIDATE_STATUS)+`
...
Program Info Log: `+$+`
`+oe+`
`+fe)}else $!==""?We("WebGLProgram: Program Info Log:",$):(X===""||z==="")&&(re=!1);re&&(I.diagnostics={runnable:W,programLog:$,vertexShader:{log:X,prefix:g},fragmentShader:{log:z,prefix:d}})}r.deleteShader(w),r.deleteShader(D),O=new Qs(r,v),x=Zv(r,v)}let O;this.getUniforms=function(){return O===void 0&&P(this),O};let x;this.getAttributes=function(){return x===void 0&&P(this),x};let E=t.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return E===!1&&(E=r.getProgramParameter(v,Hv)),E},this.destroy=function(){i.releaseStatesOfProgram(this),r.deleteProgram(v),this.program=void 0},this.type=t.shaderType,this.name=t.shaderName,this.id=Gv++,this.cacheKey=e,this.usedTimes=1,this.program=v,this.vertexShader=w,this.fragmentShader=D,this}let dS=0;class pS{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){const t=e.vertexShader,i=e.fragmentShader,r=this._getShaderStage(t),s=this._getShaderStage(i),a=this._getShaderCacheForMaterial(e);return a.has(r)===!1&&(a.add(r),r.usedTimes++),a.has(s)===!1&&(a.add(s),s.usedTimes++),this}remove(e){const t=this.materialCache.get(e);for(const i of t)i.usedTimes--,i.usedTimes===0&&this.shaderCache.delete(i.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const t=this.materialCache;let i=t.get(e);return i===void 0&&(i=new Set,t.set(e,i)),i}_getShaderStage(e){const t=this.shaderCache;let i=t.get(e);return i===void 0&&(i=new mS(e),t.set(e,i)),i}}class mS{constructor(e){this.id=dS++,this.code=e,this.usedTimes=0}}function gS(n,e,t,i,r,s,a){const o=new wh,l=new pS,u=new Set,c=[],f=new Map,h=r.logarithmicDepthBuffer;let p=r.precision;const _={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distance",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function v(x){return u.add(x),x===0?"uv":`uv${x}`}function g(x,E,I,U,B){const V=U.fog,$=B.geometry,X=x.isMeshStandardMaterial?U.environment:null,z=(x.isMeshStandardMaterial?t:e).get(x.envMap||X),W=z&&z.mapping===Ea?z.image.height:null,re=_[x.type];x.precision!==null&&(p=r.getMaxPrecision(x.precision),p!==x.precision&&We("WebGLProgram.getParameters:",x.precision,"not supported, using",p,"instead."));const oe=$.morphAttributes.position||$.morphAttributes.normal||$.morphAttributes.color,fe=oe!==void 0?oe.length:0;let Ne=0;$.morphAttributes.position!==void 0&&(Ne=1),$.morphAttributes.normal!==void 0&&(Ne=2),$.morphAttributes.color!==void 0&&(Ne=3);let he,Pe,Ie,q;if(re){const it=bn[re];he=it.vertexShader,Pe=it.fragmentShader}else he=x.vertexShader,Pe=x.fragmentShader,l.update(x),Ie=l.getVertexShaderID(x),q=l.getFragmentShaderID(x);const K=n.getRenderTarget(),_e=n.state.buffers.depth.getReversed(),Be=B.isInstancedMesh===!0,me=B.isBatchedMesh===!0,Me=!!x.map,C=!!x.matcap,R=!!z,H=!!x.aoMap,ee=!!x.lightMap,J=!!x.bumpMap,ie=!!x.normalMap,T=!!x.displacementMap,ce=!!x.emissiveMap,se=!!x.metalnessMap,ne=!!x.roughnessMap,ae=x.anisotropy>0,S=x.clearcoat>0,m=x.dispersion>0,L=x.iridescence>0,Y=x.sheen>0,te=x.transmission>0,k=ae&&!!x.anisotropyMap,Te=S&&!!x.clearcoatMap,de=S&&!!x.clearcoatNormalMap,Ce=S&&!!x.clearcoatRoughnessMap,Fe=L&&!!x.iridescenceMap,ue=L&&!!x.iridescenceThicknessMap,ve=Y&&!!x.sheenColorMap,Ee=Y&&!!x.sheenRoughnessMap,Re=!!x.specularMap,xe=!!x.specularColorMap,Xe=!!x.specularIntensityMap,N=te&&!!x.transmissionMap,we=te&&!!x.thicknessMap,ge=!!x.gradientMap,De=!!x.alphaMap,pe=x.alphaTest>0,le=!!x.alphaHash,Se=!!x.extensions;let ke=Rn;x.toneMapped&&(K===null||K.isXRRenderTarget===!0)&&(ke=n.toneMapping);const ut={shaderID:re,shaderType:x.type,shaderName:x.name,vertexShader:he,fragmentShader:Pe,defines:x.defines,customVertexShaderID:Ie,customFragmentShaderID:q,isRawShaderMaterial:x.isRawShaderMaterial===!0,glslVersion:x.glslVersion,precision:p,batching:me,batchingColor:me&&B._colorsTexture!==null,instancing:Be,instancingColor:Be&&B.instanceColor!==null,instancingMorph:Be&&B.morphTexture!==null,outputColorSpace:K===null?n.outputColorSpace:K.isXRRenderTarget===!0?K.texture.colorSpace:Er,alphaToCoverage:!!x.alphaToCoverage,map:Me,matcap:C,envMap:R,envMapMode:R&&z.mapping,envMapCubeUVHeight:W,aoMap:H,lightMap:ee,bumpMap:J,normalMap:ie,displacementMap:T,emissiveMap:ce,normalMapObjectSpace:ie&&x.normalMapType===tg,normalMapTangentSpace:ie&&x.normalMapType===eg,metalnessMap:se,roughnessMap:ne,anisotropy:ae,anisotropyMap:k,clearcoat:S,clearcoatMap:Te,clearcoatNormalMap:de,clearcoatRoughnessMap:Ce,dispersion:m,iridescence:L,iridescenceMap:Fe,iridescenceThicknessMap:ue,sheen:Y,sheenColorMap:ve,sheenRoughnessMap:Ee,specularMap:Re,specularColorMap:xe,specularIntensityMap:Xe,transmission:te,transmissionMap:N,thicknessMap:we,gradientMap:ge,opaque:x.transparent===!1&&x.blending===gr&&x.alphaToCoverage===!1,alphaMap:De,alphaTest:pe,alphaHash:le,combine:x.combine,mapUv:Me&&v(x.map.channel),aoMapUv:H&&v(x.aoMap.channel),lightMapUv:ee&&v(x.lightMap.channel),bumpMapUv:J&&v(x.bumpMap.channel),normalMapUv:ie&&v(x.normalMap.channel),displacementMapUv:T&&v(x.displacementMap.channel),emissiveMapUv:ce&&v(x.emissiveMap.channel),metalnessMapUv:se&&v(x.metalnessMap.channel),roughnessMapUv:ne&&v(x.roughnessMap.channel),anisotropyMapUv:k&&v(x.anisotropyMap.channel),clearcoatMapUv:Te&&v(x.clearcoatMap.channel),clearcoatNormalMapUv:de&&v(x.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:Ce&&v(x.clearcoatRoughnessMap.channel),iridescenceMapUv:Fe&&v(x.iridescenceMap.channel),iridescenceThicknessMapUv:ue&&v(x.iridescenceThicknessMap.channel),sheenColorMapUv:ve&&v(x.sheenColorMap.channel),sheenRoughnessMapUv:Ee&&v(x.sheenRoughnessMap.channel),specularMapUv:Re&&v(x.specularMap.channel),specularColorMapUv:xe&&v(x.specularColorMap.channel),specularIntensityMapUv:Xe&&v(x.specularIntensityMap.channel),transmissionMapUv:N&&v(x.transmissionMap.channel),thicknessMapUv:we&&v(x.thicknessMap.channel),alphaMapUv:De&&v(x.alphaMap.channel),vertexTangents:!!$.attributes.tangent&&(ie||ae),vertexColors:x.vertexColors,vertexAlphas:x.vertexColors===!0&&!!$.attributes.color&&$.attributes.color.itemSize===4,pointsUvs:B.isPoints===!0&&!!$.attributes.uv&&(Me||De),fog:!!V,useFog:x.fog===!0,fogExp2:!!V&&V.isFogExp2,flatShading:x.flatShading===!0&&x.wireframe===!1,sizeAttenuation:x.sizeAttenuation===!0,logarithmicDepthBuffer:h,reversedDepthBuffer:_e,skinning:B.isSkinnedMesh===!0,morphTargets:$.morphAttributes.position!==void 0,morphNormals:$.morphAttributes.normal!==void 0,morphColors:$.morphAttributes.color!==void 0,morphTargetsCount:fe,morphTextureStride:Ne,numDirLights:E.directional.length,numPointLights:E.point.length,numSpotLights:E.spot.length,numSpotLightMaps:E.spotLightMap.length,numRectAreaLights:E.rectArea.length,numHemiLights:E.hemi.length,numDirLightShadows:E.directionalShadowMap.length,numPointLightShadows:E.pointShadowMap.length,numSpotLightShadows:E.spotShadowMap.length,numSpotLightShadowsWithMaps:E.numSpotLightShadowsWithMaps,numLightProbes:E.numLightProbes,numClippingPlanes:a.numPlanes,numClipIntersection:a.numIntersection,dithering:x.dithering,shadowMapEnabled:n.shadowMap.enabled&&I.length>0,shadowMapType:n.shadowMap.type,toneMapping:ke,decodeVideoTexture:Me&&x.map.isVideoTexture===!0&&Ze.getTransfer(x.map.colorSpace)===st,decodeVideoTextureEmissive:ce&&x.emissiveMap.isVideoTexture===!0&&Ze.getTransfer(x.emissiveMap.colorSpace)===st,premultipliedAlpha:x.premultipliedAlpha,doubleSided:x.side===Xn,flipSided:x.side===Wt,useDepthPacking:x.depthPacking>=0,depthPacking:x.depthPacking||0,index0AttributeName:x.index0AttributeName,extensionClipCullDistance:Se&&x.extensions.clipCullDistance===!0&&i.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(Se&&x.extensions.multiDraw===!0||me)&&i.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:i.has("KHR_parallel_shader_compile"),customProgramCacheKey:x.customProgramCacheKey()};return ut.vertexUv1s=u.has(1),ut.vertexUv2s=u.has(2),ut.vertexUv3s=u.has(3),u.clear(),ut}function d(x){const E=[];if(x.shaderID?E.push(x.shaderID):(E.push(x.customVertexShaderID),E.push(x.customFragmentShaderID)),x.defines!==void 0)for(const I in x.defines)E.push(I),E.push(x.defines[I]);return x.isRawShaderMaterial===!1&&(b(E,x),A(E,x),E.push(n.outputColorSpace)),E.push(x.customProgramCacheKey),E.join()}function b(x,E){x.push(E.precision),x.push(E.outputColorSpace),x.push(E.envMapMode),x.push(E.envMapCubeUVHeight),x.push(E.mapUv),x.push(E.alphaMapUv),x.push(E.lightMapUv),x.push(E.aoMapUv),x.push(E.bumpMapUv),x.push(E.normalMapUv),x.push(E.displacementMapUv),x.push(E.emissiveMapUv),x.push(E.metalnessMapUv),x.push(E.roughnessMapUv),x.push(E.anisotropyMapUv),x.push(E.clearcoatMapUv),x.push(E.clearcoatNormalMapUv),x.push(E.clearcoatRoughnessMapUv),x.push(E.iridescenceMapUv),x.push(E.iridescenceThicknessMapUv),x.push(E.sheenColorMapUv),x.push(E.sheenRoughnessMapUv),x.push(E.specularMapUv),x.push(E.specularColorMapUv),x.push(E.specularIntensityMapUv),x.push(E.transmissionMapUv),x.push(E.thicknessMapUv),x.push(E.combine),x.push(E.fogExp2),x.push(E.sizeAttenuation),x.push(E.morphTargetsCount),x.push(E.morphAttributeCount),x.push(E.numDirLights),x.push(E.numPointLights),x.push(E.numSpotLights),x.push(E.numSpotLightMaps),x.push(E.numHemiLights),x.push(E.numRectAreaLights),x.push(E.numDirLightShadows),x.push(E.numPointLightShadows),x.push(E.numSpotLightShadows),x.push(E.numSpotLightShadowsWithMaps),x.push(E.numLightProbes),x.push(E.shadowMapType),x.push(E.toneMapping),x.push(E.numClippingPlanes),x.push(E.numClipIntersection),x.push(E.depthPacking)}function A(x,E){o.disableAll(),E.instancing&&o.enable(0),E.instancingColor&&o.enable(1),E.instancingMorph&&o.enable(2),E.matcap&&o.enable(3),E.envMap&&o.enable(4),E.normalMapObjectSpace&&o.enable(5),E.normalMapTangentSpace&&o.enable(6),E.clearcoat&&o.enable(7),E.iridescence&&o.enable(8),E.alphaTest&&o.enable(9),E.vertexColors&&o.enable(10),E.vertexAlphas&&o.enable(11),E.vertexUv1s&&o.enable(12),E.vertexUv2s&&o.enable(13),E.vertexUv3s&&o.enable(14),E.vertexTangents&&o.enable(15),E.anisotropy&&o.enable(16),E.alphaHash&&o.enable(17),E.batching&&o.enable(18),E.dispersion&&o.enable(19),E.batchingColor&&o.enable(20),E.gradientMap&&o.enable(21),x.push(o.mask),o.disableAll(),E.fog&&o.enable(0),E.useFog&&o.enable(1),E.flatShading&&o.enable(2),E.logarithmicDepthBuffer&&o.enable(3),E.reversedDepthBuffer&&o.enable(4),E.skinning&&o.enable(5),E.morphTargets&&o.enable(6),E.morphNormals&&o.enable(7),E.morphColors&&o.enable(8),E.premultipliedAlpha&&o.enable(9),E.shadowMapEnabled&&o.enable(10),E.doubleSided&&o.enable(11),E.flipSided&&o.enable(12),E.useDepthPacking&&o.enable(13),E.dithering&&o.enable(14),E.transmission&&o.enable(15),E.sheen&&o.enable(16),E.opaque&&o.enable(17),E.pointsUvs&&o.enable(18),E.decodeVideoTexture&&o.enable(19),E.decodeVideoTextureEmissive&&o.enable(20),E.alphaToCoverage&&o.enable(21),x.push(o.mask)}function y(x){const E=_[x.type];let I;if(E){const U=bn[E];I=Rg.clone(U.uniforms)}else I=x.uniforms;return I}function w(x,E){let I=f.get(E);return I!==void 0?++I.usedTimes:(I=new hS(n,E,x,s),c.push(I),f.set(E,I)),I}function D(x){if(--x.usedTimes===0){const E=c.indexOf(x);c[E]=c[c.length-1],c.pop(),f.delete(x.cacheKey),x.destroy()}}function P(x){l.remove(x)}function O(){l.dispose()}return{getParameters:g,getProgramCacheKey:d,getUniforms:y,acquireProgram:w,releaseProgram:D,releaseShaderCache:P,programs:c,dispose:O}}function _S(){let n=new WeakMap;function e(a){return n.has(a)}function t(a){let o=n.get(a);return o===void 0&&(o={},n.set(a,o)),o}function i(a){n.delete(a)}function r(a,o,l){n.get(a)[o]=l}function s(){n=new WeakMap}return{has:e,get:t,remove:i,update:r,dispose:s}}function xS(n,e){return n.groupOrder!==e.groupOrder?n.groupOrder-e.groupOrder:n.renderOrder!==e.renderOrder?n.renderOrder-e.renderOrder:n.material.id!==e.material.id?n.material.id-e.material.id:n.z!==e.z?n.z-e.z:n.id-e.id}function ku(n,e){return n.groupOrder!==e.groupOrder?n.groupOrder-e.groupOrder:n.renderOrder!==e.renderOrder?n.renderOrder-e.renderOrder:n.z!==e.z?e.z-n.z:n.id-e.id}function Wu(){const n=[];let e=0;const t=[],i=[],r=[];function s(){e=0,t.length=0,i.length=0,r.length=0}function a(f,h,p,_,v,g){let d=n[e];return d===void 0?(d={id:f.id,object:f,geometry:h,material:p,groupOrder:_,renderOrder:f.renderOrder,z:v,group:g},n[e]=d):(d.id=f.id,d.object=f,d.geometry=h,d.material=p,d.groupOrder=_,d.renderOrder=f.renderOrder,d.z=v,d.group=g),e++,d}function o(f,h,p,_,v,g){const d=a(f,h,p,_,v,g);p.transmission>0?i.push(d):p.transparent===!0?r.push(d):t.push(d)}function l(f,h,p,_,v,g){const d=a(f,h,p,_,v,g);p.transmission>0?i.unshift(d):p.transparent===!0?r.unshift(d):t.unshift(d)}function u(f,h){t.length>1&&t.sort(f||xS),i.length>1&&i.sort(h||ku),r.length>1&&r.sort(h||ku)}function c(){for(let f=e,h=n.length;f<h;f++){const p=n[f];if(p.id===null)break;p.id=null,p.object=null,p.geometry=null,p.material=null,p.group=null}}return{opaque:t,transmissive:i,transparent:r,init:s,push:o,unshift:l,finish:c,sort:u}}function vS(){let n=new WeakMap;function e(i,r){const s=n.get(i);let a;return s===void 0?(a=new Wu,n.set(i,[a])):r>=s.length?(a=new Wu,s.push(a)):a=s[r],a}function t(){n=new WeakMap}return{get:e,dispose:t}}function SS(){const n={};return{get:function(e){if(n[e.id]!==void 0)return n[e.id];let t;switch(e.type){case"DirectionalLight":t={direction:new j,color:new nt};break;case"SpotLight":t={position:new j,direction:new j,color:new nt,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":t={position:new j,color:new nt,distance:0,decay:0};break;case"HemisphereLight":t={direction:new j,skyColor:new nt,groundColor:new nt};break;case"RectAreaLight":t={color:new nt,position:new j,halfWidth:new j,halfHeight:new j};break}return n[e.id]=t,t}}}function MS(){const n={};return{get:function(e){if(n[e.id]!==void 0)return n[e.id];let t;switch(e.type){case"DirectionalLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new ot};break;case"SpotLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new ot};break;case"PointLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new ot,shadowCameraNear:1,shadowCameraFar:1e3};break}return n[e.id]=t,t}}}let ES=0;function yS(n,e){return(e.castShadow?2:0)-(n.castShadow?2:0)+(e.map?1:0)-(n.map?1:0)}function bS(n){const e=new SS,t=MS(),i={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let u=0;u<9;u++)i.probe.push(new j);const r=new j,s=new xt,a=new xt;function o(u){let c=0,f=0,h=0;for(let x=0;x<9;x++)i.probe[x].set(0,0,0);let p=0,_=0,v=0,g=0,d=0,b=0,A=0,y=0,w=0,D=0,P=0;u.sort(yS);for(let x=0,E=u.length;x<E;x++){const I=u[x],U=I.color,B=I.intensity,V=I.distance;let $=null;if(I.shadow&&I.shadow.map&&(I.shadow.map.texture.format===Mr?$=I.shadow.map.texture:$=I.shadow.map.depthTexture||I.shadow.map.texture),I.isAmbientLight)c+=U.r*B,f+=U.g*B,h+=U.b*B;else if(I.isLightProbe){for(let X=0;X<9;X++)i.probe[X].addScaledVector(I.sh.coefficients[X],B);P++}else if(I.isDirectionalLight){const X=e.get(I);if(X.color.copy(I.color).multiplyScalar(I.intensity),I.castShadow){const z=I.shadow,W=t.get(I);W.shadowIntensity=z.intensity,W.shadowBias=z.bias,W.shadowNormalBias=z.normalBias,W.shadowRadius=z.radius,W.shadowMapSize=z.mapSize,i.directionalShadow[p]=W,i.directionalShadowMap[p]=$,i.directionalShadowMatrix[p]=I.shadow.matrix,b++}i.directional[p]=X,p++}else if(I.isSpotLight){const X=e.get(I);X.position.setFromMatrixPosition(I.matrixWorld),X.color.copy(U).multiplyScalar(B),X.distance=V,X.coneCos=Math.cos(I.angle),X.penumbraCos=Math.cos(I.angle*(1-I.penumbra)),X.decay=I.decay,i.spot[v]=X;const z=I.shadow;if(I.map&&(i.spotLightMap[w]=I.map,w++,z.updateMatrices(I),I.castShadow&&D++),i.spotLightMatrix[v]=z.matrix,I.castShadow){const W=t.get(I);W.shadowIntensity=z.intensity,W.shadowBias=z.bias,W.shadowNormalBias=z.normalBias,W.shadowRadius=z.radius,W.shadowMapSize=z.mapSize,i.spotShadow[v]=W,i.spotShadowMap[v]=$,y++}v++}else if(I.isRectAreaLight){const X=e.get(I);X.color.copy(U).multiplyScalar(B),X.halfWidth.set(I.width*.5,0,0),X.halfHeight.set(0,I.height*.5,0),i.rectArea[g]=X,g++}else if(I.isPointLight){const X=e.get(I);if(X.color.copy(I.color).multiplyScalar(I.intensity),X.distance=I.distance,X.decay=I.decay,I.castShadow){const z=I.shadow,W=t.get(I);W.shadowIntensity=z.intensity,W.shadowBias=z.bias,W.shadowNormalBias=z.normalBias,W.shadowRadius=z.radius,W.shadowMapSize=z.mapSize,W.shadowCameraNear=z.camera.near,W.shadowCameraFar=z.camera.far,i.pointShadow[_]=W,i.pointShadowMap[_]=$,i.pointShadowMatrix[_]=I.shadow.matrix,A++}i.point[_]=X,_++}else if(I.isHemisphereLight){const X=e.get(I);X.skyColor.copy(I.color).multiplyScalar(B),X.groundColor.copy(I.groundColor).multiplyScalar(B),i.hemi[d]=X,d++}}g>0&&(n.has("OES_texture_float_linear")===!0?(i.rectAreaLTC1=be.LTC_FLOAT_1,i.rectAreaLTC2=be.LTC_FLOAT_2):(i.rectAreaLTC1=be.LTC_HALF_1,i.rectAreaLTC2=be.LTC_HALF_2)),i.ambient[0]=c,i.ambient[1]=f,i.ambient[2]=h;const O=i.hash;(O.directionalLength!==p||O.pointLength!==_||O.spotLength!==v||O.rectAreaLength!==g||O.hemiLength!==d||O.numDirectionalShadows!==b||O.numPointShadows!==A||O.numSpotShadows!==y||O.numSpotMaps!==w||O.numLightProbes!==P)&&(i.directional.length=p,i.spot.length=v,i.rectArea.length=g,i.point.length=_,i.hemi.length=d,i.directionalShadow.length=b,i.directionalShadowMap.length=b,i.pointShadow.length=A,i.pointShadowMap.length=A,i.spotShadow.length=y,i.spotShadowMap.length=y,i.directionalShadowMatrix.length=b,i.pointShadowMatrix.length=A,i.spotLightMatrix.length=y+w-D,i.spotLightMap.length=w,i.numSpotLightShadowsWithMaps=D,i.numLightProbes=P,O.directionalLength=p,O.pointLength=_,O.spotLength=v,O.rectAreaLength=g,O.hemiLength=d,O.numDirectionalShadows=b,O.numPointShadows=A,O.numSpotShadows=y,O.numSpotMaps=w,O.numLightProbes=P,i.version=ES++)}function l(u,c){let f=0,h=0,p=0,_=0,v=0;const g=c.matrixWorldInverse;for(let d=0,b=u.length;d<b;d++){const A=u[d];if(A.isDirectionalLight){const y=i.directional[f];y.direction.setFromMatrixPosition(A.matrixWorld),r.setFromMatrixPosition(A.target.matrixWorld),y.direction.sub(r),y.direction.transformDirection(g),f++}else if(A.isSpotLight){const y=i.spot[p];y.position.setFromMatrixPosition(A.matrixWorld),y.position.applyMatrix4(g),y.direction.setFromMatrixPosition(A.matrixWorld),r.setFromMatrixPosition(A.target.matrixWorld),y.direction.sub(r),y.direction.transformDirection(g),p++}else if(A.isRectAreaLight){const y=i.rectArea[_];y.position.setFromMatrixPosition(A.matrixWorld),y.position.applyMatrix4(g),a.identity(),s.copy(A.matrixWorld),s.premultiply(g),a.extractRotation(s),y.halfWidth.set(A.width*.5,0,0),y.halfHeight.set(0,A.height*.5,0),y.halfWidth.applyMatrix4(a),y.halfHeight.applyMatrix4(a),_++}else if(A.isPointLight){const y=i.point[h];y.position.setFromMatrixPosition(A.matrixWorld),y.position.applyMatrix4(g),h++}else if(A.isHemisphereLight){const y=i.hemi[v];y.direction.setFromMatrixPosition(A.matrixWorld),y.direction.transformDirection(g),v++}}}return{setup:o,setupView:l,state:i}}function Xu(n){const e=new bS(n),t=[],i=[];function r(c){u.camera=c,t.length=0,i.length=0}function s(c){t.push(c)}function a(c){i.push(c)}function o(){e.setup(t)}function l(c){e.setupView(t,c)}const u={lightsArray:t,shadowsArray:i,camera:null,lights:e,transmissionRenderTarget:{}};return{init:r,state:u,setupLights:o,setupLightsView:l,pushLight:s,pushShadow:a}}function TS(n){let e=new WeakMap;function t(r,s=0){const a=e.get(r);let o;return a===void 0?(o=new Xu(n),e.set(r,[o])):s>=a.length?(o=new Xu(n),a.push(o)):o=a[s],o}function i(){e=new WeakMap}return{get:t,dispose:i}}const AS=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`,CS=[new j(1,0,0),new j(-1,0,0),new j(0,1,0),new j(0,-1,0),new j(0,0,1),new j(0,0,-1)],RS=[new j(0,-1,0),new j(0,-1,0),new j(0,0,1),new j(0,0,-1),new j(0,-1,0),new j(0,-1,0)],qu=new xt,Fr=new j,Eo=new j;function PS(n,e,t){let i=new Fh;const r=new ot,s=new ot,a=new _t,o=new Gg,l=new kg,u={},c=t.maxTextureSize,f={[Si]:Wt,[Wt]:Si,[Xn]:Xn},h=new Ln({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new ot},radius:{value:4}},vertexShader:AS,fragmentShader:wS}),p=h.clone();p.defines.HORIZONTAL_PASS=1;const _=new xn;_.setAttribute("position",new ln(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const v=new ni(_,h),g=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=$s;let d=this.type;this.render=function(D,P,O){if(g.enabled===!1||g.autoUpdate===!1&&g.needsUpdate===!1||D.length===0)return;D.type===Dm&&(We("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),D.type=$s);const x=n.getRenderTarget(),E=n.getActiveCubeFace(),I=n.getActiveMipmapLevel(),U=n.state;U.setBlending(Yn),U.buffers.depth.getReversed()===!0?U.buffers.color.setClear(0,0,0,0):U.buffers.color.setClear(1,1,1,1),U.buffers.depth.setTest(!0),U.setScissorTest(!1);const B=d!==this.type;B&&P.traverse(function(V){V.material&&(Array.isArray(V.material)?V.material.forEach($=>$.needsUpdate=!0):V.material.needsUpdate=!0)});for(let V=0,$=D.length;V<$;V++){const X=D[V],z=X.shadow;if(z===void 0){We("WebGLShadowMap:",X,"has no shadow.");continue}if(z.autoUpdate===!1&&z.needsUpdate===!1)continue;r.copy(z.mapSize);const W=z.getFrameExtents();if(r.multiply(W),s.copy(z.mapSize),(r.x>c||r.y>c)&&(r.x>c&&(s.x=Math.floor(c/W.x),r.x=s.x*W.x,z.mapSize.x=s.x),r.y>c&&(s.y=Math.floor(c/W.y),r.y=s.y*W.y,z.mapSize.y=s.y)),z.map===null||B===!0){if(z.map!==null&&(z.map.depthTexture!==null&&(z.map.depthTexture.dispose(),z.map.depthTexture=null),z.map.dispose()),this.type===Br){if(X.isPointLight){We("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}z.map=new Pn(r.x,r.y,{format:Mr,type:Qn,minFilter:Dt,magFilter:Dt,generateMipmaps:!1}),z.map.texture.name=X.name+".shadowMap",z.map.depthTexture=new ls(r.x,r.y,Tn),z.map.depthTexture.name=X.name+".shadowMapDepth",z.map.depthTexture.format=ei,z.map.depthTexture.compareFunction=null,z.map.depthTexture.minFilter=Tt,z.map.depthTexture.magFilter=Tt}else{X.isPointLight?(z.map=new Nh(r.x),z.map.depthTexture=new Vg(r.x,Dn)):(z.map=new Pn(r.x,r.y),z.map.depthTexture=new ls(r.x,r.y,Dn)),z.map.depthTexture.name=X.name+".shadowMap",z.map.depthTexture.format=ei;const oe=n.state.buffers.depth.getReversed();this.type===$s?(z.map.depthTexture.compareFunction=oe?ac:sc,z.map.depthTexture.minFilter=Dt,z.map.depthTexture.magFilter=Dt):(z.map.depthTexture.compareFunction=null,z.map.depthTexture.minFilter=Tt,z.map.depthTexture.magFilter=Tt)}z.camera.updateProjectionMatrix()}const re=z.map.isWebGLCubeRenderTarget?6:1;for(let oe=0;oe<re;oe++){if(z.map.isWebGLCubeRenderTarget)n.setRenderTarget(z.map,oe),n.clear();else{oe===0&&(n.setRenderTarget(z.map),n.clear());const fe=z.getViewport(oe);a.set(s.x*fe.x,s.y*fe.y,s.x*fe.z,s.y*fe.w),U.viewport(a)}if(X.isPointLight){const fe=z.camera,Ne=z.matrix,he=X.distance||fe.far;he!==fe.far&&(fe.far=he,fe.updateProjectionMatrix()),Fr.setFromMatrixPosition(X.matrixWorld),fe.position.copy(Fr),Eo.copy(fe.position),Eo.add(CS[oe]),fe.up.copy(RS[oe]),fe.lookAt(Eo),fe.updateMatrixWorld(),Ne.makeTranslation(-Fr.x,-Fr.y,-Fr.z),qu.multiplyMatrices(fe.projectionMatrix,fe.matrixWorldInverse),z._frustum.setFromProjectionMatrix(qu,fe.coordinateSystem,fe.reversedDepth)}else z.updateMatrices(X);i=z.getFrustum(),y(P,O,z.camera,X,this.type)}z.isPointLightShadow!==!0&&this.type===Br&&b(z,O),z.needsUpdate=!1}d=this.type,g.needsUpdate=!1,n.setRenderTarget(x,E,I)};function b(D,P){const O=e.update(v);h.defines.VSM_SAMPLES!==D.blurSamples&&(h.defines.VSM_SAMPLES=D.blurSamples,p.defines.VSM_SAMPLES=D.blurSamples,h.needsUpdate=!0,p.needsUpdate=!0),D.mapPass===null&&(D.mapPass=new Pn(r.x,r.y,{format:Mr,type:Qn})),h.uniforms.shadow_pass.value=D.map.depthTexture,h.uniforms.resolution.value=D.mapSize,h.uniforms.radius.value=D.radius,n.setRenderTarget(D.mapPass),n.clear(),n.renderBufferDirect(P,null,O,h,v,null),p.uniforms.shadow_pass.value=D.mapPass.texture,p.uniforms.resolution.value=D.mapSize,p.uniforms.radius.value=D.radius,n.setRenderTarget(D.map),n.clear(),n.renderBufferDirect(P,null,O,p,v,null)}function A(D,P,O,x){let E=null;const I=O.isPointLight===!0?D.customDistanceMaterial:D.customDepthMaterial;if(I!==void 0)E=I;else if(E=O.isPointLight===!0?l:o,n.localClippingEnabled&&P.clipShadows===!0&&Array.isArray(P.clippingPlanes)&&P.clippingPlanes.length!==0||P.displacementMap&&P.displacementScale!==0||P.alphaMap&&P.alphaTest>0||P.map&&P.alphaTest>0||P.alphaToCoverage===!0){const U=E.uuid,B=P.uuid;let V=u[U];V===void 0&&(V={},u[U]=V);let $=V[B];$===void 0&&($=E.clone(),V[B]=$,P.addEventListener("dispose",w)),E=$}if(E.visible=P.visible,E.wireframe=P.wireframe,x===Br?E.side=P.shadowSide!==null?P.shadowSide:P.side:E.side=P.shadowSide!==null?P.shadowSide:f[P.side],E.alphaMap=P.alphaMap,E.alphaTest=P.alphaToCoverage===!0?.5:P.alphaTest,E.map=P.map,E.clipShadows=P.clipShadows,E.clippingPlanes=P.clippingPlanes,E.clipIntersection=P.clipIntersection,E.displacementMap=P.displacementMap,E.displacementScale=P.displacementScale,E.displacementBias=P.displacementBias,E.wireframeLinewidth=P.wireframeLinewidth,E.linewidth=P.linewidth,O.isPointLight===!0&&E.isMeshDistanceMaterial===!0){const U=n.properties.get(E);U.light=O}return E}function y(D,P,O,x,E){if(D.visible===!1)return;if(D.layers.test(P.layers)&&(D.isMesh||D.isLine||D.isPoints)&&(D.castShadow||D.receiveShadow&&E===Br)&&(!D.frustumCulled||i.intersectsObject(D))){D.modelViewMatrix.multiplyMatrices(O.matrixWorldInverse,D.matrixWorld);const B=e.update(D),V=D.material;if(Array.isArray(V)){const $=B.groups;for(let X=0,z=$.length;X<z;X++){const W=$[X],re=V[W.materialIndex];if(re&&re.visible){const oe=A(D,re,x,E);D.onBeforeShadow(n,D,P,O,B,oe,W),n.renderBufferDirect(O,null,B,oe,D,W),D.onAfterShadow(n,D,P,O,B,oe,W)}}}else if(V.visible){const $=A(D,V,x,E);D.onBeforeShadow(n,D,P,O,B,$,null),n.renderBufferDirect(O,null,B,$,D,null),D.onAfterShadow(n,D,P,O,B,$,null)}}const U=D.children;for(let B=0,V=U.length;B<V;B++)y(U[B],P,O,x,E)}function w(D){D.target.removeEventListener("dispose",w);for(const O in u){const x=u[O],E=D.target.uuid;E in x&&(x[E].dispose(),delete x[E])}}}const DS={[zo]:Vo,[Ho]:Wo,[Go]:Xo,[vr]:ko,[Vo]:zo,[Wo]:Ho,[Xo]:Go,[ko]:vr};function LS(n,e){function t(){let N=!1;const we=new _t;let ge=null;const De=new _t(0,0,0,0);return{setMask:function(pe){ge!==pe&&!N&&(n.colorMask(pe,pe,pe,pe),ge=pe)},setLocked:function(pe){N=pe},setClear:function(pe,le,Se,ke,ut){ut===!0&&(pe*=ke,le*=ke,Se*=ke),we.set(pe,le,Se,ke),De.equals(we)===!1&&(n.clearColor(pe,le,Se,ke),De.copy(we))},reset:function(){N=!1,ge=null,De.set(-1,0,0,0)}}}function i(){let N=!1,we=!1,ge=null,De=null,pe=null;return{setReversed:function(le){if(we!==le){const Se=e.get("EXT_clip_control");le?Se.clipControlEXT(Se.LOWER_LEFT_EXT,Se.ZERO_TO_ONE_EXT):Se.clipControlEXT(Se.LOWER_LEFT_EXT,Se.NEGATIVE_ONE_TO_ONE_EXT),we=le;const ke=pe;pe=null,this.setClear(ke)}},getReversed:function(){return we},setTest:function(le){le?K(n.DEPTH_TEST):_e(n.DEPTH_TEST)},setMask:function(le){ge!==le&&!N&&(n.depthMask(le),ge=le)},setFunc:function(le){if(we&&(le=DS[le]),De!==le){switch(le){case zo:n.depthFunc(n.NEVER);break;case Vo:n.depthFunc(n.ALWAYS);break;case Ho:n.depthFunc(n.LESS);break;case vr:n.depthFunc(n.LEQUAL);break;case Go:n.depthFunc(n.EQUAL);break;case ko:n.depthFunc(n.GEQUAL);break;case Wo:n.depthFunc(n.GREATER);break;case Xo:n.depthFunc(n.NOTEQUAL);break;default:n.depthFunc(n.LEQUAL)}De=le}},setLocked:function(le){N=le},setClear:function(le){pe!==le&&(we&&(le=1-le),n.clearDepth(le),pe=le)},reset:function(){N=!1,ge=null,De=null,pe=null,we=!1}}}function r(){let N=!1,we=null,ge=null,De=null,pe=null,le=null,Se=null,ke=null,ut=null;return{setTest:function(it){N||(it?K(n.STENCIL_TEST):_e(n.STENCIL_TEST))},setMask:function(it){we!==it&&!N&&(n.stencilMask(it),we=it)},setFunc:function(it,vn,In){(ge!==it||De!==vn||pe!==In)&&(n.stencilFunc(it,vn,In),ge=it,De=vn,pe=In)},setOp:function(it,vn,In){(le!==it||Se!==vn||ke!==In)&&(n.stencilOp(it,vn,In),le=it,Se=vn,ke=In)},setLocked:function(it){N=it},setClear:function(it){ut!==it&&(n.clearStencil(it),ut=it)},reset:function(){N=!1,we=null,ge=null,De=null,pe=null,le=null,Se=null,ke=null,ut=null}}}const s=new t,a=new i,o=new r,l=new WeakMap,u=new WeakMap;let c={},f={},h=new WeakMap,p=[],_=null,v=!1,g=null,d=null,b=null,A=null,y=null,w=null,D=null,P=new nt(0,0,0),O=0,x=!1,E=null,I=null,U=null,B=null,V=null;const $=n.getParameter(n.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let X=!1,z=0;const W=n.getParameter(n.VERSION);W.indexOf("WebGL")!==-1?(z=parseFloat(/^WebGL (\d)/.exec(W)[1]),X=z>=1):W.indexOf("OpenGL ES")!==-1&&(z=parseFloat(/^OpenGL ES (\d)/.exec(W)[1]),X=z>=2);let re=null,oe={};const fe=n.getParameter(n.SCISSOR_BOX),Ne=n.getParameter(n.VIEWPORT),he=new _t().fromArray(fe),Pe=new _t().fromArray(Ne);function Ie(N,we,ge,De){const pe=new Uint8Array(4),le=n.createTexture();n.bindTexture(N,le),n.texParameteri(N,n.TEXTURE_MIN_FILTER,n.NEAREST),n.texParameteri(N,n.TEXTURE_MAG_FILTER,n.NEAREST);for(let Se=0;Se<ge;Se++)N===n.TEXTURE_3D||N===n.TEXTURE_2D_ARRAY?n.texImage3D(we,0,n.RGBA,1,1,De,0,n.RGBA,n.UNSIGNED_BYTE,pe):n.texImage2D(we+Se,0,n.RGBA,1,1,0,n.RGBA,n.UNSIGNED_BYTE,pe);return le}const q={};q[n.TEXTURE_2D]=Ie(n.TEXTURE_2D,n.TEXTURE_2D,1),q[n.TEXTURE_CUBE_MAP]=Ie(n.TEXTURE_CUBE_MAP,n.TEXTURE_CUBE_MAP_POSITIVE_X,6),q[n.TEXTURE_2D_ARRAY]=Ie(n.TEXTURE_2D_ARRAY,n.TEXTURE_2D_ARRAY,1,1),q[n.TEXTURE_3D]=Ie(n.TEXTURE_3D,n.TEXTURE_3D,1,1),s.setClear(0,0,0,1),a.setClear(1),o.setClear(0),K(n.DEPTH_TEST),a.setFunc(vr),J(!1),ie(Zc),K(n.CULL_FACE),H(Yn);function K(N){c[N]!==!0&&(n.enable(N),c[N]=!0)}function _e(N){c[N]!==!1&&(n.disable(N),c[N]=!1)}function Be(N,we){return f[N]!==we?(n.bindFramebuffer(N,we),f[N]=we,N===n.DRAW_FRAMEBUFFER&&(f[n.FRAMEBUFFER]=we),N===n.FRAMEBUFFER&&(f[n.DRAW_FRAMEBUFFER]=we),!0):!1}function me(N,we){let ge=p,De=!1;if(N){ge=h.get(we),ge===void 0&&(ge=[],h.set(we,ge));const pe=N.textures;if(ge.length!==pe.length||ge[0]!==n.COLOR_ATTACHMENT0){for(let le=0,Se=pe.length;le<Se;le++)ge[le]=n.COLOR_ATTACHMENT0+le;ge.length=pe.length,De=!0}}else ge[0]!==n.BACK&&(ge[0]=n.BACK,De=!0);De&&n.drawBuffers(ge)}function Me(N){return _!==N?(n.useProgram(N),_=N,!0):!1}const C={[Oi]:n.FUNC_ADD,[Im]:n.FUNC_SUBTRACT,[Um]:n.FUNC_REVERSE_SUBTRACT};C[Nm]=n.MIN,C[Fm]=n.MAX;const R={[Om]:n.ZERO,[Bm]:n.ONE,[zm]:n.SRC_COLOR,[Oo]:n.SRC_ALPHA,[Xm]:n.SRC_ALPHA_SATURATE,[km]:n.DST_COLOR,[Hm]:n.DST_ALPHA,[Vm]:n.ONE_MINUS_SRC_COLOR,[Bo]:n.ONE_MINUS_SRC_ALPHA,[Wm]:n.ONE_MINUS_DST_COLOR,[Gm]:n.ONE_MINUS_DST_ALPHA,[qm]:n.CONSTANT_COLOR,[Ym]:n.ONE_MINUS_CONSTANT_COLOR,[$m]:n.CONSTANT_ALPHA,[Km]:n.ONE_MINUS_CONSTANT_ALPHA};function H(N,we,ge,De,pe,le,Se,ke,ut,it){if(N===Yn){v===!0&&(_e(n.BLEND),v=!1);return}if(v===!1&&(K(n.BLEND),v=!0),N!==Lm){if(N!==g||it!==x){if((d!==Oi||y!==Oi)&&(n.blendEquation(n.FUNC_ADD),d=Oi,y=Oi),it)switch(N){case gr:n.blendFuncSeparate(n.ONE,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case Fo:n.blendFunc(n.ONE,n.ONE);break;case Jc:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case Qc:n.blendFuncSeparate(n.DST_COLOR,n.ONE_MINUS_SRC_ALPHA,n.ZERO,n.ONE);break;default:Qe("WebGLState: Invalid blending: ",N);break}else switch(N){case gr:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case Fo:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE,n.ONE,n.ONE);break;case Jc:Qe("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Qc:Qe("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Qe("WebGLState: Invalid blending: ",N);break}b=null,A=null,w=null,D=null,P.set(0,0,0),O=0,g=N,x=it}return}pe=pe||we,le=le||ge,Se=Se||De,(we!==d||pe!==y)&&(n.blendEquationSeparate(C[we],C[pe]),d=we,y=pe),(ge!==b||De!==A||le!==w||Se!==D)&&(n.blendFuncSeparate(R[ge],R[De],R[le],R[Se]),b=ge,A=De,w=le,D=Se),(ke.equals(P)===!1||ut!==O)&&(n.blendColor(ke.r,ke.g,ke.b,ut),P.copy(ke),O=ut),g=N,x=!1}function ee(N,we){N.side===Xn?_e(n.CULL_FACE):K(n.CULL_FACE);let ge=N.side===Wt;we&&(ge=!ge),J(ge),N.blending===gr&&N.transparent===!1?H(Yn):H(N.blending,N.blendEquation,N.blendSrc,N.blendDst,N.blendEquationAlpha,N.blendSrcAlpha,N.blendDstAlpha,N.blendColor,N.blendAlpha,N.premultipliedAlpha),a.setFunc(N.depthFunc),a.setTest(N.depthTest),a.setMask(N.depthWrite),s.setMask(N.colorWrite);const De=N.stencilWrite;o.setTest(De),De&&(o.setMask(N.stencilWriteMask),o.setFunc(N.stencilFunc,N.stencilRef,N.stencilFuncMask),o.setOp(N.stencilFail,N.stencilZFail,N.stencilZPass)),ce(N.polygonOffset,N.polygonOffsetFactor,N.polygonOffsetUnits),N.alphaToCoverage===!0?K(n.SAMPLE_ALPHA_TO_COVERAGE):_e(n.SAMPLE_ALPHA_TO_COVERAGE)}function J(N){E!==N&&(N?n.frontFace(n.CW):n.frontFace(n.CCW),E=N)}function ie(N){N!==Rm?(K(n.CULL_FACE),N!==I&&(N===Zc?n.cullFace(n.BACK):N===Pm?n.cullFace(n.FRONT):n.cullFace(n.FRONT_AND_BACK))):_e(n.CULL_FACE),I=N}function T(N){N!==U&&(X&&n.lineWidth(N),U=N)}function ce(N,we,ge){N?(K(n.POLYGON_OFFSET_FILL),(B!==we||V!==ge)&&(n.polygonOffset(we,ge),B=we,V=ge)):_e(n.POLYGON_OFFSET_FILL)}function se(N){N?K(n.SCISSOR_TEST):_e(n.SCISSOR_TEST)}function ne(N){N===void 0&&(N=n.TEXTURE0+$-1),re!==N&&(n.activeTexture(N),re=N)}function ae(N,we,ge){ge===void 0&&(re===null?ge=n.TEXTURE0+$-1:ge=re);let De=oe[ge];De===void 0&&(De={type:void 0,texture:void 0},oe[ge]=De),(De.type!==N||De.texture!==we)&&(re!==ge&&(n.activeTexture(ge),re=ge),n.bindTexture(N,we||q[N]),De.type=N,De.texture=we)}function S(){const N=oe[re];N!==void 0&&N.type!==void 0&&(n.bindTexture(N.type,null),N.type=void 0,N.texture=void 0)}function m(){try{n.compressedTexImage2D(...arguments)}catch(N){Qe("WebGLState:",N)}}function L(){try{n.compressedTexImage3D(...arguments)}catch(N){Qe("WebGLState:",N)}}function Y(){try{n.texSubImage2D(...arguments)}catch(N){Qe("WebGLState:",N)}}function te(){try{n.texSubImage3D(...arguments)}catch(N){Qe("WebGLState:",N)}}function k(){try{n.compressedTexSubImage2D(...arguments)}catch(N){Qe("WebGLState:",N)}}function Te(){try{n.compressedTexSubImage3D(...arguments)}catch(N){Qe("WebGLState:",N)}}function de(){try{n.texStorage2D(...arguments)}catch(N){Qe("WebGLState:",N)}}function Ce(){try{n.texStorage3D(...arguments)}catch(N){Qe("WebGLState:",N)}}function Fe(){try{n.texImage2D(...arguments)}catch(N){Qe("WebGLState:",N)}}function ue(){try{n.texImage3D(...arguments)}catch(N){Qe("WebGLState:",N)}}function ve(N){he.equals(N)===!1&&(n.scissor(N.x,N.y,N.z,N.w),he.copy(N))}function Ee(N){Pe.equals(N)===!1&&(n.viewport(N.x,N.y,N.z,N.w),Pe.copy(N))}function Re(N,we){let ge=u.get(we);ge===void 0&&(ge=new WeakMap,u.set(we,ge));let De=ge.get(N);De===void 0&&(De=n.getUniformBlockIndex(we,N.name),ge.set(N,De))}function xe(N,we){const De=u.get(we).get(N);l.get(we)!==De&&(n.uniformBlockBinding(we,De,N.__bindingPointIndex),l.set(we,De))}function Xe(){n.disable(n.BLEND),n.disable(n.CULL_FACE),n.disable(n.DEPTH_TEST),n.disable(n.POLYGON_OFFSET_FILL),n.disable(n.SCISSOR_TEST),n.disable(n.STENCIL_TEST),n.disable(n.SAMPLE_ALPHA_TO_COVERAGE),n.blendEquation(n.FUNC_ADD),n.blendFunc(n.ONE,n.ZERO),n.blendFuncSeparate(n.ONE,n.ZERO,n.ONE,n.ZERO),n.blendColor(0,0,0,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(n.LESS),a.setReversed(!1),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(n.ALWAYS,0,4294967295),n.stencilOp(n.KEEP,n.KEEP,n.KEEP),n.clearStencil(0),n.cullFace(n.BACK),n.frontFace(n.CCW),n.polygonOffset(0,0),n.activeTexture(n.TEXTURE0),n.bindFramebuffer(n.FRAMEBUFFER,null),n.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),n.bindFramebuffer(n.READ_FRAMEBUFFER,null),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),c={},re=null,oe={},f={},h=new WeakMap,p=[],_=null,v=!1,g=null,d=null,b=null,A=null,y=null,w=null,D=null,P=new nt(0,0,0),O=0,x=!1,E=null,I=null,U=null,B=null,V=null,he.set(0,0,n.canvas.width,n.canvas.height),Pe.set(0,0,n.canvas.width,n.canvas.height),s.reset(),a.reset(),o.reset()}return{buffers:{color:s,depth:a,stencil:o},enable:K,disable:_e,bindFramebuffer:Be,drawBuffers:me,useProgram:Me,setBlending:H,setMaterial:ee,setFlipSided:J,setCullFace:ie,setLineWidth:T,setPolygonOffset:ce,setScissorTest:se,activeTexture:ne,bindTexture:ae,unbindTexture:S,compressedTexImage2D:m,compressedTexImage3D:L,texImage2D:Fe,texImage3D:ue,updateUBOMapping:Re,uniformBlockBinding:xe,texStorage2D:de,texStorage3D:Ce,texSubImage2D:Y,texSubImage3D:te,compressedTexSubImage2D:k,compressedTexSubImage3D:Te,scissor:ve,viewport:Ee,reset:Xe}}function IS(n,e,t,i,r,s,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),u=new ot,c=new WeakMap;let f;const h=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function _(S,m){return p?new OffscreenCanvas(S,m):as("canvas")}function v(S,m,L){let Y=1;const te=ae(S);if((te.width>L||te.height>L)&&(Y=L/Math.max(te.width,te.height)),Y<1)if(typeof HTMLImageElement<"u"&&S instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&S instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&S instanceof ImageBitmap||typeof VideoFrame<"u"&&S instanceof VideoFrame){const k=Math.floor(Y*te.width),Te=Math.floor(Y*te.height);f===void 0&&(f=_(k,Te));const de=m?_(k,Te):f;return de.width=k,de.height=Te,de.getContext("2d").drawImage(S,0,0,k,Te),We("WebGLRenderer: Texture has been resized from ("+te.width+"x"+te.height+") to ("+k+"x"+Te+")."),de}else return"data"in S&&We("WebGLRenderer: Image in DataTexture is too big ("+te.width+"x"+te.height+")."),S;return S}function g(S){return S.generateMipmaps}function d(S){n.generateMipmap(S)}function b(S){return S.isWebGLCubeRenderTarget?n.TEXTURE_CUBE_MAP:S.isWebGL3DRenderTarget?n.TEXTURE_3D:S.isWebGLArrayRenderTarget||S.isCompressedArrayTexture?n.TEXTURE_2D_ARRAY:n.TEXTURE_2D}function A(S,m,L,Y,te=!1){if(S!==null){if(n[S]!==void 0)return n[S];We("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+S+"'")}let k=m;if(m===n.RED&&(L===n.FLOAT&&(k=n.R32F),L===n.HALF_FLOAT&&(k=n.R16F),L===n.UNSIGNED_BYTE&&(k=n.R8)),m===n.RED_INTEGER&&(L===n.UNSIGNED_BYTE&&(k=n.R8UI),L===n.UNSIGNED_SHORT&&(k=n.R16UI),L===n.UNSIGNED_INT&&(k=n.R32UI),L===n.BYTE&&(k=n.R8I),L===n.SHORT&&(k=n.R16I),L===n.INT&&(k=n.R32I)),m===n.RG&&(L===n.FLOAT&&(k=n.RG32F),L===n.HALF_FLOAT&&(k=n.RG16F),L===n.UNSIGNED_BYTE&&(k=n.RG8)),m===n.RG_INTEGER&&(L===n.UNSIGNED_BYTE&&(k=n.RG8UI),L===n.UNSIGNED_SHORT&&(k=n.RG16UI),L===n.UNSIGNED_INT&&(k=n.RG32UI),L===n.BYTE&&(k=n.RG8I),L===n.SHORT&&(k=n.RG16I),L===n.INT&&(k=n.RG32I)),m===n.RGB_INTEGER&&(L===n.UNSIGNED_BYTE&&(k=n.RGB8UI),L===n.UNSIGNED_SHORT&&(k=n.RGB16UI),L===n.UNSIGNED_INT&&(k=n.RGB32UI),L===n.BYTE&&(k=n.RGB8I),L===n.SHORT&&(k=n.RGB16I),L===n.INT&&(k=n.RGB32I)),m===n.RGBA_INTEGER&&(L===n.UNSIGNED_BYTE&&(k=n.RGBA8UI),L===n.UNSIGNED_SHORT&&(k=n.RGBA16UI),L===n.UNSIGNED_INT&&(k=n.RGBA32UI),L===n.BYTE&&(k=n.RGBA8I),L===n.SHORT&&(k=n.RGBA16I),L===n.INT&&(k=n.RGBA32I)),m===n.RGB&&(L===n.UNSIGNED_INT_5_9_9_9_REV&&(k=n.RGB9_E5),L===n.UNSIGNED_INT_10F_11F_11F_REV&&(k=n.R11F_G11F_B10F)),m===n.RGBA){const Te=te?ca:Ze.getTransfer(Y);L===n.FLOAT&&(k=n.RGBA32F),L===n.HALF_FLOAT&&(k=n.RGBA16F),L===n.UNSIGNED_BYTE&&(k=Te===st?n.SRGB8_ALPHA8:n.RGBA8),L===n.UNSIGNED_SHORT_4_4_4_4&&(k=n.RGBA4),L===n.UNSIGNED_SHORT_5_5_5_1&&(k=n.RGB5_A1)}return(k===n.R16F||k===n.R32F||k===n.RG16F||k===n.RG32F||k===n.RGBA16F||k===n.RGBA32F)&&e.get("EXT_color_buffer_float"),k}function y(S,m){let L;return S?m===null||m===Dn||m===ss?L=n.DEPTH24_STENCIL8:m===Tn?L=n.DEPTH32F_STENCIL8:m===rs&&(L=n.DEPTH24_STENCIL8,We("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):m===null||m===Dn||m===ss?L=n.DEPTH_COMPONENT24:m===Tn?L=n.DEPTH_COMPONENT32F:m===rs&&(L=n.DEPTH_COMPONENT16),L}function w(S,m){return g(S)===!0||S.isFramebufferTexture&&S.minFilter!==Tt&&S.minFilter!==Dt?Math.log2(Math.max(m.width,m.height))+1:S.mipmaps!==void 0&&S.mipmaps.length>0?S.mipmaps.length:S.isCompressedTexture&&Array.isArray(S.image)?m.mipmaps.length:1}function D(S){const m=S.target;m.removeEventListener("dispose",D),O(m),m.isVideoTexture&&c.delete(m)}function P(S){const m=S.target;m.removeEventListener("dispose",P),E(m)}function O(S){const m=i.get(S);if(m.__webglInit===void 0)return;const L=S.source,Y=h.get(L);if(Y){const te=Y[m.__cacheKey];te.usedTimes--,te.usedTimes===0&&x(S),Object.keys(Y).length===0&&h.delete(L)}i.remove(S)}function x(S){const m=i.get(S);n.deleteTexture(m.__webglTexture);const L=S.source,Y=h.get(L);delete Y[m.__cacheKey],a.memory.textures--}function E(S){const m=i.get(S);if(S.depthTexture&&(S.depthTexture.dispose(),i.remove(S.depthTexture)),S.isWebGLCubeRenderTarget)for(let Y=0;Y<6;Y++){if(Array.isArray(m.__webglFramebuffer[Y]))for(let te=0;te<m.__webglFramebuffer[Y].length;te++)n.deleteFramebuffer(m.__webglFramebuffer[Y][te]);else n.deleteFramebuffer(m.__webglFramebuffer[Y]);m.__webglDepthbuffer&&n.deleteRenderbuffer(m.__webglDepthbuffer[Y])}else{if(Array.isArray(m.__webglFramebuffer))for(let Y=0;Y<m.__webglFramebuffer.length;Y++)n.deleteFramebuffer(m.__webglFramebuffer[Y]);else n.deleteFramebuffer(m.__webglFramebuffer);if(m.__webglDepthbuffer&&n.deleteRenderbuffer(m.__webglDepthbuffer),m.__webglMultisampledFramebuffer&&n.deleteFramebuffer(m.__webglMultisampledFramebuffer),m.__webglColorRenderbuffer)for(let Y=0;Y<m.__webglColorRenderbuffer.length;Y++)m.__webglColorRenderbuffer[Y]&&n.deleteRenderbuffer(m.__webglColorRenderbuffer[Y]);m.__webglDepthRenderbuffer&&n.deleteRenderbuffer(m.__webglDepthRenderbuffer)}const L=S.textures;for(let Y=0,te=L.length;Y<te;Y++){const k=i.get(L[Y]);k.__webglTexture&&(n.deleteTexture(k.__webglTexture),a.memory.textures--),i.remove(L[Y])}i.remove(S)}let I=0;function U(){I=0}function B(){const S=I;return S>=r.maxTextures&&We("WebGLTextures: Trying to use "+S+" texture units while this GPU supports only "+r.maxTextures),I+=1,S}function V(S){const m=[];return m.push(S.wrapS),m.push(S.wrapT),m.push(S.wrapR||0),m.push(S.magFilter),m.push(S.minFilter),m.push(S.anisotropy),m.push(S.internalFormat),m.push(S.format),m.push(S.type),m.push(S.generateMipmaps),m.push(S.premultiplyAlpha),m.push(S.flipY),m.push(S.unpackAlignment),m.push(S.colorSpace),m.join()}function $(S,m){const L=i.get(S);if(S.isVideoTexture&&se(S),S.isRenderTargetTexture===!1&&S.isExternalTexture!==!0&&S.version>0&&L.__version!==S.version){const Y=S.image;if(Y===null)We("WebGLRenderer: Texture marked for update but no image data found.");else if(Y.complete===!1)We("WebGLRenderer: Texture marked for update but image is incomplete");else{q(L,S,m);return}}else S.isExternalTexture&&(L.__webglTexture=S.sourceTexture?S.sourceTexture:null);t.bindTexture(n.TEXTURE_2D,L.__webglTexture,n.TEXTURE0+m)}function X(S,m){const L=i.get(S);if(S.isRenderTargetTexture===!1&&S.version>0&&L.__version!==S.version){q(L,S,m);return}else S.isExternalTexture&&(L.__webglTexture=S.sourceTexture?S.sourceTexture:null);t.bindTexture(n.TEXTURE_2D_ARRAY,L.__webglTexture,n.TEXTURE0+m)}function z(S,m){const L=i.get(S);if(S.isRenderTargetTexture===!1&&S.version>0&&L.__version!==S.version){q(L,S,m);return}t.bindTexture(n.TEXTURE_3D,L.__webglTexture,n.TEXTURE0+m)}function W(S,m){const L=i.get(S);if(S.isCubeDepthTexture!==!0&&S.version>0&&L.__version!==S.version){K(L,S,m);return}t.bindTexture(n.TEXTURE_CUBE_MAP,L.__webglTexture,n.TEXTURE0+m)}const re={[$o]:n.REPEAT,[qn]:n.CLAMP_TO_EDGE,[Ko]:n.MIRRORED_REPEAT},oe={[Tt]:n.NEAREST,[Jm]:n.NEAREST_MIPMAP_NEAREST,[Es]:n.NEAREST_MIPMAP_LINEAR,[Dt]:n.LINEAR,[Wa]:n.LINEAR_MIPMAP_NEAREST,[zi]:n.LINEAR_MIPMAP_LINEAR},fe={[ng]:n.NEVER,[og]:n.ALWAYS,[ig]:n.LESS,[sc]:n.LEQUAL,[rg]:n.EQUAL,[ac]:n.GEQUAL,[sg]:n.GREATER,[ag]:n.NOTEQUAL};function Ne(S,m){if(m.type===Tn&&e.has("OES_texture_float_linear")===!1&&(m.magFilter===Dt||m.magFilter===Wa||m.magFilter===Es||m.magFilter===zi||m.minFilter===Dt||m.minFilter===Wa||m.minFilter===Es||m.minFilter===zi)&&We("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),n.texParameteri(S,n.TEXTURE_WRAP_S,re[m.wrapS]),n.texParameteri(S,n.TEXTURE_WRAP_T,re[m.wrapT]),(S===n.TEXTURE_3D||S===n.TEXTURE_2D_ARRAY)&&n.texParameteri(S,n.TEXTURE_WRAP_R,re[m.wrapR]),n.texParameteri(S,n.TEXTURE_MAG_FILTER,oe[m.magFilter]),n.texParameteri(S,n.TEXTURE_MIN_FILTER,oe[m.minFilter]),m.compareFunction&&(n.texParameteri(S,n.TEXTURE_COMPARE_MODE,n.COMPARE_REF_TO_TEXTURE),n.texParameteri(S,n.TEXTURE_COMPARE_FUNC,fe[m.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(m.magFilter===Tt||m.minFilter!==Es&&m.minFilter!==zi||m.type===Tn&&e.has("OES_texture_float_linear")===!1)return;if(m.anisotropy>1||i.get(m).__currentAnisotropy){const L=e.get("EXT_texture_filter_anisotropic");n.texParameterf(S,L.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(m.anisotropy,r.getMaxAnisotropy())),i.get(m).__currentAnisotropy=m.anisotropy}}}function he(S,m){let L=!1;S.__webglInit===void 0&&(S.__webglInit=!0,m.addEventListener("dispose",D));const Y=m.source;let te=h.get(Y);te===void 0&&(te={},h.set(Y,te));const k=V(m);if(k!==S.__cacheKey){te[k]===void 0&&(te[k]={texture:n.createTexture(),usedTimes:0},a.memory.textures++,L=!0),te[k].usedTimes++;const Te=te[S.__cacheKey];Te!==void 0&&(te[S.__cacheKey].usedTimes--,Te.usedTimes===0&&x(m)),S.__cacheKey=k,S.__webglTexture=te[k].texture}return L}function Pe(S,m,L){return Math.floor(Math.floor(S/L)/m)}function Ie(S,m,L,Y){const k=S.updateRanges;if(k.length===0)t.texSubImage2D(n.TEXTURE_2D,0,0,0,m.width,m.height,L,Y,m.data);else{k.sort((ue,ve)=>ue.start-ve.start);let Te=0;for(let ue=1;ue<k.length;ue++){const ve=k[Te],Ee=k[ue],Re=ve.start+ve.count,xe=Pe(Ee.start,m.width,4),Xe=Pe(ve.start,m.width,4);Ee.start<=Re+1&&xe===Xe&&Pe(Ee.start+Ee.count-1,m.width,4)===xe?ve.count=Math.max(ve.count,Ee.start+Ee.count-ve.start):(++Te,k[Te]=Ee)}k.length=Te+1;const de=n.getParameter(n.UNPACK_ROW_LENGTH),Ce=n.getParameter(n.UNPACK_SKIP_PIXELS),Fe=n.getParameter(n.UNPACK_SKIP_ROWS);n.pixelStorei(n.UNPACK_ROW_LENGTH,m.width);for(let ue=0,ve=k.length;ue<ve;ue++){const Ee=k[ue],Re=Math.floor(Ee.start/4),xe=Math.ceil(Ee.count/4),Xe=Re%m.width,N=Math.floor(Re/m.width),we=xe,ge=1;n.pixelStorei(n.UNPACK_SKIP_PIXELS,Xe),n.pixelStorei(n.UNPACK_SKIP_ROWS,N),t.texSubImage2D(n.TEXTURE_2D,0,Xe,N,we,ge,L,Y,m.data)}S.clearUpdateRanges(),n.pixelStorei(n.UNPACK_ROW_LENGTH,de),n.pixelStorei(n.UNPACK_SKIP_PIXELS,Ce),n.pixelStorei(n.UNPACK_SKIP_ROWS,Fe)}}function q(S,m,L){let Y=n.TEXTURE_2D;(m.isDataArrayTexture||m.isCompressedArrayTexture)&&(Y=n.TEXTURE_2D_ARRAY),m.isData3DTexture&&(Y=n.TEXTURE_3D);const te=he(S,m),k=m.source;t.bindTexture(Y,S.__webglTexture,n.TEXTURE0+L);const Te=i.get(k);if(k.version!==Te.__version||te===!0){t.activeTexture(n.TEXTURE0+L);const de=Ze.getPrimaries(Ze.workingColorSpace),Ce=m.colorSpace===pi?null:Ze.getPrimaries(m.colorSpace),Fe=m.colorSpace===pi||de===Ce?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,m.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,m.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,m.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,Fe);let ue=v(m.image,!1,r.maxTextureSize);ue=ne(m,ue);const ve=s.convert(m.format,m.colorSpace),Ee=s.convert(m.type);let Re=A(m.internalFormat,ve,Ee,m.colorSpace,m.isVideoTexture);Ne(Y,m);let xe;const Xe=m.mipmaps,N=m.isVideoTexture!==!0,we=Te.__version===void 0||te===!0,ge=k.dataReady,De=w(m,ue);if(m.isDepthTexture)Re=y(m.format===Vi,m.type),we&&(N?t.texStorage2D(n.TEXTURE_2D,1,Re,ue.width,ue.height):t.texImage2D(n.TEXTURE_2D,0,Re,ue.width,ue.height,0,ve,Ee,null));else if(m.isDataTexture)if(Xe.length>0){N&&we&&t.texStorage2D(n.TEXTURE_2D,De,Re,Xe[0].width,Xe[0].height);for(let pe=0,le=Xe.length;pe<le;pe++)xe=Xe[pe],N?ge&&t.texSubImage2D(n.TEXTURE_2D,pe,0,0,xe.width,xe.height,ve,Ee,xe.data):t.texImage2D(n.TEXTURE_2D,pe,Re,xe.width,xe.height,0,ve,Ee,xe.data);m.generateMipmaps=!1}else N?(we&&t.texStorage2D(n.TEXTURE_2D,De,Re,ue.width,ue.height),ge&&Ie(m,ue,ve,Ee)):t.texImage2D(n.TEXTURE_2D,0,Re,ue.width,ue.height,0,ve,Ee,ue.data);else if(m.isCompressedTexture)if(m.isCompressedArrayTexture){N&&we&&t.texStorage3D(n.TEXTURE_2D_ARRAY,De,Re,Xe[0].width,Xe[0].height,ue.depth);for(let pe=0,le=Xe.length;pe<le;pe++)if(xe=Xe[pe],m.format!==dn)if(ve!==null)if(N){if(ge)if(m.layerUpdates.size>0){const Se=yu(xe.width,xe.height,m.format,m.type);for(const ke of m.layerUpdates){const ut=xe.data.subarray(ke*Se/xe.data.BYTES_PER_ELEMENT,(ke+1)*Se/xe.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,pe,0,0,ke,xe.width,xe.height,1,ve,ut)}m.clearLayerUpdates()}else t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,pe,0,0,0,xe.width,xe.height,ue.depth,ve,xe.data)}else t.compressedTexImage3D(n.TEXTURE_2D_ARRAY,pe,Re,xe.width,xe.height,ue.depth,0,xe.data,0,0);else We("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else N?ge&&t.texSubImage3D(n.TEXTURE_2D_ARRAY,pe,0,0,0,xe.width,xe.height,ue.depth,ve,Ee,xe.data):t.texImage3D(n.TEXTURE_2D_ARRAY,pe,Re,xe.width,xe.height,ue.depth,0,ve,Ee,xe.data)}else{N&&we&&t.texStorage2D(n.TEXTURE_2D,De,Re,Xe[0].width,Xe[0].height);for(let pe=0,le=Xe.length;pe<le;pe++)xe=Xe[pe],m.format!==dn?ve!==null?N?ge&&t.compressedTexSubImage2D(n.TEXTURE_2D,pe,0,0,xe.width,xe.height,ve,xe.data):t.compressedTexImage2D(n.TEXTURE_2D,pe,Re,xe.width,xe.height,0,xe.data):We("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):N?ge&&t.texSubImage2D(n.TEXTURE_2D,pe,0,0,xe.width,xe.height,ve,Ee,xe.data):t.texImage2D(n.TEXTURE_2D,pe,Re,xe.width,xe.height,0,ve,Ee,xe.data)}else if(m.isDataArrayTexture)if(N){if(we&&t.texStorage3D(n.TEXTURE_2D_ARRAY,De,Re,ue.width,ue.height,ue.depth),ge)if(m.layerUpdates.size>0){const pe=yu(ue.width,ue.height,m.format,m.type);for(const le of m.layerUpdates){const Se=ue.data.subarray(le*pe/ue.data.BYTES_PER_ELEMENT,(le+1)*pe/ue.data.BYTES_PER_ELEMENT);t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,le,ue.width,ue.height,1,ve,Ee,Se)}m.clearLayerUpdates()}else t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,0,ue.width,ue.height,ue.depth,ve,Ee,ue.data)}else t.texImage3D(n.TEXTURE_2D_ARRAY,0,Re,ue.width,ue.height,ue.depth,0,ve,Ee,ue.data);else if(m.isData3DTexture)N?(we&&t.texStorage3D(n.TEXTURE_3D,De,Re,ue.width,ue.height,ue.depth),ge&&t.texSubImage3D(n.TEXTURE_3D,0,0,0,0,ue.width,ue.height,ue.depth,ve,Ee,ue.data)):t.texImage3D(n.TEXTURE_3D,0,Re,ue.width,ue.height,ue.depth,0,ve,Ee,ue.data);else if(m.isFramebufferTexture){if(we)if(N)t.texStorage2D(n.TEXTURE_2D,De,Re,ue.width,ue.height);else{let pe=ue.width,le=ue.height;for(let Se=0;Se<De;Se++)t.texImage2D(n.TEXTURE_2D,Se,Re,pe,le,0,ve,Ee,null),pe>>=1,le>>=1}}else if(Xe.length>0){if(N&&we){const pe=ae(Xe[0]);t.texStorage2D(n.TEXTURE_2D,De,Re,pe.width,pe.height)}for(let pe=0,le=Xe.length;pe<le;pe++)xe=Xe[pe],N?ge&&t.texSubImage2D(n.TEXTURE_2D,pe,0,0,ve,Ee,xe):t.texImage2D(n.TEXTURE_2D,pe,Re,ve,Ee,xe);m.generateMipmaps=!1}else if(N){if(we){const pe=ae(ue);t.texStorage2D(n.TEXTURE_2D,De,Re,pe.width,pe.height)}ge&&t.texSubImage2D(n.TEXTURE_2D,0,0,0,ve,Ee,ue)}else t.texImage2D(n.TEXTURE_2D,0,Re,ve,Ee,ue);g(m)&&d(Y),Te.__version=k.version,m.onUpdate&&m.onUpdate(m)}S.__version=m.version}function K(S,m,L){if(m.image.length!==6)return;const Y=he(S,m),te=m.source;t.bindTexture(n.TEXTURE_CUBE_MAP,S.__webglTexture,n.TEXTURE0+L);const k=i.get(te);if(te.version!==k.__version||Y===!0){t.activeTexture(n.TEXTURE0+L);const Te=Ze.getPrimaries(Ze.workingColorSpace),de=m.colorSpace===pi?null:Ze.getPrimaries(m.colorSpace),Ce=m.colorSpace===pi||Te===de?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,m.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,m.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,m.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ce);const Fe=m.isCompressedTexture||m.image[0].isCompressedTexture,ue=m.image[0]&&m.image[0].isDataTexture,ve=[];for(let le=0;le<6;le++)!Fe&&!ue?ve[le]=v(m.image[le],!0,r.maxCubemapSize):ve[le]=ue?m.image[le].image:m.image[le],ve[le]=ne(m,ve[le]);const Ee=ve[0],Re=s.convert(m.format,m.colorSpace),xe=s.convert(m.type),Xe=A(m.internalFormat,Re,xe,m.colorSpace),N=m.isVideoTexture!==!0,we=k.__version===void 0||Y===!0,ge=te.dataReady;let De=w(m,Ee);Ne(n.TEXTURE_CUBE_MAP,m);let pe;if(Fe){N&&we&&t.texStorage2D(n.TEXTURE_CUBE_MAP,De,Xe,Ee.width,Ee.height);for(let le=0;le<6;le++){pe=ve[le].mipmaps;for(let Se=0;Se<pe.length;Se++){const ke=pe[Se];m.format!==dn?Re!==null?N?ge&&t.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+le,Se,0,0,ke.width,ke.height,Re,ke.data):t.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+le,Se,Xe,ke.width,ke.height,0,ke.data):We("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):N?ge&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+le,Se,0,0,ke.width,ke.height,Re,xe,ke.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+le,Se,Xe,ke.width,ke.height,0,Re,xe,ke.data)}}}else{if(pe=m.mipmaps,N&&we){pe.length>0&&De++;const le=ae(ve[0]);t.texStorage2D(n.TEXTURE_CUBE_MAP,De,Xe,le.width,le.height)}for(let le=0;le<6;le++)if(ue){N?ge&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+le,0,0,0,ve[le].width,ve[le].height,Re,xe,ve[le].data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+le,0,Xe,ve[le].width,ve[le].height,0,Re,xe,ve[le].data);for(let Se=0;Se<pe.length;Se++){const ut=pe[Se].image[le].image;N?ge&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+le,Se+1,0,0,ut.width,ut.height,Re,xe,ut.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+le,Se+1,Xe,ut.width,ut.height,0,Re,xe,ut.data)}}else{N?ge&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+le,0,0,0,Re,xe,ve[le]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+le,0,Xe,Re,xe,ve[le]);for(let Se=0;Se<pe.length;Se++){const ke=pe[Se];N?ge&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+le,Se+1,0,0,Re,xe,ke.image[le]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+le,Se+1,Xe,Re,xe,ke.image[le])}}}g(m)&&d(n.TEXTURE_CUBE_MAP),k.__version=te.version,m.onUpdate&&m.onUpdate(m)}S.__version=m.version}function _e(S,m,L,Y,te,k){const Te=s.convert(L.format,L.colorSpace),de=s.convert(L.type),Ce=A(L.internalFormat,Te,de,L.colorSpace),Fe=i.get(m),ue=i.get(L);if(ue.__renderTarget=m,!Fe.__hasExternalTextures){const ve=Math.max(1,m.width>>k),Ee=Math.max(1,m.height>>k);te===n.TEXTURE_3D||te===n.TEXTURE_2D_ARRAY?t.texImage3D(te,k,Ce,ve,Ee,m.depth,0,Te,de,null):t.texImage2D(te,k,Ce,ve,Ee,0,Te,de,null)}t.bindFramebuffer(n.FRAMEBUFFER,S),ce(m)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,Y,te,ue.__webglTexture,0,T(m)):(te===n.TEXTURE_2D||te>=n.TEXTURE_CUBE_MAP_POSITIVE_X&&te<=n.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&n.framebufferTexture2D(n.FRAMEBUFFER,Y,te,ue.__webglTexture,k),t.bindFramebuffer(n.FRAMEBUFFER,null)}function Be(S,m,L){if(n.bindRenderbuffer(n.RENDERBUFFER,S),m.depthBuffer){const Y=m.depthTexture,te=Y&&Y.isDepthTexture?Y.type:null,k=y(m.stencilBuffer,te),Te=m.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;ce(m)?o.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,T(m),k,m.width,m.height):L?n.renderbufferStorageMultisample(n.RENDERBUFFER,T(m),k,m.width,m.height):n.renderbufferStorage(n.RENDERBUFFER,k,m.width,m.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,Te,n.RENDERBUFFER,S)}else{const Y=m.textures;for(let te=0;te<Y.length;te++){const k=Y[te],Te=s.convert(k.format,k.colorSpace),de=s.convert(k.type),Ce=A(k.internalFormat,Te,de,k.colorSpace);ce(m)?o.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,T(m),Ce,m.width,m.height):L?n.renderbufferStorageMultisample(n.RENDERBUFFER,T(m),Ce,m.width,m.height):n.renderbufferStorage(n.RENDERBUFFER,Ce,m.width,m.height)}}n.bindRenderbuffer(n.RENDERBUFFER,null)}function me(S,m,L){const Y=m.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(n.FRAMEBUFFER,S),!(m.depthTexture&&m.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const te=i.get(m.depthTexture);if(te.__renderTarget=m,(!te.__webglTexture||m.depthTexture.image.width!==m.width||m.depthTexture.image.height!==m.height)&&(m.depthTexture.image.width=m.width,m.depthTexture.image.height=m.height,m.depthTexture.needsUpdate=!0),Y){if(te.__webglInit===void 0&&(te.__webglInit=!0,m.depthTexture.addEventListener("dispose",D)),te.__webglTexture===void 0){te.__webglTexture=n.createTexture(),t.bindTexture(n.TEXTURE_CUBE_MAP,te.__webglTexture),Ne(n.TEXTURE_CUBE_MAP,m.depthTexture);const Fe=s.convert(m.depthTexture.format),ue=s.convert(m.depthTexture.type);let ve;m.depthTexture.format===ei?ve=n.DEPTH_COMPONENT24:m.depthTexture.format===Vi&&(ve=n.DEPTH24_STENCIL8);for(let Ee=0;Ee<6;Ee++)n.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+Ee,0,ve,m.width,m.height,0,Fe,ue,null)}}else $(m.depthTexture,0);const k=te.__webglTexture,Te=T(m),de=Y?n.TEXTURE_CUBE_MAP_POSITIVE_X+L:n.TEXTURE_2D,Ce=m.depthTexture.format===Vi?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;if(m.depthTexture.format===ei)ce(m)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,Ce,de,k,0,Te):n.framebufferTexture2D(n.FRAMEBUFFER,Ce,de,k,0);else if(m.depthTexture.format===Vi)ce(m)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,Ce,de,k,0,Te):n.framebufferTexture2D(n.FRAMEBUFFER,Ce,de,k,0);else throw new Error("Unknown depthTexture format")}function Me(S){const m=i.get(S),L=S.isWebGLCubeRenderTarget===!0;if(m.__boundDepthTexture!==S.depthTexture){const Y=S.depthTexture;if(m.__depthDisposeCallback&&m.__depthDisposeCallback(),Y){const te=()=>{delete m.__boundDepthTexture,delete m.__depthDisposeCallback,Y.removeEventListener("dispose",te)};Y.addEventListener("dispose",te),m.__depthDisposeCallback=te}m.__boundDepthTexture=Y}if(S.depthTexture&&!m.__autoAllocateDepthBuffer)if(L)for(let Y=0;Y<6;Y++)me(m.__webglFramebuffer[Y],S,Y);else{const Y=S.texture.mipmaps;Y&&Y.length>0?me(m.__webglFramebuffer[0],S,0):me(m.__webglFramebuffer,S,0)}else if(L){m.__webglDepthbuffer=[];for(let Y=0;Y<6;Y++)if(t.bindFramebuffer(n.FRAMEBUFFER,m.__webglFramebuffer[Y]),m.__webglDepthbuffer[Y]===void 0)m.__webglDepthbuffer[Y]=n.createRenderbuffer(),Be(m.__webglDepthbuffer[Y],S,!1);else{const te=S.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,k=m.__webglDepthbuffer[Y];n.bindRenderbuffer(n.RENDERBUFFER,k),n.framebufferRenderbuffer(n.FRAMEBUFFER,te,n.RENDERBUFFER,k)}}else{const Y=S.texture.mipmaps;if(Y&&Y.length>0?t.bindFramebuffer(n.FRAMEBUFFER,m.__webglFramebuffer[0]):t.bindFramebuffer(n.FRAMEBUFFER,m.__webglFramebuffer),m.__webglDepthbuffer===void 0)m.__webglDepthbuffer=n.createRenderbuffer(),Be(m.__webglDepthbuffer,S,!1);else{const te=S.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,k=m.__webglDepthbuffer;n.bindRenderbuffer(n.RENDERBUFFER,k),n.framebufferRenderbuffer(n.FRAMEBUFFER,te,n.RENDERBUFFER,k)}}t.bindFramebuffer(n.FRAMEBUFFER,null)}function C(S,m,L){const Y=i.get(S);m!==void 0&&_e(Y.__webglFramebuffer,S,S.texture,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,0),L!==void 0&&Me(S)}function R(S){const m=S.texture,L=i.get(S),Y=i.get(m);S.addEventListener("dispose",P);const te=S.textures,k=S.isWebGLCubeRenderTarget===!0,Te=te.length>1;if(Te||(Y.__webglTexture===void 0&&(Y.__webglTexture=n.createTexture()),Y.__version=m.version,a.memory.textures++),k){L.__webglFramebuffer=[];for(let de=0;de<6;de++)if(m.mipmaps&&m.mipmaps.length>0){L.__webglFramebuffer[de]=[];for(let Ce=0;Ce<m.mipmaps.length;Ce++)L.__webglFramebuffer[de][Ce]=n.createFramebuffer()}else L.__webglFramebuffer[de]=n.createFramebuffer()}else{if(m.mipmaps&&m.mipmaps.length>0){L.__webglFramebuffer=[];for(let de=0;de<m.mipmaps.length;de++)L.__webglFramebuffer[de]=n.createFramebuffer()}else L.__webglFramebuffer=n.createFramebuffer();if(Te)for(let de=0,Ce=te.length;de<Ce;de++){const Fe=i.get(te[de]);Fe.__webglTexture===void 0&&(Fe.__webglTexture=n.createTexture(),a.memory.textures++)}if(S.samples>0&&ce(S)===!1){L.__webglMultisampledFramebuffer=n.createFramebuffer(),L.__webglColorRenderbuffer=[],t.bindFramebuffer(n.FRAMEBUFFER,L.__webglMultisampledFramebuffer);for(let de=0;de<te.length;de++){const Ce=te[de];L.__webglColorRenderbuffer[de]=n.createRenderbuffer(),n.bindRenderbuffer(n.RENDERBUFFER,L.__webglColorRenderbuffer[de]);const Fe=s.convert(Ce.format,Ce.colorSpace),ue=s.convert(Ce.type),ve=A(Ce.internalFormat,Fe,ue,Ce.colorSpace,S.isXRRenderTarget===!0),Ee=T(S);n.renderbufferStorageMultisample(n.RENDERBUFFER,Ee,ve,S.width,S.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+de,n.RENDERBUFFER,L.__webglColorRenderbuffer[de])}n.bindRenderbuffer(n.RENDERBUFFER,null),S.depthBuffer&&(L.__webglDepthRenderbuffer=n.createRenderbuffer(),Be(L.__webglDepthRenderbuffer,S,!0)),t.bindFramebuffer(n.FRAMEBUFFER,null)}}if(k){t.bindTexture(n.TEXTURE_CUBE_MAP,Y.__webglTexture),Ne(n.TEXTURE_CUBE_MAP,m);for(let de=0;de<6;de++)if(m.mipmaps&&m.mipmaps.length>0)for(let Ce=0;Ce<m.mipmaps.length;Ce++)_e(L.__webglFramebuffer[de][Ce],S,m,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+de,Ce);else _e(L.__webglFramebuffer[de],S,m,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+de,0);g(m)&&d(n.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(Te){for(let de=0,Ce=te.length;de<Ce;de++){const Fe=te[de],ue=i.get(Fe);let ve=n.TEXTURE_2D;(S.isWebGL3DRenderTarget||S.isWebGLArrayRenderTarget)&&(ve=S.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(ve,ue.__webglTexture),Ne(ve,Fe),_e(L.__webglFramebuffer,S,Fe,n.COLOR_ATTACHMENT0+de,ve,0),g(Fe)&&d(ve)}t.unbindTexture()}else{let de=n.TEXTURE_2D;if((S.isWebGL3DRenderTarget||S.isWebGLArrayRenderTarget)&&(de=S.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(de,Y.__webglTexture),Ne(de,m),m.mipmaps&&m.mipmaps.length>0)for(let Ce=0;Ce<m.mipmaps.length;Ce++)_e(L.__webglFramebuffer[Ce],S,m,n.COLOR_ATTACHMENT0,de,Ce);else _e(L.__webglFramebuffer,S,m,n.COLOR_ATTACHMENT0,de,0);g(m)&&d(de),t.unbindTexture()}S.depthBuffer&&Me(S)}function H(S){const m=S.textures;for(let L=0,Y=m.length;L<Y;L++){const te=m[L];if(g(te)){const k=b(S),Te=i.get(te).__webglTexture;t.bindTexture(k,Te),d(k),t.unbindTexture()}}}const ee=[],J=[];function ie(S){if(S.samples>0){if(ce(S)===!1){const m=S.textures,L=S.width,Y=S.height;let te=n.COLOR_BUFFER_BIT;const k=S.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,Te=i.get(S),de=m.length>1;if(de)for(let Fe=0;Fe<m.length;Fe++)t.bindFramebuffer(n.FRAMEBUFFER,Te.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+Fe,n.RENDERBUFFER,null),t.bindFramebuffer(n.FRAMEBUFFER,Te.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+Fe,n.TEXTURE_2D,null,0);t.bindFramebuffer(n.READ_FRAMEBUFFER,Te.__webglMultisampledFramebuffer);const Ce=S.texture.mipmaps;Ce&&Ce.length>0?t.bindFramebuffer(n.DRAW_FRAMEBUFFER,Te.__webglFramebuffer[0]):t.bindFramebuffer(n.DRAW_FRAMEBUFFER,Te.__webglFramebuffer);for(let Fe=0;Fe<m.length;Fe++){if(S.resolveDepthBuffer&&(S.depthBuffer&&(te|=n.DEPTH_BUFFER_BIT),S.stencilBuffer&&S.resolveStencilBuffer&&(te|=n.STENCIL_BUFFER_BIT)),de){n.framebufferRenderbuffer(n.READ_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.RENDERBUFFER,Te.__webglColorRenderbuffer[Fe]);const ue=i.get(m[Fe]).__webglTexture;n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,ue,0)}n.blitFramebuffer(0,0,L,Y,0,0,L,Y,te,n.NEAREST),l===!0&&(ee.length=0,J.length=0,ee.push(n.COLOR_ATTACHMENT0+Fe),S.depthBuffer&&S.resolveDepthBuffer===!1&&(ee.push(k),J.push(k),n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,J)),n.invalidateFramebuffer(n.READ_FRAMEBUFFER,ee))}if(t.bindFramebuffer(n.READ_FRAMEBUFFER,null),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),de)for(let Fe=0;Fe<m.length;Fe++){t.bindFramebuffer(n.FRAMEBUFFER,Te.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+Fe,n.RENDERBUFFER,Te.__webglColorRenderbuffer[Fe]);const ue=i.get(m[Fe]).__webglTexture;t.bindFramebuffer(n.FRAMEBUFFER,Te.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+Fe,n.TEXTURE_2D,ue,0)}t.bindFramebuffer(n.DRAW_FRAMEBUFFER,Te.__webglMultisampledFramebuffer)}else if(S.depthBuffer&&S.resolveDepthBuffer===!1&&l){const m=S.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,[m])}}}function T(S){return Math.min(r.maxSamples,S.samples)}function ce(S){const m=i.get(S);return S.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&m.__useRenderToTexture!==!1}function se(S){const m=a.render.frame;c.get(S)!==m&&(c.set(S,m),S.update())}function ne(S,m){const L=S.colorSpace,Y=S.format,te=S.type;return S.isCompressedTexture===!0||S.isVideoTexture===!0||L!==Er&&L!==pi&&(Ze.getTransfer(L)===st?(Y!==dn||te!==an)&&We("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Qe("WebGLTextures: Unsupported texture color space:",L)),m}function ae(S){return typeof HTMLImageElement<"u"&&S instanceof HTMLImageElement?(u.width=S.naturalWidth||S.width,u.height=S.naturalHeight||S.height):typeof VideoFrame<"u"&&S instanceof VideoFrame?(u.width=S.displayWidth,u.height=S.displayHeight):(u.width=S.width,u.height=S.height),u}this.allocateTextureUnit=B,this.resetTextureUnits=U,this.setTexture2D=$,this.setTexture2DArray=X,this.setTexture3D=z,this.setTextureCube=W,this.rebindTextures=C,this.setupRenderTarget=R,this.updateRenderTargetMipmap=H,this.updateMultisampleRenderTarget=ie,this.setupDepthRenderbuffer=Me,this.setupFrameBufferTexture=_e,this.useMultisampledRTT=ce,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function US(n,e){function t(i,r=pi){let s;const a=Ze.getTransfer(r);if(i===an)return n.UNSIGNED_BYTE;if(i===ec)return n.UNSIGNED_SHORT_4_4_4_4;if(i===tc)return n.UNSIGNED_SHORT_5_5_5_1;if(i===vh)return n.UNSIGNED_INT_5_9_9_9_REV;if(i===Sh)return n.UNSIGNED_INT_10F_11F_11F_REV;if(i===_h)return n.BYTE;if(i===xh)return n.SHORT;if(i===rs)return n.UNSIGNED_SHORT;if(i===Ql)return n.INT;if(i===Dn)return n.UNSIGNED_INT;if(i===Tn)return n.FLOAT;if(i===Qn)return n.HALF_FLOAT;if(i===Mh)return n.ALPHA;if(i===Eh)return n.RGB;if(i===dn)return n.RGBA;if(i===ei)return n.DEPTH_COMPONENT;if(i===Vi)return n.DEPTH_STENCIL;if(i===yh)return n.RED;if(i===nc)return n.RED_INTEGER;if(i===Mr)return n.RG;if(i===ic)return n.RG_INTEGER;if(i===rc)return n.RGBA_INTEGER;if(i===Ks||i===js||i===Zs||i===Js)if(a===st)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(i===Ks)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===js)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===Zs)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===Js)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(i===Ks)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===js)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===Zs)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===Js)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===jo||i===Zo||i===Jo||i===Qo)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(i===jo)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===Zo)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===Jo)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===Qo)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===el||i===tl||i===nl||i===il||i===rl||i===sl||i===al)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(i===el||i===tl)return a===st?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(i===nl)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC;if(i===il)return s.COMPRESSED_R11_EAC;if(i===rl)return s.COMPRESSED_SIGNED_R11_EAC;if(i===sl)return s.COMPRESSED_RG11_EAC;if(i===al)return s.COMPRESSED_SIGNED_RG11_EAC}else return null;if(i===ol||i===ll||i===cl||i===ul||i===fl||i===hl||i===dl||i===pl||i===ml||i===gl||i===_l||i===xl||i===vl||i===Sl)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(i===ol)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===ll)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===cl)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===ul)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===fl)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===hl)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===dl)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===pl)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===ml)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===gl)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===_l)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===xl)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===vl)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===Sl)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===Ml||i===El||i===yl)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(i===Ml)return a===st?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===El)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===yl)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===bl||i===Tl||i===Al||i===wl)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(i===bl)return s.COMPRESSED_RED_RGTC1_EXT;if(i===Tl)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===Al)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===wl)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===ss?n.UNSIGNED_INT_24_8:n[i]!==void 0?n[i]:null}return{convert:t}}const NS=`
void main() {
...
}`;class OS{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){const i=new Bh(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=i}}getMesh(e){if(this.texture!==null&&this.mesh===null){const t=e.cameras[0].viewport,i=new Ln({vertexShader:NS,fragmentShader:FS,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new ni(new ba(20,20),i)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class BS extends br{constructor(e,t){super();const i=this;let r=null,s=1,a=null,o="local-floor",l=1,u=null,c=null,f=null,h=null,p=null,_=null;const v=typeof XRWebGLBinding<"u",g=new OS,d={},b=t.getContextAttributes();let A=null,y=null;const w=[],D=[],P=new ot;let O=null;const x=new sn;x.viewport=new _t;const E=new sn;E.viewport=new _t;const I=[x,E],U=new $g;let B=null,V=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(q){let K=w[q];return K===void 0&&(K=new po,w[q]=K),K.getTargetRaySpace()},this.getControllerGrip=function(q){let K=w[q];return K===void 0&&(K=new po,w[q]=K),K.getGripSpace()},this.getHand=function(q){let K=w[q];return K===void 0&&(K=new po,w[q]=K),K.getHandSpace()};function $(q){const K=D.indexOf(q.inputSource);if(K===-1)return;const _e=w[K];_e!==void 0&&(_e.update(q.inputSource,q.frame,u||a),_e.dispatchEvent({type:q.type,data:q.inputSource}))}function X(){r.removeEventListener("select",$),r.removeEventListener("selectstart",$),r.removeEventListener("selectend",$),r.removeEventListener("squeeze",$),r.removeEventListener("squeezestart",$),r.removeEventListener("squeezeend",$),r.removeEventListener("end",X),r.removeEventListener("inputsourceschange",z);for(let q=0;q<w.length;q++){const K=D[q];K!==null&&(D[q]=null,w[q].disconnect(K))}B=null,V=null,g.reset();for(const q in d)delete d[q];e.setRenderTarget(A),p=null,h=null,f=null,r=null,y=null,Ie.stop(),i.isPresenting=!1,e.setPixelRatio(O),e.setSize(P.width,P.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(q){s=q,i.isPresenting===!0&&We("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(q){o=q,i.isPresenting===!0&&We("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return u||a},this.setReferenceSpace=function(q){u=q},this.getBaseLayer=function(){return h!==null?h:p},this.getBinding=function(){return f===null&&v&&(f=new XRWebGLBinding(r,t)),f},this.getFrame=function(){return _},this.getSession=function(){return r},this.setSession=async function(q){if(r=q,r!==null){if(A=e.getRenderTarget(),r.addEventListener("select",$),r.addEventListener("selectstart",$),r.addEventListener("selectend",$),r.addEventListener("squeeze",$),r.addEventListener("squeezestart",$),r.addEventListener("squeezeend",$),r.addEventListener("end",X),r.addEventListener("inputsourceschange",z),b.xrCompatible!==!0&&await t.makeXRCompatible(),O=e.getPixelRatio(),e.getSize(P),v&&"createProjectionLayer"in XRWebGLBinding.prototype){let _e=null,Be=null,me=null;b.depth&&(me=b.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,_e=b.stencil?Vi:ei,Be=b.stencil?ss:Dn);const Me={colorFormat:t.RGBA8,depthFormat:me,scaleFactor:s};f=this.getBinding(),h=f.createProjectionLayer(Me),r.updateRenderState({layers:[h]}),e.setPixelRatio(1),e.setSize(h.textureWidth,h.textureHeight,!1),y=new Pn(h.textureWidth,h.textureHeight,{format:dn,type:an,depthTexture:new ls(h.textureWidth,h.textureHeight,Be,void 0,void 0,void 0,void 0,void 0,void 0,_e),stencilBuffer:b.stencil,colorSpace:e.outputColorSpace,samples:b.antialias?4:0,resolveDepthBuffer:h.ignoreDepthValues===!1,resolveStencilBuffer:h.ignoreDepthValues===!1})}else{const _e={antialias:b.antialias,alpha:!0,depth:b.depth,stencil:b.stencil,framebufferScaleFactor:s};p=new XRWebGLLayer(r,t,_e),r.updateRenderState({baseLayer:p}),e.setPixelRatio(1),e.setSize(p.framebufferWidth,p.framebufferHeight,!1),y=new Pn(p.framebufferWidth,p.framebufferHeight,{format:dn,type:an,colorSpace:e.outputColorSpace,stencilBuffer:b.stencil,resolveDepthBuffer:p.ignoreDepthValues===!1,resolveStencilBuffer:p.ignoreDepthValues===!1})}y.isXRRenderTarget=!0,this.setFoveation(l),u=null,a=await r.requestReferenceSpace(o),Ie.setContext(r),Ie.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return g.getDepthTexture()};function z(q){for(let K=0;K<q.removed.length;K++){const _e=q.removed[K],Be=D.indexOf(_e);Be>=0&&(D[Be]=null,w[Be].disconnect(_e))}for(let K=0;K<q.added.length;K++){const _e=q.added[K];let Be=D.indexOf(_e);if(Be===-1){for(let Me=0;Me<w.length;Me++)if(Me>=D.length){D.push(_e),Be=Me;break}else if(D[Me]===null){D[Me]=_e,Be=Me;break}if(Be===-1)break}const me=w[Be];me&&me.connect(_e)}}const W=new j,re=new j;function oe(q,K,_e){W.setFromMatrixPosition(K.matrixWorld),re.setFromMatrixPosition(_e.matrixWorld);const Be=W.distanceTo(re),me=K.projectionMatrix.elements,Me=_e.projectionMatrix.elements,C=me[14]/(me[10]-1),R=me[14]/(me[10]+1),H=(me[9]+1)/me[5],ee=(me[9]-1)/me[5],J=(me[8]-1)/me[0],ie=(Me[8]+1)/Me[0],T=C*J,ce=C*ie,se=Be/(-J+ie),ne=se*-J;if(K.matrixWorld.decompose(q.position,q.quaternion,q.scale),q.translateX(ne),q.translateZ(se),q.matrixWorld.compose(q.position,q.quaternion,q.scale),q.matrixWorldInverse.copy(q.matrixWorld).invert(),me[10]===-1)q.projectionMatrix.copy(K.projectionMatrix),q.projectionMatrixInverse.copy(K.projectionMatrixInverse);else{const ae=C+se,S=R+se,m=T-ne,L=ce+(Be-ne),Y=H*R/S*ae,te=ee*R/S*ae;q.projectionMatrix.makePerspective(m,L,Y,te,ae,S),q.projectionMatrixInverse.copy(q.projectionMatrix).invert()}}function fe(q,K){K===null?q.matrixWorld.copy(q.matrix):q.matrixWorld.multiplyMatrices(K.matrixWorld,q.matrix),q.matrixWorldInverse.copy(q.matrixWorld).invert()}this.updateCamera=function(q){if(r===null)return;let K=q.near,_e=q.far;g.texture!==null&&(g.depthNear>0&&(K=g.depthNear),g.depthFar>0&&(_e=g.depthFar)),U.near=E.near=x.near=K,U.far=E.far=x.far=_e,(B!==U.near||V!==U.far)&&(r.updateRenderState({depthNear:U.near,depthFar:U.far}),B=U.near,V=U.far),U.layers.mask=q.layers.mask|6,x.layers.mask=U.layers.mask&3,E.layers.mask=U.layers.mask&5;const Be=q.parent,me=U.cameras;fe(U,Be);for(let Me=0;Me<me.length;Me++)fe(me[Me],Be);me.length===2?oe(U,x,E):U.projectionMatrix.copy(x.projectionMatrix),Ne(q,U,Be)};function Ne(q,K,_e){_e===null?q.matrix.copy(K.matrixWorld):(q.matrix.copy(_e.matrixWorld),q.matrix.invert(),q.matrix.multiply(K.matrixWorld)),q.matrix.decompose(q.position,q.quaternion,q.scale),q.updateMatrixWorld(!0),q.projectionMatrix.copy(K.projectionMatrix),q.projectionMatrixInverse.copy(K.projectionMatrixInverse),q.isPerspectiveCamera&&(q.fov=Cl*2*Math.atan(1/q.projectionMatrix.elements[5]),q.zoom=1)}this.getCamera=function(){return U},this.getFoveation=function(){if(!(h===null&&p===null))return l},this.setFoveation=function(q){l=q,h!==null&&(h.fixedFoveation=q),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=q)},this.hasDepthSensing=function(){return g.texture!==null},this.getDepthSensingMesh=function(){return g.getMesh(U)},this.getCameraTexture=function(q){return d[q]};let he=null;function Pe(q,K){if(c=K.getViewerPose(u||a),_=K,c!==null){const _e=c.views;p!==null&&(e.setRenderTargetFramebuffer(y,p.framebuffer),e.setRenderTarget(y));let Be=!1;_e.length!==U.cameras.length&&(U.cameras.length=0,Be=!0);for(let R=0;R<_e.length;R++){const H=_e[R];let ee=null;if(p!==null)ee=p.getViewport(H);else{const ie=f.getViewSubImage(h,H);ee=ie.viewport,R===0&&(e.setRenderTargetTextures(y,ie.colorTexture,ie.depthStencilTexture),e.setRenderTarget(y))}let J=I[R];J===void 0&&(J=new sn,J.layers.enable(R),J.viewport=new _t,I[R]=J),J.matrix.fromArray(H.transform.matrix),J.matrix.decompose(J.position,J.quaternion,J.scale),J.projectionMatrix.fromArray(H.projectionMatrix),J.projectionMatrixInverse.copy(J.projectionMatrix).invert(),J.viewport.set(ee.x,ee.y,ee.width,ee.height),R===0&&(U.matrix.copy(J.matrix),U.matrix.decompose(U.position,U.quaternion,U.scale)),Be===!0&&U.cameras.push(J)}const me=r.enabledFeatures;if(me&&me.includes("depth-sensing")&&r.depthUsage=="gpu-optimized"&&v){f=i.getBinding();const R=f.getDepthInformation(_e[0]);R&&R.isValid&&R.texture&&g.init(R,r.renderState)}if(me&&me.includes("camera-access")&&v){e.state.unbindTexture(),f=i.getBinding();for(let R=0;R<_e.length;R++){const H=_e[R].camera;if(H){let ee=d[H];ee||(ee=new Bh,d[H]=ee);const J=f.getCameraImage(H);ee.sourceTexture=J}}}}for(let _e=0;_e<w.length;_e++){const Be=D[_e],me=w[_e];Be!==null&&me!==void 0&&me.update(Be,K,u||a)}he&&he(q,K),K.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:K}),_=null}const Ie=new Vh;Ie.setAnimationLoop(Pe),this.setAnimationLoop=function(q){he=q},this.dispose=function(){}}}const Ii=new ti,zS=new xt;function VS(n,e){function t(g,d){g.matrixAutoUpdate===!0&&g.updateMatrix(),d.value.copy(g.matrix)}function i(g,d){d.color.getRGB(g.fogColor.value,Lh(n)),d.isFog?(g.fogNear.value=d.near,g.fogFar.value=d.far):d.isFogExp2&&(g.fogDensity.value=d.density)}function r(g,d,b,A,y){d.isMeshBasicMaterial||d.isMeshLambertMaterial?s(g,d):d.isMeshToonMaterial?(s(g,d),f(g,d)):d.isMeshPhongMaterial?(s(g,d),c(g,d)):d.isMeshStandardMaterial?(s(g,d),h(g,d),d.isMeshPhysicalMaterial&&p(g,d,y)):d.isMeshMatcapMaterial?(s(g,d),_(g,d)):d.isMeshDepthMaterial?s(g,d):d.isMeshDistanceMaterial?(s(g,d),v(g,d)):d.isMeshNormalMaterial?s(g,d):d.isLineBasicMaterial?(a(g,d),d.isLineDashedMaterial&&o(g,d)):d.isPointsMaterial?l(g,d,b,A):d.isSpriteMaterial?u(g,d):d.isShadowMaterial?(g.color.value.copy(d.color),g.opacity.value=d.opacity):d.isShaderMaterial&&(d.uniformsNeedUpdate=!1)}function s(g,d){g.opacity.value=d.opacity,d.color&&g.diffuse.value.copy(d.color),d.emissive&&g.emissive.value.copy(d.emissive).multiplyScalar(d.emissiveIntensity),d.map&&(g.map.value=d.map,t(d.map,g.mapTransform)),d.alphaMap&&(g.alphaMap.value=d.alphaMap,t(d.alphaMap,g.alphaMapTransform)),d.bumpMap&&(g.bumpMap.value=d.bumpMap,t(d.bumpMap,g.bumpMapTransform),g.bumpScale.value=d.bumpScale,d.side===Wt&&(g.bumpScale.value*=-1)),d.normalMap&&(g.normalMap.value=d.normalMap,t(d.normalMap,g.normalMapTransform),g.normalScale.value.copy(d.normalScale),d.side===Wt&&g.normalScale.value.negate()),d.displacementMap&&(g.displacementMap.value=d.displacementMap,t(d.displacementMap,g.displacementMapTransform),g.displacementScale.value=d.displacementScale,g.displacementBias.value=d.displacementBias),d.emissiveMap&&(g.emissiveMap.value=d.emissiveMap,t(d.emissiveMap,g.emissiveMapTransform)),d.specularMap&&(g.specularMap.value=d.specularMap,t(d.specularMap,g.specularMapTransform)),d.alphaTest>0&&(g.alphaTest.value=d.alphaTest);const b=e.get(d),A=b.envMap,y=b.envMapRotation;A&&(g.envMap.value=A,Ii.copy(y),Ii.x*=-1,Ii.y*=-1,Ii.z*=-1,A.isCubeTexture&&A.isRenderTargetTexture===!1&&(Ii.y*=-1,Ii.z*=-1),g.envMapRotation.value.setFromMatrix4(zS.makeRotationFromEuler(Ii)),g.flipEnvMap.value=A.isCubeTexture&&A.isRenderTargetTexture===!1?-1:1,g.reflectivity.value=d.reflectivity,g.ior.value=d.ior,g.refractionRatio.value=d.refractionRatio),d.lightMap&&(g.lightMap.value=d.lightMap,g.lightMapIntensity.value=d.lightMapIntensity,t(d.lightMap,g.lightMapTransform)),d.aoMap&&(g.aoMap.value=d.aoMap,g.aoMapIntensity.value=d.aoMapIntensity,t(d.aoMap,g.aoMapTransform))}function a(g,d){g.diffuse.value.copy(d.color),g.opacity.value=d.opacity,d.map&&(g.map.value=d.map,t(d.map,g.mapTransform))}function o(g,d){g.dashSize.value=d.dashSize,g.totalSize.value=d.dashSize+d.gapSize,g.scale.value=d.scale}function l(g,d,b,A){g.diffuse.value.copy(d.color),g.opacity.value=d.opacity,g.size.value=d.size*b,g.scale.value=A*.5,d.map&&(g.map.value=d.map,t(d.map,g.uvTransform)),d.alphaMap&&(g.alphaMap.value=d.alphaMap,t(d.alphaMap,g.alphaMapTransform)),d.alphaTest>0&&(g.alphaTest.value=d.alphaTest)}function u(g,d){g.diffuse.value.copy(d.color),g.opacity.value=d.opacity,g.rotation.value=d.rotation,d.map&&(g.map.value=d.map,t(d.map,g.mapTransform)),d.alphaMap&&(g.alphaMap.value=d.alphaMap,t(d.alphaMap,g.alphaMapTransform)),d.alphaTest>0&&(g.alphaTest.value=d.alphaTest)}function c(g,d){g.specular.value.copy(d.specular),g.shininess.value=Math.max(d.shininess,1e-4)}function f(g,d){d.gradientMap&&(g.gradientMap.value=d.gradientMap)}function h(g,d){g.metalness.value=d.metalness,d.metalnessMap&&(g.metalnessMap.value=d.metalnessMap,t(d.metalnessMap,g.metalnessMapTransform)),g.roughness.value=d.roughness,d.roughnessMap&&(g.roughnessMap.value=d.roughnessMap,t(d.roughnessMap,g.roughnessMapTransform)),d.envMap&&(g.envMapIntensity.value=d.envMapIntensity)}function p(g,d,b){g.ior.value=d.ior,d.sheen>0&&(g.sheenColor.value.copy(d.sheenColor).multiplyScalar(d.sheen),g.sheenRoughness.value=d.sheenRoughness,d.sheenColorMap&&(g.sheenColorMap.value=d.sheenColorMap,t(d.sheenColorMap,g.sheenColorMapTransform)),d.sheenRoughnessMap&&(g.sheenRoughnessMap.value=d.sheenRoughnessMap,t(d.sheenRoughnessMap,g.sheenRoughnessMapTransform))),d.clearcoat>0&&(g.clearcoat.value=d.clearcoat,g.clearcoatRoughness.value=d.clearcoatRoughness,d.clearcoatMap&&(g.clearcoatMap.value=d.clearcoatMap,t(d.clearcoatMap,g.clearcoatMapTransform)),d.clearcoatRoughnessMap&&(g.clearcoatRoughnessMap.value=d.clearcoatRoughnessMap,t(d.clearcoatRoughnessMap,g.clearcoatRoughnessMapTransform)),d.clearcoatNormalMap&&(g.clearcoatNormalMap.value=d.clearcoatNormalMap,t(d.clearcoatNormalMap,g.clearcoatNormalMapTransform),g.clearcoatNormalScale.value.copy(d.clearcoatNormalScale),d.side===Wt&&g.clearcoatNormalScale.value.negate())),d.dispersion>0&&(g.dispersion.value=d.dispersion),d.iridescence>0&&(g.iridescence.value=d.iridescence,g.iridescenceIOR.value=d.iridescenceIOR,g.iridescenceThicknessMinimum.value=d.iridescenceThicknessRange[0],g.iridescenceThicknessMaximum.value=d.iridescenceThicknessRange[1],d.iridescenceMap&&(g.iridescenceMap.value=d.iridescenceMap,t(d.iridescenceMap,g.iridescenceMapTransform)),d.iridescenceThicknessMap&&(g.iridescenceThicknessMap.value=d.iridescenceThicknessMap,t(d.iridescenceThicknessMap,g.iridescenceThicknessMapTransform))),d.transmission>0&&(g.transmission.value=d.transmission,g.transmissionSamplerMap.value=b.texture,g.transmissionSamplerSize.value.set(b.width,b.height),d.transmissionMap&&(g.transmissionMap.value=d.transmissionMap,t(d.transmissionMap,g.transmissionMapTransform)),g.thickness.value=d.thickness,d.thicknessMap&&(g.thicknessMap.value=d.thicknessMap,t(d.thicknessMap,g.thicknessMapTransform)),g.attenuationDistance.value=d.attenuationDistance,g.attenuationColor.value.copy(d.attenuationColor)),d.anisotropy>0&&(g.anisotropyVector.value.set(d.anisotropy*Math.cos(d.anisotropyRotation),d.anisotropy*Math.sin(d.anisotropyRotation)),d.anisotropyMap&&(g.anisotropyMap.value=d.anisotropyMap,t(d.anisotropyMap,g.anisotropyMapTransform))),g.specularIntensity.value=d.specularIntensity,g.specularColor.value.copy(d.specularColor),d.specularColorMap&&(g.specularColorMap.value=d.specularColorMap,t(d.specularColorMap,g.specularColorMapTransform)),d.specularIntensityMap&&(g.specularIntensityMap.value=d.specularIntensityMap,t(d.specularIntensityMap,g.specularIntensityMapTransform))}function _(g,d){d.matcap&&(g.matcap.value=d.matcap)}function v(g,d){const b=e.get(d).light;g.referencePosition.value.setFromMatrixPosition(b.matrixWorld),g.nearDistance.value=b.shadow.camera.near,g.farDistance.value=b.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:r}}function HS(n,e,t,i){let r={},s={},a=[];const o=n.getParameter(n.MAX_UNIFORM_BUFFER_BINDINGS);function l(b,A){const y=A.program;i.uniformBlockBinding(b,y)}function u(b,A){let y=r[b.id];y===void 0&&(_(b),y=c(b),r[b.id]=y,b.addEventListener("dispose",g));const w=A.program;i.updateUBOMapping(b,w);const D=e.render.frame;s[b.id]!==D&&(h(b),s[b.id]=D)}function c(b){const A=f();b.__bindingPointIndex=A;const y=n.createBuffer(),w=b.__size,D=b.usage;return n.bindBuffer(n.UNIFORM_BUFFER,y),n.bufferData(n.UNIFORM_BUFFER,w,D),n.bindBuffer(n.UNIFORM_BUFFER,null),n.bindBufferBase(n.UNIFORM_BUFFER,A,y),y}function f(){for(let b=0;b<o;b++)if(a.indexOf(b)===-1)return a.push(b),b;return Qe("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function h(b){const A=r[b.id],y=b.uniforms,w=b.__cache;n.bindBuffer(n.UNIFORM_BUFFER,A);for(let D=0,P=y.length;D<P;D++){const O=Array.isArray(y[D])?y[D]:[y[D]];for(let x=0,E=O.length;x<E;x++){const I=O[x];if(p(I,D,x,w)===!0){const U=I.__offset,B=Array.isArray(I.value)?I.value:[I.value];let V=0;for(let $=0;$<B.length;$++){const X=B[$],z=v(X);typeof X=="number"||typeof X=="boolean"?(I.__data[0]=X,n.bufferSubData(n.UNIFORM_BUFFER,U+V,I.__data)):X.isMatrix3?(I.__data[0]=X.elements[0],I.__data[1]=X.elements[1],I.__data[2]=X.elements[2],I.__data[3]=0,I.__data[4]=X.elements[3],I.__data[5]=X.elements[4],I.__data[6]=X.elements[5],I.__data[7]=0,I.__data[8]=X.elements[6],I.__data[9]=X.elements[7],I.__data[10]=X.elements[8],I.__data[11]=0):(X.toArray(I.__data,V),V+=z.storage/Float32Array.BYTES_PER_ELEMENT)}n.bufferSubData(n.UNIFORM_BUFFER,U,I.__data)}}}n.bindBuffer(n.UNIFORM_BUFFER,null)}function p(b,A,y,w){const D=b.value,P=A+"_"+y;if(w[P]===void 0)return typeof D=="number"||typeof D=="boolean"?w[P]=D:w[P]=D.clone(),!0;{const O=w[P];if(typeof D=="number"||typeof D=="boolean"){if(O!==D)return w[P]=D,!0}else if(O.equals(D)===!1)return O.copy(D),!0}return!1}function _(b){const A=b.uniforms;let y=0;const w=16;for(let P=0,O=A.length;P<O;P++){const x=Array.isArray(A[P])?A[P]:[A[P]];for(let E=0,I=x.length;E<I;E++){const U=x[E],B=Array.isArray(U.value)?U.value:[U.value];for(let V=0,$=B.length;V<$;V++){const X=B[V],z=v(X),W=y%w,re=W%z.boundary,oe=W+re;y+=re,oe!==0&&w-oe<z.storage&&(y+=w-oe),U.__data=new Float32Array(z.storage/Float32Array.BYTES_PER_ELEMENT),U.__offset=y,y+=z.storage}}}const D=y%w;return D>0&&(y+=w-D),b.__size=y,b.__cache={},this}function v(b){const A={boundary:0,storage:0};return typeof b=="number"||typeof b=="boolean"?(A.boundary=4,A.storage=4):b.isVector2?(A.boundary=8,A.storage=8):b.isVector3||b.isColor?(A.boundary=16,A.storage=12):b.isVector4?(A.boundary=16,A.storage=16):b.isMatrix3?(A.boundary=48,A.storage=48):b.isMatrix4?(A.boundary=64,A.storage=64):b.isTexture?We("WebGLRenderer: Texture samplers can not be part of an uniforms group."):We("WebGLRenderer: Unsupported uniform value type.",b),A}function g(b){const A=b.target;A.removeEventListener("dispose",g);const y=a.indexOf(A.__bindingPointIndex);a.splice(y,1),n.deleteBuffer(r[A.id]),delete r[A.id],delete s[A.id]}function d(){for(const b in r)n.deleteBuffer(r[b]);a=[],r={},s={}}return{bind:l,update:u,dispose:d}}const GS=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]);let Mn=null;function kS(){return Mn===null&&(Mn=new Ng(GS,16,16,Mr,Qn),Mn.name="DFG_LUT",Mn.minFilter=Dt,Mn.magFilter=Dt,Mn.wrapS=qn,Mn.wrapT=qn,Mn.generateMipmaps=!1,Mn.needsUpdate=!0),Mn}class WS{constructor(e={}){const{canvas:t=lg(),context:i=null,depth:r=!0,stencil:s=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:u=!1,powerPreference:c="default",failIfMajorPerformanceCaveat:f=!1,reversedDepthBuffer:h=!1,outputBufferType:p=an}=e;this.isWebGLRenderer=!0;let _;if(i!==null){if(typeof WebGLRenderingContext<"u"&&i instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");_=i.getContextAttributes().alpha}else _=a;const v=p,g=new Set([rc,ic,nc]),d=new Set([an,Dn,rs,ss,ec,tc]),b=new Uint32Array(4),A=new Int32Array(4);let y=null,w=null;const D=[],P=[];let O=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=Rn,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const x=this;let E=!1;this._outputColorSpace=nn;let I=0,U=0,B=null,V=-1,$=null;const X=new _t,z=new _t;let W=null;const re=new nt(0);let oe=0,fe=t.width,Ne=t.height,he=1,Pe=null,Ie=null;const q=new _t(0,0,fe,Ne),K=new _t(0,0,fe,Ne);let _e=!1;const Be=new Fh;let me=!1,Me=!1;const C=new xt,R=new j,H=new _t,ee={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let J=!1;function ie(){return B===null?he:1}let T=i;function ce(M,F){return t.getContext(M,F)}try{const M={alpha:!0,depth:r,stencil:s,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:u,powerPreference:c,failIfMajorPerformanceCaveat:f};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${Jl}`),t.addEventListener("webglcontextlost",ke,!1),t.addEventListener("webglcontextrestored",ut,!1),t.addEventListener("webglcontextcreationerror",it,!1),T===null){const F="webgl2";if(T=ce(F,M),T===null)throw ce(F)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(M){throw Qe("WebGLRenderer: "+M.message),M}let se,ne,ae,S,m,L,Y,te,k,Te,de,Ce,Fe,ue,ve,Ee,Re,xe,Xe,N,we,ge,De,pe;function le(){se=new kx(T),se.init(),ge=new US(T,se),ne=new Ux(T,se,e,ge),ae=new LS(T,se),ne.reversedDepthBuffer&&h&&ae.buffers.depth.setReversed(!0),S=new qx(T),m=new _S,L=new IS(T,se,ae,m,ne,ge,S),Y=new Fx(x),te=new Gx(x),k=new jg(T),De=new Lx(T,k),Te=new Wx(T,k,S,De),de=new $x(T,Te,k,S),Xe=new Yx(T,ne,L),Ee=new Nx(m),Ce=new gS(x,Y,te,se,ne,De,Ee),Fe=new VS(x,m),ue=new vS,ve=new TS(se),xe=new Dx(x,Y,te,ae,de,_,l),Re=new PS(x,de,ne),pe=new HS(T,S,ne,ae),N=new Ix(T,se,S),we=new Xx(T,se,S),S.programs=Ce.programs,x.capabilities=ne,x.extensions=se,x.properties=m,x.renderLists=ue,x.shadowMap=Re,x.state=ae,x.info=S}le(),v!==an&&(O=new jx(v,t.width,t.height,r,s));const Se=new BS(x,T);this.xr=Se,this.getContext=function(){return T},this.getContextAttributes=function(){return T.getContextAttributes()},this.forceContextLoss=function(){const M=se.get("WEBGL_lose_context");M&&M.loseContext()},this.forceContextRestore=function(){const M=se.get("WEBGL_lose_context");M&&M.restoreContext()},this.getPixelRatio=function(){return he},this.setPixelRatio=function(M){M!==void 0&&(he=M,this.setSize(fe,Ne,!1))},this.getSize=function(M){return M.set(fe,Ne)},this.setSize=function(M,F,Q=!0){if(Se.isPresenting){We("WebGLRenderer: Can't change size while VR device is presenting.");return}fe=M,Ne=F,t.width=Math.floor(M*he),t.height=Math.floor(F*he),Q===!0&&(t.style.width=M+"px",t.style.height=F+"px"),O!==null&&O.setSize(t.width,t.height),this.setViewport(0,0,M,F)},this.getDrawingBufferSize=function(M){return M.set(fe*he,Ne*he).floor()},this.setDrawingBufferSize=function(M,F,Q){fe=M,Ne=F,he=Q,t.width=Math.floor(M*Q),t.height=Math.floor(F*Q),this.setViewport(0,0,M,F)},this.setEffects=function(M){if(v===an){console.error("THREE.WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(M){for(let F=0;F<M.length;F++)if(M[F].isOutputPass===!0){console.warn("THREE.WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}O.setEffects(M||[])},this.getCurrentViewport=function(M){return M.copy(X)},this.getViewport=function(M){return M.copy(q)},this.setViewport=function(M,F,Q,Z){M.isVector4?q.set(M.x,M.y,M.z,M.w):q.set(M,F,Q,Z),ae.viewport(X.copy(q).multiplyScalar(he).round())},this.getScissor=function(M){return M.copy(K)},this.setScissor=function(M,F,Q,Z){M.isVector4?K.set(M.x,M.y,M.z,M.w):K.set(M,F,Q,Z),ae.scissor(z.copy(K).multiplyScalar(he).round())},this.getScissorTest=function(){return _e},this.setScissorTest=function(M){ae.setScissorTest(_e=M)},this.setOpaqueSort=function(M){Pe=M},this.setTransparentSort=function(M){Ie=M},this.getClearColor=function(M){return M.copy(xe.getClearColor())},this.setClearColor=function(){xe.setClearColor(...arguments)},this.getClearAlpha=function(){return xe.getClearAlpha()},this.setClearAlpha=function(){xe.setClearAlpha(...arguments)},this.clear=function(M=!0,F=!0,Q=!0){let Z=0;if(M){let G=!1;if(B!==null){const ye=B.texture.format;G=g.has(ye)}if(G){const ye=B.texture.type,Le=d.has(ye),Ae=xe.getClearColor(),Ue=xe.getClearAlpha(),Oe=Ae.r,He=Ae.g,ze=Ae.b;Le?(b[0]=Oe,b[1]=He,b[2]=ze,b[3]=Ue,T.clearBufferuiv(T.COLOR,0,b)):(A[0]=Oe,A[1]=He,A[2]=ze,A[3]=Ue,T.clearBufferiv(T.COLOR,0,A))}else Z|=T.COLOR_BUFFER_BIT}F&&(Z|=T.DEPTH_BUFFER_BIT),Q&&(Z|=T.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),T.clear(Z)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener("webglcontextlost",ke,!1),t.removeEventListener("webglcontextrestored",ut,!1),t.removeEventListener("webglcontextcreationerror",it,!1),xe.dispose(),ue.dispose(),ve.dispose(),m.dispose(),Y.dispose(),te.dispose(),de.dispose(),De.dispose(),pe.dispose(),Ce.dispose(),Se.dispose(),Se.removeEventListener("sessionstart",fc),Se.removeEventListener("sessionend",hc),Ei.stop()};function ke(M){M.preventDefault(),ru("WebGLRenderer: Context Lost."),E=!0}function ut(){ru("WebGLRenderer: Context Restored."),E=!1;const M=S.autoReset,F=Re.enabled,Q=Re.autoUpdate,Z=Re.needsUpdate,G=Re.type;le(),S.autoReset=M,Re.enabled=F,Re.autoUpdate=Q,Re.needsUpdate=Z,Re.type=G}function it(M){Qe("WebGLRenderer: A WebGL context could not be created. Reason: ",M.statusMessage)}function vn(M){const F=M.target;F.removeEventListener("dispose",vn),In(F)}function In(M){Xh(M),m.remove(M)}function Xh(M){const F=m.get(M).programs;F!==void 0&&(F.forEach(function(Q){Ce.releaseProgram(Q)}),M.isShaderMaterial&&Ce.releaseShaderCache(M))}this.renderBufferDirect=function(M,F,Q,Z,G,ye){F===null&&(F=ee);const Le=G.isMesh&&G.matrixWorld.determinant()<0,Ae=Yh(M,F,Q,Z,G);ae.setMaterial(Z,Le);let Ue=Q.index,Oe=1;if(Z.wireframe===!0){if(Ue=Te.getWireframeAttribute(Q),Ue===void 0)return;Oe=2}const He=Q.drawRange,ze=Q.attributes.position;let Ke=He.start*Oe,at=(He.start+He.count)*Oe;ye!==null&&(Ke=Math.max(Ke,ye.start*Oe),at=Math.min(at,(ye.start+ye.count)*Oe)),Ue!==null?(Ke=Math.max(Ke,0),at=Math.min(at,Ue.count)):ze!=null&&(Ke=Math.max(Ke,0),at=Math.min(at,ze.count));const mt=at-Ke;if(mt<0||mt===1/0)return;De.setup(G,Z,Ae,Q,Ue);let gt,lt=N;if(Ue!==null&&(gt=k.get(Ue),lt=we,lt.setIndex(gt)),G.isMesh)Z.wireframe===!0?(ae.setLineWidth(Z.wireframeLinewidth*ie()),lt.setMode(T.LINES)):lt.setMode(T.TRIANGLES);else if(G.isLine){let Ve=Z.linewidth;Ve===void 0&&(Ve=1),ae.setLineWidth(Ve*ie()),G.isLineSegments?lt.setMode(T.LINES):G.isLineLoop?lt.setMode(T.LINE_LOOP):lt.setMode(T.LINE_STRIP)}else G.isPoints?lt.setMode(T.POINTS):G.isSprite&&lt.setMode(T.TRIANGLES);if(G.isBatchedMesh)if(G._multiDrawInstances!==null)os("WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),lt.renderMultiDrawInstances(G._multiDrawStarts,G._multiDrawCounts,G._multiDrawCount,G._multiDrawInstances);else if(se.get("WEBGL_multi_draw"))lt.renderMultiDraw(G._multiDrawStarts,G._multiDrawCounts,G._multiDrawCount);else{const Ve=G._multiDrawStarts,rt=G._multiDrawCounts,Je=G._multiDrawCount,qt=Ue?k.get(Ue).bytesPerElement:1,Wi=m.get(Z).currentProgram.getUniforms();for(let Yt=0;Yt<Je;Yt++)Wi.setValue(T,"_gl_DrawID",Yt),lt.render(Ve[Yt]/qt,rt[Yt])}else if(G.isInstancedMesh)lt.renderInstances(Ke,mt,G.count);else if(Q.isInstancedBufferGeometry){const Ve=Q._maxInstanceCount!==void 0?Q._maxInstanceCount:1/0,rt=Math.min(Q.instanceCount,Ve);lt.renderInstances(Ke,mt,rt)}else lt.render(Ke,mt)};function uc(M,F,Q){M.transparent===!0&&M.side===Xn&&M.forceSinglePass===!1?(M.side=Wt,M.needsUpdate=!0,_s(M,F,Q),M.side=Si,M.needsUpdate=!0,_s(M,F,Q),M.side=Xn):_s(M,F,Q)}this.compile=function(M,F,Q=null){Q===null&&(Q=M),w=ve.get(Q),w.init(F),P.push(w),Q.traverseVisible(function(G){G.isLight&&G.layers.test(F.layers)&&(w.pushLight(G),G.castShadow&&w.pushShadow(G))}),M!==Q&&M.traverseVisible(function(G){G.isLight&&G.layers.test(F.layers)&&(w.pushLight(G),G.castShadow&&w.pushShadow(G))}),w.setupLights();const Z=new Set;return M.traverse(function(G){if(!(G.isMesh||G.isPoints||G.isLine||G.isSprite))return;const ye=G.material;if(ye)if(Array.isArray(ye))for(let Le=0;Le<ye.length;Le++){const Ae=ye[Le];uc(Ae,Q,G),Z.add(Ae)}else uc(ye,Q,G),Z.add(ye)}),w=P.pop(),Z},this.compileAsync=function(M,F,Q=null){const Z=this.compile(M,F,Q);return new Promise(G=>{function ye(){if(Z.forEach(function(Le){m.get(Le).currentProgram.isReady()&&Z.delete(Le)}),Z.size===0){G(M);return}setTimeout(ye,10)}se.get("KHR_parallel_shader_compile")!==null?ye():setTimeout(ye,10)})};let Ca=null;function qh(M){Ca&&Ca(M)}function fc(){Ei.stop()}function hc(){Ei.start()}const Ei=new Vh;Ei.setAnimationLoop(qh),typeof self<"u"&&Ei.setContext(self),this.setAnimationLoop=function(M){Ca=M,Se.setAnimationLoop(M),M===null?Ei.stop():Ei.start()},Se.addEventListener("sessionstart",fc),Se.addEventListener("sessionend",hc),this.render=function(M,F){if(F!==void 0&&F.isCamera!==!0){Qe("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(E===!0)return;const Q=Se.enabled===!0&&Se.isPresenting===!0,Z=O!==null&&(B===null||Q)&&O.begin(x,B);if(M.matrixWorldAutoUpdate===!0&&M.updateMatrixWorld(),F.parent===null&&F.matrixWorldAutoUpdate===!0&&F.updateMatrixWorld(),Se.enabled===!0&&Se.isPresenting===!0&&(O===null||O.isCompositing()===!1)&&(Se.cameraAutoUpdate===!0&&Se.updateCamera(F),F=Se.getCamera()),M.isScene===!0&&M.onBeforeRender(x,M,F,B),w=ve.get(M,P.length),w.init(F),P.push(w),C.multiplyMatrices(F.projectionMatrix,F.matrixWorldInverse),Be.setFromProjectionMatrix(C,An,F.reversedDepth),Me=this.localClippingEnabled,me=Ee.init(this.clippingPlanes,Me),y=ue.get(M,D.length),y.init(),D.push(y),Se.enabled===!0&&Se.isPresenting===!0){const Le=x.xr.getDepthSensingMesh();Le!==null&&Ra(Le,F,-1/0,x.sortObjects)}Ra(M,F,0,x.sortObjects),y.finish(),x.sortObjects===!0&&y.sort(Pe,Ie),J=Se.enabled===!1||Se.isPresenting===!1||Se.hasDepthSensing()===!1,J&&xe.addToRenderList(y,M),this.info.render.frame++,me===!0&&Ee.beginShadows();const G=w.state.shadowsArray;if(Re.render(G,M,F),me===!0&&Ee.endShadows(),this.info.autoReset===!0&&this.info.reset(),(Z&&O.hasRenderPass())===!1){const Le=y.opaque,Ae=y.transmissive;if(w.setupLights(),F.isArrayCamera){const Ue=F.cameras;if(Ae.length>0)for(let Oe=0,He=Ue.length;Oe<He;Oe++){const ze=Ue[Oe];pc(Le,Ae,M,ze)}J&&xe.render(M);for(let Oe=0,He=Ue.length;Oe<He;Oe++){const ze=Ue[Oe];dc(y,M,ze,ze.viewport)}}else Ae.length>0&&pc(Le,Ae,M,F),J&&xe.render(M),dc(y,M,F)}B!==null&&U===0&&(L.updateMultisampleRenderTarget(B),L.updateRenderTargetMipmap(B)),Z&&O.end(x),M.isScene===!0&&M.onAfterRender(x,M,F),De.resetDefaultState(),V=-1,$=null,P.pop(),P.length>0?(w=P[P.length-1],me===!0&&Ee.setGlobalState(x.clippingPlanes,w.state.camera)):w=null,D.pop(),D.length>0?y=D[D.length-1]:y=null};function Ra(M,F,Q,Z){if(M.visible===!1)return;if(M.layers.test(F.layers)){if(M.isGroup)Q=M.renderOrder;else if(M.isLOD)M.autoUpdate===!0&&M.update(F);else if(M.isLight)w.pushLight(M),M.castShadow&&w.pushShadow(M);else if(M.isSprite){if(!M.frustumCulled||Be.intersectsSprite(M)){Z&&H.setFromMatrixPosition(M.matrixWorld).applyMatrix4(C);const Le=de.update(M),Ae=M.material;Ae.visible&&y.push(M,Le,Ae,Q,H.z,null)}}else if((M.isMesh||M.isLine||M.isPoints)&&(!M.frustumCulled||Be.intersectsObject(M))){const Le=de.update(M),Ae=M.material;if(Z&&(M.boundingSphere!==void 0?(M.boundingSphere===null&&M.computeBoundingSphere(),H.copy(M.boundingSphere.center)):(Le.boundingSphere===null&&Le.computeBoundingSphere(),H.copy(Le.boundingSphere.center)),H.applyMatrix4(M.matrixWorld).applyMatrix4(C)),Array.isArray(Ae)){const Ue=Le.groups;for(let Oe=0,He=Ue.length;Oe<He;Oe++){const ze=Ue[Oe],Ke=Ae[ze.materialIndex];Ke&&Ke.visible&&y.push(M,Le,Ke,Q,H.z,ze)}}else Ae.visible&&y.push(M,Le,Ae,Q,H.z,null)}}const ye=M.children;for(let Le=0,Ae=ye.length;Le<Ae;Le++)Ra(ye[Le],F,Q,Z)}function dc(M,F,Q,Z){const{opaque:G,transmissive:ye,transparent:Le}=M;w.setupLightsView(Q),me===!0&&Ee.setGlobalState(x.clippingPlanes,Q),Z&&ae.viewport(X.copy(Z)),G.length>0&&gs(G,F,Q),ye.length>0&&gs(ye,F,Q),Le.length>0&&gs(Le,F,Q),ae.buffers.depth.setTest(!0),ae.buffers.depth.setMask(!0),ae.buffers.color.setMask(!0),ae.setPolygonOffset(!1)}function pc(M,F,Q,Z){if((Q.isScene===!0?Q.overrideMaterial:null)!==null)return;if(w.state.transmissionRenderTarget[Z.id]===void 0){const Ke=se.has("EXT_color_buffer_half_float")||se.has("EXT_color_buffer_float");w.state.transmissionRenderTarget[Z.id]=new Pn(1,1,{generateMipmaps:!0,type:Ke?Qn:an,minFilter:zi,samples:ne.samples,stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Ze.workingColorSpace})}const ye=w.state.transmissionRenderTarget[Z.id],Le=Z.viewport||X;ye.setSize(Le.z*x.transmissionResolutionScale,Le.w*x.transmissionResolutionScale);const Ae=x.getRenderTarget(),Ue=x.getActiveCubeFace(),Oe=x.getActiveMipmapLevel();x.setRenderTarget(ye),x.getClearColor(re),oe=x.getClearAlpha(),oe<1&&x.setClearColor(16777215,.5),x.clear(),J&&xe.render(Q);const He=x.toneMapping;x.toneMapping=Rn;const ze=Z.viewport;if(Z.viewport!==void 0&&(Z.viewport=void 0),w.setupLightsView(Z),me===!0&&Ee.setGlobalState(x.clippingPlanes,Z),gs(M,Q,Z),L.updateMultisampleRenderTarget(ye),L.updateRenderTargetMipmap(ye),se.has("WEBGL_multisampled_render_to_texture")===!1){let Ke=!1;for(let at=0,mt=F.length;at<mt;at++){const gt=F[at],{object:lt,geometry:Ve,material:rt,group:Je}=gt;if(rt.side===Xn&&lt.layers.test(Z.layers)){const qt=rt.side;rt.side=Wt,rt.needsUpdate=!0,mc(lt,Q,Z,Ve,rt,Je),rt.side=qt,rt.needsUpdate=!0,Ke=!0}}Ke===!0&&(L.updateMultisampleRenderTarget(ye),L.updateRenderTargetMipmap(ye))}x.setRenderTarget(Ae,Ue,Oe),x.setClearColor(re,oe),ze!==void 0&&(Z.viewport=ze),x.toneMapping=He}function gs(M,F,Q){const Z=F.isScene===!0?F.overrideMaterial:null;for(let G=0,ye=M.length;G<ye;G++){const Le=M[G],{object:Ae,geometry:Ue,group:Oe}=Le;let He=Le.material;He.allowOverride===!0&&Z!==null&&(He=Z),Ae.layers.test(Q.layers)&&mc(Ae,F,Q,Ue,He,Oe)}}function mc(M,F,Q,Z,G,ye){M.onBeforeRender(x,F,Q,Z,G,ye),M.modelViewMatrix.multiplyMatrices(Q.matrixWorldInverse,M.matrixWorld),M.normalMatrix.getNormalMatrix(M.modelViewMatrix),G.onBeforeRender(x,F,Q,Z,M,ye),G.transparent===!0&&G.side===Xn&&G.forceSinglePass===!1?(G.side=Wt,G.needsUpdate=!0,x.renderBufferDirect(Q,F,Z,G,M,ye),G.side=Si,G.needsUpdate=!0,x.renderBufferDirect(Q,F,Z,G,M,ye),G.side=Xn):x.renderBufferDirect(Q,F,Z,G,M,ye),M.onAfterRender(x,F,Q,Z,G,ye)}function _s(M,F,Q){F.isScene!==!0&&(F=ee);const Z=m.get(M),G=w.state.lights,ye=w.state.shadowsArray,Le=G.state.version,Ae=Ce.getParameters(M,G.state,ye,F,Q),Ue=Ce.getProgramCacheKey(Ae);let Oe=Z.programs;Z.environment=M.isMeshStandardMaterial?F.environment:null,Z.fog=F.fog,Z.envMap=(M.isMeshStandardMaterial?te:Y).get(M.envMap||Z.environment),Z.envMapRotation=Z.environment!==null&&M.envMap===null?F.environmentRotation:M.envMapRotation,Oe===void 0&&(M.addEventListener("dispose",vn),Oe=new Map,Z.programs=Oe);let He=Oe.get(Ue);if(He!==void 0){if(Z.currentProgram===He&&Z.lightsStateVersion===Le)return _c(M,Ae),He}else Ae.uniforms=Ce.getUniforms(M),M.onBeforeCompile(Ae,x),He=Ce.acquireProgram(Ae,Ue),Oe.set(Ue,He),Z.uniforms=Ae.uniforms;const ze=Z.uniforms;return(!M.isShaderMaterial&&!M.isRawShaderMaterial||M.clipping===!0)&&(ze.clippingPlanes=Ee.uniform),_c(M,Ae),Z.needsLights=Kh(M),Z.lightsStateVersion=Le,Z.needsLights&&(ze.ambientLightColor.value=G.state.ambient,ze.lightProbe.value=G.state.probe,ze.directionalLights.value=G.state.directional,ze.directionalLightShadows.value=G.state.directionalShadow,ze.spotLights.value=G.state.spot,ze.spotLightShadows.value=G.state.spotShadow,ze.rectAreaLights.value=G.state.rectArea,ze.ltc_1.value=G.state.rectAreaLTC1,ze.ltc_2.value=G.state.rectAreaLTC2,ze.pointLights.value=G.state.point,ze.pointLightShadows.value=G.state.pointShadow,ze.hemisphereLights.value=G.state.hemi,ze.directionalShadowMap.value=G.state.directionalShadowMap,ze.directionalShadowMatrix.value=G.state.directionalShadowMatrix,ze.spotShadowMap.value=G.state.spotShadowMap,ze.spotLightMatrix.value=G.state.spotLightMatrix,ze.spotLightMap.value=G.state.spotLightMap,ze.pointShadowMap.value=G.state.pointShadowMap,ze.pointShadowMatrix.value=G.state.pointShadowMatrix),Z.currentProgram=He,Z.uniformsList=null,He}function gc(M){if(M.uniformsList===null){const F=M.currentProgram.getUniforms();M.uniformsList=Qs.seqWithValue(F.seq,M.uniforms)}return M.uniformsList}function _c(M,F){const Q=m.get(M);Q.outputColorSpace=F.outputColorSpace,Q.batching=F.batching,Q.batchingColor=F.batchingColor,Q.instancing=F.instancing,Q.instancingColor=F.instancingColor,Q.instancingMorph=F.instancingMorph,Q.skinning=F.skinning,Q.morphTargets=F.morphTargets,Q.morphNormals=F.morphNormals,Q.morphColors=F.morphColors,Q.morphTargetsCount=F.morphTargetsCount,Q.numClippingPlanes=F.numClippingPlanes,Q.numIntersection=F.numClipIntersection,Q.vertexAlphas=F.vertexAlphas,Q.vertexTangents=F.vertexTangents,Q.toneMapping=F.toneMapping}function Yh(M,F,Q,Z,G){F.isScene!==!0&&(F=ee),L.resetTextureUnits();const ye=F.fog,Le=Z.isMeshStandardMaterial?F.environment:null,Ae=B===null?x.outputColorSpace:B.isXRRenderTarget===!0?B.texture.colorSpace:Er,Ue=(Z.isMeshStandardMaterial?te:Y).get(Z.envMap||Le),Oe=Z.vertexColors===!0&&!!Q.attributes.color&&Q.attributes.color.itemSize===4,He=!!Q.attributes.tangent&&(!!Z.normalMap||Z.anisotropy>0),ze=!!Q.morphAttributes.position,Ke=!!Q.morphAttributes.normal,at=!!Q.morphAttributes.color;let mt=Rn;Z.toneMapped&&(B===null||B.isXRRenderTarget===!0)&&(mt=x.toneMapping);const gt=Q.morphAttributes.position||Q.morphAttributes.normal||Q.morphAttributes.color,lt=gt!==void 0?gt.length:0,Ve=m.get(Z),rt=w.state.lights;if(me===!0&&(Me===!0||M!==$)){const Ut=M===$&&Z.id===V;Ee.setState(Z,M,Ut)}let Je=!1;Z.version===Ve.__version?(Ve.needsLights&&Ve.lightsStateVersion!==rt.state.version||Ve.outputColorSpace!==Ae||G.isBatchedMesh&&Ve.batching===!1||!G.isBatchedMesh&&Ve.batching===!0||G.isBatchedMesh&&Ve.batchingColor===!0&&G.colorTexture===null||G.isBatchedMesh&&Ve.batchingColor===!1&&G.colorTexture!==null||G.isInstancedMesh&&Ve.instancing===!1||!G.isInstancedMesh&&Ve.instancing===!0||G.isSkinnedMesh&&Ve.skinning===!1||!G.isSkinnedMesh&&Ve.skinning===!0||G.isInstancedMesh&&Ve.instancingColor===!0&&G.instanceColor===null||G.isInstancedMesh&&Ve.instancingColor===!1&&G.instanceColor!==null||G.isInstancedMesh&&Ve.instancingMorph===!0&&G.morphTexture===null||G.isInstancedMesh&&Ve.instancingMorph===!1&&G.morphTexture!==null||Ve.envMap!==Ue||Z.fog===!0&&Ve.fog!==ye||Ve.numClippingPlanes!==void 0&&(Ve.numClippingPlanes!==Ee.numPlanes||Ve.numIntersection!==Ee.numIntersection)||Ve.vertexAlphas!==Oe||Ve.vertexTangents!==He||Ve.morphTargets!==ze||Ve.morphNormals!==Ke||Ve.morphColors!==at||Ve.toneMapping!==mt||Ve.morphTargetsCount!==lt)&&(Je=!0):(Je=!0,Ve.__version=Z.version);let qt=Ve.currentProgram;Je===!0&&(qt=_s(Z,F,G));let Wi=!1,Yt=!1,Ar=!1;const ft=qt.getUniforms(),Vt=Ve.uniforms;if(ae.useProgram(qt.program)&&(Wi=!0,Yt=!0,Ar=!0),Z.id!==V&&(V=Z.id,Yt=!0),Wi||$!==M){ae.buffers.depth.getReversed()&&M.reversedDepth!==!0&&(M._reversedDepth=!0,M.updateProjectionMatrix()),ft.setValue(T,"projectionMatrix",M.projectionMatrix),ft.setValue(T,"viewMatrix",M.matrixWorldInverse);const Ht=ft.map.cameraPosition;Ht!==void 0&&Ht.setValue(T,R.setFromMatrixPosition(M.matrixWorld)),ne.logarithmicDepthBuffer&&ft.setValue(T,"logDepthBufFC",2/(Math.log(M.far+1)/Math.LN2)),(Z.isMeshPhongMaterial||Z.isMeshToonMaterial||Z.isMeshLambertMaterial||Z.isMeshBasicMaterial||Z.isMeshStandardMaterial||Z.isShaderMaterial)&&ft.setValue(T,"isOrthographic",M.isOrthographicCamera===!0),$!==M&&($=M,Yt=!0,Ar=!0)}if(Ve.needsLights&&(rt.state.directionalShadowMap.length>0&&ft.setValue(T,"directionalShadowMap",rt.state.directionalShadowMap,L),rt.state.spotShadowMap.length>0&&ft.setValue(T,"spotShadowMap",rt.state.spotShadowMap,L),rt.state.pointShadowMap.length>0&&ft.setValue(T,"pointShadowMap",rt.state.pointShadowMap,L)),G.isSkinnedMesh){ft.setOptional(T,G,"bindMatrix"),ft.setOptional(T,G,"bindMatrixInverse");const Ut=G.skeleton;Ut&&(Ut.boneTexture===null&&Ut.computeBoneTexture(),ft.setValue(T,"boneTexture",Ut.boneTexture,L))}G.isBatchedMesh&&(ft.setOptional(T,G,"batchingTexture"),ft.setValue(T,"batchingTexture",G._matricesTexture,L),ft.setOptional(T,G,"batchingIdTexture"),ft.setValue(T,"batchingIdTexture",G._indirectTexture,L),ft.setOptional(T,G,"batchingColorTexture"),G._colorsTexture!==null&&ft.setValue(T,"batchingColorTexture",G._colorsTexture,L));const Qt=Q.morphAttributes;if((Qt.position!==void 0||Qt.normal!==void 0||Qt.color!==void 0)&&Xe.update(G,Q,qt),(Yt||Ve.receiveShadow!==G.receiveShadow)&&(Ve.receiveShadow=G.receiveShadow,ft.setValue(T,"receiveShadow",G.receiveShadow)),Z.isMeshGouraudMaterial&&Z.envMap!==null&&(Vt.envMap.value=Ue,Vt.flipEnvMap.value=Ue.isCubeTexture&&Ue.isRenderTargetTexture===!1?-1:1),Z.isMeshStandardMaterial&&Z.envMap===null&&F.environment!==null&&(Vt.envMapIntensity.value=F.environmentIntensity),Vt.dfgLUT!==void 0&&(Vt.dfgLUT.value=kS()),Yt&&(ft.setValue(T,"toneMappingExposure",x.toneMappingExposure),Ve.needsLights&&$h(Vt,Ar),ye&&Z.fog===!0&&Fe.refreshFogUniforms(Vt,ye),Fe.refreshMaterialUniforms(Vt,Z,he,Ne,w.state.transmissionRenderTarget[M.id]),Qs.upload(T,gc(Ve),Vt,L)),Z.isShaderMaterial&&Z.uniformsNeedUpdate===!0&&(Qs.upload(T,gc(Ve),Vt,L),Z.uniformsNeedUpdate=!1),Z.isSpriteMaterial&&ft.setValue(T,"center",G.center),ft.setValue(T,"modelViewMatrix",G.modelViewMatrix),ft.setValue(T,"normalMatrix",G.normalMatrix),ft.setValue(T,"modelMatrix",G.matrixWorld),Z.isShaderMaterial||Z.isRawShaderMaterial){const Ut=Z.uniformsGroups;for(let Ht=0,Pa=Ut.length;Ht<Pa;Ht++){const yi=Ut[Ht];pe.update(yi,qt),pe.bind(yi,qt)}}return qt}function $h(M,F){M.ambientLightColor.needsUpdate=F,M.lightProbe.needsUpdate=F,M.directionalLights.needsUpdate=F,M.directionalLightShadows.needsUpdate=F,M.pointLights.needsUpdate=F,M.pointLightShadows.needsUpdate=F,M.spotLights.needsUpdate=F,M.spotLightShadows.needsUpdate=F,M.rectAreaLights.needsUpdate=F,M.hemisphereLights.needsUpdate=F}function Kh(M){return M.isMeshLambertMaterial||M.isMeshToonMaterial||M.isMeshPhongMaterial||M.isMeshStandardMaterial||M.isShadowMaterial||M.isShaderMaterial&&M.lights===!0}this.getActiveCubeFace=function(){return I},this.getActiveMipmapLevel=function(){return U},this.getRenderTarget=function(){return B},this.setRenderTargetTextures=function(M,F,Q){const Z=m.get(M);Z.__autoAllocateDepthBuffer=M.resolveDepthBuffer===!1,Z.__autoAllocateDepthBuffer===!1&&(Z.__useRenderToTexture=!1),m.get(M.texture).__webglTexture=F,m.get(M.depthTexture).__webglTexture=Z.__autoAllocateDepthBuffer?void 0:Q,Z.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(M,F){const Q=m.get(M);Q.__webglFramebuffer=F,Q.__useDefaultFramebuffer=F===void 0};const jh=T.createFramebuffer();this.setRenderTarget=function(M,F=0,Q=0){B=M,I=F,U=Q;let Z=null,G=!1,ye=!1;if(M){const Ae=m.get(M);if(Ae.__useDefaultFramebuffer!==void 0){ae.bindFramebuffer(T.FRAMEBUFFER,Ae.__webglFramebuffer),X.copy(M.viewport),z.copy(M.scissor),W=M.scissorTest,ae.viewport(X),ae.scissor(z),ae.setScissorTest(W),V=-1;return}else if(Ae.__webglFramebuffer===void 0)L.setupRenderTarget(M);else if(Ae.__hasExternalTextures)L.rebindTextures(M,m.get(M.texture).__webglTexture,m.get(M.depthTexture).__webglTexture);else if(M.depthBuffer){const He=M.depthTexture;if(Ae.__boundDepthTexture!==He){if(He!==null&&m.has(He)&&(M.width!==He.image.width||M.height!==He.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");L.setupDepthRenderbuffer(M)}}const Ue=M.texture;(Ue.isData3DTexture||Ue.isDataArrayTexture||Ue.isCompressedArrayTexture)&&(ye=!0);const Oe=m.get(M).__webglFramebuffer;M.isWebGLCubeRenderTarget?(Array.isArray(Oe[F])?Z=Oe[F][Q]:Z=Oe[F],G=!0):M.samples>0&&L.useMultisampledRTT(M)===!1?Z=m.get(M).__webglMultisampledFramebuffer:Array.isArray(Oe)?Z=Oe[Q]:Z=Oe,X.copy(M.viewport),z.copy(M.scissor),W=M.scissorTest}else X.copy(q).multiplyScalar(he).floor(),z.copy(K).multiplyScalar(he).floor(),W=_e;if(Q!==0&&(Z=jh),ae.bindFramebuffer(T.FRAMEBUFFER,Z)&&ae.drawBuffers(M,Z),ae.viewport(X),ae.scissor(z),ae.setScissorTest(W),G){const Ae=m.get(M.texture);T.framebufferTexture2D(T.FRAMEBUFFER,T.COLOR_ATTACHMENT0,T.TEXTURE_CUBE_MAP_POSITIVE_X+F,Ae.__webglTexture,Q)}else if(ye){const Ae=F;for(let Ue=0;Ue<M.textures.length;Ue++){const Oe=m.get(M.textures[Ue]);T.framebufferTextureLayer(T.FRAMEBUFFER,T.COLOR_ATTACHMENT0+Ue,Oe.__webglTexture,Q,Ae)}}else if(M!==null&&Q!==0){const Ae=m.get(M.texture);T.framebufferTexture2D(T.FRAMEBUFFER,T.COLOR_ATTACHMENT0,T.TEXTURE_2D,Ae.__webglTexture,Q)}V=-1},this.readRenderTargetPixels=function(M,F,Q,Z,G,ye,Le,Ae=0){if(!(M&&M.isWebGLRenderTarget)){Qe("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Ue=m.get(M).__webglFramebuffer;if(M.isWebGLCubeRenderTarget&&Le!==void 0&&(Ue=Ue[Le]),Ue){ae.bindFramebuffer(T.FRAMEBUFFER,Ue);try{const Oe=M.textures[Ae],He=Oe.format,ze=Oe.type;if(!ne.textureFormatReadable(He)){Qe("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!ne.textureTypeReadable(ze)){Qe("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}F>=0&&F<=M.width-Z&&Q>=0&&Q<=M.height-G&&(M.textures.length>1&&T.readBuffer(T.COLOR_ATTACHMENT0+Ae),T.readPixels(F,Q,Z,G,ge.convert(He),ge.convert(ze),ye))}finally{const Oe=B!==null?m.get(B).__webglFramebuffer:null;ae.bindFramebuffer(T.FRAMEBUFFER,Oe)}}},this.readRenderTargetPixelsAsync=async function(M,F,Q,Z,G,ye,Le,Ae=0){if(!(M&&M.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Ue=m.get(M).__webglFramebuffer;if(M.isWebGLCubeRenderTarget&&Le!==void 0&&(Ue=Ue[Le]),Ue)if(F>=0&&F<=M.width-Z&&Q>=0&&Q<=M.height-G){ae.bindFramebuffer(T.FRAMEBUFFER,Ue);const Oe=M.textures[Ae],He=Oe.format,ze=Oe.type;if(!ne.textureFormatReadable(He))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!ne.textureTypeReadable(ze))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const Ke=T.createBuffer();T.bindBuffer(T.PIXEL_PACK_BUFFER,Ke),T.bufferData(T.PIXEL_PACK_BUFFER,ye.byteLength,T.STREAM_READ),M.textures.length>1&&T.readBuffer(T.COLOR_ATTACHMENT0+Ae),T.readPixels(F,Q,Z,G,ge.convert(He),ge.convert(ze),0);const at=B!==null?m.get(B).__webglFramebuffer:null;ae.bindFramebuffer(T.FRAMEBUFFER,at);const mt=T.fenceSync(T.SYNC_GPU_COMMANDS_COMPLETE,0);return T.flush(),await cg(T,mt,4),T.bindBuffer(T.PIXEL_PACK_BUFFER,Ke),T.getBufferSubData(T.PIXEL_PACK_BUFFER,0,ye),T.deleteBuffer(Ke),T.deleteSync(mt),ye}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(M,F=null,Q=0){const Z=Math.pow(2,-Q),G=Math.floor(M.image.width*Z),ye=Math.floor(M.image.height*Z),Le=F!==null?F.x:0,Ae=F!==null?F.y:0;L.setTexture2D(M,0),T.copyTexSubImage2D(T.TEXTURE_2D,Q,0,0,Le,Ae,G,ye),ae.unbindTexture()};const Zh=T.createFramebuffer(),Jh=T.createFramebuffer();this.copyTextureToTexture=function(M,F,Q=null,Z=null,G=0,ye=null){ye===null&&(G!==0?(os("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),ye=G,G=0):ye=0);let Le,Ae,Ue,Oe,He,ze,Ke,at,mt;const gt=M.isCompressedTexture?M.mipmaps[ye]:M.image;if(Q!==null)Le=Q.max.x-Q.min.x,Ae=Q.max.y-Q.min.y,Ue=Q.isBox3?Q.max.z-Q.min.z:1,Oe=Q.min.x,He=Q.min.y,ze=Q.isBox3?Q.min.z:0;else{const Qt=Math.pow(2,-G);Le=Math.floor(gt.width*Qt),Ae=Math.floor(gt.height*Qt),M.isDataArrayTexture?Ue=gt.depth:M.isData3DTexture?Ue=Math.floor(gt.depth*Qt):Ue=1,Oe=0,He=0,ze=0}Z!==null?(Ke=Z.x,at=Z.y,mt=Z.z):(Ke=0,at=0,mt=0);const lt=ge.convert(F.format),Ve=ge.convert(F.type);let rt;F.isData3DTexture?(L.setTexture3D(F,0),rt=T.TEXTURE_3D):F.isDataArrayTexture||F.isCompressedArrayTexture?(L.setTexture2DArray(F,0),rt=T.TEXTURE_2D_ARRAY):(L.setTexture2D(F,0),rt=T.TEXTURE_2D),T.pixelStorei(T.UNPACK_FLIP_Y_WEBGL,F.flipY),T.pixelStorei(T.UNPACK_PREMULTIPLY_ALPHA_WEBGL,F.premultiplyAlpha),T.pixelStorei(T.UNPACK_ALIGNMENT,F.unpackAlignment);const Je=T.getParameter(T.UNPACK_ROW_LENGTH),qt=T.getParameter(T.UNPACK_IMAGE_HEIGHT),Wi=T.getParameter(T.UNPACK_SKIP_PIXELS),Yt=T.getParameter(T.UNPACK_SKIP_ROWS),Ar=T.getParameter(T.UNPACK_SKIP_IMAGES);T.pixelStorei(T.UNPACK_ROW_LENGTH,gt.width),T.pixelStorei(T.UNPACK_IMAGE_HEIGHT,gt.height),T.pixelStorei(T.UNPACK_SKIP_PIXELS,Oe),T.pixelStorei(T.UNPACK_SKIP_ROWS,He),T.pixelStorei(T.UNPACK_SKIP_IMAGES,ze);const ft=M.isDataArrayTexture||M.isData3DTexture,Vt=F.isDataArrayTexture||F.isData3DTexture;if(M.isDepthTexture){const Qt=m.get(M),Ut=m.get(F),Ht=m.get(Qt.__renderTarget),Pa=m.get(Ut.__renderTarget);ae.bindFramebuffer(T.READ_FRAMEBUFFER,Ht.__webglFramebuffer),ae.bindFramebuffer(T.DRAW_FRAMEBUFFER,Pa.__webglFramebuffer);for(let yi=0;yi<Ue;yi++)ft&&(T.framebufferTextureLayer(T.READ_FRAMEBUFFER,T.COLOR_ATTACHMENT0,m.get(M).__webglTexture,G,ze+yi),T.framebufferTextureLayer(T.DRAW_FRAMEBUFFER,T.COLOR_ATTACHMENT0,m.get(F).__webglTexture,ye,mt+yi)),T.blitFramebuffer(Oe,He,Le,Ae,Ke,at,Le,Ae,T.DEPTH_BUFFER_BIT,T.NEAREST);ae.bindFramebuffer(T.READ_FRAMEBUFFER,null),ae.bindFramebuffer(T.DRAW_FRAMEBUFFER,null)}else if(G!==0||M.isRenderTargetTexture||m.has(M)){const Qt=m.get(M),Ut=m.get(F);ae.bindFramebuffer(T.READ_FRAMEBUFFER,Zh),ae.bindFramebuffer(T.DRAW_FRAMEBUFFER,Jh);for(let Ht=0;Ht<Ue;Ht++)ft?T.framebufferTextureLayer(T.READ_FRAMEBUFFER,T.COLOR_ATTACHMENT0,Qt.__webglTexture,G,ze+Ht):T.framebufferTexture2D(T.READ_FRAMEBUFFER,T.COLOR_ATTACHMENT0,T.TEXTURE_2D,Qt.__webglTexture,G),Vt?T.framebufferTextureLayer(T.DRAW_FRAMEBUFFER,T.COLOR_ATTACHMENT0,Ut.__webglTexture,ye,mt+Ht):T.framebufferTexture2D(T.DRAW_FRAMEBUFFER,T.COLOR_ATTACHMENT0,T.TEXTURE_2D,Ut.__webglTexture,ye),G!==0?T.blitFramebuffer(Oe,He,Le,Ae,Ke,at,Le,Ae,T.COLOR_BUFFER_BIT,T.NEAREST):Vt?T.copyTexSubImage3D(rt,ye,Ke,at,mt+Ht,Oe,He,Le,Ae):T.copyTexSubImage2D(rt,ye,Ke,at,Oe,He,Le,Ae);ae.bindFramebuffer(T.READ_FRAMEBUFFER,null),ae.bindFramebuffer(T.DRAW_FRAMEBUFFER,null)}else Vt?M.isDataTexture||M.isData3DTexture?T.texSubImage3D(rt,ye,Ke,at,mt,Le,Ae,Ue,lt,Ve,gt.data):F.isCompressedArrayTexture?T.compressedTexSubImage3D(rt,ye,Ke,at,mt,Le,Ae,Ue,lt,gt.data):T.texSubImage3D(rt,ye,Ke,at,mt,Le,Ae,Ue,lt,Ve,gt):M.isDataTexture?T.texSubImage2D(T.TEXTURE_2D,ye,Ke,at,Le,Ae,lt,Ve,gt.data):M.isCompressedTexture?T.compressedTexSubImage2D(T.TEXTURE_2D,ye,Ke,at,gt.width,gt.height,lt,gt.data):T.texSubImage2D(T.TEXTURE_2D,ye,Ke,at,Le,Ae,lt,Ve,gt);T.pixelStorei(T.UNPACK_ROW_LENGTH,Je),T.pixelStorei(T.UNPACK_IMAGE_HEIGHT,qt),T.pixelStorei(T.UNPACK_SKIP_PIXELS,Wi),T.pixelStorei(T.UNPACK_SKIP_ROWS,Yt),T.pixelStorei(T.UNPACK_SKIP_IMAGES,Ar),ye===0&&F.generateMipmaps&&T.generateMipmap(rt),ae.unbindTexture()},this.initRenderTarget=function(M){m.get(M).__webglFramebuffer===void 0&&L.setupRenderTarget(M)},this.initTexture=function(M){M.isCubeTexture?L.setTextureCube(M,0):M.isData3DTexture?L.setTexture3D(M,0):M.isDataArrayTexture||M.isCompressedArrayTexture?L.setTexture2DArray(M,0):L.setTexture2D(M,0),ae.unbindTexture()},this.resetState=function(){I=0,U=0,B=null,ae.reset(),De.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return An}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=Ze._getDrawingBufferColorSpace(e),t.unpackColorSpace=Ze._getUnpackColorSpace()}}const Yr=window.innerWidth<768,Rt={particleCount:Yr?22e3:45e3,particleSize:Yr?1.6:1.2,textScale:Yr?.14:.22,canvasFont:'900 100px "Microsoft YaHei", sans-serif'},XS=["快乐","悲伤","喜悦","愤怒","平静","恐惧","爱","焦虑","感恩","羞愧","希望","嫉妒","自豪","孤独","兴奋","内疚","幽默","厌恶"];function $r(n,e=null){const t=e!==null?e:Rt.textScale,i=document.createElement("canvas"),r=i.getContext("2d");i.width=1024,i.height=256,r.fillStyle="black",r.fillRect(0,0,i.width,i.height),r.fillStyle="white",r.font=Rt.canvasFont,r.textAlign="center",r.textBaseline="middle",r.fillText(n,i.width/2,i.height/2);const s=r.getImageData(0,0,i.width,i.height),a=[],o=Yr?4:2;for(let l=0;l<i.height;l+=o)for(let u=0;u<i.width;u+=o)s.data[(l*i.width+u)*4]>100&&a.push({x:(u-i.width/2)*t,y:-(l-i.height/2)*t,z:0});return a}function qS(){return XS.map(n=>$r(n))}function YS(n){const e=[];for(let s=0;s<n;s++)e.push({x:(Math.random()-.5)*100,y:-150+Math.random()*30,z:(Math.random()-.5)*60,vx:(Math.random()-.5)*.2,vy:Math.random()*.5});return e}function $S(n){const e=[];for(let t=0;t<n;t++){const i=(Math.random()-.5)*220;let r=Math.sqrt(Math.pow(i,2))*.5+3;Math.abs(i)>100&&(r=60*Math.random());const s=Math.random()*Math.PI*2;Math.random()>.85&&(r*=Math.random()),e.push({x:r*Math.cos(s),y:i,z:r*Math.sin(s)})}return e}function Yu(n,e){return $r(n,Yr?.08:.12).map(r=>({x:r.x,y:r.y+e,z:r.z}))}function KS(n){const e=[];for(let t=0;t<n;t++){const i=t<n/2,r=i?-50:50;let s="glass",a=(Math.random()-.5)*110,o=28,l=Math.random()*Math.PI*2;Math.random()>.35&&a<35&&a>-50&&(s="liquid",o=Math.random()*26,a>30&&(s="foam"));let u=o*Math.cos(l),c=o*Math.sin(l),f=a;s==="glass"&&a>-15&&a<35&&Math.abs(l-(i?Math.PI:0))<.6&&(u+=i?-18:18,s="handle"),e.push({x:u+r,y:f,z:c,type:s,isLeft:i,baseX:u+r})}return e}function jS(n){const e=[];for(let t=0;t<n;t++){const i=(Math.random()-.5)*200;let r=0;i>60?r=20*(100-i)/40:i>-80?r=20:r=20+(-80-i)*1.5;const s=Math.random()*Math.PI*2;i<60&&i>-80&&Math.random()>.4&&(r*=Math.random()),e.push({x:r*Math.cos(s),y:i,z:r*Math.sin(s)})}return e}function ZS(n){const e=[],i=n-4e3,r=[{r:1,g:0,b:0},{r:1,g:.5,b:0},{r:1,g:1,b:0},{r:0,g:1,b:0},{r:0,g:1,b:1},{r:0,g:0,b:1},{r:.5,g:0,b:1}],s=900,a=-s/2;for(let o=0;o<i;o++){const l=a+Math.random()*s,c=l<0?"left":"right",f=Math.random();let h,p,_="deck";const v=-20,g=50,d=100,b=l/(s/2),A=v+d*(b*b);if(f<.65)h=v+(Math.random()-.5)*8,p=(Math.random()-.5)*g,_="deck";else if(f<.85)h=A+(Math.random()-.5)*2,p=(Math.random()>.5?1:-1)*(g/2)+(Math.random()-.5)*2,_="cable";else{const P=Math.round(l/25)*25;if(Math.abs(l-P)<4){const O=Math.random();h=v+O*(A-v),p=(Math.random()>.5?1:-1)*(g/2),_="hanger",e.push({x:P+(Math.random()-.5)*2,y:h,z:p,type:"bridge",side:P<0?"left":"right",color:r[Math.floor((P+450)/900*7)]||{r:1,g:1,b:1},baseX:P});continue}else h=v+(Math.random()-.5)*8,p=(Math.random()-.5)*g,_="deck"}const y=Math.floor((l+450)/900*7),w=Math.max(0,Math.min(6,y));e.push({x:l,y:h,z:p,type:"bridge",section:_,side:c,color:r[w],baseX:l})}for(let o=0;o<4e3;o++){const l=o<2e3?0:1,u=Math.random();let c="body",f=0,h=0,p=0;if(u<.15){const _=Math.random()*Math.PI*2,v=Math.random()*Math.PI,g=4*Math.random();f=g*Math.sin(v)*Math.cos(_),h=30+g*Math.sin(v)*Math.sin(_),p=g*Math.cos(v),c="head"}else u<.5?(f=(Math.random()-.5)*6,h=14+Math.random()*14,p=(Math.random()-.5)*4,c="torso"):u<.75?(f=(Math.random()>.5?-2.5:2.5)+(Math.random()-.5)*2,h=Math.random()*14,p=(Math.random()-.5)*2.5,c="leg"):(f=(Math.random()>.5?-5:5)+(Math.random()-.5)*2,h=16+Math.random()*10,p=(Math.random()-.5)*2,c="arm");e.push({x:0,y:-1e3,z:0,type:"man",manIndex:l,part:c,localX:f,localY:h,localZ:p})}return e}const wa=(n,e)=>{const t=n.__vccOpts||n;for(const[i,r]of e)t[i]=r;return t},or=3e3,JS={__name:"ParticleScene",props:{currentShape:String,triggerState:Number,currentTheme:String,isRunning:Boolean},emits:["firework-tick"],setup(n,{emit:e}){const t=n,i=e,r=Zt(null);let s,a,o,l,u,c=[],f,h=0,p=[],_=[],v=[],g=[],d=[],b=[],A=0,y=[],w=[],D=[],P=[],O=[],x=[],E=0,I=!1;const U=()=>{t.isRunning&&(s=new Ug,s.fog=new lc(0,.002),a=new sn(75,window.innerWidth/window.innerHeight,.1,1e3),a.position.z=140,o=new WS({antialias:!0,alpha:!0}),o.setSize(window.innerWidth,window.innerHeight),o.setPixelRatio(Math.min(window.devicePixelRatio,2)),r.value&&(r.value.innerHTML="",r.value.appendChild(o.domElement)),B(),X())},B=()=>{u=new xn;const W=Rt.particleCount,re=new Float32Array(W*3),oe=new Float32Array(W*3);c=new Float32Array(W*3);for(let he=0;he<W;he++)re[he*3]=(Math.random()-.5)*800,re[he*3+1]=(Math.random()-.5)*800,re[he*3+2]=(Math.random()-.5)*800,c[he*3]=0,c[he*3+1]=-1e3,c[he*3+2]=0,oe[he*3]=1,oe[he*3+1]=1,oe[he*3+2]=1;u.setAttribute("position",new ln(re,3)),u.setAttribute("color",new ln(oe,3));const fe=new Yg().load("https://threejs.org/examples/textures/sprites/spark1.png"),Ne=new Oh({size:Rt.particleSize,map:fe,transparent:!0,opacity:.9,vertexColors:!0,blending:Fo,depthWrite:!1});l=new zg(u,Ne),s.add(l),V()},V=()=>{if(!u||!t.isRunning)return;h=0,A=0;let W=[];const re=Rt.particleCount;for(let oe=0;oe<re;oe++)c[oe*3]=(Math.random()-.5)*200,c[oe*3+1]=-1e3,c[oe*3+2]=0;if(t.currentShape==="fireworks")O.length===0&&(O=YS(or)),x.length===0&&(x=qS()),I=!1,E=0,i("firework-tick",{idx:0,total:18,time:0}),W=O;else if(t.currentShape==="hourglass"){if(p.length===0){p=$S(re*.6),_=Yu("2025",60),v=Yu("今年辛苦啦",-60);const oe=re-p.length;g=new Float32Array(oe);for(let fe=0;fe<oe;fe++)g[fe]=Math.random()*3}W=p}else t.currentShape==="beer"?(d.length===0&&(d=KS(re*.9),b=$r("2025 有你相伴")),W=d):t.currentShape==="rocket"?(y.length===0&&(y=jS(re),w=$r("2026新年快乐")),W=y):t.currentShape==="bridge"&&(D=ZS(re),P=$r("2026 与你同行"),W=D);for(let oe=0;oe<W.length;oe++){const fe=oe*3;c[fe]=W[oe].x,c[fe+1]=W[oe].y,c[fe+2]=W[oe].z}$()},$=()=>{if(!u)return;const W=u.attributes.color;for(let re=0;re<Rt.particleCount;re++){let oe=1,fe=1,Ne=1;if(t.currentTheme==="warm"?(oe=1,fe=.8,Ne=.4):(oe=.2,fe=.8,Ne=1),t.currentShape==="beer"&&re<d.length&&d[re].type==="liquid"&&(oe=1,fe=.6,Ne=0),t.currentShape==="bridge"&&re<D.length&&D[re].type==="bridge"){const he=D[re].color;oe=he.r,fe=he.g,Ne=he.b}W.setXYZ(re,oe,fe,Ne)}W.needsUpdate=!0},X=()=>{if(f=requestAnimationFrame(X),!u)return;const W=u.attributes.position.array,re=u.attributes.color.array;if(h+=.015,t.currentShape==="fireworks"){for(let he=0;he<or;he++){const Pe=he*3;if(he<O.length){const Ie=O[he];c[Pe]=Ie.x+(Math.random()-.5)*2,c[Pe+1]=Ie.y+Math.random()*5,c[Pe+2]=Ie.z+(Math.random()-.5)*2,re[Pe]=1,re[Pe+1]=.6,re[Pe+2]=.1}}if(t.triggerState>=1){I||(I=!0,E=Date.now());const Pe=(Date.now()-E)/1e3,Ie=5,q=18,K=Math.floor(Pe/Ie),_e=Pe%Ie;if(K<q){i("firework-tick",{idx:K+1,total:q,time:(Ie-_e).toFixed(1)});const Be=x[K%18];for(let me=or;me<Rt.particleCount;me++){const Me=me*3,C=me-or;if(_e<1){const R=_e/1,H=R*20+C*.05,ee=5*Math.sin(R*Math.PI);c[Me]=Math.cos(H)*ee,c[Me+1]=-150+R*280,c[Me+2]=Math.sin(H)*ee,re[Me]=1,re[Me+1]=.9,re[Me+2]=.6}else if(_e<1.5){if(_e<1.1){const R=Math.acos(-1+2*Math.random()),H=Math.sqrt(Rt.particleCount*Math.PI)*R,ee=120+Math.random()*60;c[Me]=ee*Math.sin(R)*Math.cos(H),c[Me+1]=100+ee*Math.sin(R)*Math.sin(H),c[Me+2]=ee*Math.cos(R),re[Me]=Math.random(),re[Me+1]=Math.random(),re[Me+2]=1}}else if(_e<2)c[Me+1]-=3,c[Me]*=.97,c[Me+2]*=.97;else if(_e<4)if(C<Be.length){const R=Be[C];c[Me]+=(R.x-c[Me])*.15,c[Me+1]+=(R.y+50-c[Me+1])*.15,c[Me+2]+=(R.z-c[Me+2])*.15,["快乐","喜悦","爱","感恩","希望","自豪","兴奋","幽默","平静"].includes(Rt.emotionWords?.[K%18])?(re[Me]=1,re[Me+1]=.4,re[Me+2]=.2):(re[Me]=.2,re[Me+1]=.3,re[Me+2]=.9)}else c[Me+1]-=5;else c[Me]*=1.05,c[Me+1]+=3}u.attributes.color.needsUpdate=!0}else i("firework-tick",{idx:18,total:18,time:0})}else for(let he=or;he<Rt.particleCount;he++)c[he*3]=0,c[he*3+1]=-1e3}else if(t.currentShape==="hourglass"){const Ie=h%5;for(let q=0;q<Rt.particleCount;q++){const K=q*3;if(q<p.length){const _e=c[K],Be=c[K+2],me=Math.atan2(Be,_e)+.005,Me=Math.sqrt(_e*_e+Be*Be);c[K]=Me*Math.cos(me),c[K+2]=Me*Math.sin(me)}else{if(t.triggerState===0){const C=q-p.length,R=_[C%_.length];R&&(c[K]+=(R.x-c[K])*.1,c[K+1]+=(R.y-c[K+1])*.1,c[K+2]+=(R.z-c[K+2])*.1);continue}const _e=q-p.length,Be=g[_e%g.length],me=_[_e%_.length],Me=v[_e%v.length];if(Ie<Be)me&&(c[K]=me.x,c[K+1]=me.y,c[K+2]=me.z);else if(Ie<Be+1.2){const C=(Ie-Be)/1.2;if(C<.5){const R=C*2;c[K]=me.x*(1-R),c[K+1]=me.y*(1-R),c[K+2]=me.z*(1-R)}else{const R=(C-.5)*2;c[K]=Me.x*R,c[K+1]=Me.y*R,c[K+2]=Me.z*R}}else Me&&(c[K]=Me.x,c[K+1]=Me.y,c[K+2]=Me.z);Ie>4.8&&me&&(c[K]=me.x,c[K+1]=me.y,c[K+2]=me.z)}}}else if(t.currentShape==="beer"){t.triggerState>=1?A+=2:A=0;for(let he=0;he<Rt.particleCount;he++){const Pe=he*3;if(he<d.length){const Ie=d[he];let q=Ie.x;if(t.triggerState>=1){const K=Math.min(25,A*.8);q+=Ie.isLeft?K:-K,K>=25&&(q+=(Math.random()-.5)*2)}c[Pe]=q,c[Pe+1]=Ie.y}else if(t.triggerState>=1&&A>100&&b.length>0){const Ie=he-d.length,q=b[Ie%b.length];c[Pe]+=(q.x-c[Pe])*.1,c[Pe+1]+=(q.y-60-c[Pe+1])*.1,c[Pe+2]+=(q.z-c[Pe+2])*.1}else c[Pe]=0,c[Pe+1]=-1e3}}else if(t.currentShape==="rocket"){if(t.triggerState===1)for(let he=0;he<Rt.particleCount;he++)c[he*3+1]+=12;else if(t.triggerState===2)for(let he=0;he<Rt.particleCount;he++){const Pe=he*3;if(he<w.length){const Ie=w[he];c[Pe]=Ie.x,c[Pe+1]=Ie.y,c[Pe+2]=Ie.z}else c[Pe]*=1.1}}else if(t.currentShape==="bridge"){let he=0;t.triggerState===0&&(he=180);for(let Pe=0;Pe<Rt.particleCount;Pe++){const Ie=Pe*3;if(Pe<D.length){const q=D[Pe];if(q.type==="bridge"){let K=q.baseX;q.side==="left"?K-=he:K+=he,c[Ie]=K,c[Ie+1]=q.y,c[Ie+2]=q.z}else if(q.type==="man")if(t.triggerState===2){const me=q.manIndex===0?0:40,Me=q.manIndex===0?-15:15,C=h*60%1100+-450-100,R=h*15;let H=0,ee=0;if(ee+=Math.abs(Math.sin(R))*3,q.part==="leg"||q.part==="arm"){const J=q.localX<0?0:Math.PI,ie=Math.sin(R+J)*8;H+=ie}c[Ie]=C+q.localX+H+me,c[Ie+1]=-20+q.localY+ee,c[Ie+2]=q.localZ+Me}else c[Ie]=0,c[Ie+1]=-1e3}else if(t.triggerState===2&&P.length>0){const q=Pe-D.length,K=P[q%P.length];c[Ie]=K.x,c[Ie+1]=K.y-120,c[Ie+2]=K.z}else c[Ie]=0,c[Ie+1]=-1e3}}const fe=t.triggerState===0&&t.currentShape!=="hourglass"?.25:.18,Ne=t.currentShape==="fireworks"?or:0;for(let he=Ne;he<Rt.particleCount;he++){const Pe=he*3;W[Pe]+=(c[Pe]-W[Pe])*fe,W[Pe+1]+=(c[Pe+1]-W[Pe+1])*fe,W[Pe+2]+=(c[Pe+2]-W[Pe+2])*fe}u.attributes.position.needsUpdate=!0,o.render(s,a)};pr(()=>t.isRunning,W=>{W&&U()}),pr(()=>t.currentShape,V),pr(()=>t.currentTheme,$),Yl(()=>{window.addEventListener("resize",z)}),xa(()=>{cancelAnimationFrame(f),window.removeEventListener("resize",z)});const z=()=>{a&&o&&(a.aspect=window.innerWidth/window.innerHeight,a.updateProjectionMatrix(),o.setSize(window.innerWidth,window.innerHeight))};return(W,re)=>(gn(),Cn("div",{ref_key:"canvasContainer",ref:r,class:"canvas-wrapper"},null,512))}},QS=wa(JS,[["__scopeId","data-v-c622a170"]]),eM={id:"ui-container"},tM={class:"panel-card"},nM={class:"year-group"},iM={class:"year-item"},rM={key:0,class:"hint-wrap"},sM={class:"sub-hint"},aM={class:"year-item"},oM={key:0,class:"hint-wrap"},lM={class:"sub-hint"},cM={__name:"ControlPanel",props:{currentYear:String,sceneIndex:Number},emits:["select-year"],setup(n){const e=n,t=Zl(()=>{if(e.currentYear==="2025"){if(e.sceneIndex===0)return"✊握拳: 重置流沙";if(e.sceneIndex===1)return"✌️剪刀手: 18连发烟花";if(e.sceneIndex===2)return"✊握拳: 干杯碰撞"}else{if(e.sceneIndex===0)return"🖐️上滑: 发射火箭";if(e.sceneIndex===1)return"✊握拳: 断桥重连"}return"互动就绪"});return(i,r)=>(gn(),Cn("div",eM,[pt("div",tM,[pt("div",nM,[pt("div",iM,[pt("button",{class:xr(["year-btn y25",{active:n.currentYear==="2025"}]),onClick:r[0]||(r[0]=s=>i.$emit("select-year","2025"))}," 2025 ",2),n.currentYear==="2025"?(gn(),Cn("div",rM,[r[2]||(r[2]=pt("div",{class:"main-hint"},"👋 左 → 右 切页",-1)),pt("div",sM,fr(t.value),1)])):ts("",!0)]),r[4]||(r[4]=pt("div",{class:"divider"},null,-1)),pt("div",aM,[pt("button",{class:xr(["year-btn y26",{active:n.currentYear==="2026"}]),onClick:r[1]||(r[1]=s=>i.$emit("select-year","2026"))}," 2026 ",2),n.currentYear==="2026"?(gn(),Cn("div",oM,[r[3]||(r[3]=pt("div",{class:"main-hint"},"👋 右 ← 左 切页",-1)),pt("div",lM,fr(t.value),1)])):ts("",!0)])])])]))}},uM=wa(cM,[["__scopeId","data-v-a36f4ce9"]]);function $u(n){return new Promise((e,t)=>{if(document.querySelector(`script[src="${n}"]`)){e();return}const i=document.createElement("script");i.src=n,i.async=!0,i.crossOrigin="anonymous",i.onload=()=>e(),i.onerror=()=>t(new Error(`Script load error: ${n}`)),document.head.appendChild(i)})}const fM={class:"camera-wrapper"},hM=3,dM={__name:"CameraInput",props:{isActive:Boolean},emits:["status-change","camera-error","gesture","hand-x","hand-y","lock-swipe"],setup(n,{expose:e,emit:t}){const i=n,r=t,s=Zt(null),a=Zt(null);let o=null,l=null,u=-1,c="NONE",f=0;const h=async()=>{try{r("status-change","启动视觉引擎..."),await Promise.all([$u("https://cdn.jsdelivr.net/npm/@mediapipe/hands/hands.js"),$u("https://cdn.jsdelivr.net/npm/@mediapipe/drawing_utils/drawing_utils.js")]);const d=window.Hands;o=new d({locateFile:A=>`https://cdn.jsdelivr.net/npm/@mediapipe/hands/${A}`}),o.setOptions({maxNumHands:1,modelComplexity:0,minDetectionConfidence:.5,minTrackingConfidence:.5}),o.onResults(g);let b;try{b=await navigator.mediaDevices.getUserMedia({video:{facingMode:"user",width:{ideal:640},height:{ideal:480}}})}catch(A){console.warn("方案A失败，尝试方案B...",A);try{b=await navigator.mediaDevices.getUserMedia({video:{facingMode:"user"}})}catch(y){console.warn("方案B失败，尝试方案C...",y);try{b=await navigator.mediaDevices.getUserMedia({video:!0})}catch(w){throw w}}}p(b)}catch(d){console.error("Camera Init Error:",d);let b="无法开启摄像头";d.name==="NotAllowedError"&&(b="请允许访问摄像头"),r("camera-error",b)}},p=d=>{s.value&&(s.value.srcObject=d,s.value.onloadedmetadata=()=>{s.value.play().catch(b=>console.error("Auto-play failed:",b)),a.value.width=s.value.videoWidth,a.value.height=s.value.videoHeight,r("status-change","Ready"),_()})},_=async()=>{i.isActive&&(s.value&&s.value.readyState>=2&&s.value.currentTime!==u&&(u=s.value.currentTime,o&&await o.send({image:s.value})),l=requestAnimationFrame(_))},v=(d,b)=>Math.sqrt(Math.pow(d.x-b.x,2)+Math.pow(d.y-b.y,2)),g=d=>{if(!a.value)return;const b=a.value.getContext("2d"),A=a.value.width,y=a.value.height;b.save(),b.clearRect(0,0,A,y),b.translate(A,0),b.scale(-1,1),b.drawImage(d.image,0,0,A,y);let w="NONE",D=-1;if(d.multiHandLandmarks&&d.multiHandLandmarks.length>0){const P=d.multiHandLandmarks[0];window.drawConnectors&&(window.drawConnectors(b,P,window.HAND_CONNECTIONS,{color:"#00d2ff",lineWidth:2}),window.drawLandmarks(b,P,{color:"#ff0000",lineWidth:1,radius:2})),D=P[0].x,r("hand-x",D),r("hand-y",P[0].y);const O=P[0],x=($,X)=>v(O,P[$])>v(O,P[X])*1.1,E=($,X)=>v(O,P[$])<v(O,P[X]),I=x(8,6),U=x(12,10),B=E(16,14),V=E(20,18);I&&U&&B&&V?w="VICTORY":!I&&!U&&B&&V?w="FIST":I&&U&&!B&&!V&&(w="PALM")}w===c?(f++,f>hM&&(r("gesture",w),r("lock-swipe",w==="VICTORY"||w==="FIST"))):(f=0,c=w,(w==="NONE"||w==="PALM")&&r("lock-swipe",!1)),b.restore()};return e({startCamera:h}),xa(()=>{s.value?.srcObject&&s.value.srcObject.getTracks().forEach(d=>d.stop()),cancelAnimationFrame(l),o&&o.close()}),(d,b)=>(gn(),Cn("div",fM,[pt("video",{ref_key:"inputVideo",ref:s,playsinline:"","webkit-playsinline":"",muted:"",style:{display:"none"}},null,512),Xd(pt("canvas",{ref_key:"previewCanvas",ref:a,class:"video-preview"},null,512),[[cm,n.isActive]])]))}},pM=wa(dM,[["__scopeId","data-v-2133c7e0"]]),mM={key:0,id:"overlay"},gM={__name:"IntroOverlay",props:{visible:Boolean,showGuide:Boolean},emits:["select-mode"],setup(n){return(e,t)=>(gn(),Cn(rn,null,[n.visible?(gn(),Cn("div",mM,[t[2]||(t[2]=pt("h2",{class:"title"},"Lynx",-1)),t[3]||(t[3]=pt("div",{class:"msg-box"},"请选择交互方式",-1)),pt("button",{id:"btn-cam",class:"action-btn",onClick:t[0]||(t[0]=i=>e.$emit("select-mode","camera"))},"开启摄像头"),pt("button",{id:"btn-touch",class:"action-btn",onClick:t[1]||(t[1]=i=>e.$emit("select-mode","touch"))},"触屏 / 鼠标模式")])):ts("",!0),pt("div",{id:"touch-guide",class:xr({show:n.showGuide})},"⟵ 滑动屏幕控制扩散 ⟶",2)],64))}},_M=wa(gM,[["__scopeId","data-v-da6579d6"]]),xM={class:"app-container"},vM={key:0,class:"firework-hud"},SM={class:"hud-row"},MM={class:"hud-row"},EM={key:0,class:"status-tip"},yM={__name:"App",setup(n){const e=Zt("2025"),t=Zt(0),i=Zt("warm"),r=Zt(0),s=Zt(""),a=Zt(!0),o=Zt(!1),l=Zt(null),u=Zt(!1);let c=null,f=null;const h=Zt({idx:0,total:18,time:0}),p={2025:["hourglass","fireworks","beer"],2026:["rocket","bridge"]},_=Zl(()=>p[e.value][t.value]);let v=-1,g=-1,d=!1;const b=V=>{a.value=!1,o.value=!0,V==="camera"&&l.value.startCamera()},A=()=>{c&&(clearTimeout(c),c=null),f&&(clearTimeout(f),f=null),r.value=0,d=!1,u.value=!1,s.value="",h.value={idx:0,total:18,time:0}},y=V=>{e.value!==V&&(A(),e.value=V,t.value=0,i.value=V==="2025"?"warm":"cyber")},w=V=>{_.value==="fireworks"&&r.value===1&&(h.value=V)},D=V=>{if(d||u.value){v=V;return}if(v===-1){v=V;return}const $=V-v;v=V;const X=.04;(e.value==="2025"&&$>X||e.value==="2026"&&$<-X)&&P()},P=()=>{A();const V=p[e.value].length;t.value=(t.value+1)%V,s.value="切换场景...",d=!0,setTimeout(()=>{d=!1,s.value=""},1e3)},O=V=>{if(d||r.value!==0)return;if(g===-1){g=V;return}const $=V-g;g=V,$<-.05&&_.value==="rocket"&&I(2e3)};let x=0;const E=V=>{d&&_.value!=="hourglass"||(_.value==="hourglass"&&V==="FIST"?(x++,x>3&&(x=0,r.value=0,s.value="流沙重置")):_.value==="hourglass"&&r.value===0&&V==="NONE"?setTimeout(()=>{r.value===0&&(r.value=1),s.value=""},500):_.value==="fireworks"&&V==="VICTORY"&&r.value===0?(x++,x>3&&(x=0,I(0))):_.value==="beer"&&V==="FIST"&&r.value===0?(x++,x>5&&(x=0,I(4e3))):_.value==="bridge"&&V==="FIST"&&r.value===0?(x++,x>5&&(x=0,I(0))):x>0&&x--)},I=V=>{d=!0,r.value=1,s.value="特效触发!",c&&clearTimeout(c),_.value==="fireworks"?c=setTimeout(()=>{r.value===1&&U()},92e3):_.value==="bridge"?(s.value="桥梁合拢中...",f=setTimeout(()=>{r.value===1&&(r.value=2,s.value="与你同行",c=setTimeout(()=>{r.value===2&&U()},2e4))},2500)):V>0&&(c=setTimeout(()=>{r.value===1&&(r.value=2,setTimeout(()=>{U()},3e3))},V))},U=()=>{r.value=0,d=!1,s.value="",u.value=!1},B=V=>{s.value=V};return(V,$)=>(gn(),Cn("div",xM,[bt(QS,{currentShape:_.value,currentTheme:i.value,triggerState:r.value,isRunning:o.value,onFireworkTick:w},null,8,["currentShape","currentTheme","triggerState","isRunning"]),bt(im,{name:"fade"},{default:Af(()=>[e.value==="2025"&&t.value===1&&r.value>=1?(gn(),Cn("div",vM,[pt("div",SM,[$[2]||($[2]=pt("span",{class:"label"},"发射进度:",-1)),Io(" "+fr(h.value.idx)+" / 18",1)]),pt("div",MM,[$[3]||($[3]=pt("span",{class:"label"},"下轮倒计时:",-1)),Io(" "+fr(h.value.time)+"s",1)])])):ts("",!0)]),_:1}),bt(pM,{ref_key:"cameraInputRef",ref:l,isActive:"",onStatusChange:$[0]||($[0]=X=>s.value=X),onCameraError:B,onHandX:D,onHandY:O,onGesture:E,onLockSwipe:$[1]||($[1]=X=>u.value=X)},null,512),bt(uM,{currentYear:e.value,sceneIndex:t.value,onSelectYear:y},null,8,["currentYear","sceneIndex"]),bt(_M,{visible:a.value,onSelectMode:b},null,8,["visible"]),s.value?(gn(),Cn("div",EM,fr(s.value),1)):ts("",!0)]))}};Am(yM).mount("#app");
