...
`)}const cv={[Lf]:"Linear",[If]:"Reinhard",[Uf]:"Cineon",[Nf]:"ACESFilmic",[Of]:"AgX",[Bf]:"Neutral",[Ff]:"Custom"};function uv(n,e){const t=cv[e];return t===void 0?(He("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+n+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+n+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Ds=new X;function fv(){je.getLuminanceCoefficients(Ds);const n=Ds.x.toFixed(4),e=Ds.y.toFixed(4),t=Ds.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${n}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
`)+`
`+d);const A=T+g+a,y=T+d+o,w=hu(r,r.VERTEX_SHADER,A),R=hu(r,r.FRAGMENT_SHADER,y);r.attachShader(x,w),r.attachShader(x,R),t.index0AttributeName!==void 0?r.bindAttribLocation(x,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(x,0,"position"),r.linkProgram(x);function P(F){if(n.debug.checkShaderErrors){const Z=r.getProgramInfoLog(x)||"",W=r.getShaderInfoLog(w)||"",K=r.getShaderInfoLog(R)||"",Y=Z.trim(),U=W.trim(),D=K.trim();let N=!0,ne=!0;if(r.getProgramParameter(x,r.LINK_STATUS)===!1)if(N=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(r,x,w,R);else{const ce=pu(r,w,"vertex"),de=pu(r,R,"fragment");Je("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(x,r.VALIDATE_STATUS)+`
...
}`,Xv=[new X(1,0,0),new X(-1,0,0),new X(0,1,0),new X(0,-1,0),new X(0,0,1),new X(0,0,-1)],qv=[new X(0,-1,0),new X(0,-1,0),new X(0,0,1),new X(0,0,-1),new X(0,-1,0),new X(0,-1,0)],Eu=new _t,Rr=new X,ro=new X;function Yv(n,e,t){let i=new sh;const r=new ot,s=new ot,a=new gt,o=new sg,l=new ag,c={},u=t.maxTextureSize,f={[mi]:Ht,[Ht]:mi,[Vn]:Vn},h=new Cn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new ot},radius:{value:4}},vertexShader:kv,fragmentShader:Wv}),p=h.clone();p.defines.HORIZONTAL_PASS=1;const _=new dn;_.setAttribute("position",new rn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const x=new Jn(_,h),g=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Ns;let d=this.type;this.render=function(R,P,z){if(g.enabled===!1||g.autoUpdate===!1&&g.needsUpdate===!1||R.length===0)return;R.type===$p&&(He("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),R.type=Ns);const M=n.getRenderTarget(),E=n.getActiveCubeFace(),F=n.getActiveMipmapLevel(),Z=n.state;Z.setBlending(kn),Z.buffers.depth.getReversed()===!0?Z.buffers.color.setClear(0,0,0,0):Z.buffers.color.setClear(1,1,1,1),Z.buffers.depth.setTest(!0),Z.setScissorTest(!1);const W=d!==this.type;W&&P.traverse(function(K){K.material&&(Array.isArray(K.material)?K.material.forEach(Y=>Y.needsUpdate=!0):K.material.needsUpdate=!0)});for(let K=0,Y=R.length;K<Y;K++){const U=R[K],D=U.shadow;if(D===void 0){He("WebGLShadowMap:",U,"has no shadow.");continue}if(D.autoUpdate===!1&&D.needsUpdate===!1)continue;r.copy(D.mapSize);const N=D.getFrameExtents();if(r.multiply(N),s.copy(D.mapSize),(r.x>u||r.y>u)&&(r.x>u&&(s.x=Math.floor(u/N.x),r.x=s.x*N.x,D.mapSize.x=s.x),r.y>u&&(s.y=Math.floor(u/N.y),r.y=s.y*N.y,D.mapSize.y=s.y)),D.map===null||W===!0){if(D.map!==null&&(D.map.depthTexture!==null&&(D.map.depthTexture.dispose(),D.map.depthTexture=null),D.map.dispose()),this.type===Pr){if(U.isPointLight){He("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}D.map=new An(r.x,r.y,{format:dr,type:Kn,minFilter:Rt,magFilter:Rt,generateMipmaps:!1}),D.map.texture.name=U.name+".shadowMap",D.map.depthTexture=new jr(r.x,r.y,Mn),D.map.depthTexture.name=U.name+".shadowMapDepth",D.map.depthTexture.format=jn,D.map.depthTexture.compareFunction=null,D.map.depthTexture.minFilter=bt,D.map.depthTexture.magFilter=bt}else{U.isPointLight?(D.map=new rh(r.x),D.map.depthTexture=new ig(r.x,Rn)):(D.map=new An(r.x,r.y),D.map.depthTexture=new jr(r.x,r.y,Rn)),D.map.depthTexture.name=U.name+".shadowMap",D.map.depthTexture.format=jn;const ce=n.state.buffers.depth.getReversed();this.type===Ns?(D.map.depthTexture.compareFunction=ce?Gl:Hl,D.map.depthTexture.minFilter=Rt,D.map.depthTexture.magFilter=Rt):(D.map.depthTexture.compareFunction=null,D.map.depthTexture.minFilter=bt,D.map.depthTexture.magFilter=bt)}D.camera.updateProjectionMatrix()}const ne=D.map.isWebGLCubeRenderTarget?6:1;for(let ce=0;ce<ne;ce++){if(D.map.isWebGLCubeRenderTarget)n.setRenderTarget(D.map,ce),n.clear();else{ce===0&&(n.setRenderTarget(D.map),n.clear());const de=D.getViewport(ce);a.set(s.x*de.x,s.y*de.y,s.x*de.z,s.y*de.w),Z.viewport(a)}if(U.isPointLight){const de=D.camera,De=D.matrix,Fe=U.distance||de.far;Fe!==de.far&&(de.far=Fe,de.updateProjectionMatrix()),Rr.setFromMatrixPosition(U.matrixWorld),de.position.copy(Rr),ro.copy(de.position),ro.add(Xv[ce]),de.up.copy(qv[ce]),de.lookAt(ro),de.updateMatrixWorld(),De.makeTranslation(-Rr.x,-Rr.y,-Rr.z),Eu.multiplyMatrices(de.projectionMatrix,de.matrixWorldInverse),D._frustum.setFromProjectionMatrix(Eu,de.coordinateSystem,de.reversedDepth)}else D.updateMatrices(U);i=D.getFrustum(),y(P,z,D.camera,U,this.type)}D.isPointLightShadow!==!0&&this.type===Pr&&T(D,z),D.needsUpdate=!1}d=this.type,g.needsUpdate=!1,n.setRenderTarget(M,E,F)};function T(R,P){const z=e.update(x);h.defines.VSM_SAMPLES!==R.blurSamples&&(h.defines.VSM_SAMPLES=R.blurSamples,p.defines.VSM_SAMPLES=R.blurSamples,h.needsUpdate=!0,p.needsUpdate=!0),R.mapPass===null&&(R.mapPass=new An(r.x,r.y,{format:dr,type:Kn})),h.uniforms.shadow_pass.value=R.map.depthTexture,h.uniforms.resolution.value=R.mapSize,h.uniforms.radius.value=R.radius,n.setRenderTarget(R.mapPass),n.clear(),n.renderBufferDirect(P,null,z,h,x,null),p.uniforms.shadow_pass.value=R.mapPass.texture,p.uniforms.resolution.value=R.mapSize,p.uniforms.radius.value=R.radius,n.setRenderTarget(R.map),n.clear(),n.renderBufferDirect(P,null,z,p,x,null)}function A(R,P,z,M){let E=null;const F=z.isPointLight===!0?R.customDistanceMaterial:R.customDepthMaterial;if(F!==void 0)E=F;else if(E=z.isPointLight===!0?l:o,n.localClippingEnabled&&P.clipShadows===!0&&Array.isArray(P.clippingPlanes)&&P.clippingPlanes.length!==0||P.displacementMap&&P.displacementScale!==0||P.alphaMap&&P.alphaTest>0||P.map&&P.alphaTest>0||P.alphaToCoverage===!0){const Z=E.uuid,W=P.uuid;let K=c[Z];K===void 0&&(K={},c[Z]=K);let Y=K[W];Y===void 0&&(Y=E.clone(),K[W]=Y,P.addEventListener("dispose",w)),E=Y}if(E.visible=P.visible,E.wireframe=P.wireframe,M===Pr?E.side=P.shadowSide!==null?P.shadowSide:P.side:E.side=P.shadowSide!==null?P.shadowSide:f[P.side],E.alphaMap=P.alphaMap,E.alphaTest=P.alphaToCoverage===!0?.5:P.alphaTest,E.map=P.map,E.clipShadows=P.clipShadows,E.clippingPlanes=P.clippingPlanes,E.clipIntersection=P.clipIntersection,E.displacementMap=P.displacementMap,E.displacementScale=P.displacementScale,E.displacementBias=P.displacementBias,E.wireframeLinewidth=P.wireframeLinewidth,E.linewidth=P.linewidth,z.isPointLight===!0&&E.isMeshDistanceMaterial===!0){const Z=n.properties.get(E);Z.light=z}return E}function y(R,P,z,M,E){if(R.visible===!1)return;if(R.layers.test(P.layers)&&(R.isMesh||R.isLine||R.isPoints)&&(R.castShadow||R.receiveShadow&&E===Pr)&&(!R.frustumCulled||i.intersectsObject(R))){R.modelViewMatrix.multiplyMatrices(z.matrixWorldInverse,R.matrixWorld);const W=e.update(R),K=R.material;if(Array.isArray(K)){const Y=W.groups;for(let U=0,D=Y.length;U<D;U++){const N=Y[U],ne=K[N.materialIndex];if(ne&&ne.visible){const ce=A(R,ne,M,E);R.onBeforeShadow(n,R,P,z,W,ce,N),n.renderBufferDirect(z,null,W,ce,R,N),R.onAfterShadow(n,R,P,z,W,ce,N)}}}else if(K.visible){const Y=A(R,K,M,E);R.onBeforeShadow(n,R,P,z,W,Y,null),n.renderBufferDirect(z,null,W,Y,R,null),R.onAfterShadow(n,R,P,z,W,Y,null)}}const Z=R.children;for(let W=0,K=Z.length;W<K;W++)y(Z[W],P,z,M,E)}function w(R){R.target.removeEventListener("dispose",w);for(const z in c){const M=c[z],E=R.target.uuid;E in M&&(M[E].dispose(),delete M[E])}}}const $v={[So]:Mo,[Eo]:To,[yo]:Ao,[fr]:bo,[Mo]:So,[To]:Eo,[Ao]:yo,[bo]:fr};function Kv(n,e){function t(){let O=!1;const ye=new gt;let pe=null;const Ae=new gt(0,0,0,0);return{setMask:function(he){pe!==he&&!O&&(n.colorMask(he,he,he,he),pe=he)},setLocked:function(he){O=he},setClear:function(he,ae,_e,Ve,ut){ut===!0&&(he*=Ve,ae*=Ve,_e*=Ve),ye.set(he,ae,_e,Ve),Ae.equals(ye)===!1&&(n.clearColor(he,ae,_e,Ve),Ae.copy(ye))},reset:function(){O=!1,pe=null,Ae.set(-1,0,0,0)}}}function i(){let O=!1,ye=!1,pe=null,Ae=null,he=null;return{setReversed:function(ae){if(ye!==ae){const _e=e.get("EXT_clip_control");ae?_e.clipControlEXT(_e.LOWER_LEFT_EXT,_e.ZERO_TO_ONE_EXT):_e.clipControlEXT(_e.LOWER_LEFT_EXT,_e.NEGATIVE_ONE_TO_ONE_EXT),ye=ae;const Ve=he;he=null,this.setClear(Ve)}},getReversed:function(){return ye},setTest:function(ae){ae?oe(n.DEPTH_TEST):we(n.DEPTH_TEST)},setMask:function(ae){pe!==ae&&!O&&(n.depthMask(ae),pe=ae)},setFunc:function(ae){if(ye&&(ae=$v[ae]),Ae!==ae){switch(ae){case So:n.depthFunc(n.NEVER);break;case Mo:n.depthFunc(n.ALWAYS);break;case Eo:n.depthFunc(n.LESS);break;case fr:n.depthFunc(n.LEQUAL);break;case yo:n.depthFunc(n.EQUAL);break;case bo:n.depthFunc(n.GEQUAL);break;case To:n.depthFunc(n.GREATER);break;case Ao:n.depthFunc(n.NOTEQUAL);break;default:n.depthFunc(n.LEQUAL)}Ae=ae}},setLocked:function(ae){O=ae},setClear:function(ae){he!==ae&&(ye&&(ae=1-ae),n.clearDepth(ae),he=ae)},reset:function(){O=!1,pe=null,Ae=null,he=null,ye=!1}}}function r(){let O=!1,ye=null,pe=null,Ae=null,he=null,ae=null,_e=null,Ve=null,ut=null;return{setTest:function(it){O||(it?oe(n.STENCIL_TEST):we(n.STENCIL_TEST))},setMask:function(it){ye!==it&&!O&&(n.stencilMask(it),ye=it)},setFunc:function(it,pn,Pn){(pe!==it||Ae!==pn||he!==Pn)&&(n.stencilFunc(it,pn,Pn),pe=it,Ae=pn,he=Pn)},setOp:function(it,pn,Pn){(ae!==it||_e!==pn||Ve!==Pn)&&(n.stencilOp(it,pn,Pn),ae=it,_e=pn,Ve=Pn)},setLocked:function(it){O=it},setClear:function(it){ut!==it&&(n.clearStencil(it),ut=it)},reset:function(){O=!1,ye=null,pe=null,Ae=null,he=null,ae=null,_e=null,Ve=null,ut=null}}}const s=new t,a=new i,o=new r,l=new WeakMap,c=new WeakMap;let u={},f={},h=new WeakMap,p=[],_=null,x=!1,g=null,d=null,T=null,A=null,y=null,w=null,R=null,P=new nt(0,0,0),z=0,M=!1,E=null,F=null,Z=null,W=null,K=null;const Y=n.getParameter(n.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let U=!1,D=0;const N=n.getParameter(n.VERSION);N.indexOf("WebGL")!==-1?(D=parseFloat(/^WebGL (\d)/.exec(N)[1]),U=D>=1):N.indexOf("OpenGL ES")!==-1&&(D=parseFloat(/^OpenGL ES (\d)/.exec(N)[1]),U=D>=2);let ne=null,ce={};const de=n.getParameter(n.SCISSOR_BOX),De=n.getParameter(n.VIEWPORT),Fe=new gt().fromArray(de),Oe=new gt().fromArray(De);function Qe(O,ye,pe,Ae){const he=new Uint8Array(4),ae=n.createTexture();n.bindTexture(O,ae),n.texParameteri(O,n.TEXTURE_MIN_FILTER,n.NEAREST),n.texParameteri(O,n.TEXTURE_MAG_FILTER,n.NEAREST);for(let _e=0;_e<pe;_e++)O===n.TEXTURE_3D||O===n.TEXTURE_2D_ARRAY?n.texImage3D(ye,0,n.RGBA,1,1,Ae,0,n.RGBA,n.UNSIGNED_BYTE,he):n.texImage2D(ye+_e,0,n.RGBA,1,1,0,n.RGBA,n.UNSIGNED_BYTE,he);return ae}const te={};te[n.TEXTURE_2D]=Qe(n.TEXTURE_2D,n.TEXTURE_2D,1),te[n.TEXTURE_CUBE_MAP]=Qe(n.TEXTURE_CUBE_MAP,n.TEXTURE_CUBE_MAP_POSITIVE_X,6),te[n.TEXTURE_2D_ARRAY]=Qe(n.TEXTURE_2D_ARRAY,n.TEXTURE_2D_ARRAY,1,1),te[n.TEXTURE_3D]=Qe(n.TEXTURE_3D,n.TEXTURE_3D,1,1),s.setClear(0,0,0,1),a.setClear(1),o.setClear(0),oe(n.DEPTH_TEST),a.setFunc(fr),j(!1),ie(wc),oe(n.CULL_FACE),G(kn);function oe(O){u[O]!==!0&&(n.enable(O),u[O]=!0)}function we(O){u[O]!==!1&&(n.disable(O),u[O]=!1)}function ze(O,ye){return f[O]!==ye?(n.bindFramebuffer(O,ye),f[O]=ye,O===n.DRAW_FRAMEBUFFER&&(f[n.FRAMEBUFFER]=ye),O===n.FRAMEBUFFER&&(f[n.DRAW_FRAMEBUFFER]=ye),!0):!1}function Re(O,ye){let pe=p,Ae=!1;if(O){pe=h.get(ye),pe===void 0&&(pe=[],h.set(ye,pe));const he=O.textures;if(pe.length!==he.length||pe[0]!==n.COLOR_ATTACHMENT0){for(let ae=0,_e=he.length;ae<_e;ae++)pe[ae]=n.COLOR_ATTACHMENT0+ae;pe.length=he.length,Ae=!0}}else pe[0]!==n.BACK&&(pe[0]=n.BACK,Ae=!0);Ae&&n.drawBuffers(pe)}function Ke(O){return _!==O?(n.useProgram(O),_=O,!0):!1}const C={[Ci]:n.FUNC_ADD,[jp]:n.FUNC_SUBTRACT,[Zp]:n.FUNC_REVERSE_SUBTRACT};C[Jp]=n.MIN,C[Qp]=n.MAX;const I={[em]:n.ZERO,[tm]:n.ONE,[nm]:n.SRC_COLOR,[xo]:n.SRC_ALPHA,[lm]:n.SRC_ALPHA_SATURATE,[am]:n.DST_COLOR,[rm]:n.DST_ALPHA,[im]:n.ONE_MINUS_SRC_COLOR,[vo]:n.ONE_MINUS_SRC_ALPHA,[om]:n.ONE_MINUS_DST_COLOR,[sm]:n.ONE_MINUS_DST_ALPHA,[cm]:n.CONSTANT_COLOR,[um]:n.ONE_MINUS_CONSTANT_COLOR,[fm]:n.CONSTANT_ALPHA,[hm]:n.ONE_MINUS_CONSTANT_ALPHA};function G(O,ye,pe,Ae,he,ae,_e,Ve,ut,it){if(O===kn){x===!0&&(we(n.BLEND),x=!1);return}if(x===!1&&(oe(n.BLEND),x=!0),O!==Kp){if(O!==g||it!==M){if((d!==Ci||y!==Ci)&&(n.blendEquation(n.FUNC_ADD),d=Ci,y=Ci),it)switch(O){case or:n.blendFuncSeparate(n.ONE,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case _o:n.blendFunc(n.ONE,n.ONE);break;case Rc:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case Cc:n.blendFuncSeparate(n.DST_COLOR,n.ONE_MINUS_SRC_ALPHA,n.ZERO,n.ONE);break;default:Je("WebGLState: Invalid blending: ",O);break}else switch(O){case or:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case _o:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE,n.ONE,n.ONE);break;case Rc:Je("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Cc:Je("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Je("WebGLState: Invalid blending: ",O);break}T=null,A=null,w=null,R=null,P.set(0,0,0),z=0,g=O,M=it}return}he=he||ye,ae=ae||pe,_e=_e||Ae,(ye!==d||he!==y)&&(n.blendEquationSeparate(C[ye],C[he]),d=ye,y=he),(pe!==T||Ae!==A||ae!==w||_e!==R)&&(n.blendFuncSeparate(I[pe],I[Ae],I[ae],I[_e]),T=pe,A=Ae,w=ae,R=_e),(Ve.equals(P)===!1||ut!==z)&&(n.blendColor(Ve.r,Ve.g,Ve.b,ut),P.copy(Ve),z=ut),g=O,M=!1}function ee(O,ye){O.side===Vn?we(n.CULL_FACE):oe(n.CULL_FACE);let pe=O.side===Ht;ye&&(pe=!pe),j(pe),O.blending===or&&O.transparent===!1?G(kn):G(O.blending,O.blendEquation,O.blendSrc,O.blendDst,O.blendEquationAlpha,O.blendSrcAlpha,O.blendDstAlpha,O.blendColor,O.blendAlpha,O.premultipliedAlpha),a.setFunc(O.depthFunc),a.setTest(O.depthTest),a.setMask(O.depthWrite),s.setMask(O.colorWrite);const Ae=O.stencilWrite;o.setTest(Ae),Ae&&(o.setMask(O.stencilWriteMask),o.setFunc(O.stencilFunc,O.stencilRef,O.stencilFuncMask),o.setOp(O.stencilFail,O.stencilZFail,O.stencilZPass)),le(O.polygonOffset,O.polygonOffsetFactor,O.polygonOffsetUnits),O.alphaToCoverage===!0?oe(n.SAMPLE_ALPHA_TO_COVERAGE):we(n.SAMPLE_ALPHA_TO_COVERAGE)}function j(O){E!==O&&(O?n.frontFace(n.CW):n.frontFace(n.CCW),E=O)}function ie(O){O!==qp?(oe(n.CULL_FACE),O!==F&&(O===wc?n.cullFace(n.BACK):O===Yp?n.cullFace(n.FRONT):n.cullFace(n.FRONT_AND_BACK))):we(n.CULL_FACE),F=O}function b(O){O!==Z&&(U&&n.lineWidth(O),Z=O)}function le(O,ye,pe){O?(oe(n.POLYGON_OFFSET_FILL),(W!==ye||K!==pe)&&(n.polygonOffset(ye,pe),W=ye,K=pe)):we(n.POLYGON_OFFSET_FILL)}function re(O){O?oe(n.SCISSOR_TEST):we(n.SCISSOR_TEST)}function Q(O){O===void 0&&(O=n.TEXTURE0+Y-1),ne!==O&&(n.activeTexture(O),ne=O)}function se(O,ye,pe){pe===void 0&&(ne===null?pe=n.TEXTURE0+Y-1:pe=ne);let Ae=ce[pe];Ae===void 0&&(Ae={type:void 0,texture:void 0},ce[pe]=Ae),(Ae.type!==O||Ae.texture!==ye)&&(ne!==pe&&(n.activeTexture(pe),ne=pe),n.bindTexture(O,ye||te[O]),Ae.type=O,Ae.texture=ye)}function v(){const O=ce[ne];O!==void 0&&O.type!==void 0&&(n.bindTexture(O.type,null),O.type=void 0,O.texture=void 0)}function m(){try{n.compressedTexImage2D(...arguments)}catch(O){Je("WebGLState:",O)}}function L(){try{n.compressedTexImage3D(...arguments)}catch(O){Je("WebGLState:",O)}}function k(){try{n.texSubImage2D(...arguments)}catch(O){Je("WebGLState:",O)}}function J(){try{n.texSubImage3D(...arguments)}catch(O){Je("WebGLState:",O)}}function H(){try{n.compressedTexSubImage2D(...arguments)}catch(O){Je("WebGLState:",O)}}function Me(){try{n.compressedTexSubImage3D(...arguments)}catch(O){Je("WebGLState:",O)}}function fe(){try{n.texStorage2D(...arguments)}catch(O){Je("WebGLState:",O)}}function be(){try{n.texStorage3D(...arguments)}catch(O){Je("WebGLState:",O)}}function Le(){try{n.texImage2D(...arguments)}catch(O){Je("WebGLState:",O)}}function ue(){try{n.texImage3D(...arguments)}catch(O){Je("WebGLState:",O)}}function ge(O){Fe.equals(O)===!1&&(n.scissor(O.x,O.y,O.z,O.w),Fe.copy(O))}function xe(O){Oe.equals(O)===!1&&(n.viewport(O.x,O.y,O.z,O.w),Oe.copy(O))}function Te(O,ye){let pe=c.get(ye);pe===void 0&&(pe=new WeakMap,c.set(ye,pe));let Ae=pe.get(O);Ae===void 0&&(Ae=n.getUniformBlockIndex(ye,O.name),pe.set(O,Ae))}function me(O,ye){const Ae=c.get(ye).get(O);l.get(ye)!==Ae&&(n.uniformBlockBinding(ye,Ae,O.__bindingPointIndex),l.set(ye,Ae))}function Ge(){n.disable(n.BLEND),n.disable(n.CULL_FACE),n.disable(n.DEPTH_TEST),n.disable(n.POLYGON_OFFSET_FILL),n.disable(n.SCISSOR_TEST),n.disable(n.STENCIL_TEST),n.disable(n.SAMPLE_ALPHA_TO_COVERAGE),n.blendEquation(n.FUNC_ADD),n.blendFunc(n.ONE,n.ZERO),n.blendFuncSeparate(n.ONE,n.ZERO,n.ONE,n.ZERO),n.blendColor(0,0,0,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(n.LESS),a.setReversed(!1),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(n.ALWAYS,0,4294967295),n.stencilOp(n.KEEP,n.KEEP,n.KEEP),n.clearStencil(0),n.cullFace(n.BACK),n.frontFace(n.CCW),n.polygonOffset(0,0),n.activeTexture(n.TEXTURE0),n.bindFramebuffer(n.FRAMEBUFFER,null),n.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),n.bindFramebuffer(n.READ_FRAMEBUFFER,null),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),u={},ne=null,ce={},f={},h=new WeakMap,p=[],_=null,x=!1,g=null,d=null,T=null,A=null,y=null,w=null,R=null,P=new nt(0,0,0),z=0,M=!1,E=null,F=null,Z=null,W=null,K=null,Fe.set(0,0,n.canvas.width,n.canvas.height),Oe.set(0,0,n.canvas.width,n.canvas.height),s.reset(),a.reset(),o.reset()}return{buffers:{color:s,depth:a,stencil:o},enable:oe,disable:we,bindFramebuffer:ze,drawBuffers:Re,useProgram:Ke,setBlending:G,setMaterial:ee,setFlipSided:j,setCullFace:ie,setLineWidth:b,setPolygonOffset:le,setScissorTest:re,activeTexture:Q,bindTexture:se,unbindTexture:v,compressedTexImage2D:m,compressedTexImage3D:L,texImage2D:Le,texImage3D:ue,updateUBOMapping:Te,uniformBlockBinding:me,texStorage2D:fe,texStorage3D:be,texSubImage2D:k,texSubImage3D:J,compressedTexSubImage2D:H,compressedTexSubImage3D:Me,scissor:ge,viewport:xe,reset:Ge}}function jv(n,e,t,i,r,s,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new ot,u=new WeakMap;let f;const h=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function _(v,m){return p?new OffscreenCanvas(v,m):$r("canvas")}function x(v,m,L){let k=1;const J=se(v);if((J.width>L||J.height>L)&&(k=L/Math.max(J.width,J.height)),k<1)if(typeof HTMLImageElement<"u"&&v instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&v instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&v instanceof ImageBitmap||typeof VideoFrame<"u"&&v instanceof VideoFrame){const H=Math.floor(k*J.width),Me=Math.floor(k*J.height);f===void 0&&(f=_(H,Me));const fe=m?_(H,Me):f;return fe.width=H,fe.height=Me,fe.getContext("2d").drawImage(v,0,0,H,Me),He("WebGLRenderer: Texture has been resized from ("+J.width+"x"+J.height+") to ("+H+"x"+Me+")."),fe}else return"data"in v&&He("WebGLRenderer: Image in DataTexture is too big ("+J.width+"x"+J.height+")."),v;return v}function g(v){return v.generateMipmaps}function d(v){n.generateMipmap(v)}function T(v){return v.isWebGLCubeRenderTarget?n.TEXTURE_CUBE_MAP:v.isWebGL3DRenderTarget?n.TEXTURE_3D:v.isWebGLArrayRenderTarget||v.isCompressedArrayTexture?n.TEXTURE_2D_ARRAY:n.TEXTURE_2D}function A(v,m,L,k,J=!1){if(v!==null){if(n[v]!==void 0)return n[v];He("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+v+"'")}let H=m;if(m===n.RED&&(L===n.FLOAT&&(H=n.R32F),L===n.HALF_FLOAT&&(H=n.R16F),L===n.UNSIGNED_BYTE&&(H=n.R8)),m===n.RED_INTEGER&&(L===n.UNSIGNED_BYTE&&(H=n.R8UI),L===n.UNSIGNED_SHORT&&(H=n.R16UI),L===n.UNSIGNED_INT&&(H=n.R32UI),L===n.BYTE&&(H=n.R8I),L===n.SHORT&&(H=n.R16I),L===n.INT&&(H=n.R32I)),m===n.RG&&(L===n.FLOAT&&(H=n.RG32F),L===n.HALF_FLOAT&&(H=n.RG16F),L===n.UNSIGNED_BYTE&&(H=n.RG8)),m===n.RG_INTEGER&&(L===n.UNSIGNED_BYTE&&(H=n.RG8UI),L===n.UNSIGNED_SHORT&&(H=n.RG16UI),L===n.UNSIGNED_INT&&(H=n.RG32UI),L===n.BYTE&&(H=n.RG8I),L===n.SHORT&&(H=n.RG16I),L===n.INT&&(H=n.RG32I)),m===n.RGB_INTEGER&&(L===n.UNSIGNED_BYTE&&(H=n.RGB8UI),L===n.UNSIGNED_SHORT&&(H=n.RGB16UI),L===n.UNSIGNED_INT&&(H=n.RGB32UI),L===n.BYTE&&(H=n.RGB8I),L===n.SHORT&&(H=n.RGB16I),L===n.INT&&(H=n.RGB32I)),m===n.RGBA_INTEGER&&(L===n.UNSIGNED_BYTE&&(H=n.RGBA8UI),L===n.UNSIGNED_SHORT&&(H=n.RGBA16UI),L===n.UNSIGNED_INT&&(H=n.RGBA32UI),L===n.BYTE&&(H=n.RGBA8I),L===n.SHORT&&(H=n.RGBA16I),L===n.INT&&(H=n.RGBA32I)),m===n.RGB&&(L===n.UNSIGNED_INT_5_9_9_9_REV&&(H=n.RGB9_E5),L===n.UNSIGNED_INT_10F_11F_11F_REV&&(H=n.R11F_G11F_B10F)),m===n.RGBA){const Me=J?js:je.getTransfer(k);L===n.FLOAT&&(H=n.RGBA32F),L===n.HALF_FLOAT&&(H=n.RGBA16F),L===n.UNSIGNED_BYTE&&(H=Me===st?n.SRGB8_ALPHA8:n.RGBA8),L===n.UNSIGNED_SHORT_4_4_4_4&&(H=n.RGBA4),L===n.UNSIGNED_SHORT_5_5_5_1&&(H=n.RGB5_A1)}return(H===n.R16F||H===n.R32F||H===n.RG16F||H===n.RG32F||H===n.RGBA16F||H===n.RGBA32F)&&e.get("EXT_color_buffer_float"),H}function y(v,m){let L;return v?m===null||m===Rn||m===Yr?L=n.DEPTH24_STENCIL8:m===Mn?L=n.DEPTH32F_STENCIL8:m===qr&&(L=n.DEPTH24_STENCIL8,He("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):m===null||m===Rn||m===Yr?L=n.DEPTH_COMPONENT24:m===Mn?L=n.DEPTH_COMPONENT32F:m===qr&&(L=n.DEPTH_COMPONENT16),L}function w(v,m){return g(v)===!0||v.isFramebufferTexture&&v.minFilter!==bt&&v.minFilter!==Rt?Math.log2(Math.max(m.width,m.height))+1:v.mipmaps!==void 0&&v.mipmaps.length>0?v.mipmaps.length:v.isCompressedTexture&&Array.isArray(v.image)?m.mipmaps.length:1}function R(v){const m=v.target;m.removeEventListener("dispose",R),z(m),m.isVideoTexture&&u.delete(m)}function P(v){const m=v.target;m.removeEventListener("dispose",P),E(m)}function z(v){const m=i.get(v);if(m.__webglInit===void 0)return;const L=v.source,k=h.get(L);if(k){const J=k[m.__cacheKey];J.usedTimes--,J.usedTimes===0&&M(v),Object.keys(k).length===0&&h.delete(L)}i.remove(v)}function M(v){const m=i.get(v);n.deleteTexture(m.__webglTexture);const L=v.source,k=h.get(L);delete k[m.__cacheKey],a.memory.textures--}function E(v){const m=i.get(v);if(v.depthTexture&&(v.depthTexture.dispose(),i.remove(v.depthTexture)),v.isWebGLCubeRenderTarget)for(let k=0;k<6;k++){if(Array.isArray(m.__webglFramebuffer[k]))for(let J=0;J<m.__webglFramebuffer[k].length;J++)n.deleteFramebuffer(m.__webglFramebuffer[k][J]);else n.deleteFramebuffer(m.__webglFramebuffer[k]);m.__webglDepthbuffer&&n.deleteRenderbuffer(m.__webglDepthbuffer[k])}else{if(Array.isArray(m.__webglFramebuffer))for(let k=0;k<m.__webglFramebuffer.length;k++)n.deleteFramebuffer(m.__webglFramebuffer[k]);else n.deleteFramebuffer(m.__webglFramebuffer);if(m.__webglDepthbuffer&&n.deleteRenderbuffer(m.__webglDepthbuffer),m.__webglMultisampledFramebuffer&&n.deleteFramebuffer(m.__webglMultisampledFramebuffer),m.__webglColorRenderbuffer)for(let k=0;k<m.__webglColorRenderbuffer.length;k++)m.__webglColorRenderbuffer[k]&&n.deleteRenderbuffer(m.__webglColorRenderbuffer[k]);m.__webglDepthRenderbuffer&&n.deleteRenderbuffer(m.__webglDepthRenderbuffer)}const L=v.textures;for(let k=0,J=L.length;k<J;k++){const H=i.get(L[k]);H.__webglTexture&&(n.deleteTexture(H.__webglTexture),a.memory.textures--),i.remove(L[k])}i.remove(v)}let F=0;function Z(){F=0}function W(){const v=F;return v>=r.maxTextures&&He("WebGLTextures: Trying to use "+v+" texture units while this GPU supports only "+r.maxTextures),F+=1,v}function K(v){const m=[];return m.push(v.wrapS),m.push(v.wrapT),m.push(v.wrapR||0),m.push(v.magFilter),m.push(v.minFilter),m.push(v.anisotropy),m.push(v.internalFormat),m.push(v.format),m.push(v.type),m.push(v.generateMipmaps),m.push(v.premultiplyAlpha),m.push(v.flipY),m.push(v.unpackAlignment),m.push(v.colorSpace),m.join()}function Y(v,m){const L=i.get(v);if(v.isVideoTexture&&re(v),v.isRenderTargetTexture===!1&&v.isExternalTexture!==!0&&v.version>0&&L.__version!==v.version){const k=v.image;if(k===null)He("WebGLRenderer: Texture marked for update but no image data found.");else if(k.complete===!1)He("WebGLRenderer: Texture marked for update but image is incomplete");else{te(L,v,m);return}}else v.isExternalTexture&&(L.__webglTexture=v.sourceTexture?v.sourceTexture:null);t.bindTexture(n.TEXTURE_2D,L.__webglTexture,n.TEXTURE0+m)}function U(v,m){const L=i.get(v);if(v.isRenderTargetTexture===!1&&v.version>0&&L.__version!==v.version){te(L,v,m);return}else v.isExternalTexture&&(L.__webglTexture=v.sourceTexture?v.sourceTexture:null);t.bindTexture(n.TEXTURE_2D_ARRAY,L.__webglTexture,n.TEXTURE0+m)}function D(v,m){const L=i.get(v);if(v.isRenderTargetTexture===!1&&v.version>0&&L.__version!==v.version){te(L,v,m);return}t.bindTexture(n.TEXTURE_3D,L.__webglTexture,n.TEXTURE0+m)}function N(v,m){const L=i.get(v);if(v.isCubeDepthTexture!==!0&&v.version>0&&L.__version!==v.version){oe(L,v,m);return}t.bindTexture(n.TEXTURE_CUBE_MAP,L.__webglTexture,n.TEXTURE0+m)}const ne={[Co]:n.REPEAT,[Hn]:n.CLAMP_TO_EDGE,[Po]:n.MIRRORED_REPEAT},ce={[bt]:n.NEAREST,[mm]:n.NEAREST_MIPMAP_NEAREST,[cs]:n.NEAREST_MIPMAP_LINEAR,[Rt]:n.LINEAR,[wa]:n.LINEAR_MIPMAP_NEAREST,[Di]:n.LINEAR_MIPMAP_LINEAR},de={[vm]:n.NEVER,[bm]:n.ALWAYS,[Sm]:n.LESS,[Hl]:n.LEQUAL,[Mm]:n.EQUAL,[Gl]:n.GEQUAL,[Em]:n.GREATER,[ym]:n.NOTEQUAL};function De(v,m){if(m.type===Mn&&e.has("OES_texture_float_linear")===!1&&(m.magFilter===Rt||m.magFilter===wa||m.magFilter===cs||m.magFilter===Di||m.minFilter===Rt||m.minFilter===wa||m.minFilter===cs||m.minFilter===Di)&&He("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),n.texParameteri(v,n.TEXTURE_WRAP_S,ne[m.wrapS]),n.texParameteri(v,n.TEXTURE_WRAP_T,ne[m.wrapT]),(v===n.TEXTURE_3D||v===n.TEXTURE_2D_ARRAY)&&n.texParameteri(v,n.TEXTURE_WRAP_R,ne[m.wrapR]),n.texParameteri(v,n.TEXTURE_MAG_FILTER,ce[m.magFilter]),n.texParameteri(v,n.TEXTURE_MIN_FILTER,ce[m.minFilter]),m.compareFunction&&(n.texParameteri(v,n.TEXTURE_COMPARE_MODE,n.COMPARE_REF_TO_TEXTURE),n.texParameteri(v,n.TEXTURE_COMPARE_FUNC,de[m.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(m.magFilter===bt||m.minFilter!==cs&&m.minFilter!==Di||m.type===Mn&&e.has("OES_texture_float_linear")===!1)return;if(m.anisotropy>1||i.get(m).__currentAnisotropy){const L=e.get("EXT_texture_filter_anisotropic");n.texParameterf(v,L.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(m.anisotropy,r.getMaxAnisotropy())),i.get(m).__currentAnisotropy=m.anisotropy}}}function Fe(v,m){let L=!1;v.__webglInit===void 0&&(v.__webglInit=!0,m.addEventListener("dispose",R));const k=m.source;let J=h.get(k);J===void 0&&(J={},h.set(k,J));const H=K(m);if(H!==v.__cacheKey){J[H]===void 0&&(J[H]={texture:n.createTexture(),usedTimes:0},a.memory.textures++,L=!0),J[H].usedTimes++;const Me=J[v.__cacheKey];Me!==void 0&&(J[v.__cacheKey].usedTimes--,Me.usedTimes===0&&M(m)),v.__cacheKey=H,v.__webglTexture=J[H].texture}return L}function Oe(v,m,L){return Math.floor(Math.floor(v/L)/m)}function Qe(v,m,L,k){const H=v.updateRanges;if(H.length===0)t.texSubImage2D(n.TEXTURE_2D,0,0,0,m.width,m.height,L,k,m.data);else{H.sort((ue,ge)=>ue.start-ge.start);let Me=0;for(let ue=1;ue<H.length;ue++){const ge=H[Me],xe=H[ue],Te=ge.start+ge.count,me=Oe(xe.start,m.width,4),Ge=Oe(ge.start,m.width,4);xe.start<=Te+1&&me===Ge&&Oe(xe.start+xe.count-1,m.width,4)===me?ge.count=Math.max(ge.count,xe.start+xe.count-ge.start):(++Me,H[Me]=xe)}H.length=Me+1;const fe=n.getParameter(n.UNPACK_ROW_LENGTH),be=n.getParameter(n.UNPACK_SKIP_PIXELS),Le=n.getParameter(n.UNPACK_SKIP_ROWS);n.pixelStorei(n.UNPACK_ROW_LENGTH,m.width);for(let ue=0,ge=H.length;ue<ge;ue++){const xe=H[ue],Te=Math.floor(xe.start/4),me=Math.ceil(xe.count/4),Ge=Te%m.width,O=Math.floor(Te/m.width),ye=me,pe=1;n.pixelStorei(n.UNPACK_SKIP_PIXELS,Ge),n.pixelStorei(n.UNPACK_SKIP_ROWS,O),t.texSubImage2D(n.TEXTURE_2D,0,Ge,O,ye,pe,L,k,m.data)}v.clearUpdateRanges(),n.pixelStorei(n.UNPACK_ROW_LENGTH,fe),n.pixelStorei(n.UNPACK_SKIP_PIXELS,be),n.pixelStorei(n.UNPACK_SKIP_ROWS,Le)}}function te(v,m,L){let k=n.TEXTURE_2D;(m.isDataArrayTexture||m.isCompressedArrayTexture)&&(k=n.TEXTURE_2D_ARRAY),m.isData3DTexture&&(k=n.TEXTURE_3D);const J=Fe(v,m),H=m.source;t.bindTexture(k,v.__webglTexture,n.TEXTURE0+L);const Me=i.get(H);if(H.version!==Me.__version||J===!0){t.activeTexture(n.TEXTURE0+L);const fe=je.getPrimaries(je.workingColorSpace),be=m.colorSpace===ci?null:je.getPrimaries(m.colorSpace),Le=m.colorSpace===ci||fe===be?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,m.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,m.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,m.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,Le);let ue=x(m.image,!1,r.maxTextureSize);ue=Q(m,ue);const ge=s.convert(m.format,m.colorSpace),xe=s.convert(m.type);let Te=A(m.internalFormat,ge,xe,m.colorSpace,m.isVideoTexture);De(k,m);let me;const Ge=m.mipmaps,O=m.isVideoTexture!==!0,ye=Me.__version===void 0||J===!0,pe=H.dataReady,Ae=w(m,ue);if(m.isDepthTexture)Te=y(m.format===Li,m.type),ye&&(O?t.texStorage2D(n.TEXTURE_2D,1,Te,ue.width,ue.height):t.texImage2D(n.TEXTURE_2D,0,Te,ue.width,ue.height,0,ge,xe,null));else if(m.isDataTexture)if(Ge.length>0){O&&ye&&t.texStorage2D(n.TEXTURE_2D,Ae,Te,Ge[0].width,Ge[0].height);for(let he=0,ae=Ge.length;he<ae;he++)me=Ge[he],O?pe&&t.texSubImage2D(n.TEXTURE_2D,he,0,0,me.width,me.height,ge,xe,me.data):t.texImage2D(n.TEXTURE_2D,he,Te,me.width,me.height,0,ge,xe,me.data);m.generateMipmaps=!1}else O?(ye&&t.texStorage2D(n.TEXTURE_2D,Ae,Te,ue.width,ue.height),pe&&Qe(m,ue,ge,xe)):t.texImage2D(n.TEXTURE_2D,0,Te,ue.width,ue.height,0,ge,xe,ue.data);else if(m.isCompressedTexture)if(m.isCompressedArrayTexture){O&&ye&&t.texStorage3D(n.TEXTURE_2D_ARRAY,Ae,Te,Ge[0].width,Ge[0].height,ue.depth);for(let he=0,ae=Ge.length;he<ae;he++)if(me=Ge[he],m.format!==un)if(ge!==null)if(O){if(pe)if(m.layerUpdates.size>0){const _e=Qc(me.width,me.height,m.format,m.type);for(const Ve of m.layerUpdates){const ut=me.data.subarray(Ve*_e/me.data.BYTES_PER_ELEMENT,(Ve+1)*_e/me.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,he,0,0,Ve,me.width,me.height,1,ge,ut)}m.clearLayerUpdates()}else t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,he,0,0,0,me.width,me.height,ue.depth,ge,me.data)}else t.compressedTexImage3D(n.TEXTURE_2D_ARRAY,he,Te,me.width,me.height,ue.depth,0,me.data,0,0);else He("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else O?pe&&t.texSubImage3D(n.TEXTURE_2D_ARRAY,he,0,0,0,me.width,me.height,ue.depth,ge,xe,me.data):t.texImage3D(n.TEXTURE_2D_ARRAY,he,Te,me.width,me.height,ue.depth,0,ge,xe,me.data)}else{O&&ye&&t.texStorage2D(n.TEXTURE_2D,Ae,Te,Ge[0].width,Ge[0].height);for(let he=0,ae=Ge.length;he<ae;he++)me=Ge[he],m.format!==un?ge!==null?O?pe&&t.compressedTexSubImage2D(n.TEXTURE_2D,he,0,0,me.width,me.height,ge,me.data):t.compressedTexImage2D(n.TEXTURE_2D,he,Te,me.width,me.height,0,me.data):He("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):O?pe&&t.texSubImage2D(n.TEXTURE_2D,he,0,0,me.width,me.height,ge,xe,me.data):t.texImage2D(n.TEXTURE_2D,he,Te,me.width,me.height,0,ge,xe,me.data)}else if(m.isDataArrayTexture)if(O){if(ye&&t.texStorage3D(n.TEXTURE_2D_ARRAY,Ae,Te,ue.width,ue.height,ue.depth),pe)if(m.layerUpdates.size>0){const he=Qc(ue.width,ue.height,m.format,m.type);for(const ae of m.layerUpdates){const _e=ue.data.subarray(ae*he/ue.data.BYTES_PER_ELEMENT,(ae+1)*he/ue.data.BYTES_PER_ELEMENT);t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,ae,ue.width,ue.height,1,ge,xe,_e)}m.clearLayerUpdates()}else t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,0,ue.width,ue.height,ue.depth,ge,xe,ue.data)}else t.texImage3D(n.TEXTURE_2D_ARRAY,0,Te,ue.width,ue.height,ue.depth,0,ge,xe,ue.data);else if(m.isData3DTexture)O?(ye&&t.texStorage3D(n.TEXTURE_3D,Ae,Te,ue.width,ue.height,ue.depth),pe&&t.texSubImage3D(n.TEXTURE_3D,0,0,0,0,ue.width,ue.height,ue.depth,ge,xe,ue.data)):t.texImage3D(n.TEXTURE_3D,0,Te,ue.width,ue.height,ue.depth,0,ge,xe,ue.data);else if(m.isFramebufferTexture){if(ye)if(O)t.texStorage2D(n.TEXTURE_2D,Ae,Te,ue.width,ue.height);else{let he=ue.width,ae=ue.height;for(let _e=0;_e<Ae;_e++)t.texImage2D(n.TEXTURE_2D,_e,Te,he,ae,0,ge,xe,null),he>>=1,ae>>=1}}else if(Ge.length>0){if(O&&ye){const he=se(Ge[0]);t.texStorage2D(n.TEXTURE_2D,Ae,Te,he.width,he.height)}for(let he=0,ae=Ge.length;he<ae;he++)me=Ge[he],O?pe&&t.texSubImage2D(n.TEXTURE_2D,he,0,0,ge,xe,me):t.texImage2D(n.TEXTURE_2D,he,Te,ge,xe,me);m.generateMipmaps=!1}else if(O){if(ye){const he=se(ue);t.texStorage2D(n.TEXTURE_2D,Ae,Te,he.width,he.height)}pe&&t.texSubImage2D(n.TEXTURE_2D,0,0,0,ge,xe,ue)}else t.texImage2D(n.TEXTURE_2D,0,Te,ge,xe,ue);g(m)&&d(k),Me.__version=H.version,m.onUpdate&&m.onUpdate(m)}v.__version=m.version}function oe(v,m,L){if(m.image.length!==6)return;const k=Fe(v,m),J=m.source;t.bindTexture(n.TEXTURE_CUBE_MAP,v.__webglTexture,n.TEXTURE0+L);const H=i.get(J);if(J.version!==H.__version||k===!0){t.activeTexture(n.TEXTURE0+L);const Me=je.getPrimaries(je.workingColorSpace),fe=m.colorSpace===ci?null:je.getPrimaries(m.colorSpace),be=m.colorSpace===ci||Me===fe?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,m.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,m.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,m.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,be);const Le=m.isCompressedTexture||m.image[0].isCompressedTexture,ue=m.image[0]&&m.image[0].isDataTexture,ge=[];for(let ae=0;ae<6;ae++)!Le&&!ue?ge[ae]=x(m.image[ae],!0,r.maxCubemapSize):ge[ae]=ue?m.image[ae].image:m.image[ae],ge[ae]=Q(m,ge[ae]);const xe=ge[0],Te=s.convert(m.format,m.colorSpace),me=s.convert(m.type),Ge=A(m.internalFormat,Te,me,m.colorSpace),O=m.isVideoTexture!==!0,ye=H.__version===void 0||k===!0,pe=J.dataReady;let Ae=w(m,xe);De(n.TEXTURE_CUBE_MAP,m);let he;if(Le){O&&ye&&t.texStorage2D(n.TEXTURE_CUBE_MAP,Ae,Ge,xe.width,xe.height);for(let ae=0;ae<6;ae++){he=ge[ae].mipmaps;for(let _e=0;_e<he.length;_e++){const Ve=he[_e];m.format!==un?Te!==null?O?pe&&t.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ae,_e,0,0,Ve.width,Ve.height,Te,Ve.data):t.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ae,_e,Ge,Ve.width,Ve.height,0,Ve.data):He("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):O?pe&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ae,_e,0,0,Ve.width,Ve.height,Te,me,Ve.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ae,_e,Ge,Ve.width,Ve.height,0,Te,me,Ve.data)}}}else{if(he=m.mipmaps,O&&ye){he.length>0&&Ae++;const ae=se(ge[0]);t.texStorage2D(n.TEXTURE_CUBE_MAP,Ae,Ge,ae.width,ae.height)}for(let ae=0;ae<6;ae++)if(ue){O?pe&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ae,0,0,0,ge[ae].width,ge[ae].height,Te,me,ge[ae].data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ae,0,Ge,ge[ae].width,ge[ae].height,0,Te,me,ge[ae].data);for(let _e=0;_e<he.length;_e++){const ut=he[_e].image[ae].image;O?pe&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ae,_e+1,0,0,ut.width,ut.height,Te,me,ut.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ae,_e+1,Ge,ut.width,ut.height,0,Te,me,ut.data)}}else{O?pe&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ae,0,0,0,Te,me,ge[ae]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ae,0,Ge,Te,me,ge[ae]);for(let _e=0;_e<he.length;_e++){const Ve=he[_e];O?pe&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ae,_e+1,0,0,Te,me,Ve.image[ae]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ae,_e+1,Ge,Te,me,Ve.image[ae])}}}g(m)&&d(n.TEXTURE_CUBE_MAP),H.__version=J.version,m.onUpdate&&m.onUpdate(m)}v.__version=m.version}function we(v,m,L,k,J,H){const Me=s.convert(L.format,L.colorSpace),fe=s.convert(L.type),be=A(L.internalFormat,Me,fe,L.colorSpace),Le=i.get(m),ue=i.get(L);if(ue.__renderTarget=m,!Le.__hasExternalTextures){const ge=Math.max(1,m.width>>H),xe=Math.max(1,m.height>>H);J===n.TEXTURE_3D||J===n.TEXTURE_2D_ARRAY?t.texImage3D(J,H,be,ge,xe,m.depth,0,Me,fe,null):t.texImage2D(J,H,be,ge,xe,0,Me,fe,null)}t.bindFramebuffer(n.FRAMEBUFFER,v),le(m)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,k,J,ue.__webglTexture,0,b(m)):(J===n.TEXTURE_2D||J>=n.TEXTURE_CUBE_MAP_POSITIVE_X&&J<=n.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&n.framebufferTexture2D(n.FRAMEBUFFER,k,J,ue.__webglTexture,H),t.bindFramebuffer(n.FRAMEBUFFER,null)}function ze(v,m,L){if(n.bindRenderbuffer(n.RENDERBUFFER,v),m.depthBuffer){const k=m.depthTexture,J=k&&k.isDepthTexture?k.type:null,H=y(m.stencilBuffer,J),Me=m.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;le(m)?o.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,b(m),H,m.width,m.height):L?n.renderbufferStorageMultisample(n.RENDERBUFFER,b(m),H,m.width,m.height):n.renderbufferStorage(n.RENDERBUFFER,H,m.width,m.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,Me,n.RENDERBUFFER,v)}else{const k=m.textures;for(let J=0;J<k.length;J++){const H=k[J],Me=s.convert(H.format,H.colorSpace),fe=s.convert(H.type),be=A(H.internalFormat,Me,fe,H.colorSpace);le(m)?o.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,b(m),be,m.width,m.height):L?n.renderbufferStorageMultisample(n.RENDERBUFFER,b(m),be,m.width,m.height):n.renderbufferStorage(n.RENDERBUFFER,be,m.width,m.height)}}n.bindRenderbuffer(n.RENDERBUFFER,null)}function Re(v,m,L){const k=m.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(n.FRAMEBUFFER,v),!(m.depthTexture&&m.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const J=i.get(m.depthTexture);if(J.__renderTarget=m,(!J.__webglTexture||m.depthTexture.image.width!==m.width||m.depthTexture.image.height!==m.height)&&(m.depthTexture.image.width=m.width,m.depthTexture.image.height=m.height,m.depthTexture.needsUpdate=!0),k){if(J.__webglInit===void 0&&(J.__webglInit=!0,m.depthTexture.addEventListener("dispose",R)),J.__webglTexture===void 0){J.__webglTexture=n.createTexture(),t.bindTexture(n.TEXTURE_CUBE_MAP,J.__webglTexture),De(n.TEXTURE_CUBE_MAP,m.depthTexture);const Le=s.convert(m.depthTexture.format),ue=s.convert(m.depthTexture.type);let ge;m.depthTexture.format===jn?ge=n.DEPTH_COMPONENT24:m.depthTexture.format===Li&&(ge=n.DEPTH24_STENCIL8);for(let xe=0;xe<6;xe++)n.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+xe,0,ge,m.width,m.height,0,Le,ue,null)}}else Y(m.depthTexture,0);const H=J.__webglTexture,Me=b(m),fe=k?n.TEXTURE_CUBE_MAP_POSITIVE_X+L:n.TEXTURE_2D,be=m.depthTexture.format===Li?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;if(m.depthTexture.format===jn)le(m)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,be,fe,H,0,Me):n.framebufferTexture2D(n.FRAMEBUFFER,be,fe,H,0);else if(m.depthTexture.format===Li)le(m)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,be,fe,H,0,Me):n.framebufferTexture2D(n.FRAMEBUFFER,be,fe,H,0);else throw new Error("Unknown depthTexture format")}function Ke(v){const m=i.get(v),L=v.isWebGLCubeRenderTarget===!0;if(m.__boundDepthTexture!==v.depthTexture){const k=v.depthTexture;if(m.__depthDisposeCallback&&m.__depthDisposeCallback(),k){const J=()=>{delete m.__boundDepthTexture,delete m.__depthDisposeCallback,k.removeEventListener("dispose",J)};k.addEventListener("dispose",J),m.__depthDisposeCallback=J}m.__boundDepthTexture=k}if(v.depthTexture&&!m.__autoAllocateDepthBuffer)if(L)for(let k=0;k<6;k++)Re(m.__webglFramebuffer[k],v,k);else{const k=v.texture.mipmaps;k&&k.length>0?Re(m.__webglFramebuffer[0],v,0):Re(m.__webglFramebuffer,v,0)}else if(L){m.__webglDepthbuffer=[];for(let k=0;k<6;k++)if(t.bindFramebuffer(n.FRAMEBUFFER,m.__webglFramebuffer[k]),m.__webglDepthbuffer[k]===void 0)m.__webglDepthbuffer[k]=n.createRenderbuffer(),ze(m.__webglDepthbuffer[k],v,!1);else{const J=v.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,H=m.__webglDepthbuffer[k];n.bindRenderbuffer(n.RENDERBUFFER,H),n.framebufferRenderbuffer(n.FRAMEBUFFER,J,n.RENDERBUFFER,H)}}else{const k=v.texture.mipmaps;if(k&&k.length>0?t.bindFramebuffer(n.FRAMEBUFFER,m.__webglFramebuffer[0]):t.bindFramebuffer(n.FRAMEBUFFER,m.__webglFramebuffer),m.__webglDepthbuffer===void 0)m.__webglDepthbuffer=n.createRenderbuffer(),ze(m.__webglDepthbuffer,v,!1);else{const J=v.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,H=m.__webglDepthbuffer;n.bindRenderbuffer(n.RENDERBUFFER,H),n.framebufferRenderbuffer(n.FRAMEBUFFER,J,n.RENDERBUFFER,H)}}t.bindFramebuffer(n.FRAMEBUFFER,null)}function C(v,m,L){const k=i.get(v);m!==void 0&&we(k.__webglFramebuffer,v,v.texture,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,0),L!==void 0&&Ke(v)}function I(v){const m=v.texture,L=i.get(v),k=i.get(m);v.addEventListener("dispose",P);const J=v.textures,H=v.isWebGLCubeRenderTarget===!0,Me=J.length>1;if(Me||(k.__webglTexture===void 0&&(k.__webglTexture=n.createTexture()),k.__version=m.version,a.memory.textures++),H){L.__webglFramebuffer=[];for(let fe=0;fe<6;fe++)if(m.mipmaps&&m.mipmaps.length>0){L.__webglFramebuffer[fe]=[];for(let be=0;be<m.mipmaps.length;be++)L.__webglFramebuffer[fe][be]=n.createFramebuffer()}else L.__webglFramebuffer[fe]=n.createFramebuffer()}else{if(m.mipmaps&&m.mipmaps.length>0){L.__webglFramebuffer=[];for(let fe=0;fe<m.mipmaps.length;fe++)L.__webglFramebuffer[fe]=n.createFramebuffer()}else L.__webglFramebuffer=n.createFramebuffer();if(Me)for(let fe=0,be=J.length;fe<be;fe++){const Le=i.get(J[fe]);Le.__webglTexture===void 0&&(Le.__webglTexture=n.createTexture(),a.memory.textures++)}if(v.samples>0&&le(v)===!1){L.__webglMultisampledFramebuffer=n.createFramebuffer(),L.__webglColorRenderbuffer=[],t.bindFramebuffer(n.FRAMEBUFFER,L.__webglMultisampledFramebuffer);for(let fe=0;fe<J.length;fe++){const be=J[fe];L.__webglColorRenderbuffer[fe]=n.createRenderbuffer(),n.bindRenderbuffer(n.RENDERBUFFER,L.__webglColorRenderbuffer[fe]);const Le=s.convert(be.format,be.colorSpace),ue=s.convert(be.type),ge=A(be.internalFormat,Le,ue,be.colorSpace,v.isXRRenderTarget===!0),xe=b(v);n.renderbufferStorageMultisample(n.RENDERBUFFER,xe,ge,v.width,v.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+fe,n.RENDERBUFFER,L.__webglColorRenderbuffer[fe])}n.bindRenderbuffer(n.RENDERBUFFER,null),v.depthBuffer&&(L.__webglDepthRenderbuffer=n.createRenderbuffer(),ze(L.__webglDepthRenderbuffer,v,!0)),t.bindFramebuffer(n.FRAMEBUFFER,null)}}if(H){t.bindTexture(n.TEXTURE_CUBE_MAP,k.__webglTexture),De(n.TEXTURE_CUBE_MAP,m);for(let fe=0;fe<6;fe++)if(m.mipmaps&&m.mipmaps.length>0)for(let be=0;be<m.mipmaps.length;be++)we(L.__webglFramebuffer[fe][be],v,m,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+fe,be);else we(L.__webglFramebuffer[fe],v,m,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+fe,0);g(m)&&d(n.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(Me){for(let fe=0,be=J.length;fe<be;fe++){const Le=J[fe],ue=i.get(Le);let ge=n.TEXTURE_2D;(v.isWebGL3DRenderTarget||v.isWebGLArrayRenderTarget)&&(ge=v.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(ge,ue.__webglTexture),De(ge,Le),we(L.__webglFramebuffer,v,Le,n.COLOR_ATTACHMENT0+fe,ge,0),g(Le)&&d(ge)}t.unbindTexture()}else{let fe=n.TEXTURE_2D;if((v.isWebGL3DRenderTarget||v.isWebGLArrayRenderTarget)&&(fe=v.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(fe,k.__webglTexture),De(fe,m),m.mipmaps&&m.mipmaps.length>0)for(let be=0;be<m.mipmaps.length;be++)we(L.__webglFramebuffer[be],v,m,n.COLOR_ATTACHMENT0,fe,be);else we(L.__webglFramebuffer,v,m,n.COLOR_ATTACHMENT0,fe,0);g(m)&&d(fe),t.unbindTexture()}v.depthBuffer&&Ke(v)}function G(v){const m=v.textures;for(let L=0,k=m.length;L<k;L++){const J=m[L];if(g(J)){const H=T(v),Me=i.get(J).__webglTexture;t.bindTexture(H,Me),d(H),t.unbindTexture()}}}const ee=[],j=[];function ie(v){if(v.samples>0){if(le(v)===!1){const m=v.textures,L=v.width,k=v.height;let J=n.COLOR_BUFFER_BIT;const H=v.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,Me=i.get(v),fe=m.length>1;if(fe)for(let Le=0;Le<m.length;Le++)t.bindFramebuffer(n.FRAMEBUFFER,Me.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+Le,n.RENDERBUFFER,null),t.bindFramebuffer(n.FRAMEBUFFER,Me.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+Le,n.TEXTURE_2D,null,0);t.bindFramebuffer(n.READ_FRAMEBUFFER,Me.__webglMultisampledFramebuffer);const be=v.texture.mipmaps;be&&be.length>0?t.bindFramebuffer(n.DRAW_FRAMEBUFFER,Me.__webglFramebuffer[0]):t.bindFramebuffer(n.DRAW_FRAMEBUFFER,Me.__webglFramebuffer);for(let Le=0;Le<m.length;Le++){if(v.resolveDepthBuffer&&(v.depthBuffer&&(J|=n.DEPTH_BUFFER_BIT),v.stencilBuffer&&v.resolveStencilBuffer&&(J|=n.STENCIL_BUFFER_BIT)),fe){n.framebufferRenderbuffer(n.READ_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.RENDERBUFFER,Me.__webglColorRenderbuffer[Le]);const ue=i.get(m[Le]).__webglTexture;n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,ue,0)}n.blitFramebuffer(0,0,L,k,0,0,L,k,J,n.NEAREST),l===!0&&(ee.length=0,j.length=0,ee.push(n.COLOR_ATTACHMENT0+Le),v.depthBuffer&&v.resolveDepthBuffer===!1&&(ee.push(H),j.push(H),n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,j)),n.invalidateFramebuffer(n.READ_FRAMEBUFFER,ee))}if(t.bindFramebuffer(n.READ_FRAMEBUFFER,null),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),fe)for(let Le=0;Le<m.length;Le++){t.bindFramebuffer(n.FRAMEBUFFER,Me.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+Le,n.RENDERBUFFER,Me.__webglColorRenderbuffer[Le]);const ue=i.get(m[Le]).__webglTexture;t.bindFramebuffer(n.FRAMEBUFFER,Me.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+Le,n.TEXTURE_2D,ue,0)}t.bindFramebuffer(n.DRAW_FRAMEBUFFER,Me.__webglMultisampledFramebuffer)}else if(v.depthBuffer&&v.resolveDepthBuffer===!1&&l){const m=v.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,[m])}}}function b(v){return Math.min(r.maxSamples,v.samples)}function le(v){const m=i.get(v);return v.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&m.__useRenderToTexture!==!1}function re(v){const m=a.render.frame;u.get(v)!==m&&(u.set(v,m),v.update())}function Q(v,m){const L=v.colorSpace,k=v.format,J=v.type;return v.isCompressedTexture===!0||v.isVideoTexture===!0||L!==pr&&L!==ci&&(je.getTransfer(L)===st?(k!==un||J!==tn)&&He("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Je("WebGLTextures: Unsupported texture color space:",L)),m}function se(v){return typeof HTMLImageElement<"u"&&v instanceof HTMLImageElement?(c.width=v.naturalWidth||v.width,c.height=v.naturalHeight||v.height):typeof VideoFrame<"u"&&v instanceof VideoFrame?(c.width=v.displayWidth,c.height=v.displayHeight):(c.width=v.width,c.height=v.height),c}this.allocateTextureUnit=W,this.resetTextureUnits=Z,this.setTexture2D=Y,this.setTexture2DArray=U,this.setTexture3D=D,this.setTextureCube=N,this.rebindTextures=C,this.setupRenderTarget=I,this.updateRenderTargetMipmap=G,this.updateMultisampleRenderTarget=ie,this.setupDepthRenderbuffer=Ke,this.setupFrameBufferTexture=we,this.useMultisampledRTT=le,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function Zv(n,e){function t(i,r=ci){let s;const a=je.getTransfer(r);if(i===tn)return n.UNSIGNED_BYTE;if(i===Fl)return n.UNSIGNED_SHORT_4_4_4_4;if(i===Ol)return n.UNSIGNED_SHORT_5_5_5_1;if(i===Gf)return n.UNSIGNED_INT_5_9_9_9_REV;if(i===kf)return n.UNSIGNED_INT_10F_11F_11F_REV;if(i===Vf)return n.BYTE;if(i===Hf)return n.SHORT;if(i===qr)return n.UNSIGNED_SHORT;if(i===Nl)return n.INT;if(i===Rn)return n.UNSIGNED_INT;if(i===Mn)return n.FLOAT;if(i===Kn)return n.HALF_FLOAT;if(i===Wf)return n.ALPHA;if(i===Xf)return n.RGB;if(i===un)return n.RGBA;if(i===jn)return n.DEPTH_COMPONENT;if(i===Li)return n.DEPTH_STENCIL;if(i===qf)return n.RED;if(i===Bl)return n.RED_INTEGER;if(i===dr)return n.RG;if(i===zl)return n.RG_INTEGER;if(i===Vl)return n.RGBA_INTEGER;if(i===Fs||i===Os||i===Bs||i===zs)if(a===st)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(i===Fs)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===Os)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===Bs)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===zs)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(i===Fs)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===Os)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===Bs)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===zs)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===Do||i===Lo||i===Io||i===Uo)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(i===Do)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===Lo)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===Io)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===Uo)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===No||i===Fo||i===Oo||i===Bo||i===zo||i===Vo||i===Ho)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(i===No||i===Fo)return a===st?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(i===Oo)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC;if(i===Bo)return s.COMPRESSED_R11_EAC;if(i===zo)return s.COMPRESSED_SIGNED_R11_EAC;if(i===Vo)return s.COMPRESSED_RG11_EAC;if(i===Ho)return s.COMPRESSED_SIGNED_RG11_EAC}else return null;if(i===Go||i===ko||i===Wo||i===Xo||i===qo||i===Yo||i===$o||i===Ko||i===jo||i===Zo||i===Jo||i===Qo||i===el||i===tl)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(i===Go)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===ko)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===Wo)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===Xo)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===qo)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===Yo)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===$o)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===Ko)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===jo)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===Zo)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===Jo)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===Qo)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===el)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===tl)return a===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===nl||i===il||i===rl)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(i===nl)return a===st?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===il)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===rl)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===sl||i===al||i===ol||i===ll)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(i===sl)return s.COMPRESSED_RED_RGTC1_EXT;if(i===al)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===ol)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===ll)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===Yr?n.UNSIGNED_INT_24_8:n[i]!==void 0?n[i]:null}return{convert:t}}const Jv=`
void main() {
...
}`;class eS{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){const i=new oh(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=i}}getMesh(e){if(this.texture!==null&&this.mesh===null){const t=e.cameras[0].viewport,i=new Cn({vertexShader:Jv,fragmentShader:Qv,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new Jn(new ca(20,20),i)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class tS extends gr{constructor(e,t){super();const i=this;let r=null,s=1,a=null,o="local-floor",l=1,c=null,u=null,f=null,h=null,p=null,_=null;const x=typeof XRWebGLBinding<"u",g=new eS,d={},T=t.getContextAttributes();let A=null,y=null;const w=[],R=[],P=new ot;let z=null;const M=new en;M.viewport=new gt;const E=new en;E.viewport=new gt;const F=[M,E],Z=new fg;let W=null,K=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(te){let oe=w[te];return oe===void 0&&(oe=new ja,w[te]=oe),oe.getTargetRaySpace()},this.getControllerGrip=function(te){let oe=w[te];return oe===void 0&&(oe=new ja,w[te]=oe),oe.getGripSpace()},this.getHand=function(te){let oe=w[te];return oe===void 0&&(oe=new ja,w[te]=oe),oe.getHandSpace()};function Y(te){const oe=R.indexOf(te.inputSource);if(oe===-1)return;const we=w[oe];we!==void 0&&(we.update(te.inputSource,te.frame,c||a),we.dispatchEvent({type:te.type,data:te.inputSource}))}function U(){r.removeEventListener("select",Y),r.removeEventListener("selectstart",Y),r.removeEventListener("selectend",Y),r.removeEventListener("squeeze",Y),r.removeEventListener("squeezestart",Y),r.removeEventListener("squeezeend",Y),r.removeEventListener("end",U),r.removeEventListener("inputsourceschange",D);for(let te=0;te<w.length;te++){const oe=R[te];oe!==null&&(R[te]=null,w[te].disconnect(oe))}W=null,K=null,g.reset();for(const te in d)delete d[te];e.setRenderTarget(A),p=null,h=null,f=null,r=null,y=null,Qe.stop(),i.isPresenting=!1,e.setPixelRatio(z),e.setSize(P.width,P.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(te){s=te,i.isPresenting===!0&&He("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(te){o=te,i.isPresenting===!0&&He("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(te){c=te},this.getBaseLayer=function(){return h!==null?h:p},this.getBinding=function(){return f===null&&x&&(f=new XRWebGLBinding(r,t)),f},this.getFrame=function(){return _},this.getSession=function(){return r},this.setSession=async function(te){if(r=te,r!==null){if(A=e.getRenderTarget(),r.addEventListener("select",Y),r.addEventListener("selectstart",Y),r.addEventListener("selectend",Y),r.addEventListener("squeeze",Y),r.addEventListener("squeezestart",Y),r.addEventListener("squeezeend",Y),r.addEventListener("end",U),r.addEventListener("inputsourceschange",D),T.xrCompatible!==!0&&await t.makeXRCompatible(),z=e.getPixelRatio(),e.getSize(P),x&&"createProjectionLayer"in XRWebGLBinding.prototype){let we=null,ze=null,Re=null;T.depth&&(Re=T.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,we=T.stencil?Li:jn,ze=T.stencil?Yr:Rn);const Ke={colorFormat:t.RGBA8,depthFormat:Re,scaleFactor:s};f=this.getBinding(),h=f.createProjectionLayer(Ke),r.updateRenderState({layers:[h]}),e.setPixelRatio(1),e.setSize(h.textureWidth,h.textureHeight,!1),y=new An(h.textureWidth,h.textureHeight,{format:un,type:tn,depthTexture:new jr(h.textureWidth,h.textureHeight,ze,void 0,void 0,void 0,void 0,void 0,void 0,we),stencilBuffer:T.stencil,colorSpace:e.outputColorSpace,samples:T.antialias?4:0,resolveDepthBuffer:h.ignoreDepthValues===!1,resolveStencilBuffer:h.ignoreDepthValues===!1})}else{const we={antialias:T.antialias,alpha:!0,depth:T.depth,stencil:T.stencil,framebufferScaleFactor:s};p=new XRWebGLLayer(r,t,we),r.updateRenderState({baseLayer:p}),e.setPixelRatio(1),e.setSize(p.framebufferWidth,p.framebufferHeight,!1),y=new An(p.framebufferWidth,p.framebufferHeight,{format:un,type:tn,colorSpace:e.outputColorSpace,stencilBuffer:T.stencil,resolveDepthBuffer:p.ignoreDepthValues===!1,resolveStencilBuffer:p.ignoreDepthValues===!1})}y.isXRRenderTarget=!0,this.setFoveation(l),c=null,a=await r.requestReferenceSpace(o),Qe.setContext(r),Qe.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return g.getDepthTexture()};function D(te){for(let oe=0;oe<te.removed.length;oe++){const we=te.removed[oe],ze=R.indexOf(we);ze>=0&&(R[ze]=null,w[ze].disconnect(we))}for(let oe=0;oe<te.added.length;oe++){const we=te.added[oe];let ze=R.indexOf(we);if(ze===-1){for(let Ke=0;Ke<w.length;Ke++)if(Ke>=R.length){R.push(we),ze=Ke;break}else if(R[Ke]===null){R[Ke]=we,ze=Ke;break}if(ze===-1)break}const Re=w[ze];Re&&Re.connect(we)}}const N=new X,ne=new X;function ce(te,oe,we){N.setFromMatrixPosition(oe.matrixWorld),ne.setFromMatrixPosition(we.matrixWorld);const ze=N.distanceTo(ne),Re=oe.projectionMatrix.elements,Ke=we.projectionMatrix.elements,C=Re[14]/(Re[10]-1),I=Re[14]/(Re[10]+1),G=(Re[9]+1)/Re[5],ee=(Re[9]-1)/Re[5],j=(Re[8]-1)/Re[0],ie=(Ke[8]+1)/Ke[0],b=C*j,le=C*ie,re=ze/(-j+ie),Q=re*-j;if(oe.matrixWorld.decompose(te.position,te.quaternion,te.scale),te.translateX(Q),te.translateZ(re),te.matrixWorld.compose(te.position,te.quaternion,te.scale),te.matrixWorldInverse.copy(te.matrixWorld).invert(),Re[10]===-1)te.projectionMatrix.copy(oe.projectionMatrix),te.projectionMatrixInverse.copy(oe.projectionMatrixInverse);else{const se=C+re,v=I+re,m=b-Q,L=le+(ze-Q),k=G*I/v*se,J=ee*I/v*se;te.projectionMatrix.makePerspective(m,L,k,J,se,v),te.projectionMatrixInverse.copy(te.projectionMatrix).invert()}}function de(te,oe){oe===null?te.matrixWorld.copy(te.matrix):te.matrixWorld.multiplyMatrices(oe.matrixWorld,te.matrix),te.matrixWorldInverse.copy(te.matrixWorld).invert()}this.updateCamera=function(te){if(r===null)return;let oe=te.near,we=te.far;g.texture!==null&&(g.depthNear>0&&(oe=g.depthNear),g.depthFar>0&&(we=g.depthFar)),Z.near=E.near=M.near=oe,Z.far=E.far=M.far=we,(W!==Z.near||K!==Z.far)&&(r.updateRenderState({depthNear:Z.near,depthFar:Z.far}),W=Z.near,K=Z.far),Z.layers.mask=te.layers.mask|6,M.layers.mask=Z.layers.mask&3,E.layers.mask=Z.layers.mask&5;const ze=te.parent,Re=Z.cameras;de(Z,ze);for(let Ke=0;Ke<Re.length;Ke++)de(Re[Ke],ze);Re.length===2?ce(Z,M,E):Z.projectionMatrix.copy(M.projectionMatrix),De(te,Z,ze)};function De(te,oe,we){we===null?te.matrix.copy(oe.matrixWorld):(te.matrix.copy(we.matrixWorld),te.matrix.invert(),te.matrix.multiply(oe.matrixWorld)),te.matrix.decompose(te.position,te.quaternion,te.scale),te.updateMatrixWorld(!0),te.projectionMatrix.copy(oe.projectionMatrix),te.projectionMatrixInverse.copy(oe.projectionMatrixInverse),te.isPerspectiveCamera&&(te.fov=cl*2*Math.atan(1/te.projectionMatrix.elements[5]),te.zoom=1)}this.getCamera=function(){return Z},this.getFoveation=function(){if(!(h===null&&p===null))return l},this.setFoveation=function(te){l=te,h!==null&&(h.fixedFoveation=te),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=te)},this.hasDepthSensing=function(){return g.texture!==null},this.getDepthSensingMesh=function(){return g.getMesh(Z)},this.getCameraTexture=function(te){return d[te]};let Fe=null;function Oe(te,oe){if(u=oe.getViewerPose(c||a),_=oe,u!==null){const we=u.views;p!==null&&(e.setRenderTargetFramebuffer(y,p.framebuffer),e.setRenderTarget(y));let ze=!1;we.length!==Z.cameras.length&&(Z.cameras.length=0,ze=!0);for(let I=0;I<we.length;I++){const G=we[I];let ee=null;if(p!==null)ee=p.getViewport(G);else{const ie=f.getViewSubImage(h,G);ee=ie.viewport,I===0&&(e.setRenderTargetTextures(y,ie.colorTexture,ie.depthStencilTexture),e.setRenderTarget(y))}let j=F[I];j===void 0&&(j=new en,j.layers.enable(I),j.viewport=new gt,F[I]=j),j.matrix.fromArray(G.transform.matrix),j.matrix.decompose(j.position,j.quaternion,j.scale),j.projectionMatrix.fromArray(G.projectionMatrix),j.projectionMatrixInverse.copy(j.projectionMatrix).invert(),j.viewport.set(ee.x,ee.y,ee.width,ee.height),I===0&&(Z.matrix.copy(j.matrix),Z.matrix.decompose(Z.position,Z.quaternion,Z.scale)),ze===!0&&Z.cameras.push(j)}const Re=r.enabledFeatures;if(Re&&Re.includes("depth-sensing")&&r.depthUsage=="gpu-optimized"&&x){f=i.getBinding();const I=f.getDepthInformation(we[0]);I&&I.isValid&&I.texture&&g.init(I,r.renderState)}if(Re&&Re.includes("camera-access")&&x){e.state.unbindTexture(),f=i.getBinding();for(let I=0;I<we.length;I++){const G=we[I].camera;if(G){let ee=d[G];ee||(ee=new oh,d[G]=ee);const j=f.getCameraImage(G);ee.sourceTexture=j}}}}for(let we=0;we<w.length;we++){const ze=R[we],Re=w[we];ze!==null&&Re!==void 0&&Re.update(ze,oe,c||a)}Fe&&Fe(te,oe),oe.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:oe}),_=null}const Qe=new ch;Qe.setAnimationLoop(Oe),this.setAnimationLoop=function(te){Fe=te},this.dispose=function(){}}}const Ai=new Zn,nS=new _t;function iS(n,e){function t(g,d){g.matrixAutoUpdate===!0&&g.updateMatrix(),d.value.copy(g.matrix)}function i(g,d){d.color.getRGB(g.fogColor.value,th(n)),d.isFog?(g.fogNear.value=d.near,g.fogFar.value=d.far):d.isFogExp2&&(g.fogDensity.value=d.density)}function r(g,d,T,A,y){d.isMeshBasicMaterial||d.isMeshLambertMaterial?s(g,d):d.isMeshToonMaterial?(s(g,d),f(g,d)):d.isMeshPhongMaterial?(s(g,d),u(g,d)):d.isMeshStandardMaterial?(s(g,d),h(g,d),d.isMeshPhysicalMaterial&&p(g,d,y)):d.isMeshMatcapMaterial?(s(g,d),_(g,d)):d.isMeshDepthMaterial?s(g,d):d.isMeshDistanceMaterial?(s(g,d),x(g,d)):d.isMeshNormalMaterial?s(g,d):d.isLineBasicMaterial?(a(g,d),d.isLineDashedMaterial&&o(g,d)):d.isPointsMaterial?l(g,d,T,A):d.isSpriteMaterial?c(g,d):d.isShadowMaterial?(g.color.value.copy(d.color),g.opacity.value=d.opacity):d.isShaderMaterial&&(d.uniformsNeedUpdate=!1)}function s(g,d){g.opacity.value=d.opacity,d.color&&g.diffuse.value.copy(d.color),d.emissive&&g.emissive.value.copy(d.emissive).multiplyScalar(d.emissiveIntensity),d.map&&(g.map.value=d.map,t(d.map,g.mapTransform)),d.alphaMap&&(g.alphaMap.value=d.alphaMap,t(d.alphaMap,g.alphaMapTransform)),d.bumpMap&&(g.bumpMap.value=d.bumpMap,t(d.bumpMap,g.bumpMapTransform),g.bumpScale.value=d.bumpScale,d.side===Ht&&(g.bumpScale.value*=-1)),d.normalMap&&(g.normalMap.value=d.normalMap,t(d.normalMap,g.normalMapTransform),g.normalScale.value.copy(d.normalScale),d.side===Ht&&g.normalScale.value.negate()),d.displacementMap&&(g.displacementMap.value=d.displacementMap,t(d.displacementMap,g.displacementMapTransform),g.displacementScale.value=d.displacementScale,g.displacementBias.value=d.displacementBias),d.emissiveMap&&(g.emissiveMap.value=d.emissiveMap,t(d.emissiveMap,g.emissiveMapTransform)),d.specularMap&&(g.specularMap.value=d.specularMap,t(d.specularMap,g.specularMapTransform)),d.alphaTest>0&&(g.alphaTest.value=d.alphaTest);const T=e.get(d),A=T.envMap,y=T.envMapRotation;A&&(g.envMap.value=A,Ai.copy(y),Ai.x*=-1,Ai.y*=-1,Ai.z*=-1,A.isCubeTexture&&A.isRenderTargetTexture===!1&&(Ai.y*=-1,Ai.z*=-1),g.envMapRotation.value.setFromMatrix4(nS.makeRotationFromEuler(Ai)),g.flipEnvMap.value=A.isCubeTexture&&A.isRenderTargetTexture===!1?-1:1,g.reflectivity.value=d.reflectivity,g.ior.value=d.ior,g.refractionRatio.value=d.refractionRatio),d.lightMap&&(g.lightMap.value=d.lightMap,g.lightMapIntensity.value=d.lightMapIntensity,t(d.lightMap,g.lightMapTransform)),d.aoMap&&(g.aoMap.value=d.aoMap,g.aoMapIntensity.value=d.aoMapIntensity,t(d.aoMap,g.aoMapTransform))}function a(g,d){g.diffuse.value.copy(d.color),g.opacity.value=d.opacity,d.map&&(g.map.value=d.map,t(d.map,g.mapTransform))}function o(g,d){g.dashSize.value=d.dashSize,g.totalSize.value=d.dashSize+d.gapSize,g.scale.value=d.scale}function l(g,d,T,A){g.diffuse.value.copy(d.color),g.opacity.value=d.opacity,g.size.value=d.size*T,g.scale.value=A*.5,d.map&&(g.map.value=d.map,t(d.map,g.uvTransform)),d.alphaMap&&(g.alphaMap.value=d.alphaMap,t(d.alphaMap,g.alphaMapTransform)),d.alphaTest>0&&(g.alphaTest.value=d.alphaTest)}function c(g,d){g.diffuse.value.copy(d.color),g.opacity.value=d.opacity,g.rotation.value=d.rotation,d.map&&(g.map.value=d.map,t(d.map,g.mapTransform)),d.alphaMap&&(g.alphaMap.value=d.alphaMap,t(d.alphaMap,g.alphaMapTransform)),d.alphaTest>0&&(g.alphaTest.value=d.alphaTest)}function u(g,d){g.specular.value.copy(d.specular),g.shininess.value=Math.max(d.shininess,1e-4)}function f(g,d){d.gradientMap&&(g.gradientMap.value=d.gradientMap)}function h(g,d){g.metalness.value=d.metalness,d.metalnessMap&&(g.metalnessMap.value=d.metalnessMap,t(d.metalnessMap,g.metalnessMapTransform)),g.roughness.value=d.roughness,d.roughnessMap&&(g.roughnessMap.value=d.roughnessMap,t(d.roughnessMap,g.roughnessMapTransform)),d.envMap&&(g.envMapIntensity.value=d.envMapIntensity)}function p(g,d,T){g.ior.value=d.ior,d.sheen>0&&(g.sheenColor.value.copy(d.sheenColor).multiplyScalar(d.sheen),g.sheenRoughness.value=d.sheenRoughness,d.sheenColorMap&&(g.sheenColorMap.value=d.sheenColorMap,t(d.sheenColorMap,g.sheenColorMapTransform)),d.sheenRoughnessMap&&(g.sheenRoughnessMap.value=d.sheenRoughnessMap,t(d.sheenRoughnessMap,g.sheenRoughnessMapTransform))),d.clearcoat>0&&(g.clearcoat.value=d.clearcoat,g.clearcoatRoughness.value=d.clearcoatRoughness,d.clearcoatMap&&(g.clearcoatMap.value=d.clearcoatMap,t(d.clearcoatMap,g.clearcoatMapTransform)),d.clearcoatRoughnessMap&&(g.clearcoatRoughnessMap.value=d.clearcoatRoughnessMap,t(d.clearcoatRoughnessMap,g.clearcoatRoughnessMapTransform)),d.clearcoatNormalMap&&(g.clearcoatNormalMap.value=d.clearcoatNormalMap,t(d.clearcoatNormalMap,g.clearcoatNormalMapTransform),g.clearcoatNormalScale.value.copy(d.clearcoatNormalScale),d.side===Ht&&g.clearcoatNormalScale.value.negate())),d.dispersion>0&&(g.dispersion.value=d.dispersion),d.iridescence>0&&(g.iridescence.value=d.iridescence,g.iridescenceIOR.value=d.iridescenceIOR,g.iridescenceThicknessMinimum.value=d.iridescenceThicknessRange[0],g.iridescenceThicknessMaximum.value=d.iridescenceThicknessRange[1],d.iridescenceMap&&(g.iridescenceMap.value=d.iridescenceMap,t(d.iridescenceMap,g.iridescenceMapTransform)),d.iridescenceThicknessMap&&(g.iridescenceThicknessMap.value=d.iridescenceThicknessMap,t(d.iridescenceThicknessMap,g.iridescenceThicknessMapTransform))),d.transmission>0&&(g.transmission.value=d.transmission,g.transmissionSamplerMap.value=T.texture,g.transmissionSamplerSize.value.set(T.width,T.height),d.transmissionMap&&(g.transmissionMap.value=d.transmissionMap,t(d.transmissionMap,g.transmissionMapTransform)),g.thickness.value=d.thickness,d.thicknessMap&&(g.thicknessMap.value=d.thicknessMap,t(d.thicknessMap,g.thicknessMapTransform)),g.attenuationDistance.value=d.attenuationDistance,g.attenuationColor.value.copy(d.attenuationColor)),d.anisotropy>0&&(g.anisotropyVector.value.set(d.anisotropy*Math.cos(d.anisotropyRotation),d.anisotropy*Math.sin(d.anisotropyRotation)),d.anisotropyMap&&(g.anisotropyMap.value=d.anisotropyMap,t(d.anisotropyMap,g.anisotropyMapTransform))),g.specularIntensity.value=d.specularIntensity,g.specularColor.value.copy(d.specularColor),d.specularColorMap&&(g.specularColorMap.value=d.specularColorMap,t(d.specularColorMap,g.specularColorMapTransform)),d.specularIntensityMap&&(g.specularIntensityMap.value=d.specularIntensityMap,t(d.specularIntensityMap,g.specularIntensityMapTransform))}function _(g,d){d.matcap&&(g.matcap.value=d.matcap)}function x(g,d){const T=e.get(d).light;g.referencePosition.value.setFromMatrixPosition(T.matrixWorld),g.nearDistance.value=T.shadow.camera.near,g.farDistance.value=T.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:r}}function rS(n,e,t,i){let r={},s={},a=[];const o=n.getParameter(n.MAX_UNIFORM_BUFFER_BINDINGS);function l(T,A){const y=A.program;i.uniformBlockBinding(T,y)}function c(T,A){let y=r[T.id];y===void 0&&(_(T),y=u(T),r[T.id]=y,T.addEventListener("dispose",g));const w=A.program;i.updateUBOMapping(T,w);const R=e.render.frame;s[T.id]!==R&&(h(T),s[T.id]=R)}function u(T){const A=f();T.__bindingPointIndex=A;const y=n.createBuffer(),w=T.__size,R=T.usage;return n.bindBuffer(n.UNIFORM_BUFFER,y),n.bufferData(n.UNIFORM_BUFFER,w,R),n.bindBuffer(n.UNIFORM_BUFFER,null),n.bindBufferBase(n.UNIFORM_BUFFER,A,y),y}function f(){for(let T=0;T<o;T++)if(a.indexOf(T)===-1)return a.push(T),T;return Je("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function h(T){const A=r[T.id],y=T.uniforms,w=T.__cache;n.bindBuffer(n.UNIFORM_BUFFER,A);for(let R=0,P=y.length;R<P;R++){const z=Array.isArray(y[R])?y[R]:[y[R]];for(let M=0,E=z.length;M<E;M++){const F=z[M];if(p(F,R,M,w)===!0){const Z=F.__offset,W=Array.isArray(F.value)?F.value:[F.value];let K=0;for(let Y=0;Y<W.length;Y++){const U=W[Y],D=x(U);typeof U=="number"||typeof U=="boolean"?(F.__data[0]=U,n.bufferSubData(n.UNIFORM_BUFFER,Z+K,F.__data)):U.isMatrix3?(F.__data[0]=U.elements[0],F.__data[1]=U.elements[1],F.__data[2]=U.elements[2],F.__data[3]=0,F.__data[4]=U.elements[3],F.__data[5]=U.elements[4],F.__data[6]=U.elements[5],F.__data[7]=0,F.__data[8]=U.elements[6],F.__data[9]=U.elements[7],F.__data[10]=U.elements[8],F.__data[11]=0):(U.toArray(F.__data,K),K+=D.storage/Float32Array.BYTES_PER_ELEMENT)}n.bufferSubData(n.UNIFORM_BUFFER,Z,F.__data)}}}n.bindBuffer(n.UNIFORM_BUFFER,null)}function p(T,A,y,w){const R=T.value,P=A+"_"+y;if(w[P]===void 0)return typeof R=="number"||typeof R=="boolean"?w[P]=R:w[P]=R.clone(),!0;{const z=w[P];if(typeof R=="number"||typeof R=="boolean"){if(z!==R)return w[P]=R,!0}else if(z.equals(R)===!1)return z.copy(R),!0}return!1}function _(T){const A=T.uniforms;let y=0;const w=16;for(let P=0,z=A.length;P<z;P++){const M=Array.isArray(A[P])?A[P]:[A[P]];for(let E=0,F=M.length;E<F;E++){const Z=M[E],W=Array.isArray(Z.value)?Z.value:[Z.value];for(let K=0,Y=W.length;K<Y;K++){const U=W[K],D=x(U),N=y%w,ne=N%D.boundary,ce=N+ne;y+=ne,ce!==0&&w-ce<D.storage&&(y+=w-ce),Z.__data=new Float32Array(D.storage/Float32Array.BYTES_PER_ELEMENT),Z.__offset=y,y+=D.storage}}}const R=y%w;return R>0&&(y+=w-R),T.__size=y,T.__cache={},this}function x(T){const A={boundary:0,storage:0};return typeof T=="number"||typeof T=="boolean"?(A.boundary=4,A.storage=4):T.isVector2?(A.boundary=8,A.storage=8):T.isVector3||T.isColor?(A.boundary=16,A.storage=12):T.isVector4?(A.boundary=16,A.storage=16):T.isMatrix3?(A.boundary=48,A.storage=48):T.isMatrix4?(A.boundary=64,A.storage=64):T.isTexture?He("WebGLRenderer: Texture samplers can not be part of an uniforms group."):He("WebGLRenderer: Unsupported uniform value type.",T),A}function g(T){const A=T.target;A.removeEventListener("dispose",g);const y=a.indexOf(A.__bindingPointIndex);a.splice(y,1),n.deleteBuffer(r[A.id]),delete r[A.id],delete s[A.id]}function d(){for(const T in r)n.deleteBuffer(r[T]);a=[],r={},s={}}return{bind:l,update:c,dispose:d}}const sS=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]);let gn=null;function aS(){return gn===null&&(gn=new Jm(sS,16,16,dr,Kn),gn.name="DFG_LUT",gn.minFilter=Rt,gn.magFilter=Rt,gn.wrapS=Hn,gn.wrapT=Hn,gn.generateMipmaps=!1,gn.needsUpdate=!0),gn}class oS{constructor(e={}){const{canvas:t=Tm(),context:i=null,depth:r=!0,stencil:s=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:u="default",failIfMajorPerformanceCaveat:f=!1,reversedDepthBuffer:h=!1,outputBufferType:p=tn}=e;this.isWebGLRenderer=!0;let _;if(i!==null){if(typeof WebGLRenderingContext<"u"&&i instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");_=i.getContextAttributes().alpha}else _=a;const x=p,g=new Set([Vl,zl,Bl]),d=new Set([tn,Rn,qr,Yr,Fl,Ol]),T=new Uint32Array(4),A=new Int32Array(4);let y=null,w=null;const R=[],P=[];let z=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=Tn,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const M=this;let E=!1;this._outputColorSpace=Qt;let F=0,Z=0,W=null,K=-1,Y=null;const U=new gt,D=new gt;let N=null;const ne=new nt(0);let ce=0,de=t.width,De=t.height,Fe=1,Oe=null,Qe=null;const te=new gt(0,0,de,De),oe=new gt(0,0,de,De);let we=!1;const ze=new sh;let Re=!1,Ke=!1;const C=new _t,I=new X,G=new gt,ee={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let j=!1;function ie(){return W===null?Fe:1}let b=i;function le(S,B){return t.getContext(S,B)}try{const S={alpha:!0,depth:r,stencil:s,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:u,failIfMajorPerformanceCaveat:f};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${Ul}`),t.addEventListener("webglcontextlost",Ve,!1),t.addEventListener("webglcontextrestored",ut,!1),t.addEventListener("webglcontextcreationerror",it,!1),b===null){const B="webgl2";if(b=le(B,S),b===null)throw le(B)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(S){throw Je("WebGLRenderer: "+S.message),S}let re,Q,se,v,m,L,k,J,H,Me,fe,be,Le,ue,ge,xe,Te,me,Ge,O,ye,pe,Ae,he;function ae(){re=new ax(b),re.init(),pe=new Zv(b,re),Q=new Z0(b,re,e,pe),se=new Kv(b,re),Q.reversedDepthBuffer&&h&&se.buffers.depth.setReversed(!0),v=new cx(b),m=new Uv,L=new jv(b,re,se,m,Q,pe,v),k=new Q0(M),J=new sx(M),H=new dg(b),Ae=new K0(b,H),Me=new ox(b,H,v,Ae),fe=new fx(b,Me,H,v),Ge=new ux(b,Q,L),xe=new J0(m),be=new Iv(M,k,J,re,Q,Ae,xe),Le=new iS(M,m),ue=new Fv,ge=new Gv(re),me=new $0(M,k,J,se,fe,_,l),Te=new Yv(M,fe,Q),he=new rS(b,v,Q,se),O=new j0(b,re,v),ye=new lx(b,re,v),v.programs=be.programs,M.capabilities=Q,M.extensions=re,M.properties=m,M.renderLists=ue,M.shadowMap=Te,M.state=se,M.info=v}ae(),x!==tn&&(z=new dx(x,t.width,t.height,r,s));const _e=new tS(M,b);this.xr=_e,this.getContext=function(){return b},this.getContextAttributes=function(){return b.getContextAttributes()},this.forceContextLoss=function(){const S=re.get("WEBGL_lose_context");S&&S.loseContext()},this.forceContextRestore=function(){const S=re.get("WEBGL_lose_context");S&&S.restoreContext()},this.getPixelRatio=function(){return Fe},this.setPixelRatio=function(S){S!==void 0&&(Fe=S,this.setSize(de,De,!1))},this.getSize=function(S){return S.set(de,De)},this.setSize=function(S,B,$=!0){if(_e.isPresenting){He("WebGLRenderer: Can't change size while VR device is presenting.");return}de=S,De=B,t.width=Math.floor(S*Fe),t.height=Math.floor(B*Fe),$===!0&&(t.style.width=S+"px",t.style.height=B+"px"),z!==null&&z.setSize(t.width,t.height),this.setViewport(0,0,S,B)},this.getDrawingBufferSize=function(S){return S.set(de*Fe,De*Fe).floor()},this.setDrawingBufferSize=function(S,B,$){de=S,De=B,Fe=$,t.width=Math.floor(S*$),t.height=Math.floor(B*$),this.setViewport(0,0,S,B)},this.setEffects=function(S){if(x===tn){console.error("THREE.WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(S){for(let B=0;B<S.length;B++)if(S[B].isOutputPass===!0){console.warn("THREE.WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}z.setEffects(S||[])},this.getCurrentViewport=function(S){return S.copy(U)},this.getViewport=function(S){return S.copy(te)},this.setViewport=function(S,B,$,q){S.isVector4?te.set(S.x,S.y,S.z,S.w):te.set(S,B,$,q),se.viewport(U.copy(te).multiplyScalar(Fe).round())},this.getScissor=function(S){return S.copy(oe)},this.setScissor=function(S,B,$,q){S.isVector4?oe.set(S.x,S.y,S.z,S.w):oe.set(S,B,$,q),se.scissor(D.copy(oe).multiplyScalar(Fe).round())},this.getScissorTest=function(){return we},this.setScissorTest=function(S){se.setScissorTest(we=S)},this.setOpaqueSort=function(S){Oe=S},this.setTransparentSort=function(S){Qe=S},this.getClearColor=function(S){return S.copy(me.getClearColor())},this.setClearColor=function(){me.setClearColor(...arguments)},this.getClearAlpha=function(){return me.getClearAlpha()},this.setClearAlpha=function(){me.setClearAlpha(...arguments)},this.clear=function(S=!0,B=!0,$=!0){let q=0;if(S){let V=!1;if(W!==null){const ve=W.texture.format;V=g.has(ve)}if(V){const ve=W.texture.type,Ce=d.has(ve),Ee=me.getClearColor(),Pe=me.getClearAlpha(),Ie=Ee.r,Be=Ee.g,Ue=Ee.b;Ce?(T[0]=Ie,T[1]=Be,T[2]=Ue,T[3]=Pe,b.clearBufferuiv(b.COLOR,0,T)):(A[0]=Ie,A[1]=Be,A[2]=Ue,A[3]=Pe,b.clearBufferiv(b.COLOR,0,A))}else q|=b.COLOR_BUFFER_BIT}B&&(q|=b.DEPTH_BUFFER_BIT),$&&(q|=b.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),b.clear(q)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener("webglcontextlost",Ve,!1),t.removeEventListener("webglcontextrestored",ut,!1),t.removeEventListener("webglcontextcreationerror",it,!1),me.dispose(),ue.dispose(),ge.dispose(),m.dispose(),k.dispose(),J.dispose(),fe.dispose(),Ae.dispose(),he.dispose(),be.dispose(),_e.dispose(),_e.removeEventListener("sessionstart",Yl),_e.removeEventListener("sessionend",$l),_i.stop()};function Ve(S){S.preventDefault(),Uc("WebGLRenderer: Context Lost."),E=!0}function ut(){Uc("WebGLRenderer: Context Restored."),E=!1;const S=v.autoReset,B=Te.enabled,$=Te.autoUpdate,q=Te.needsUpdate,V=Te.type;ae(),v.autoReset=S,Te.enabled=B,Te.autoUpdate=$,Te.needsUpdate=q,Te.type=V}function it(S){Je("WebGLRenderer: A WebGL context could not be created. Reason: ",S.statusMessage)}function pn(S){const B=S.target;B.removeEventListener("dispose",pn),Pn(B)}function Pn(S){ph(S),m.remove(S)}function ph(S){const B=m.get(S).programs;B!==void 0&&(B.forEach(function($){be.releaseProgram($)}),S.isShaderMaterial&&be.releaseShaderCache(S))}this.renderBufferDirect=function(S,B,$,q,V,ve){B===null&&(B=ee);const Ce=V.isMesh&&V.matrixWorld.determinant()<0,Ee=gh(S,B,$,q,V);se.setMaterial(q,Ce);let Pe=$.index,Ie=1;if(q.wireframe===!0){if(Pe=Me.getWireframeAttribute($),Pe===void 0)return;Ie=2}const Be=$.drawRange,Ue=$.attributes.position;let Ye=Be.start*Ie,at=(Be.start+Be.count)*Ie;ve!==null&&(Ye=Math.max(Ye,ve.start*Ie),at=Math.min(at,(ve.start+ve.count)*Ie)),Pe!==null?(Ye=Math.max(Ye,0),at=Math.min(at,Pe.count)):Ue!=null&&(Ye=Math.max(Ye,0),at=Math.min(at,Ue.count));const pt=at-Ye;if(pt<0||pt===1/0)return;Ae.setup(V,q,Ee,$,Pe);let mt,lt=O;if(Pe!==null&&(mt=H.get(Pe),lt=ye,lt.setIndex(mt)),V.isMesh)q.wireframe===!0?(se.setLineWidth(q.wireframeLinewidth*ie()),lt.setMode(b.LINES)):lt.setMode(b.TRIANGLES);else if(V.isLine){let Ne=q.linewidth;Ne===void 0&&(Ne=1),se.setLineWidth(Ne*ie()),V.isLineSegments?lt.setMode(b.LINES):V.isLineLoop?lt.setMode(b.LINE_LOOP):lt.setMode(b.LINE_STRIP)}else V.isPoints?lt.setMode(b.POINTS):V.isSprite&&lt.setMode(b.TRIANGLES);if(V.isBatchedMesh)if(V._multiDrawInstances!==null)Kr("WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),lt.renderMultiDrawInstances(V._multiDrawStarts,V._multiDrawCounts,V._multiDrawCount,V._multiDrawInstances);else if(re.get("WEBGL_multi_draw"))lt.renderMultiDraw(V._multiDrawStarts,V._multiDrawCounts,V._multiDrawCount);else{const Ne=V._multiDrawStarts,rt=V._multiDrawCounts,Ze=V._multiDrawCount,kt=Pe?H.get(Pe).bytesPerElement:1,Fi=m.get(q).currentProgram.getUniforms();for(let Wt=0;Wt<Ze;Wt++)Fi.setValue(b,"_gl_DrawID",Wt),lt.render(Ne[Wt]/kt,rt[Wt])}else if(V.isInstancedMesh)lt.renderInstances(Ye,pt,V.count);else if($.isInstancedBufferGeometry){const Ne=$._maxInstanceCount!==void 0?$._maxInstanceCount:1/0,rt=Math.min($.instanceCount,Ne);lt.renderInstances(Ye,pt,rt)}else lt.render(Ye,pt)};function ql(S,B,$){S.transparent===!0&&S.side===Vn&&S.forceSinglePass===!1?(S.side=Ht,S.needsUpdate=!0,ss(S,B,$),S.side=mi,S.needsUpdate=!0,ss(S,B,$),S.side=Vn):ss(S,B,$)}this.compile=function(S,B,$=null){$===null&&($=S),w=ge.get($),w.init(B),P.push(w),$.traverseVisible(function(V){V.isLight&&V.layers.test(B.layers)&&(w.pushLight(V),V.castShadow&&w.pushShadow(V))}),S!==$&&S.traverseVisible(function(V){V.isLight&&V.layers.test(B.layers)&&(w.pushLight(V),V.castShadow&&w.pushShadow(V))}),w.setupLights();const q=new Set;return S.traverse(function(V){if(!(V.isMesh||V.isPoints||V.isLine||V.isSprite))return;const ve=V.material;if(ve)if(Array.isArray(ve))for(let Ce=0;Ce<ve.length;Ce++){const Ee=ve[Ce];ql(Ee,$,V),q.add(Ee)}else ql(ve,$,V),q.add(ve)}),w=P.pop(),q},this.compileAsync=function(S,B,$=null){const q=this.compile(S,B,$);return new Promise(V=>{function ve(){if(q.forEach(function(Ce){m.get(Ce).currentProgram.isReady()&&q.delete(Ce)}),q.size===0){V(S);return}setTimeout(ve,10)}re.get("KHR_parallel_shader_compile")!==null?ve():setTimeout(ve,10)})};let da=null;function mh(S){da&&da(S)}function Yl(){_i.stop()}function $l(){_i.start()}const _i=new ch;_i.setAnimationLoop(mh),typeof self<"u"&&_i.setContext(self),this.setAnimationLoop=function(S){da=S,_e.setAnimationLoop(S),S===null?_i.stop():_i.start()},_e.addEventListener("sessionstart",Yl),_e.addEventListener("sessionend",$l),this.render=function(S,B){if(B!==void 0&&B.isCamera!==!0){Je("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(E===!0)return;const $=_e.enabled===!0&&_e.isPresenting===!0,q=z!==null&&(W===null||$)&&z.begin(M,W);if(S.matrixWorldAutoUpdate===!0&&S.updateMatrixWorld(),B.parent===null&&B.matrixWorldAutoUpdate===!0&&B.updateMatrixWorld(),_e.enabled===!0&&_e.isPresenting===!0&&(z===null||z.isCompositing()===!1)&&(_e.cameraAutoUpdate===!0&&_e.updateCamera(B),B=_e.getCamera()),S.isScene===!0&&S.onBeforeRender(M,S,B,W),w=ge.get(S,P.length),w.init(B),P.push(w),C.multiplyMatrices(B.projectionMatrix,B.matrixWorldInverse),ze.setFromProjectionMatrix(C,En,B.reversedDepth),Ke=this.localClippingEnabled,Re=xe.init(this.clippingPlanes,Ke),y=ue.get(S,R.length),y.init(),R.push(y),_e.enabled===!0&&_e.isPresenting===!0){const Ce=M.xr.getDepthSensingMesh();Ce!==null&&pa(Ce,B,-1/0,M.sortObjects)}pa(S,B,0,M.sortObjects),y.finish(),M.sortObjects===!0&&y.sort(Oe,Qe),j=_e.enabled===!1||_e.isPresenting===!1||_e.hasDepthSensing()===!1,j&&me.addToRenderList(y,S),this.info.render.frame++,Re===!0&&xe.beginShadows();const V=w.state.shadowsArray;if(Te.render(V,S,B),Re===!0&&xe.endShadows(),this.info.autoReset===!0&&this.info.reset(),(q&&z.hasRenderPass())===!1){const Ce=y.opaque,Ee=y.transmissive;if(w.setupLights(),B.isArrayCamera){const Pe=B.cameras;if(Ee.length>0)for(let Ie=0,Be=Pe.length;Ie<Be;Ie++){const Ue=Pe[Ie];jl(Ce,Ee,S,Ue)}j&&me.render(S);for(let Ie=0,Be=Pe.length;Ie<Be;Ie++){const Ue=Pe[Ie];Kl(y,S,Ue,Ue.viewport)}}else Ee.length>0&&jl(Ce,Ee,S,B),j&&me.render(S),Kl(y,S,B)}W!==null&&Z===0&&(L.updateMultisampleRenderTarget(W),L.updateRenderTargetMipmap(W)),q&&z.end(M),S.isScene===!0&&S.onAfterRender(M,S,B),Ae.resetDefaultState(),K=-1,Y=null,P.pop(),P.length>0?(w=P[P.length-1],Re===!0&&xe.setGlobalState(M.clippingPlanes,w.state.camera)):w=null,R.pop(),R.length>0?y=R[R.length-1]:y=null};function pa(S,B,$,q){if(S.visible===!1)return;if(S.layers.test(B.layers)){if(S.isGroup)$=S.renderOrder;else if(S.isLOD)S.autoUpdate===!0&&S.update(B);else if(S.isLight)w.pushLight(S),S.castShadow&&w.pushShadow(S);else if(S.isSprite){if(!S.frustumCulled||ze.intersectsSprite(S)){q&&G.setFromMatrixPosition(S.matrixWorld).applyMatrix4(C);const Ce=fe.update(S),Ee=S.material;Ee.visible&&y.push(S,Ce,Ee,$,G.z,null)}}else if((S.isMesh||S.isLine||S.isPoints)&&(!S.frustumCulled||ze.intersectsObject(S))){const Ce=fe.update(S),Ee=S.material;if(q&&(S.boundingSphere!==void 0?(S.boundingSphere===null&&S.computeBoundingSphere(),G.copy(S.boundingSphere.center)):(Ce.boundingSphere===null&&Ce.computeBoundingSphere(),G.copy(Ce.boundingSphere.center)),G.applyMatrix4(S.matrixWorld).applyMatrix4(C)),Array.isArray(Ee)){const Pe=Ce.groups;for(let Ie=0,Be=Pe.length;Ie<Be;Ie++){const Ue=Pe[Ie],Ye=Ee[Ue.materialIndex];Ye&&Ye.visible&&y.push(S,Ce,Ye,$,G.z,Ue)}}else Ee.visible&&y.push(S,Ce,Ee,$,G.z,null)}}const ve=S.children;for(let Ce=0,Ee=ve.length;Ce<Ee;Ce++)pa(ve[Ce],B,$,q)}function Kl(S,B,$,q){const{opaque:V,transmissive:ve,transparent:Ce}=S;w.setupLightsView($),Re===!0&&xe.setGlobalState(M.clippingPlanes,$),q&&se.viewport(U.copy(q)),V.length>0&&rs(V,B,$),ve.length>0&&rs(ve,B,$),Ce.length>0&&rs(Ce,B,$),se.buffers.depth.setTest(!0),se.buffers.depth.setMask(!0),se.buffers.color.setMask(!0),se.setPolygonOffset(!1)}function jl(S,B,$,q){if(($.isScene===!0?$.overrideMaterial:null)!==null)return;if(w.state.transmissionRenderTarget[q.id]===void 0){const Ye=re.has("EXT_color_buffer_half_float")||re.has("EXT_color_buffer_float");w.state.transmissionRenderTarget[q.id]=new An(1,1,{generateMipmaps:!0,type:Ye?Kn:tn,minFilter:Di,samples:Q.samples,stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:je.workingColorSpace})}const ve=w.state.transmissionRenderTarget[q.id],Ce=q.viewport||U;ve.setSize(Ce.z*M.transmissionResolutionScale,Ce.w*M.transmissionResolutionScale);const Ee=M.getRenderTarget(),Pe=M.getActiveCubeFace(),Ie=M.getActiveMipmapLevel();M.setRenderTarget(ve),M.getClearColor(ne),ce=M.getClearAlpha(),ce<1&&M.setClearColor(16777215,.5),M.clear(),j&&me.render($);const Be=M.toneMapping;M.toneMapping=Tn;const Ue=q.viewport;if(q.viewport!==void 0&&(q.viewport=void 0),w.setupLightsView(q),Re===!0&&xe.setGlobalState(M.clippingPlanes,q),rs(S,$,q),L.updateMultisampleRenderTarget(ve),L.updateRenderTargetMipmap(ve),re.has("WEBGL_multisampled_render_to_texture")===!1){let Ye=!1;for(let at=0,pt=B.length;at<pt;at++){const mt=B[at],{object:lt,geometry:Ne,material:rt,group:Ze}=mt;if(rt.side===Vn&&lt.layers.test(q.layers)){const kt=rt.side;rt.side=Ht,rt.needsUpdate=!0,Zl(lt,$,q,Ne,rt,Ze),rt.side=kt,rt.needsUpdate=!0,Ye=!0}}Ye===!0&&(L.updateMultisampleRenderTarget(ve),L.updateRenderTargetMipmap(ve))}M.setRenderTarget(Ee,Pe,Ie),M.setClearColor(ne,ce),Ue!==void 0&&(q.viewport=Ue),M.toneMapping=Be}function rs(S,B,$){const q=B.isScene===!0?B.overrideMaterial:null;for(let V=0,ve=S.length;V<ve;V++){const Ce=S[V],{object:Ee,geometry:Pe,group:Ie}=Ce;let Be=Ce.material;Be.allowOverride===!0&&q!==null&&(Be=q),Ee.layers.test($.layers)&&Zl(Ee,B,$,Pe,Be,Ie)}}function Zl(S,B,$,q,V,ve){S.onBeforeRender(M,B,$,q,V,ve),S.modelViewMatrix.multiplyMatrices($.matrixWorldInverse,S.matrixWorld),S.normalMatrix.getNormalMatrix(S.modelViewMatrix),V.onBeforeRender(M,B,$,q,S,ve),V.transparent===!0&&V.side===Vn&&V.forceSinglePass===!1?(V.side=Ht,V.needsUpdate=!0,M.renderBufferDirect($,B,q,V,S,ve),V.side=mi,V.needsUpdate=!0,M.renderBufferDirect($,B,q,V,S,ve),V.side=Vn):M.renderBufferDirect($,B,q,V,S,ve),S.onAfterRender(M,B,$,q,V,ve)}function ss(S,B,$){B.isScene!==!0&&(B=ee);const q=m.get(S),V=w.state.lights,ve=w.state.shadowsArray,Ce=V.state.version,Ee=be.getParameters(S,V.state,ve,B,$),Pe=be.getProgramCacheKey(Ee);let Ie=q.programs;q.environment=S.isMeshStandardMaterial?B.environment:null,q.fog=B.fog,q.envMap=(S.isMeshStandardMaterial?J:k).get(S.envMap||q.environment),q.envMapRotation=q.environment!==null&&S.envMap===null?B.environmentRotation:S.envMapRotation,Ie===void 0&&(S.addEventListener("dispose",pn),Ie=new Map,q.programs=Ie);let Be=Ie.get(Pe);if(Be!==void 0){if(q.currentProgram===Be&&q.lightsStateVersion===Ce)return Ql(S,Ee),Be}else Ee.uniforms=be.getUniforms(S),S.onBeforeCompile(Ee,M),Be=be.acquireProgram(Ee,Pe),Ie.set(Pe,Be),q.uniforms=Ee.uniforms;const Ue=q.uniforms;return(!S.isShaderMaterial&&!S.isRawShaderMaterial||S.clipping===!0)&&(Ue.clippingPlanes=xe.uniform),Ql(S,Ee),q.needsLights=xh(S),q.lightsStateVersion=Ce,q.needsLights&&(Ue.ambientLightColor.value=V.state.ambient,Ue.lightProbe.value=V.state.probe,Ue.directionalLights.value=V.state.directional,Ue.directionalLightShadows.value=V.state.directionalShadow,Ue.spotLights.value=V.state.spot,Ue.spotLightShadows.value=V.state.spotShadow,Ue.rectAreaLights.value=V.state.rectArea,Ue.ltc_1.value=V.state.rectAreaLTC1,Ue.ltc_2.value=V.state.rectAreaLTC2,Ue.pointLights.value=V.state.point,Ue.pointLightShadows.value=V.state.pointShadow,Ue.hemisphereLights.value=V.state.hemi,Ue.directionalShadowMap.value=V.state.directionalShadowMap,Ue.directionalShadowMatrix.value=V.state.directionalShadowMatrix,Ue.spotShadowMap.value=V.state.spotShadowMap,Ue.spotLightMatrix.value=V.state.spotLightMatrix,Ue.spotLightMap.value=V.state.spotLightMap,Ue.pointShadowMap.value=V.state.pointShadowMap,Ue.pointShadowMatrix.value=V.state.pointShadowMatrix),q.currentProgram=Be,q.uniformsList=null,Be}function Jl(S){if(S.uniformsList===null){const B=S.currentProgram.getUniforms();S.uniformsList=Vs.seqWithValue(B.seq,S.uniforms)}return S.uniformsList}function Ql(S,B){const $=m.get(S);$.outputColorSpace=B.outputColorSpace,$.batching=B.batching,$.batchingColor=B.batchingColor,$.instancing=B.instancing,$.instancingColor=B.instancingColor,$.instancingMorph=B.instancingMorph,$.skinning=B.skinning,$.morphTargets=B.morphTargets,$.morphNormals=B.morphNormals,$.morphColors=B.morphColors,$.morphTargetsCount=B.morphTargetsCount,$.numClippingPlanes=B.numClippingPlanes,$.numIntersection=B.numClipIntersection,$.vertexAlphas=B.vertexAlphas,$.vertexTangents=B.vertexTangents,$.toneMapping=B.toneMapping}function gh(S,B,$,q,V){B.isScene!==!0&&(B=ee),L.resetTextureUnits();const ve=B.fog,Ce=q.isMeshStandardMaterial?B.environment:null,Ee=W===null?M.outputColorSpace:W.isXRRenderTarget===!0?W.texture.colorSpace:pr,Pe=(q.isMeshStandardMaterial?J:k).get(q.envMap||Ce),Ie=q.vertexColors===!0&&!!$.attributes.color&&$.attributes.color.itemSize===4,Be=!!$.attributes.tangent&&(!!q.normalMap||q.anisotropy>0),Ue=!!$.morphAttributes.position,Ye=!!$.morphAttributes.normal,at=!!$.morphAttributes.color;let pt=Tn;q.toneMapped&&(W===null||W.isXRRenderTarget===!0)&&(pt=M.toneMapping);const mt=$.morphAttributes.position||$.morphAttributes.normal||$.morphAttributes.color,lt=mt!==void 0?mt.length:0,Ne=m.get(q),rt=w.state.lights;if(Re===!0&&(Ke===!0||S!==Y)){const Dt=S===Y&&q.id===K;xe.setState(q,S,Dt)}let Ze=!1;q.version===Ne.__version?(Ne.needsLights&&Ne.lightsStateVersion!==rt.state.version||Ne.outputColorSpace!==Ee||V.isBatchedMesh&&Ne.batching===!1||!V.isBatchedMesh&&Ne.batching===!0||V.isBatchedMesh&&Ne.batchingColor===!0&&V.colorTexture===null||V.isBatchedMesh&&Ne.batchingColor===!1&&V.colorTexture!==null||V.isInstancedMesh&&Ne.instancing===!1||!V.isInstancedMesh&&Ne.instancing===!0||V.isSkinnedMesh&&Ne.skinning===!1||!V.isSkinnedMesh&&Ne.skinning===!0||V.isInstancedMesh&&Ne.instancingColor===!0&&V.instanceColor===null||V.isInstancedMesh&&Ne.instancingColor===!1&&V.instanceColor!==null||V.isInstancedMesh&&Ne.instancingMorph===!0&&V.morphTexture===null||V.isInstancedMesh&&Ne.instancingMorph===!1&&V.morphTexture!==null||Ne.envMap!==Pe||q.fog===!0&&Ne.fog!==ve||Ne.numClippingPlanes!==void 0&&(Ne.numClippingPlanes!==xe.numPlanes||Ne.numIntersection!==xe.numIntersection)||Ne.vertexAlphas!==Ie||Ne.vertexTangents!==Be||Ne.morphTargets!==Ue||Ne.morphNormals!==Ye||Ne.morphColors!==at||Ne.toneMapping!==pt||Ne.morphTargetsCount!==lt)&&(Ze=!0):(Ze=!0,Ne.__version=q.version);let kt=Ne.currentProgram;Ze===!0&&(kt=ss(q,B,V));let Fi=!1,Wt=!1,xr=!1;const ft=kt.getUniforms(),Ot=Ne.uniforms;if(se.useProgram(kt.program)&&(Fi=!0,Wt=!0,xr=!0),q.id!==K&&(K=q.id,Wt=!0),Fi||Y!==S){se.buffers.depth.getReversed()&&S.reversedDepth!==!0&&(S._reversedDepth=!0,S.updateProjectionMatrix()),ft.setValue(b,"projectionMatrix",S.projectionMatrix),ft.setValue(b,"viewMatrix",S.matrixWorldInverse);const Bt=ft.map.cameraPosition;Bt!==void 0&&Bt.setValue(b,I.setFromMatrixPosition(S.matrixWorld)),Q.logarithmicDepthBuffer&&ft.setValue(b,"logDepthBufFC",2/(Math.log(S.far+1)/Math.LN2)),(q.isMeshPhongMaterial||q.isMeshToonMaterial||q.isMeshLambertMaterial||q.isMeshBasicMaterial||q.isMeshStandardMaterial||q.isShaderMaterial)&&ft.setValue(b,"isOrthographic",S.isOrthographicCamera===!0),Y!==S&&(Y=S,Wt=!0,xr=!0)}if(Ne.needsLights&&(rt.state.directionalShadowMap.length>0&&ft.setValue(b,"directionalShadowMap",rt.state.directionalShadowMap,L),rt.state.spotShadowMap.length>0&&ft.setValue(b,"spotShadowMap",rt.state.spotShadowMap,L),rt.state.pointShadowMap.length>0&&ft.setValue(b,"pointShadowMap",rt.state.pointShadowMap,L)),V.isSkinnedMesh){ft.setOptional(b,V,"bindMatrix"),ft.setOptional(b,V,"bindMatrixInverse");const Dt=V.skeleton;Dt&&(Dt.boneTexture===null&&Dt.computeBoneTexture(),ft.setValue(b,"boneTexture",Dt.boneTexture,L))}V.isBatchedMesh&&(ft.setOptional(b,V,"batchingTexture"),ft.setValue(b,"batchingTexture",V._matricesTexture,L),ft.setOptional(b,V,"batchingIdTexture"),ft.setValue(b,"batchingIdTexture",V._indirectTexture,L),ft.setOptional(b,V,"batchingColorTexture"),V._colorsTexture!==null&&ft.setValue(b,"batchingColorTexture",V._colorsTexture,L));const Zt=$.morphAttributes;if((Zt.position!==void 0||Zt.normal!==void 0||Zt.color!==void 0)&&Ge.update(V,$,kt),(Wt||Ne.receiveShadow!==V.receiveShadow)&&(Ne.receiveShadow=V.receiveShadow,ft.setValue(b,"receiveShadow",V.receiveShadow)),q.isMeshGouraudMaterial&&q.envMap!==null&&(Ot.envMap.value=Pe,Ot.flipEnvMap.value=Pe.isCubeTexture&&Pe.isRenderTargetTexture===!1?-1:1),q.isMeshStandardMaterial&&q.envMap===null&&B.environment!==null&&(Ot.envMapIntensity.value=B.environmentIntensity),Ot.dfgLUT!==void 0&&(Ot.dfgLUT.value=aS()),Wt&&(ft.setValue(b,"toneMappingExposure",M.toneMappingExposure),Ne.needsLights&&_h(Ot,xr),ve&&q.fog===!0&&Le.refreshFogUniforms(Ot,ve),Le.refreshMaterialUniforms(Ot,q,Fe,De,w.state.transmissionRenderTarget[S.id]),Vs.upload(b,Jl(Ne),Ot,L)),q.isShaderMaterial&&q.uniformsNeedUpdate===!0&&(Vs.upload(b,Jl(Ne),Ot,L),q.uniformsNeedUpdate=!1),q.isSpriteMaterial&&ft.setValue(b,"center",V.center),ft.setValue(b,"modelViewMatrix",V.modelViewMatrix),ft.setValue(b,"normalMatrix",V.normalMatrix),ft.setValue(b,"modelMatrix",V.matrixWorld),q.isShaderMaterial||q.isRawShaderMaterial){const Dt=q.uniformsGroups;for(let Bt=0,ma=Dt.length;Bt<ma;Bt++){const xi=Dt[Bt];he.update(xi,kt),he.bind(xi,kt)}}return kt}function _h(S,B){S.ambientLightColor.needsUpdate=B,S.lightProbe.needsUpdate=B,S.directionalLights.needsUpdate=B,S.directionalLightShadows.needsUpdate=B,S.pointLights.needsUpdate=B,S.pointLightShadows.needsUpdate=B,S.spotLights.needsUpdate=B,S.spotLightShadows.needsUpdate=B,S.rectAreaLights.needsUpdate=B,S.hemisphereLights.needsUpdate=B}function xh(S){return S.isMeshLambertMaterial||S.isMeshToonMaterial||S.isMeshPhongMaterial||S.isMeshStandardMaterial||S.isShadowMaterial||S.isShaderMaterial&&S.lights===!0}this.getActiveCubeFace=function(){return F},this.getActiveMipmapLevel=function(){return Z},this.getRenderTarget=function(){return W},this.setRenderTargetTextures=function(S,B,$){const q=m.get(S);q.__autoAllocateDepthBuffer=S.resolveDepthBuffer===!1,q.__autoAllocateDepthBuffer===!1&&(q.__useRenderToTexture=!1),m.get(S.texture).__webglTexture=B,m.get(S.depthTexture).__webglTexture=q.__autoAllocateDepthBuffer?void 0:$,q.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(S,B){const $=m.get(S);$.__webglFramebuffer=B,$.__useDefaultFramebuffer=B===void 0};const vh=b.createFramebuffer();this.setRenderTarget=function(S,B=0,$=0){W=S,F=B,Z=$;let q=null,V=!1,ve=!1;if(S){const Ee=m.get(S);if(Ee.__useDefaultFramebuffer!==void 0){se.bindFramebuffer(b.FRAMEBUFFER,Ee.__webglFramebuffer),U.copy(S.viewport),D.copy(S.scissor),N=S.scissorTest,se.viewport(U),se.scissor(D),se.setScissorTest(N),K=-1;return}else if(Ee.__webglFramebuffer===void 0)L.setupRenderTarget(S);else if(Ee.__hasExternalTextures)L.rebindTextures(S,m.get(S.texture).__webglTexture,m.get(S.depthTexture).__webglTexture);else if(S.depthBuffer){const Be=S.depthTexture;if(Ee.__boundDepthTexture!==Be){if(Be!==null&&m.has(Be)&&(S.width!==Be.image.width||S.height!==Be.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");L.setupDepthRenderbuffer(S)}}const Pe=S.texture;(Pe.isData3DTexture||Pe.isDataArrayTexture||Pe.isCompressedArrayTexture)&&(ve=!0);const Ie=m.get(S).__webglFramebuffer;S.isWebGLCubeRenderTarget?(Array.isArray(Ie[B])?q=Ie[B][$]:q=Ie[B],V=!0):S.samples>0&&L.useMultisampledRTT(S)===!1?q=m.get(S).__webglMultisampledFramebuffer:Array.isArray(Ie)?q=Ie[$]:q=Ie,U.copy(S.viewport),D.copy(S.scissor),N=S.scissorTest}else U.copy(te).multiplyScalar(Fe).floor(),D.copy(oe).multiplyScalar(Fe).floor(),N=we;if($!==0&&(q=vh),se.bindFramebuffer(b.FRAMEBUFFER,q)&&se.drawBuffers(S,q),se.viewport(U),se.scissor(D),se.setScissorTest(N),V){const Ee=m.get(S.texture);b.framebufferTexture2D(b.FRAMEBUFFER,b.COLOR_ATTACHMENT0,b.TEXTURE_CUBE_MAP_POSITIVE_X+B,Ee.__webglTexture,$)}else if(ve){const Ee=B;for(let Pe=0;Pe<S.textures.length;Pe++){const Ie=m.get(S.textures[Pe]);b.framebufferTextureLayer(b.FRAMEBUFFER,b.COLOR_ATTACHMENT0+Pe,Ie.__webglTexture,$,Ee)}}else if(S!==null&&$!==0){const Ee=m.get(S.texture);b.framebufferTexture2D(b.FRAMEBUFFER,b.COLOR_ATTACHMENT0,b.TEXTURE_2D,Ee.__webglTexture,$)}K=-1},this.readRenderTargetPixels=function(S,B,$,q,V,ve,Ce,Ee=0){if(!(S&&S.isWebGLRenderTarget)){Je("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Pe=m.get(S).__webglFramebuffer;if(S.isWebGLCubeRenderTarget&&Ce!==void 0&&(Pe=Pe[Ce]),Pe){se.bindFramebuffer(b.FRAMEBUFFER,Pe);try{const Ie=S.textures[Ee],Be=Ie.format,Ue=Ie.type;if(!Q.textureFormatReadable(Be)){Je("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!Q.textureTypeReadable(Ue)){Je("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}B>=0&&B<=S.width-q&&$>=0&&$<=S.height-V&&(S.textures.length>1&&b.readBuffer(b.COLOR_ATTACHMENT0+Ee),b.readPixels(B,$,q,V,pe.convert(Be),pe.convert(Ue),ve))}finally{const Ie=W!==null?m.get(W).__webglFramebuffer:null;se.bindFramebuffer(b.FRAMEBUFFER,Ie)}}},this.readRenderTargetPixelsAsync=async function(S,B,$,q,V,ve,Ce,Ee=0){if(!(S&&S.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Pe=m.get(S).__webglFramebuffer;if(S.isWebGLCubeRenderTarget&&Ce!==void 0&&(Pe=Pe[Ce]),Pe)if(B>=0&&B<=S.width-q&&$>=0&&$<=S.height-V){se.bindFramebuffer(b.FRAMEBUFFER,Pe);const Ie=S.textures[Ee],Be=Ie.format,Ue=Ie.type;if(!Q.textureFormatReadable(Be))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!Q.textureTypeReadable(Ue))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const Ye=b.createBuffer();b.bindBuffer(b.PIXEL_PACK_BUFFER,Ye),b.bufferData(b.PIXEL_PACK_BUFFER,ve.byteLength,b.STREAM_READ),S.textures.length>1&&b.readBuffer(b.COLOR_ATTACHMENT0+Ee),b.readPixels(B,$,q,V,pe.convert(Be),pe.convert(Ue),0);const at=W!==null?m.get(W).__webglFramebuffer:null;se.bindFramebuffer(b.FRAMEBUFFER,at);const pt=b.fenceSync(b.SYNC_GPU_COMMANDS_COMPLETE,0);return b.flush(),await Am(b,pt,4),b.bindBuffer(b.PIXEL_PACK_BUFFER,Ye),b.getBufferSubData(b.PIXEL_PACK_BUFFER,0,ve),b.deleteBuffer(Ye),b.deleteSync(pt),ve}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(S,B=null,$=0){const q=Math.pow(2,-$),V=Math.floor(S.image.width*q),ve=Math.floor(S.image.height*q),Ce=B!==null?B.x:0,Ee=B!==null?B.y:0;L.setTexture2D(S,0),b.copyTexSubImage2D(b.TEXTURE_2D,$,0,0,Ce,Ee,V,ve),se.unbindTexture()};const Sh=b.createFramebuffer(),Mh=b.createFramebuffer();this.copyTextureToTexture=function(S,B,$=null,q=null,V=0,ve=null){ve===null&&(V!==0?(Kr("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),ve=V,V=0):ve=0);let Ce,Ee,Pe,Ie,Be,Ue,Ye,at,pt;const mt=S.isCompressedTexture?S.mipmaps[ve]:S.image;if($!==null)Ce=$.max.x-$.min.x,Ee=$.max.y-$.min.y,Pe=$.isBox3?$.max.z-$.min.z:1,Ie=$.min.x,Be=$.min.y,Ue=$.isBox3?$.min.z:0;else{const Zt=Math.pow(2,-V);Ce=Math.floor(mt.width*Zt),Ee=Math.floor(mt.height*Zt),S.isDataArrayTexture?Pe=mt.depth:S.isData3DTexture?Pe=Math.floor(mt.depth*Zt):Pe=1,Ie=0,Be=0,Ue=0}q!==null?(Ye=q.x,at=q.y,pt=q.z):(Ye=0,at=0,pt=0);const lt=pe.convert(B.format),Ne=pe.convert(B.type);let rt;B.isData3DTexture?(L.setTexture3D(B,0),rt=b.TEXTURE_3D):B.isDataArrayTexture||B.isCompressedArrayTexture?(L.setTexture2DArray(B,0),rt=b.TEXTURE_2D_ARRAY):(L.setTexture2D(B,0),rt=b.TEXTURE_2D),b.pixelStorei(b.UNPACK_FLIP_Y_WEBGL,B.flipY),b.pixelStorei(b.UNPACK_PREMULTIPLY_ALPHA_WEBGL,B.premultiplyAlpha),b.pixelStorei(b.UNPACK_ALIGNMENT,B.unpackAlignment);const Ze=b.getParameter(b.UNPACK_ROW_LENGTH),kt=b.getParameter(b.UNPACK_IMAGE_HEIGHT),Fi=b.getParameter(b.UNPACK_SKIP_PIXELS),Wt=b.getParameter(b.UNPACK_SKIP_ROWS),xr=b.getParameter(b.UNPACK_SKIP_IMAGES);b.pixelStorei(b.UNPACK_ROW_LENGTH,mt.width),b.pixelStorei(b.UNPACK_IMAGE_HEIGHT,mt.height),b.pixelStorei(b.UNPACK_SKIP_PIXELS,Ie),b.pixelStorei(b.UNPACK_SKIP_ROWS,Be),b.pixelStorei(b.UNPACK_SKIP_IMAGES,Ue);const ft=S.isDataArrayTexture||S.isData3DTexture,Ot=B.isDataArrayTexture||B.isData3DTexture;if(S.isDepthTexture){const Zt=m.get(S),Dt=m.get(B),Bt=m.get(Zt.__renderTarget),ma=m.get(Dt.__renderTarget);se.bindFramebuffer(b.READ_FRAMEBUFFER,Bt.__webglFramebuffer),se.bindFramebuffer(b.DRAW_FRAMEBUFFER,ma.__webglFramebuffer);for(let xi=0;xi<Pe;xi++)ft&&(b.framebufferTextureLayer(b.READ_FRAMEBUFFER,b.COLOR_ATTACHMENT0,m.get(S).__webglTexture,V,Ue+xi),b.framebufferTextureLayer(b.DRAW_FRAMEBUFFER,b.COLOR_ATTACHMENT0,m.get(B).__webglTexture,ve,pt+xi)),b.blitFramebuffer(Ie,Be,Ce,Ee,Ye,at,Ce,Ee,b.DEPTH_BUFFER_BIT,b.NEAREST);se.bindFramebuffer(b.READ_FRAMEBUFFER,null),se.bindFramebuffer(b.DRAW_FRAMEBUFFER,null)}else if(V!==0||S.isRenderTargetTexture||m.has(S)){const Zt=m.get(S),Dt=m.get(B);se.bindFramebuffer(b.READ_FRAMEBUFFER,Sh),se.bindFramebuffer(b.DRAW_FRAMEBUFFER,Mh);for(let Bt=0;Bt<Pe;Bt++)ft?b.framebufferTextureLayer(b.READ_FRAMEBUFFER,b.COLOR_ATTACHMENT0,Zt.__webglTexture,V,Ue+Bt):b.framebufferTexture2D(b.READ_FRAMEBUFFER,b.COLOR_ATTACHMENT0,b.TEXTURE_2D,Zt.__webglTexture,V),Ot?b.framebufferTextureLayer(b.DRAW_FRAMEBUFFER,b.COLOR_ATTACHMENT0,Dt.__webglTexture,ve,pt+Bt):b.framebufferTexture2D(b.DRAW_FRAMEBUFFER,b.COLOR_ATTACHMENT0,b.TEXTURE_2D,Dt.__webglTexture,ve),V!==0?b.blitFramebuffer(Ie,Be,Ce,Ee,Ye,at,Ce,Ee,b.COLOR_BUFFER_BIT,b.NEAREST):Ot?b.copyTexSubImage3D(rt,ve,Ye,at,pt+Bt,Ie,Be,Ce,Ee):b.copyTexSubImage2D(rt,ve,Ye,at,Ie,Be,Ce,Ee);se.bindFramebuffer(b.READ_FRAMEBUFFER,null),se.bindFramebuffer(b.DRAW_FRAMEBUFFER,null)}else Ot?S.isDataTexture||S.isData3DTexture?b.texSubImage3D(rt,ve,Ye,at,pt,Ce,Ee,Pe,lt,Ne,mt.data):B.isCompressedArrayTexture?b.compressedTexSubImage3D(rt,ve,Ye,at,pt,Ce,Ee,Pe,lt,mt.data):b.texSubImage3D(rt,ve,Ye,at,pt,Ce,Ee,Pe,lt,Ne,mt):S.isDataTexture?b.texSubImage2D(b.TEXTURE_2D,ve,Ye,at,Ce,Ee,lt,Ne,mt.data):S.isCompressedTexture?b.compressedTexSubImage2D(b.TEXTURE_2D,ve,Ye,at,mt.width,mt.height,lt,mt.data):b.texSubImage2D(b.TEXTURE_2D,ve,Ye,at,Ce,Ee,lt,Ne,mt);b.pixelStorei(b.UNPACK_ROW_LENGTH,Ze),b.pixelStorei(b.UNPACK_IMAGE_HEIGHT,kt),b.pixelStorei(b.UNPACK_SKIP_PIXELS,Fi),b.pixelStorei(b.UNPACK_SKIP_ROWS,Wt),b.pixelStorei(b.UNPACK_SKIP_IMAGES,xr),ve===0&&B.generateMipmaps&&b.generateMipmap(rt),se.unbindTexture()},this.initRenderTarget=function(S){m.get(S).__webglFramebuffer===void 0&&L.setupRenderTarget(S)},this.initTexture=function(S){S.isCubeTexture?L.setTextureCube(S,0):S.isData3DTexture?L.setTexture3D(S,0):S.isDataArrayTexture||S.isCompressedArrayTexture?L.setTexture2DArray(S,0):L.setTexture2D(S,0),se.unbindTexture()},this.resetState=function(){F=0,Z=0,W=null,se.reset(),Ae.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return En}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=je._getDrawingBufferColorSpace(e),t.unpackColorSpace=je._getUnpackColorSpace()}}const tr=window.innerWidth<768,$t={particleCount:tr?8e3:15e3,particleSize:tr?1.5:1,textScale:tr?.12:.15,canvasFont:tr?'900 80px "Microsoft YaHei", sans-serif':'900 120px "Microsoft YaHei", sans-serif'},lS=["快乐","喜悦","平静","爱","感恩","希望","自豪","兴奋","幽默","悲伤","愤怒","恐惧","焦虑","羞愧","嫉妒","孤独","内疚","厌恶"];function Qi(n){const e=document.createElement("canvas"),t=e.getContext("2d");e.width=tr?512:1024,e.height=256,t.fillStyle="black",t.fillRect(0,0,e.width,e.height),t.fillStyle="white",t.font=$t.canvasFont,t.textAlign="center",t.textBaseline="middle",t.fillText(n,e.width/2,e.height/2);const i=t.getImageData(0,0,e.width,e.height),r=[],s=tr?3:2;for(let a=0;a<e.height;a+=s)for(let o=0;o<e.width;o+=s)i.data[(a*e.width+o)*4]>100&&r.push({x:(o-e.width/2)*$t.textScale,y:-(a-e.height/2)*$t.textScale,z:0});return r}function cS(n){const e=[];for(let t=0;t<n;t++){const i=(Math.random()-.5)*200;let r=Math.sqrt(Math.pow(i,2))*.5+2;Math.abs(i)>90&&(r=55);const s=Math.random()*Math.PI*2;Math.random()>.8&&(r*=Math.random()),e.push({x:r*Math.cos(s),y:i,z:r*Math.sin(s)})}return e}function uS(n){const e=[];for(let s=0;s<n;s++)e.push({x:(Math.random()-.5)*100,y:(Math.random()-.5)*40-140,z:(Math.random()-.5)*60});return e}function fS(n){const e=[];for(let t=0;t<n;t++){const i=t<n/2,r=i?-50:50;let s="glass",a=(Math.random()-.5)*100,o=25,l=Math.random()*Math.PI*2;Math.random()>.4&&a<30&&a>-45&&(s="liquid",o=Math.random()*23,a>25&&(s="foam"));let c=o*Math.cos(l),u=o*Math.sin(l),f=a;s==="glass"&&a>-10&&a<30&&Math.abs(l-(i?Math.PI:0))<.6&&(c+=i?-15:15,s="handle"),e.push({x:c+r,y:f,z:u,type:s,isLeft:i,baseX:c+r})}return e}function hS(n){const e=[];for(let t=0;t<n;t++){const i=(Math.random()-.5)*180;let r=0;i>50?r=18*(90-i)/40:i>-70?r=18:r=18+(-70-i)*1.5;const s=Math.random()*Math.PI*2;i<50&&i>-70&&Math.random()>.3&&(r*=Math.random()),e.push({x:r*Math.cos(s),y:i,z:r*Math.sin(s)})}return e}function dS(n){const e=[],i=n-1e3;for(let r=0;r<i;r++){const s=Math.random();let a,o,l;a=(s-.5)*360,o=-6e-4*a*a+20,l=(Math.random()-.5)*60,Math.abs(l)>25?o+=Math.random()*15:o-=Math.random()*10;let u=s>.42&&s<.58,f=o;u&&(f=-200-Math.random()*80),e.push({x:a,y:f,z:l,targetY:o,type:"bridge",isBrokenPart:u})}for(let r=0;r<1e3;r++){const s=Math.random();let a=0,o=0;if(s<.2){const l=Math.random()*Math.PI*2,c=Math.random()*3;a=Math.cos(l)*c,o=14+Math.sin(l)*c}else s<.6?(a=(Math.random()-.5)*3,o=Math.random()*10+2):(a=(Math.random()-.5)*6,o=Math.random()*8);e.push({x:-200,y:0,z:(Math.random()-.5)*30,type:"man",offsetX:a,offsetY:o,part:s})}return e}const ha=(n,e)=>{const t=n.__vccOpts||n;for(const[i,r]of e)t[i]=r;return t},pS={__name:"ParticleScene",props:{currentShape:String,triggerState:Number,currentTheme:String},setup(n){const e=n,t=xn(null);let i,r,s,a,o,l=[],c,u=0,f=[],h=[],p=[],_=[],x=[],g=[],d=[],T=[],A=0,y=[],w=[],R=[],P=[];const z=async()=>{i=new Zm,i.fog=new Wl(0,.002),r=new en(75,window.innerWidth/window.innerHeight,.1,1e3),r.position.z=130,s=new oS({antialias:!0,alpha:!0}),s.setSize(window.innerWidth,window.innerHeight),s.setPixelRatio(Math.min(window.devicePixelRatio,2)),t.value&&t.value.appendChild(s.domElement),M(),Z()},M=()=>{o=new dn;const K=$t.particleCount,Y=new Float32Array(K*3),U=new Float32Array(K*3);l=new Float32Array(K*3);for(let ne=0;ne<K;ne++)Y[ne*3]=(Math.random()-.5)*800,Y[ne*3+1]=(Math.random()-.5)*800,Y[ne*3+2]=(Math.random()-.5)*800,U[ne*3]=1,U[ne*3+1]=1,U[ne*3+2]=1;o.setAttribute("position",new rn(Y,3)),o.setAttribute("color",new rn(U,3));const D=new ug().load("https://threejs.org/examples/textures/sprites/spark1.png"),N=new ah({size:$t.particleSize,map:D,transparent:!0,opacity:.95,vertexColors:!0,blending:_o,depthWrite:!1});a=new ng(o,N),i.add(a),E()},E=()=>{u=0,A=0;let K=[];const Y=$t.particleCount;if(e.currentShape==="hourglass")f.length===0&&(f=cS(Y*.7),h=Qi("2025"),p=Qi("今年辛苦啦")),K=[...f];else if(e.currentShape==="fireworks"){_.length===0&&(_=uS(Y)),x.length===0&&(x=lS.map(N=>Qi(N))),g=[];const U=350;let D=_.length;for(let N=0;N<18;N++){const ne=[];for(let ce=0;ce<U;ce++)D<Y&&ne.push(D++);g.push({state:0,timer:0,targetWord:x[N],particlesIndices:ne})}K=_}else e.currentShape==="beer"?(d.length===0&&(d=fS(Y*.9),T=Qi("2025 有你相伴")),K=d):e.currentShape==="rocket"?(y.length===0&&(y=hS(Y),w=Qi("2026新年快乐")),K=y):e.currentShape==="bridge"&&(R.length===0&&(R=dS(Y*.9),P=Qi("2026 与你同行")),K=R);for(let U=0;U<Y;U++){const D=U*3;U<K.length?(l[D]=K[U].x,l[D+1]=K[U].y,l[D+2]=K[U].z):(l[D]=(Math.random()-.5)*600,l[D+1]=(Math.random()-.5)*600,l[D+2]=(Math.random()-.5)*200-150)}F()},F=()=>{if(!o)return;const K=o.attributes.color;for(let Y=0;Y<$t.particleCount;Y++){let U,D,N;const ne=Math.random();e.currentTheme==="warm"?ne>.6?(U=1,D=.8,N=.2):ne>.3?(U=1,D=.5,N=.1):(U=1,D=.9,N=.8):ne>.6?(U=.1,D=.9,N=1):ne>.3?(U=.6,D=.1,N=1):(U=.9,D=1,N=1),e.currentShape==="beer"&&Y<d.length&&d[Y].type==="liquid"&&(U=1,D=.65,N=0),K.setXYZ(Y,U,D,N)}K.needsUpdate=!0},Z=()=>{c=requestAnimationFrame(Z);const K=o.attributes.position.array;if(u+=.01,e.currentShape==="hourglass")for(let D=0;D<$t.particleCount;D++){const N=D*3;if(D<f.length){const ne=l[N],ce=l[N+2],de=Math.atan2(ce,ne)+.003,De=Math.sqrt(ne*ne+ce*ce);l[N]=De*Math.cos(de),l[N+2]=De*Math.sin(de)}else{const ne=D-f.length,ce=h.length,de=p.length,De=ne%800*.005,Fe=u-De;if(Fe<0){const Oe=h[ne%ce];l[N]=Oe.x,l[N+1]=Oe.y+45,l[N+2]=Oe.z}else if(Fe<3){const Oe=Fe/3;l[N]=(Math.random()-.5)*3,l[N+1]=45-Oe*90,l[N+2]=(Math.random()-.5)*3}else{const Oe=p[ne%de];l[N]=Oe.x,l[N+1]=Oe.y-45,l[N+2]=Oe.z}}}else if(e.currentShape==="fireworks"){for(let U=0;U<_.length;U++)Math.random()>.99?l[U*3+1]+=20:l[U*3+1]+=(_[U].y-l[U*3+1])*.1;if(e.triggerState>=1){const D=Math.floor(u*100);g.forEach((N,ne)=>{if(D>ne*20&&N.state===0&&(N.state=1),N.state>0){N.timer++;const ce=N.state===1,de=N.state===2,De=N.state===3;N.particlesIndices.forEach(Fe=>{const Oe=Fe*3;if(ce)l[Oe]=(Math.random()-.5)*5,l[Oe+1]+=4,l[Oe+2]=(Math.random()-.5)*5,N.timer>35&&(N.state=2);else if(de){const Qe=N.targetWord[Fe%N.targetWord.length],te=(Math.random()-.5)*200,oe=50+(Math.random()-.5)*80;l[Oe]+=(Qe.x+te-l[Oe])*.15,l[Oe+1]+=(Qe.y+oe-l[Oe+1])*.15,l[Oe+2]+=(Qe.z-l[Oe+2])*.15,N.timer>120&&(N.state=3)}else De&&(l[Oe]*=1.1,l[Oe+1]+=2,l[Oe+2]*=1.1)})}})}}else if(e.currentShape==="beer"){e.triggerState>=1&&A++;for(let U=0;U<$t.particleCount;U++){const D=U*3;if(U<d.length){const N=d[U];let ne=N.x,ce=N.y;if(e.triggerState>=1){const de=Math.min(20,A*.5);if(N.isLeft?ne+=de:ne-=de,A>50&&N.type==="liquid"&&Math.random()>.98){l[D+1]+=2;continue}}N.type==="liquid"&&(ce+=Math.sin(u*4+ne*.1)),l[D]=ne,l[D+1]=ce}else if(A>250){const N=U-d.length,ne=T[N%T.length];l[D]+=(ne.x-l[D])*.05,l[D+1]+=(ne.y-60-l[D+1])*.05,l[D+2]+=(ne.z-l[D+2])*.05}else l[D]=0,l[D+1]=-500}if(A>300)for(let U=0;U<d.length;U++)l[U*3+1]-=3}else if(e.currentShape==="rocket"){if(e.triggerState===1)for(let U=0;U<$t.particleCount;U++)l[U*3+1]+=6,Math.random()>.6&&(l[U*3+1]-=15);else if(e.triggerState===2)for(let U=0;U<$t.particleCount;U++){const D=U*3;if(U<w.length){const N=w[U];l[D]=N.x,l[D+1]=N.y,l[D+2]=N.z}else l[D]*=1.1}}else if(e.currentShape==="bridge"&&e.triggerState>=1)for(let U=0;U<$t.particleCount;U++){const D=U*3;if(U<R.length){const N=R[U];if(N.isBrokenPart&&(l[D+1]+=(N.targetY-l[D+1])*.03),N.type==="man"){let ce=(u*180+U)%400-200,de=N.offsetX,De=N.offsetY;de+=Math.sin(u*25)*4,De+=Math.abs(Math.cos(u*25))*3,l[D]=ce+de;const Fe=-6e-4*ce*ce+20;l[D+1]=Fe+De,l[D+2]=N.z}}else{const N=U-R.length,ne=P[N%P.length];l[D]=ne.x,l[D+1]=ne.y-60,l[D+2]=ne.z}}const Y=.12;for(let U=0;U<$t.particleCount;U++){const D=U*3;K[D]+=(l[D]-K[D])*Y,K[D+1]+=(l[D+1]-K[D+1])*Y,K[D+2]+=(l[D+2]-K[D+2])*Y}o.attributes.position.needsUpdate=!0,s.render(i,r)};Nr(()=>e.currentShape,E),Nr(()=>e.currentTheme,F),af(()=>{z(),window.addEventListener("resize",W)}),Cl(()=>{cancelAnimationFrame(c),window.removeEventListener("resize",W)});const W=()=>{!r||!s||(r.aspect=window.innerWidth/window.innerHeight,r.updateProjectionMatrix(),s.setSize(window.innerWidth,window.innerHeight),E())};return(K,Y)=>(bn(),Gn("div",{ref_key:"canvasContainer",ref:t,class:"canvas-wrapper"},null,512))}},mS=ha(pS,[["__scopeId","data-v-92e8d8ee"]]),gS={id:"ui-container"},_S={class:"panel-card"},xS={class:"year-group"},vS={class:"year-item"},SS={key:0,class:"hint-wrap"},MS={class:"sub-hint"},ES={class:"year-item"},yS={key:0,class:"hint-wrap"},bS={class:"sub-hint"},TS={__name:"ControlPanel",props:{currentYear:String,sceneIndex:Number},emits:["select-year"],setup(n){const e=n,t=Il(()=>{if(e.currentYear==="2025"){if(e.sceneIndex===0)return"流沙: 自动播放";if(e.sceneIndex===1)return"✌️剪刀手: 18连发烟花";if(e.sceneIndex===2)return"✊握拳: 干杯碰撞"}else{if(e.sceneIndex===0)return"🖐️上滑: 发射火箭";if(e.sceneIndex===1)return"✊握拳: 断桥重连"}return"互动准备就绪"});return(i,r)=>(bn(),Gn("div",gS,[vt("div",_S,[vt("div",xS,[vt("div",vS,[vt("button",{class:cr(["year-btn y25",{active:n.currentYear==="2025"}]),onClick:r[0]||(r[0]=s=>i.$emit("select-year","2025"))}," 2025 ",2),n.currentYear==="2025"?(bn(),Gn("div",SS,[r[2]||(r[2]=vt("div",{class:"main-hint"},"👋 左 → 右 切页",-1)),vt("div",MS,Hs(t.value),1)])):Ys("",!0)]),r[4]||(r[4]=vt("div",{class:"divider"},null,-1)),vt("div",ES,[vt("button",{class:cr(["year-btn y26",{active:n.currentYear==="2026"}]),onClick:r[1]||(r[1]=s=>i.$emit("select-year","2026"))}," 2026 ",2),n.currentYear==="2026"?(bn(),Gn("div",yS,[r[3]||(r[3]=vt("div",{class:"main-hint"},"👋 右 ← 左 切页",-1)),vt("div",bS,Hs(t.value),1)])):Ys("",!0)])])])]))}},AS=ha(TS,[["__scopeId","data-v-096cec97"]]);function yu(n){return new Promise((e,t)=>{if(document.querySelector(`script[src="${n}"]`)){e();return}const i=document.createElement("script");i.src=n,i.async=!0,i.crossOrigin="anonymous",i.onload=()=>e(),i.onerror=()=>t(new Error(`Script load error: ${n}`)),document.head.appendChild(i)})}const wS={class:"camera-wrapper"},RS={__name:"CameraInput",props:{isActive:Boolean},emits:["status-change","camera-error","gesture","hand-x","hand-y"],setup(n,{expose:e,emit:t}){const i=n,r=t,s=xn(null),a=xn(null);let o=null,l=null,c=-1;const u=(_,x)=>Math.sqrt(Math.pow(_.x-x.x,2)+Math.pow(_.y-x.y,2)),f=async()=>{try{r("status-change","引擎启动中..."),await Promise.all([yu("https://cdn.jsdelivr.net/npm/@mediapipe/hands/hands.js"),yu("https://cdn.jsdelivr.net/npm/@mediapipe/drawing_utils/drawing_utils.js")]);const _=window.Hands;o=new _({locateFile:g=>`https://cdn.jsdelivr.net/npm/@mediapipe/hands/${g}`}),o.setOptions({maxNumHands:1,modelComplexity:0,minDetectionConfidence:.3,minTrackingConfidence:.3}),o.onResults(p);const x=await navigator.mediaDevices.getUserMedia({video:{facingMode:"user",width:{ideal:320},height:{ideal:240}}});s.value.srcObject=x,s.value.onloadedmetadata=()=>{s.value.play(),a.value.width=s.value.videoWidth,a.value.height=s.value.videoHeight,r("status-change","准备就绪"),h()}}catch(_){console.error(_),r("camera-error",_.name==="NotAllowedError"?"NO_PERMISSION":"NO_HARDWARE")}},h=async()=>{i.isActive&&(s.value&&s.value.readyState>=2&&s.value.currentTime!==c&&(c=s.value.currentTime,o&&await o.send({image:s.value})),l=requestAnimationFrame(h))},p=_=>{if(!a.value)return;const x=a.value.getContext("2d"),g=a.value.width,d=a.value.height;if(x.save(),x.clearRect(0,0,g,d),x.translate(g,0),x.scale(-1,1),x.drawImage(_.image,0,0,g,d),_.multiHandLandmarks&&_.multiHandLandmarks.length>0){const T=_.multiHandLandmarks[0];window.drawConnectors&&window.drawConnectors(x,T,window.HAND_CONNECTIONS,{color:"#00d2ff",lineWidth:2}),r("hand-x",T[0].x),r("hand-y",T[0].y);const A=(M,E)=>u(T[0],T[M])>u(T[0],T[E])*1,y=A(8,6),w=A(12,10),R=A(16,14),P=A(20,18);let z="NONE";y&&w&&!R&&!P?z="VICTORY":!y&&!w&&!R&&!P?z="FIST":(y&&w&&R||w&&R&&P)&&(z="PALM"),r("gesture",z)}x.restore()};return e({startCamera:f}),Cl(()=>{s.value?.srcObject&&s.value.srcObject.getTracks().forEach(_=>_.stop()),cancelAnimationFrame(l),o&&o.close()}),(_,x)=>(bn(),Gn("div",wS,[vt("video",{ref_key:"inputVideo",ref:s,playsinline:"","webkit-playsinline":"",style:{display:"none"}},null,512),pd(vt("canvas",{ref_key:"previewCanvas",ref:a,class:"video-preview"},null,512),[[Ap,n.isActive]])]))}},CS=ha(RS,[["__scopeId","data-v-3cb2676e"]]),PS={key:0,id:"overlay"},DS={__name:"IntroOverlay",props:{visible:Boolean,showGuide:Boolean},emits:["select-mode"],setup(n){return(e,t)=>(bn(),Gn(ln,null,[n.visible?(bn(),Gn("div",PS,[t[2]||(t[2]=vt("h2",{class:"title"},"Lynx",-1)),t[3]||(t[3]=vt("div",{class:"msg-box"},"请选择交互方式",-1)),vt("button",{id:"btn-cam",class:"action-btn",onClick:t[0]||(t[0]=i=>e.$emit("select-mode","camera"))},"开启摄像头"),vt("button",{id:"btn-touch",class:"action-btn",onClick:t[1]||(t[1]=i=>e.$emit("select-mode","touch"))},"触屏 / 鼠标模式")])):Ys("",!0),vt("div",{id:"touch-guide",class:cr({show:n.showGuide})},"⟵ 滑动屏幕控制扩散 ⟶",2)],64))}},LS=ha(DS,[["__scopeId","data-v-da6579d6"]]),IS={class:"app-container"},US={key:0,class:"status-tip"},NS={__name:"App",setup(n){const e=xn("2025"),t=xn(0),i=xn("warm"),r=xn(0),s=xn(""),a=xn(!0),o=xn(null),l={2025:["hourglass","fireworks","beer"],2026:["rocket","bridge"]},c=Il(()=>l[e.value][t.value]);let u=-1,f=-1,h=!1;const p=R=>{a.value=!1,R==="camera"&&o.value.startCamera()},_=R=>{e.value=R,t.value=0,r.value=0,i.value=R==="2025"?"warm":"cyber"},x=R=>{if(h)return;if(u===-1){u=R;return}const P=R-u;u=R;const z=.04;(e.value==="2025"&&P>z||e.value==="2026"&&P<-z)&&g()},g=()=>{h=!0,r.value=0;const R=l[e.value].length;t.value=(t.value+1)%R,s.value="切换场景...",setTimeout(()=>h=!1,1500)},d=R=>{if(h||r.value!==0)return;if(f===-1){f=R;return}const P=R-f;f=R,P<-.05&&c.value==="rocket"&&y(2e3)};let T=0;const A=R=>{if(!(h||r.value!==0))if(c.value==="fireworks"&&R==="VICTORY")T++,T>3&&y(0);else if((c.value==="beer"||c.value==="bridge")&&R==="FIST"){if(T++,T>5){const P=c.value==="beer"?5e3:2e3;y(P)}}else T=0},y=R=>{h=!0,r.value=1,s.value="特效触发!",R>0?setTimeout(()=>{r.value=2,setTimeout(()=>{h=!1},3e3)},R):setTimeout(()=>{h=!1},2e3)},w=R=>{s.value="摄像头错误: "+R};return(R,P)=>(bn(),Gn("div",IS,[jt(mS,{currentShape:c.value,currentTheme:i.value,triggerState:r.value},null,8,["currentShape","currentTheme","triggerState"]),jt(CS,{ref_key:"cameraInputRef",ref:o,isActive:"",onStatusChange:P[0]||(P[0]=z=>s.value=z),onCameraError:w,onHandX:x,onHandY:d,onGesture:A},null,512),jt(AS,{currentYear:e.value,sceneIndex:t.value,onSelectYear:_},null,8,["currentYear","sceneIndex"]),jt(LS,{visible:a.value,onSelectMode:p},null,8,["visible"]),s.value?(bn(),Gn("div",US,Hs(s.value),1)):Ys("",!0)]))}};kp(NS).mount("#app");
